...
// node_modules/mermaid/dist/chunks/mermaid.core/kanban-definition-UXKFOSKX.mjs
var ie = (function() {
  var e = /* @__PURE__ */ o(function(O, i, n, s) {
    for (n = n || {}, s = O.length; s--; n[O[s]] = i) ;
    return n;
  }, "o"), u = [1, 4], p = [1, 13], r = [1, 12], d = [1, 15], k = [1, 16], m = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], E = [6, 7, 11], U = [1, 31], N = [6, 7, 11, 24], j = [1, 6, 13, 16, 17, 20, 23], f = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], H = [1, 38], T = {
    ...
    performAction: /* @__PURE__ */ o(function(i, n, s, a, h, t, R) {
      var c = t.length - 1;
      switch (h) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: u }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: u }, { 6: p, 7: [1, 10], 9: 9, 12: 11, 13: r, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l }, e(D, [2, 3]), { 1: [2, 2] }, e(D, [2, 4]), e(D, [2, 5]), { 1: [2, 6], 6: p, 12: 21, 13: r, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l }, { 6: p, 9: 22, 12: 11, 13: r, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l }, { 6: I, 7: g, 10: 23, 11: w }, e(E, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: m, 23: l }), e(E, [2, 19]), e(E, [2, 21], { 15: 30, 24: U }), e(E, [2, 22]), e(E, [2, 23]), e(N, [2, 25]), e(N, [2, 26]), e(N, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: I, 7: g, 10: 34, 11: w }, { 1: [2, 7], 6: p, 12: 21, 13: r, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l }, e(j, [2, 14], { 7: f, 11: A }), e(L, [2, 8]), e(L, [2, 9]), e(L, [2, 10]), e(E, [2, 16], { 15: 37, 24: U }), e(E, [2, 17]), e(E, [2, 18]), e(E, [2, 20], { 24: H }), e(N, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, e(j, [2, 13], { 7: f, 11: A }), e(L, [2, 11]), e(L, [2, 12]), e(E, [2, 15], { 24: H }), e(N, [2, 30]), { 22: [1, 41] }, e(N, [2, 27]), e(N, [2, 29])],
    ...
    parse: /* @__PURE__ */ o(function(i) {
      var n = this, s = [0], a = [], h = [null], t = [], R = this.table, c = "", z = 0, oe = 0, ce = 0, Se = 2, le = 1, Ne = t.slice.call(arguments, 1), y = Object.create(this.lexer), P = { yy: {} };
      for (var q in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, q) && (P.yy[q] = this.yy[q]);
      y.setInput(i, P.yy), P.yy.lexer = y, P.yy.parser = this, typeof y.yylloc > "u" && (y.yylloc = {});
      var Q = y.yylloc;
      t.push(Q);
      var xe = y.options && y.options.ranges;
      ...
      function he() {
        var S;
        return S = a.pop() || y.lex() || le, typeof S != "number" && (S instanceof Array && (a = S, S = a.pop()), S = n.symbols_[S] || S), S;
      }
      o(he, "lex");
      for (var _, Z, V, x, We, $, G = {}, X, C, ue, K; ; ) {
        if (V = s[s.length - 1], this.defaultActions[V] ? x = this.defaultActions[V] : ((_ === null || typeof _ > "u") && (_ = he()), x = R[V] && R[V][_]), typeof x > "u" || !x.length || !x[0]) {
          var ee = "";
          K = [];
          for (X in R[V])
            this.terminals_[X] && X > Se && K.push("'" + this.terminals_[X] + "'");
          y.showPosition ? ee = "Parse error on line " + (z + 1) + `:
` + y.showPosition() + `
Expecting ` + K.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : ee = "Parse error on line " + (z + 1) + ": Unexpected " + (_ == le ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(ee, {
            text: y.match,
        ...
        switch (x[0]) {
          case 1:
            s.push(_), h.push(y.yytext), t.push(y.yylloc), s.push(x[1]), _ = null, Z ? (_ = Z, Z = null) : (oe = y.yyleng, c = y.yytext, z = y.yylineno, Q = y.yylloc, ce > 0 && ce--);
            break;
          case 2:
            if (C = this.productions_[x[1]][1], G.$ = h[h.length - C], G._$ = {
              ...
              return $;
            C && (s = s.slice(0, -1 * C * 2), h = h.slice(0, -1 * C), t = t.slice(0, -1 * C)), s.push(this.productions_[x[1]][0]), h.push(G.$), t.push(G._$), ue = R[s[s.length - 2]][s[s.length - 1]], s.push(ue);
            break;
          case 3:
            return !0;
        }
    ...
    var O = {
      EOF: 1,
      parseError: /* @__PURE__ */ o(function(n, s) {
        if (this.yy.parser)
...
` + n + "^";
      ...
      test_match: /* @__PURE__ */ o(function(i, n) {
        ...
        }, this.yytext += i[0], this.match += i[0], this.matches = i, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(i[0].length), this.matched += i[0], s = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), s)
          return s;
        if (this._backtrack) {
          for (var t in h)
            this[t] = h[t];
      ...
      next: /* @__PURE__ */ o(function() {
        ...
        for (var h = this._currentRules(), t = 0; t < h.length; t++)
          if (s = this._input.match(this.rules[h[t]]), s && (!n || s[0].length > n[0].length)) {
            if (n = s, a = t, this.options.backtrack_lexer) {
              if (i = this.test_match(s, h[t]), i !== !1)
                return i;
              if (this._backtrack) {
                n = !1;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: /* @__PURE__ */ o(function(n, s, a, h) {
        var t = h;
        switch (a) {
          case 0:
  ...
  return o(F, "Parser"), F.prototype = T, T.Parser = F, new F();
})();
ie.parser = ie;
var De = ie, v = [], se = [], re = 0, ae = {}, Le = /* @__PURE__ */ o(() => {
  v = [], se = [], re = 0, ae = {};
}, "clear"), Oe = /* @__PURE__ */ o((e) => {
  if (v.length === 0)
    return null;
  let u = v[0].level, p = null;
  for (let r = v.length - 1; r >= 0; r--)
    if (v[r].level === u && !p && (p = v[r]), v[r].level < u)
      throw new Error('Items without section detected, found section ("' + v[r].label + '")');
  return e === p?.level ? null : p;
}, "getSection"), _e = /* @__PURE__ */ o(function() {
  return se;
}, "getSections"), Ie = /* @__PURE__ */ o(function() {
  let e = [], u = [], p = _e(), r = M();
  for (let d of p) {
    let k = {
      id: d.id,
    ...
    u.push(k);
    let m = v.filter((l) => l.parentId === d.id);
    for (let l of m) {
      let D = {
        id: l.id,
        parentId: d.id,
  ...
  return { nodes: u, edges: e, other: {}, config: M() };
}, "getData"), Ce = /* @__PURE__ */ o((e, u, p, r, d) => {
  let k = M(), m = k.mindmap?.padding ?? W.mindmap.padding;
  switch (r) {
    case b.ROUNDED_RECT:
    case b.RECT:
    case b.HEXAGON:
  ...
  let l = {
    ...
    level: e,
    label: B(p, k),
    width: k.mindmap?.maxNodeWidth ?? W.mindmap.maxNodeWidth,
    padding: m,
    isGroup: !1
  };
  if (d !== void 0) {
...
` + d + `
  ...
  let D = Oe(e);
  D ? l.parentId = D.id || "kbn" + re++ : se.push(l), v.push(l);
}, "addNode"), b = {
  DEFAULT: 0,
  NO_BORDER: 0,
  ROUNDED_RECT: 1,
  ...
  switch (Y.debug("In get type", e, u), e) {
    case "[":
      return b.RECT;
    case "(":
      return u === ")" ? b.ROUNDED_RECT : b.CLOUD;
    case "((":
      return b.CIRCLE;
    case ")":
      return b.CLOUD;
...
}, "getType"), Ae = /* @__PURE__ */ o((e, u) => {
  ae[e] = u;
}, "setElementForId"), Te = /* @__PURE__ */ o((e) => {
  if (!e)
    return;
  let u = M(), p = v[v.length - 1];
  e.icon && (p.icon = B(e.icon, u)), e.class && (p.cssClasses = B(e.class, u));
}, "decorateNode"), Re = /* @__PURE__ */ o((e) => {
  switch (e) {
    case b.DEFAULT:
      return "no-border";
    case b.RECT:
...
}, "type2Str"), Pe = /* @__PURE__ */ o(() => Y, "getLogger"), Ve = /* @__PURE__ */ o((e) => ae[e], "getElementById"), Be = {
  clear: Le,
  addNode: Ce,
  getSections: _e,
  getData: Ie,
  ...
  getLogger: Pe,
  getElementById: Ve
}, je = Be, Fe = /* @__PURE__ */ o(async (e, u, p, r) => {
  Y.debug(`Rendering kanban diagram
` + e);
  let k = r.db.getData(), m = M();
  m.htmlLabels = !1;
  let l = pe(u);
  for (let f of k.nodes)
    f.domId = `${u}-${f.id}`;
  let D = l.append("g");
  D.attr("class", "sections");
  let I = l.append("g");
  I.attr("class", "items");
  let g = k.nodes.filter(
    // TODO: TypeScript 5.5 will infer this predicate automatically
    (f) => f.isGroup
  ), w = 0, E = 10, U = [], N = 25;
  for (let f of g) {
    let A = m?.kanban?.sectionWidth || 200;
    w = w + 1, f.x = A * w + (w - 1) * E / 2, f.width = A, f.y = 0, f.height = A * 3, f.rx = 5, f.ry = 5, f.cssClasses = f.cssClasses + " section-" + w;
    let L = await ye(D, f);
    N = Math.max(N, L?.labelBBox?.height), U.push(L);
  }
  let j = 0;
  for (let f of g) {
    let A = U[j];
    j = j + 1;
    let L = m?.kanban?.sectionWidth || 200, H = -L * 3 / 2 + N, T = H, J = k.nodes.filter((i) => i.parentId === f.id);
    for (let i of J) {
      if (i.isGroup)
        throw new Error("Groups within groups are not allowed in Kanban diagrams");
      i.x = f.x, i.width = L - 1.5 * E;
      let s = (await fe(I, i, { config: m })).node().getBBox();
      i.y = T + s.height / 2, await be(i), T = i.y + s.height / 2 + E / 2;
    }
    let F = A.cluster.select("rect"), O = Math.max(T - H + 3 * E, 50) + (N - 25);
    F.attr("height", O);
  }
  de(
    void 0,
    l,
    m.mindmap?.padding ?? W.kanban.padding,
    m.mindmap?.useMaxWidth ?? W.kanban.useMaxWidth
  );
}, "draw"), Ge = {
  draw: Fe
}, Me = /* @__PURE__ */ o((e) => {
  ...
  for (let r = 0; r < e.THEME_COLOR_LIMIT; r++)
    e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r], ge(e["lineColor" + r]) ? e["lineColor" + r] = te(e["lineColor" + r], 20) : e["lineColor" + r] = ne(e["lineColor" + r], 20);
  let p = /* @__PURE__ */ o((r, d) => e.darkMode ? ne(r, d) : te(r, d), "adjuster");
  for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) {
    let d = "" + (17 - 3 * r);
    u += `
