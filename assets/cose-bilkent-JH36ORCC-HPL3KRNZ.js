...
var q = $((k, K) => {
  (function(C, v) {
    typeof k == "object" && typeof K == "object" ? K.exports = v() : typeof define == "function" && define.amd ? define([], v) : typeof k == "object" ? k.layoutBase = v() : C.layoutBase = v();
  })(k, function() {
    return (
      /******/
      (function(N) {
        ...
        function v(n) {
          ...
          return N[n].call(e.exports, e, e.exports, v), e.l = !0, e.exports;
        }
        return v.m = N, v.c = C, v.i = function(n) {
          return n;
        }, v.d = function(n, e, t) {
          v.o(n, e) || Object.defineProperty(n, e, {
            /******/
            configurable: !1,
            /******/
            enumerable: !0,
        ...
        (function(N, C, v) {
          ...
          n.QUALITY = 1, n.DEFAULT_CREATE_BENDS_AS_NEEDED = !1, n.DEFAULT_INCREMENTAL = !1, n.DEFAULT_ANIMATION_ON_LAYOUT = !0, n.DEFAULT_ANIMATION_DURING_LAYOUT = !1, n.DEFAULT_ANIMATION_PERIOD = 50, n.DEFAULT_UNIFORM_LEAF_NODE_SIZES = !1, n.DEFAULT_GRAPH_MARGIN = 15, n.NODE_DIMENSIONS_INCLUDE_LABELS = !1, n.SIMPLE_NODE_SIZE = 40, n.SIMPLE_NODE_HALF_SIZE = n.SIMPLE_NODE_SIZE / 2, n.EMPTY_COMPOUND_NODE_SIZE = 40, n.MIN_EDGE_LENGTH = 1, n.WORLD_BOUNDARY = 1e6, n.INITIAL_WORLD_BOUNDARY = n.WORLD_BOUNDARY / 1e3, n.WORLD_CENTER_X = 1200, n.WORLD_CENTER_Y = 900, N.exports = n;
        }),
        /* 1 */
        /***/
        (function(N, C, v) {
          "use strict";
          var n = v(2), e = v(8), t = v(9);
          function r(u, s, p) {
            n.call(this, p), this.isOverlapingSourceAndTarget = !1, this.vGraphObject = p, this.bendpoints = [], this.source = u, this.target = s;
          }
          ...
          }, r.prototype.getOtherEndInGraph = function(u, s) {
            for (var p = this.getOtherEnd(u), i = s.getGraphManager().getRoot(); ; ) {
              if (p.getOwner() == s)
                return p;
              if (p.getOwner() == i)
                break;
        ...
        (function(N, C, v) {
          "use strict";
          var n = v(2), e = v(10), t = v(13), r = v(0), a = v(16), u = v(4);
          function s(i, h, l, d) {
            l == null && d == null && (d = h), n.call(this, d), i.graphManager != null && (i = i.graphManager), this.estimatedSize = e.MIN_VALUE, this.inclusionTreeDepth = e.MAX_VALUE, this.vGraphObject = d, this.edges = [], this.graphManager = i, l != null && h != null ? this.rect = new t(h.x, h.y, l.width, l.height) : this.rect = new t();
          }
          ...
          s.prototype.getEdges = function() {
          ...
          }, s.prototype.setWidth = function(i) {
            this.rect.width = i;
          }, s.prototype.getHeight = function() {
            return this.rect.height;
          }, s.prototype.setHeight = function(i) {
            this.rect.height = i;
          ...
          }, s.prototype.setRect = function(i, h) {
            this.rect.x = i.x, this.rect.y = i.y, this.rect.width = h.width, this.rect.height = h.height;
          }, s.prototype.setCenter = function(i, h) {
            this.rect.x = i - this.rect.width / 2, this.rect.y = h - this.rect.height / 2;
          }, s.prototype.setLocation = function(i, h) {
            this.rect.x = i, this.rect.y = h;
          }, s.prototype.moveBy = function(i, h) {
            this.rect.x += i, this.rect.y += h;
          }, s.prototype.getEdgeListToNode = function(i) {
            var h = [], l, d = this;
          ...
          }, s.prototype.getEdgesBetween = function(i) {
            var h = [], l, d = this;
            return d.edges.forEach(function(y) {
            ...
            if (i.add(this), this.child != null)
              for (var d = this.child.getNodes(), y = 0; y < d.length; y++)
                h = d[y], l = h.withChildren(), l.forEach(function(T) {
                  i.add(T);
                });
            return i;
            ...
            if (this.child == null)
              ...
              for (var l = this.child.getNodes(), d = 0; d < l.length; d++)
                h = l[d], i += h.getNoOfChildren();
            return i == 0 && (i = 1), i;
          ...
          }, s.prototype.transform = function(i) {
            var h = this.rect.x;
            ...
            var d = new u(h, l), y = i.inverseTransformPoint(d);
        ...
        (function(N, C, v) {
          "use strict";
          var n = v(2), e = v(10), t = v(0), r = v(6), a = v(3), u = v(1), s = v(13), p = v(12), i = v(11);
          function h(d, y, T) {
            n.call(this, T), this.estimatedSize = e.MIN_VALUE, this.margin = t.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = !1, this.parent = d, y != null && y instanceof r ? this.graphManager = y : y != null && y instanceof Layout && (this.graphManager = y.graphManager);
          }
          ...
          h.prototype.getNodes = function() {
            ...
            if (y == null && T == null) {
              ...
              var D = d;
              if (!(this.getNodes().indexOf(y) > -1 && this.getNodes().indexOf(T) > -1))
                throw "Source or target not in graph!";
              if (!(y.owner == T.owner && y.owner == this))
            ...
            if (d instanceof a) {
              ...
              for (var T = y.edges.slice(), c, D = T.length, E = 0; E < D; E++)
                c = T[E], c.isInterGraph ? this.graphManager.remove(c) : c.source.owner.remove(c);
              var O = this.nodes.indexOf(y);
              if (O == -1)
              ...
              var o = c.source.edges.indexOf(c), g = c.target.edges.indexOf(c);
              if (!(o > -1 && g > -1))
                throw "Source and/or target doesn't know this edge!";
              c.source.edges.splice(o, 1), c.target != c.source && c.target.edges.splice(g, 1);
              var O = c.source.owner.getEdges().indexOf(c);
              if (O == -1)
                throw "Not in owner's edge list!";
              c.source.owner.getEdges().splice(O, 1);
            }
          }, h.prototype.updateLeftTop = function() {
            for (var d = e.MAX_VALUE, y = e.MAX_VALUE, T, c, D, E = this.getNodes(), O = E.length, o = 0; o < O; o++) {
              var g = E[o];
              T = g.getTop(), c = g.getLeft(), d > T && (d = T), y > c && (y = c);
            }
            ...
            for (var y = e.MAX_VALUE, T = -e.MAX_VALUE, c = e.MAX_VALUE, D = -e.MAX_VALUE, E, O, o, g, f, L = this.nodes, A = L.length, I = 0; I < A; I++) {
              var m = L[I];
              d && m.child != null && m.updateBounds(), E = m.getLeft(), O = m.getRight(), o = m.getTop(), g = m.getBottom(), y > E && (y = E), T < O && (T = O), c > o && (c = o), D < g && (D = g);
            }
            var R = new s(y, c, T - y, D - c);
            y == e.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), L[0].getParent().paddingLeft != null ? f = L[0].getParent().paddingLeft : f = this.margin, this.left = R.x - f, this.right = R.x + R.width + f, this.top = R.y - f, this.bottom = R.y + R.height + f;
          }, h.calculateBounds = function(d) {
            for (var y = e.MAX_VALUE, T = -e.MAX_VALUE, c = e.MAX_VALUE, D = -e.MAX_VALUE, E, O, o, g, f = d.length, L = 0; L < f; L++) {
              var A = d[L];
              E = A.getLeft(), O = A.getRight(), o = A.getTop(), g = A.getBottom(), y > E && (y = E), T < O && (T = O), c > o && (c = o), D < g && (D = g);
            }
            var I = new s(y, c, T - y, D - c);
            return I;
            ...
            var y = new i(), T = /* @__PURE__ */ new Set(), c = this.nodes[0], D, E, O = c.withChildren();
            for (O.forEach(function(I) {
              y.push(I), T.add(I);
            }); y.length !== 0; ) {
              c = y.shift(), D = c.getEdges();
              for (var o = D.length, g = 0; g < o; g++) {
                var f = D[g];
                if (E = f.getOtherEndInGraph(c, this), E != null && !T.has(E)) {
                  var L = E.withChildren();
        ...
        (function(N, C, v) {
          ...
          var n, e = v(1);
          function t(r) {
            n = v(5), this.layout = r, this.graphs = [], this.edges = [];
          }
          t.prototype.addRoot = function() {
          ...
          }, t.prototype.add = function(r, a, u, s, p) {
            if (u == null && s == null && p == null) {
              ...
              p = u, s = a, u = r;
              var i = s.getOwner(), h = p.getOwner();
              if (!(i != null && i.getGraphManager() == this))
                throw "Source not in this graph mgr!";
              if (!(h != null && h.getGraphManager() == this))
                throw "Target not in this graph mgr!";
              if (i == h)
                return u.isInterGraph = !1, i.add(u, s, p);
              if (u.isInterGraph = !0, u.source = s, u.target = p, this.edges.indexOf(u) > -1)
            ...
            if (r instanceof n) {
              ...
              for (var s, p = u.length, i = 0; i < p; i++)
                s = u[i], a.remove(s);
              var h = [];
              ...
              if (!(s.source.edges.indexOf(s) != -1 && s.target.edges.indexOf(s) != -1))
                throw "Source and/or target doesn't know this edge!";
              var d = s.source.edges.indexOf(s);
              if (s.source.edges.splice(d, 1), d = s.target.edges.indexOf(s), s.target.edges.splice(d, 1), !(s.source.owner != null && s.source.owner.getGraphManager() != null))
                throw "Edge owner graph or owner graph manager is null!";
              if (s.source.owner.getGraphManager().edges.indexOf(s) == -1)
                throw "Not in owner graph manager's edge list!";
              var d = s.source.owner.getGraphManager().edges.indexOf(s);
              s.source.owner.getGraphManager().edges.splice(d, 1);
            }
            ...
            if (this.allNodes == null) {
              for (var r = [], a = this.getGraphs(), u = a.length, s = 0; s < u; s++)
            ...
            if (this.allEdges == null) {
              for (var r = [], a = this.getGraphs(), u = a.length, s = 0; s < a.length; s++)
                r = r.concat(a[s].getEdges());
            ...
            var u = r.getOwner(), s;
            do {
              if (s = u.getParent(), s == null)
                break;
              if (s == a)
                return !0;
              if (u = s.getOwner(), u == null)
                break;
            } while (!0);
            u = a.getOwner();
            do {
            ...
            for (var u, s = r.getNodes(), p = s.length, i = 0; i < p; i++)
              u = s[i], u.inclusionTreeDepth = a, u.child != null && this.calcInclusionTreeDepths(u.child, a + 1);
          }, t.prototype.includesInvalidEdge = function() {
            for (var r, a = this.edges.length, u = 0; u < a; u++)
              if (r = this.edges[u], this.isOneAncestorOfOther(r.source, r.target))
                return !0;
            return !1;
          }, N.exports = t;
        }),
        ...
        (function(N, C, v) {
          ...
          e.calcSeparationAmount = function(t, r, a, u) {
            if (!t.intersects(r))
              throw "assert failed";
            var s = new Array(2);
            this.decideDirectionsForOverlappingNodes(t, r, s), a[0] = Math.min(t.getRight(), r.getRight()) - Math.max(t.x, r.x), a[1] = Math.min(t.getBottom(), r.getBottom()) - Math.max(t.y, r.y), t.getX() <= r.getX() && t.getRight() >= r.getRight() ? a[0] += Math.min(r.getX() - t.getX(), t.getRight() - r.getRight()) : r.getX() <= t.getX() && r.getRight() >= t.getRight() && (a[0] += Math.min(t.getX() - r.getX(), r.getRight() - t.getRight())), t.getY() <= r.getY() && t.getBottom() >= r.getBottom() ? a[1] += Math.min(r.getY() - t.getY(), t.getBottom() - r.getBottom()) : r.getY() <= t.getY() && r.getBottom() >= t.getBottom() && (a[1] += Math.min(t.getY() - r.getY(), r.getBottom() - t.getBottom()));
            ...
            var i = p * a[0], h = a[1] / p;
            a[0] < h ? h = a[0] : i = a[1], a[0] = -1 * s[0] * (h / 2 + u), a[1] = -1 * s[1] * (i / 2 + u);
            ...
            var u = t.getCenterX(), s = t.getCenterY(), p = r.getCenterX(), i = r.getCenterY();
            if (t.intersects(r))
              return a[0] = u, a[1] = s, a[2] = p, a[3] = i, !0;
            var h = t.getX(), l = t.getY(), d = t.getRight(), y = t.getX(), T = t.getBottom(), c = t.getRight(), D = t.getWidthHalf(), E = t.getHeightHalf(), O = r.getX(), o = r.getY(), g = r.getRight(), f = r.getX(), L = r.getBottom(), A = r.getRight(), I = r.getWidthHalf(), m = r.getHeightHalf(), R = !1, w = !1;
            if (u === p) {
              if (s > i)
                return a[0] = u, a[1] = l, a[2] = p, a[3] = L, !1;
              if (s < i)
                return a[0] = u, a[1] = T, a[2] = p, a[3] = o, !1;
            } else if (s === i) {
              if (u > p)
                return a[0] = h, a[1] = s, a[2] = g, a[3] = i, !1;
              if (u < p)
                return a[0] = d, a[1] = s, a[2] = O, a[3] = i, !1;
            } else {
              var F = t.height / t.width, Y = r.height / r.width, x = (i - s) / (p - u), M = void 0, G = void 0, S = void 0, P = void 0, _ = void 0, U = void 0;
              if (-F === x ? u > p ? (a[0] = y, a[1] = T, R = !0) : (a[0] = d, a[1] = l, R = !0) : F === x && (u > p ? (a[0] = h, a[1] = l, R = !0) : (a[0] = c, a[1] = T, R = !0)), -Y === x ? p > u ? (a[2] = f, a[3] = L, w = !0) : (a[2] = g, a[3] = o, w = !0) : Y === x && (p > u ? (a[2] = O, a[3] = o, w = !0) : (a[2] = A, a[3] = L, w = !0)), R && w)
                return !1;
              if (u > p ? s > i ? (M = this.getCardinalDirection(F, x, 4), G = this.getCardinalDirection(Y, x, 2)) : (M = this.getCardinalDirection(-F, x, 3), G = this.getCardinalDirection(-Y, x, 1)) : s > i ? (M = this.getCardinalDirection(-F, x, 1), G = this.getCardinalDirection(-Y, x, 3)) : (M = this.getCardinalDirection(F, x, 2), G = this.getCardinalDirection(Y, x, 4)), !R)
                switch (M) {
                  case 1:
                    P = l, S = u + -E / x, a[0] = S, a[1] = P;
                    break;
                  case 2:
                    S = c, P = s + D * x, a[0] = S, a[1] = P;
                    break;
                  case 3:
                    P = T, S = u + E / x, a[0] = S, a[1] = P;
                    break;
                  case 4:
                    S = y, P = s + -D * x, a[0] = S, a[1] = P;
                    break;
                }
              if (!w)
                switch (G) {
                  case 1:
                    U = o, _ = p + -m / x, a[2] = _, a[3] = U;
                    break;
                  case 2:
                    _ = A, U = i + I * x, a[2] = _, a[3] = U;
                    break;
                  case 3:
                    U = L, _ = p + m / x, a[2] = _, a[3] = U;
                    break;
                  case 4:
                    _ = f, U = i + -I * x, a[2] = _, a[3] = U;
                    break;
                }
            }
            return !1;
            ...
            if (u == null)
              return this.getIntersection2(t, r, a);
            var s = t.x, p = t.y, i = r.x, h = r.y, l = a.x, d = a.y, y = u.x, T = u.y, c = void 0, D = void 0, E = void 0, O = void 0, o = void 0, g = void 0, f = void 0, L = void 0, A = void 0;
            return E = h - p, o = s - i, f = i * p - s * h, O = T - d, g = l - y, L = y * d - l * T, A = E * g - O * o, A === 0 ? null : (c = (o * L - g * f) / A, D = (O * f - E * L) / A, new n(c, D));
          }, e.angleOfVector = function(t, r, a, u) {
            var s = void 0;
            return t !== a ? (s = Math.atan((u - r) / (a - t)), a < t ? s += Math.PI : u < r && (s += this.TWO_PI)) : u < r ? s = this.ONE_AND_HALF_PI : s = this.HALF_PI, s;
          }, e.doIntersect = function(t, r, a, u) {
            var s = t.x, p = t.y, i = r.x, h = r.y, l = a.x, d = a.y, y = u.x, T = u.y, c = (i - s) * (T - d) - (y - l) * (h - p);
            if (c === 0)
              return !1;
            var D = ((T - d) * (y - s) + (l - y) * (T - p)) / c, E = ((p - h) * (y - s) + (i - s) * (T - p)) / c;
        ...
        (function(N, C, v) {
          ...
          var n = /* @__PURE__ */ (function() {
            ...
            return function(p, i, h) {
              return i && s(p.prototype, i), h && s(p, h), p;
            };
          })();
          function e(s, p) {
            if (!(s instanceof p))
          ...
          var t = function(p) {
            ...
            function s(p) {
              var i = this;
              e(this, s), this.length = 0, this.head = null, this.tail = null, p?.forEach(function(h) {
                return i.push(h);
              });
            }
            return n(s, [{
              ...
              key: "insertBefore",
              value: function(i, h) {
                return r(h.prev, t(i), h, this);
              }
            }, {
              key: "insertAfter",
              value: function(i, h) {
                return r(h, t(i), h.next, this);
              }
            }, {
              ...
              key: "push",
              value: function(i) {
                return r(this.tail, t(i), null, this);
              }
            }, {
              key: "unshift",
              value: function(i) {
                return r(null, t(i), this.head, this);
              }
            }, {
              key: "remove",
              value: function(i) {
        ...
        (function(N, C, v) {
          ...
          function n(l) {
            if (Array.isArray(l)) {
              for (var d = 0, y = Array(l.length); d < l.length; d++)
                y[d] = l[d];
              return y;
            } else
              return Array.from(l);
          }
          var e = v(0), t = v(6), r = v(3), a = v(1), u = v(5), s = v(4), p = v(17), i = v(27);
          function h(l) {
          ...
          h.RANDOM_SEED = 1, h.prototype = Object.create(i.prototype), h.prototype.getGraphManager = function() {
            return this.graphManager;
            ...
            if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
              for (var l, d = this.graphManager.getAllEdges(), y = 0; y < d.length; y++)
                l = d[y];
              for (var T, c = this.graphManager.getRoot().getNodes(), y = 0; y < c.length; y++)
                T = c[y];
            ...
            if (l == null)
              ...
              var d = l;
              if (d.getChild() != null)
                for (var y = d.getChild().getNodes(), T = 0; T < y.length; T++)
                  update(y[T]);
              if (d.vGraphObject != null) {
                var c = d.vGraphObject;
                c.update(d);
              }
            } else if (l instanceof a) {
              var D = l;
              if (D.vGraphObject != null) {
                var E = D.vGraphObject;
                E.update(D);
              }
            } else if (l instanceof u) {
              var O = l;
              if (O.vGraphObject != null) {
                var o = O.vGraphObject;
                o.update(O);
              }
            }
            ...
            if (l == null)
              ...
              var d = new p(), y = this.graphManager.getRoot().updateLeftTop();
              if (y != null) {
                d.setWorldOrgX(l.x), d.setWorldOrgY(l.y), d.setDeviceOrgX(y.x), d.setDeviceOrgY(y.y);
                for (var T = this.getAllNodes(), c, D = 0; D < T.length; D++)
                  c = T[D], c.transform(d);
              }
            }
            ...
            if (l == null)
              ...
              for (var d, y, T = l.getNodes(), c = 0; c < T.length; c++)
                d = T[c], y = d.getChild(), y == null || y.getNodes().length == 0 ? d.scatter() : (this.positionNodesRandomly(y), d.updateBounds());
          }, h.prototype.getFlatForest = function() {
            for (var l = [], d = !0, y = this.graphManager.getRoot().getNodes(), T = !0, c = 0; c < y.length; c++)
              y[c].getChild() != null && (T = !1);
            if (!T)
              return l;
            var D = /* @__PURE__ */ new Set(), E = [], O = /* @__PURE__ */ new Map(), o = [];
            for (o = o.concat(y); o.length > 0 && d; ) {
              for (E.push(o[0]); E.length > 0 && d; ) {
                var g = E[0];
                E.splice(0, 1), D.add(g);
                for (var f = g.getEdges(), c = 0; c < f.length; c++) {
                  var L = f[c].getOtherEnd(g);
                  if (O.get(g) != L)
                    if (!D.has(L))
                      E.push(L), O.set(L, g);
                    else {
            ...
            for (var d = [], y = l.source, T = this.graphManager.calcLowestCommonAncestor(l.source, l.target), c = 0; c < l.bendpoints.length; c++) {
            ...
            for (var d = 0; d < l.length; d++) {
              ...
              if (y.bendpoints.length > 0) {
                for (var T = this.edgeToDummyNodes.get(y), c = 0; c < T.length; c++) {
                  var D = T[c], E = new s(D.getCenterX(), D.getCenterY()), O = y.bendpoints.get(c);
            ...
            if (y != null && T != null) {
              ...
              var O, o;
              return l <= 50 ? (O = 9 * d / 500, o = d / 10) : (O = 9 * d / 50, o = -8 * d), O * l + o;
            }
            ...
            for (var E = 0; E < d.length; E++) {
              var O = d[E], o = O.getNeighborsList().size;
              T.set(O, O.getNeighborsList().size), o == 1 && y.push(O);
            }
            var g = [];
            for (g = g.concat(y); !c; ) {
              var f = [];
              f = f.concat(g), g = [];
              for (var E = 0; E < d.length; E++) {
                var O = d[E], L = d.indexOf(O);
                L >= 0 && d.splice(L, 1);
                var A = O.getNeighborsList();
                A.forEach(function(R) {
                  if (y.indexOf(R) < 0) {
                    var w = T.get(R), F = w - 1;
                    F == 1 && g.push(R), T.set(R, F);
                  }
                });
              }
              y = y.concat(g), (d.length == 1 || d.length == 2) && (c = !0, D = d[0]);
            }
            return D;
        ...
        (function(N, C, v) {
          ...
          function n(i) {
            if (Array.isArray(i)) {
              for (var h = 0, l = Array(i.length); h < i.length; h++)
                l[h] = i[h];
              return l;
            } else
              return Array.from(i);
          }
          var e = v(15), t = v(7), r = v(0), a = v(8), u = v(9);
          function s() {
          ...
          s.prototype.initParameters = function() {
            ...
            for (var i, h, l, d, y, T, c = this.getGraphManager().getAllEdges(), D = 0; D < c.length; D++)
              i = c[D], i.idealLength = this.idealEdgeLength, i.isInterGraph && (l = i.getSource(), d = i.getTarget(), y = i.getSourceInLca().getEstimatedSize(), T = i.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (i.idealLength += y + T - 2 * r.SIMPLE_NODE_SIZE), h = i.getLca().getInclusionTreeDepth(), i.idealLength += t.DEFAULT_EDGE_LENGTH * t.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (l.getInclusionTreeDepth() + d.getInclusionTreeDepth() - 2 * h));
            ...
            for (var i = this.getAllEdges(), h, l = 0; l < i.length; l++)
              h = i[l], this.calcSpringForce(h, h.idealLength);
          }, s.prototype.calcRepulsionForces = function() {
            var i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, l, d, y, T, c = this.getAllNodes(), D;
            if (this.useFRGridVariant)
              for (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && i && this.updateGrid(), D = /* @__PURE__ */ new Set(), l = 0; l < c.length; l++)
                y = c[l], this.calculateRepulsionForceOfANode(y, D, i, h), D.add(y);
            else
              for (l = 0; l < c.length; l++)
                for (y = c[l], d = l + 1; d < c.length; d++)
                  T = c[d], y.getOwner() == T.getOwner() && this.calcRepulsionForce(y, T);
          }, s.prototype.calcGravitationalForces = function() {
            for (var i, h = this.getAllNodesToApplyGravitation(), l = 0; l < h.length; l++)
              i = h[l], this.calcGravitationalForce(i);
          }, s.prototype.moveNodes = function() {
            for (var i = this.getAllNodes(), h, l = 0; l < i.length; l++)
              h = i[l], h.move();
          }, s.prototype.calcSpringForce = function(i, h) {
            var l = i.getSource(), d = i.getTarget(), y, T, c, D;
            if (this.uniformLeafNodeSizes && l.getChild() == null && d.getChild() == null)
              i.updateLengthSimple();
            else if (i.updateLength(), i.isOverlapingSourceAndTarget)
              return;
            y = i.getLength(), y != 0 && (T = this.springConstant * (y - h), c = T * (i.lengthX / y), D = T * (i.lengthY / y), l.springForceX += c, l.springForceY += D, d.springForceX -= c, d.springForceY -= D);
          }, s.prototype.calcRepulsionForce = function(i, h) {
            var l = i.getRect(), d = h.getRect(), y = new Array(2), T = new Array(4), c, D, E, O, o, g, f;
            if (l.intersects(d)) {
            ...
            for (var i, h = this.graphManager.getAllNodes(), l = 0; l < h.length; l++)
              i = h[l], i.noOfChildren = i.getNoOfChildren();
          }, s.prototype.calcGrid = function(i) {
            var h = 0, l = 0;
            h = parseInt(Math.ceil((i.getRight() - i.getLeft()) / this.repulsionRange)), l = parseInt(Math.ceil((i.getBottom() - i.getTop()) / this.repulsionRange));
            for (var d = new Array(h), y = 0; y < h; y++)
              d[y] = new Array(l);
            for (var y = 0; y < h; y++)
              for (var T = 0; T < l; T++)
                d[y][T] = new Array();
            return d;
          }, s.prototype.addNodeToGrid = function(i, h, l) {
            var d = 0, y = 0, T = 0, c = 0;
            d = parseInt(Math.floor((i.getRect().x - h) / this.repulsionRange)), y = parseInt(Math.floor((i.getRect().width + i.getRect().x - h) / this.repulsionRange)), T = parseInt(Math.floor((i.getRect().y - l) / this.repulsionRange)), c = parseInt(Math.floor((i.getRect().height + i.getRect().y - l) / this.repulsionRange));
            for (var D = d; D <= y; D++)
              for (var E = T; E <= c; E++)
                this.grid[D][E].push(i), i.setGridCoordinates(d, y, T, c);
          }, s.prototype.updateGrid = function() {
            var i, h, l = this.getAllNodes();
            for (this.grid = this.calcGrid(this.graphManager.getRoot()), i = 0; i < l.length; i++)
              h = l[i], this.addNodeToGrid(h, this.graphManager.getRoot().getLeft(), this.graphManager.getRoot().getTop());
          }, s.prototype.calculateRepulsionForceOfANode = function(i, h, l, d) {
            if (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && l || d) {
              var y = /* @__PURE__ */ new Set();
              i.surrounding = new Array();
              for (var T, c = this.grid, D = i.startX - 1; D < i.finishX + 2; D++)
                for (var E = i.startY - 1; E < i.finishY + 2; E++)
                  if (!(D < 0 || E < 0 || D >= c.length || E >= c[0].length)) {
                    for (var O = 0; O < c[D][E].length; O++)
                      if (T = c[D][E][O], !(i.getOwner() != T.getOwner() || i == T) && !h.has(T) && !y.has(T)) {
                        var o = Math.abs(i.getCenterX() - T.getCenterX()) - (i.getWidth() / 2 + T.getWidth() / 2), g = Math.abs(i.getCenterY() - T.getCenterY()) - (i.getHeight() / 2 + T.getHeight() / 2);
                        o <= this.repulsionRange && g <= this.repulsionRange && y.add(T);
                      }
                  }
              i.surrounding = [].concat(n(y));
            }
            for (D = 0; D < i.surrounding.length; D++)
              this.calcRepulsionForce(i, i.surrounding[D]);
        ...
        (function(N, C, v) {
          ...
          var n = v(1), e = v(7);
          function t(a, u, s) {
            n.call(this, a, u, s), this.idealLength = e.DEFAULT_EDGE_LENGTH;
          }
        ...
        (function(N, C, v) {
          ...
          var n = v(3);
          function e(r, a, u, s) {
            n.call(this, r, a, u, s), this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
          }
          e.prototype = Object.create(n.prototype);
          for (var t in n)
            e[t] = n[t];
          e.prototype.setGridCoordinates = function(r, a, u, s) {
            this.startX = r, this.finishX = a, this.startY = u, this.finishY = s;
          }, N.exports = e;
        }),
        /* 21 */
        /***/
        ...
        (function(N, C, v) {
          ...
          var n = /* @__PURE__ */ (function() {
            ...
            return function(u, s, p) {
              return s && a(u.prototype, s), p && a(u, p), u;
            };
          })();
          function e(a, u) {
            if (!(a instanceof u))
          ...
          var t = v(11), r = (function() {
            function a(u, s) {
              e(this, a), (s !== null || s !== void 0) && (this.compareFunction = this._defaultCompareFunction);
              var p = void 0;
              u instanceof t ? p = u.size() : p = u.length, this._quicksort(u, 0, p - 1);
            }
            return n(a, [{
              key: "_quicksort",
              value: function(s, p, i) {
                if (p < i) {
                  var h = this._partition(s, p, i);
                  this._quicksort(s, p, h), this._quicksort(s, h + 1, i);
                }
              }
            }, {
              key: "_partition",
              value: function(s, p, i) {
                for (var h = this._get(s, p), l = p, d = i; ; ) {
                  for (; this.compareFunction(h, this._get(s, d)); )
                    d--;
                  for (; this.compareFunction(this._get(s, l), h); )
                    l++;
                  if (l < d)
                    this._swap(s, l, d), l++, d--;
                  else return d;
                }
              }
            }, {
              key: "_get",
              value: function(s, p) {
                return s instanceof t ? s.get_object_at(p) : s[p];
              }
            }, {
              key: "_set",
              value: function(s, p, i) {
                s instanceof t ? s.set_object_at(p, i) : s[p] = i;
              }
            }, {
              key: "_swap",
              value: function(s, p, i) {
                var h = this._get(s, p);
                this._set(s, p, this._get(s, i)), this._set(s, i, h);
              }
            }, {
        ...
        (function(N, C, v) {
          ...
          var n = /* @__PURE__ */ (function() {
            ...
            return function(a, u, s) {
              return u && r(a.prototype, u), s && r(a, s), a;
            };
          })();
          function e(r, a) {
            if (!(r instanceof a))
          ...
          var t = (function() {
            function r(a, u) {
              var s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1, p = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : -1, i = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : -1;
              e(this, r), this.sequence1 = a, this.sequence2 = u, this.match_score = s, this.mismatch_penalty = p, this.gap_penalty = i, this.iMax = a.length + 1, this.jMax = u.length + 1, this.grid = new Array(this.iMax);
              ...
              for (var d = 0; d < this.iMax; d++) {
                ...
                for (var y = 0; y < this.jMax; y++)
                  this.tracebackGrid[d][y] = [null, null, null];
              }
            ...
            return n(r, [{
              ...
              value: function() {
                ...
                for (var s = 1; s < this.iMax; s++)
                  this.grid[s][0] = this.grid[s - 1][0] + this.gap_penalty, this.tracebackGrid[s][0] = [!1, !0, !1];
                for (var p = 1; p < this.iMax; p++)
                  for (var i = 1; i < this.jMax; i++) {
                    ...
                    var l = this.grid[p - 1][i] + this.gap_penalty, d = this.grid[p][i - 1] + this.gap_penalty, y = [h, l, d], T = this.arrayAllMaxIndexes(y);
                    this.grid[p][i] = y[T[0]], this.tracebackGrid[p][i] = [T.includes(0), T.includes(1), T.includes(2)];
                  }
              ...
              value: function() {
                ...
                for (u.push({
                  ...
                  var s = u[0], p = this.tracebackGrid[s.pos[0]][s.pos[1]];
                  p[0] && u.push({
              ...
              key: "getAllIndexes",
              value: function(u, s) {
                for (var p = [], i = -1; (i = u.indexOf(s, i + 1)) !== -1; )
                  p.push(i);
                return p;
              }
            }, {
...
var J = $((Z, z) => {
  (function(C, v) {
    typeof Z == "object" && typeof z == "object" ? z.exports = v(q()) : typeof define == "function" && define.amd ? define(["layout-base"], v) : typeof Z == "object" ? Z.coseBase = v(q()) : C.coseBase = v(C.layoutBase);
  })(Z, function(N) {
    return (
      /******/
      (function(C) {
        ...
        function n(e) {
          ...
          return C[e].call(t.exports, t, t.exports, n), t.l = !0, t.exports;
        }
        return n.m = C, n.c = v, n.i = function(e) {
          return e;
        }, n.d = function(e, t, r) {
        ...
        (function(C, v, n) {
          ...
          for (var r in e)
            t[r] = e[r];
          t.DEFAULT_USE_MULTI_LEVEL_SCALING = !1, t.DEFAULT_RADIAL_SEPARATION = e.DEFAULT_EDGE_LENGTH, t.DEFAULT_COMPONENT_SEPERATION = 60, t.TILE = !0, t.TILING_PADDING_VERTICAL = 10, t.TILING_PADDING_HORIZONTAL = 10, t.TREE_REDUCTION_ON_INCREMENTAL = !1, C.exports = t;
        }),
        /* 2 */
        /***/
        (function(C, v, n) {
        ...
        (function(C, v, n) {
          ...
          }, r.prototype.propogateDisplacementToChildren = function(u, s) {
            for (var p = this.getChild().getNodes(), i, h = 0; h < p.length; h++)
              i = p[h], i.getChild() == null ? (i.moveBy(u, s), i.displacementX += u, i.displacementY += s) : i.propogateDisplacementToChildren(u, s);
        ...
        (function(C, v, n) {
          "use strict";
          var e = n(0).FDLayout, t = n(4), r = n(3), a = n(5), u = n(2), s = n(1), p = n(0).FDLayoutConstants, i = n(0).LayoutConstants, h = n(0).Point, l = n(0).PointD, d = n(0).Layout, y = n(0).Integer, T = n(0).IGeometry, c = n(0).LGraph, D = n(0).Transform;
          function E() {
          ...
          E.prototype.newGraphManager = function() {
            ...
            if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
              if (s.TREE_REDUCTION_ON_INCREMENTAL) {
                ...
                var g = new Set(this.getAllNodes()), f = this.nodesWithGravity.filter(function(I) {
                  return g.has(I);
                });
              ...
              if (o.length > 0)
                ...
                this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
                var g = new Set(this.getAllNodes()), f = this.nodesWithGravity.filter(function(L) {
                  return g.has(L);
                });
            ...
            if (this.isTreeGrowing) {
              if (this.growTreeIterations % 10 == 0)
                if (this.prunedNodesAll.length > 0) {
                  ...
                  var o = new Set(this.getAllNodes()), g = this.nodesWithGravity.filter(function(A) {
                    return o.has(A);
                  });
            ...
            for (var o = this.graphManager.getAllNodes(), g = {}, f = 0; f < o.length; f++) {
              var L = o[f].rect, A = o[f].id;
              g[A] = {
                id: A,
                x: L.getCenterX(),
                y: L.getCenterY(),
            ...
            var o = [], g, f = this.graphManager.getGraphs(), L = f.length, A;
            for (A = 0; A < L; A++)
              g = f[A], g.updateConnected(), g.isConnected || (o = o.concat(g.getNodes()));
            return o;
            ...
            for (f = 0; f < o.length; f++) {
              var L = o[f];
              if (!g.has(L)) {
                var A = L.getSource(), I = L.getTarget();
                if (A == I)
                  L.getBendpoints().push(new l()), L.getBendpoints().push(new l()), this.createDummyNodesForBendpoints(L), g.add(L);
                else {
                  var m = [];
                  if (m = m.concat(A.getEdgeListToNode(I)), m = m.concat(I.getEdgeListToNode(A)), !g.has(m[0])) {
                    if (m.length > 1) {
                      var R;
                      for (R = 0; R < m.length; R++) {
                        var w = m[R];
                        w.getBendpoints().push(new l()), this.createDummyNodesForBendpoints(w);
                      }
                    }
          ...
          }, E.prototype.positionNodesRadially = function(o) {
            for (var g = new h(0, 0), f = Math.ceil(Math.sqrt(o.length)), L = 0, A = 0, I = 0, m = new l(0, 0), R = 0; R < o.length; R++) {
              R % f == 0 && (I = 0, A = L, R != 0 && (A += s.DEFAULT_COMPONENT_SEPERATION), L = 0);
              var w = o[R], F = d.findCenterOfTree(w);
              g.x = I, g.y = A, m = E.radialLayout(w, F, g), m.y > L && (L = Math.floor(m.y)), I = Math.floor(m.x + s.DEFAULT_COMPONENT_SEPERATION);
            }
            this.transform(new l(i.WORLD_CENTER_X - m.x / 2, i.WORLD_CENTER_Y - m.y / 2));
          }, E.radialLayout = function(o, g, f) {
            var L = Math.max(this.maxDiagonalInTree(o), s.DEFAULT_RADIAL_SEPARATION);
            E.branchRadialLayout(g, null, 0, 359, 0, L);
            var A = c.calculateBounds(o), I = new D();
            I.setDeviceOrgX(A.getMinX()), I.setDeviceOrgY(A.getMinY()), I.setWorldOrgX(f.x), I.setWorldOrgY(f.y);
            for (var m = 0; m < o.length; m++) {
              var R = o[m];
              R.transform(I);
            }
            var w = new l(A.getMaxX(), A.getMaxY());
            return I.inverseTransformPoint(w);
          }, E.branchRadialLayout = function(o, g, f, L, A, I) {
            var m = (L - f + 1) / 2;
            m < 0 && (m += 180);
            var R = (m + f) % 360, w = R * T.TWO_PI / 360, F = Math.cos(w), Y = A * Math.cos(w), x = A * Math.sin(w);
            o.setCenter(Y, x);
            var M = [];
            M = M.concat(o.getEdges());
            var G = M.length;
            g != null && G--;
            for (var S = 0, P = M.length, _, U = o.getEdgesBetween(g); U.length > 1; ) {
              var X = U[0];
              U.splice(0, 1);
              var B = M.indexOf(X);
              B >= 0 && M.splice(B, 1), P--, G--;
            }
            g != null ? _ = (M.indexOf(U[0]) + 1) % P : _ = 0;
            for (var b = Math.abs(L - f) / G, H = _; S != G; H = ++H % P) {
              var et = M[H].getOtherEnd(o);
              if (et != g) {
                var rt = (f + S * b) % 360, ct = (rt + b) % 360;
                E.branchRadialLayout(et, o, rt, ct, A + I, I), S++;
              }
            }
          }, E.maxDiagonalInTree = function(o) {
            for (var g = y.MIN_VALUE, f = 0; f < o.length; f++) {
              var L = o[f], A = L.getDiagonal();
              A > g && (g = A);
            }
            return g;
            ...
            for (var f = [], L = this.graphManager.getAllNodes(), A = 0; A < L.length; A++) {
              var I = L[A], m = I.getParent();
              this.getNodeDegreeWithChildren(I) === 0 && (m.id == null || !this.getToBeTiled(m)) && f.push(I);
            }
            for (var A = 0; A < f.length; A++) {
              var I = f[A], R = I.getParent().id;
              typeof g[R] > "u" && (g[R] = []), g[R] = g[R].concat(I);
            }
            Object.keys(g).forEach(function(w) {
              if (g[w].length > 1) {
                var F = "DummyCompound_" + w;
                o.memberGroups[F] = g[w];
                var Y = g[w][0].getParent(), x = new a(o.graphManager);
                x.id = F, x.paddingLeft = Y.paddingLeft || 0, x.paddingRight = Y.paddingRight || 0, x.paddingBottom = Y.paddingBottom || 0, x.paddingTop = Y.paddingTop || 0, o.idToDummyNode[F] = x;
                var M = o.getGraphManager().add(o.newGraph(), x), G = Y.getChild();
                G.add(x);
                for (var S = 0; S < g[w].length; S++) {
                  var P = g[w][S];
                  G.remove(P), M.add(P);
                }
              }
            ...
            for (var f = 0; f < this.compoundOrder.length; f++)
              g[this.compoundOrder[f].id] = this.compoundOrder[f], o[this.compoundOrder[f].id] = [].concat(this.compoundOrder[f].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[f].getChild()), this.compoundOrder[f].child = null;
            this.graphManager.resetAllNodes(), this.tileCompoundMembers(o, g);
          }, E.prototype.clearZeroDegreeMembers = function() {
            var o = this, g = this.tiledZeroDegreePack = [];
            Object.keys(this.memberGroups).forEach(function(f) {
              var L = o.idToDummyNode[f];
              g[f] = o.tileNodes(o.memberGroups[f], L.paddingLeft + L.paddingRight), L.rect.width = g[f].width, L.rect.height = g[f].height;
            });
          }, E.prototype.repopulateCompounds = function() {
            for (var o = this.compoundOrder.length - 1; o >= 0; o--) {
              var g = this.compoundOrder[o], f = g.id, L = g.paddingLeft, A = g.paddingTop;
              this.adjustLocations(this.tiledMemberPack[f], g.rect.x, g.rect.y, L, A);
            }
          }, E.prototype.repopulateZeroDegreeMembers = function() {
            var o = this, g = this.tiledZeroDegreePack;
            Object.keys(g).forEach(function(f) {
              var L = o.idToDummyNode[f], A = L.paddingLeft, I = L.paddingTop;
              o.adjustLocations(g[f], L.rect.x, L.rect.y, A, I);
            });
          }, E.prototype.getToBeTiled = function(o) {
            var g = o.id;
            if (this.toBeTiled[g] != null)
              return this.toBeTiled[g];
            var f = o.getChild();
            if (f == null)
              return this.toBeTiled[g] = !1, !1;
            for (var L = f.getNodes(), A = 0; A < L.length; A++) {
              var I = L[A];
          ...
          }, E.prototype.getNodeDegree = function(o) {
            for (var g = o.id, f = o.getEdges(), L = 0, A = 0; A < f.length; A++) {
              var I = f[A];
              I.getSource().id !== I.getTarget().id && (L = L + 1);
            }
            return L;
          }, E.prototype.getNodeDegreeWithChildren = function(o) {
            var g = this.getNodeDegree(o);
            if (o.getChild() == null)
              return g;
            for (var f = o.getChild().getNodes(), L = 0; L < f.length; L++) {
              var A = f[L];
              g += this.getNodeDegreeWithChildren(A);
            }
            return g;
          }, E.prototype.performDFSOnCompounds = function() {
            this.compoundOrder = [], this.fillCompexOrderByDFS(this.graphManager.getRoot().getNodes());
          }, E.prototype.fillCompexOrderByDFS = function(o) {
            for (var g = 0; g < o.length; g++) {
              var f = o[g];
              f.getChild() != null && this.fillCompexOrderByDFS(f.getChild().getNodes()), this.getToBeTiled(f) && this.compoundOrder.push(f);
            }
          }, E.prototype.adjustLocations = function(o, g, f, L, A) {
            g += L, f += A;
            for (var I = g, m = 0; m < o.rows.length; m++) {
              var R = o.rows[m];
              g = I;
              for (var w = 0, F = 0; F < R.length; F++) {
                var Y = R[F];
                Y.rect.x = g, Y.rect.y = f, g += Y.rect.width + o.horizontalPadding, Y.rect.height > w && (w = Y.rect.height);
              }
              f += w + o.verticalPadding;
            }
          }, E.prototype.tileCompoundMembers = function(o, g) {
            var f = this;
            this.tiledMemberPack = [], Object.keys(o).forEach(function(L) {
              var A = g[L];
              f.tiledMemberPack[L] = f.tileNodes(o[L], A.paddingLeft + A.paddingRight), A.rect.width = f.tiledMemberPack[L].width, A.rect.height = f.tiledMemberPack[L].height;
            });
          }, E.prototype.tileNodes = function(o, g) {
            var f = s.TILING_PADDING_VERTICAL, L = s.TILING_PADDING_HORIZONTAL, A = {
              rows: [],
              rowWidth: [],
              rowHeight: [],
              width: 0,
            ...
            o.sort(function(R, w) {
              return R.rect.width * R.rect.height > w.rect.width * w.rect.height ? -1 : R.rect.width * R.rect.height < w.rect.width * w.rect.height ? 1 : 0;
            });
            for (var I = 0; I < o.length; I++) {
              var m = o[I];
              A.rows.length == 0 ? this.insertNodeToRow(A, m, 0, g) : this.canAddHorizontal(A, m.rect.width, m.rect.height) ? this.insertNodeToRow(A, m, this.getShortestRowIndex(A), g) : this.insertNodeToRow(A, m, A.rows.length, g), this.shiftToLastRow(A);
            }
            return A;
          }, E.prototype.insertNodeToRow = function(o, g, f, L) {
            var A = L;
            if (f == o.rows.length) {
              var I = [];
              o.rows.push(I), o.rowWidth.push(A), o.rowHeight.push(0);
            }
            var m = o.rowWidth[f] + g.rect.width;
            o.rows[f].length > 0 && (m += o.horizontalPadding), o.rowWidth[f] = m, o.width < m && (o.width = m);
            var R = g.rect.height;
            f > 0 && (R += o.verticalPadding);
            var w = 0;
            R > o.rowHeight[f] && (w = o.rowHeight[f], o.rowHeight[f] = R, w = o.rowHeight[f] - w), o.height += w, o.rows[f].push(g);
          }, E.prototype.getShortestRowIndex = function(o) {
            for (var g = -1, f = Number.MAX_VALUE, L = 0; L < o.rows.length; L++)
              o.rowWidth[L] < f && (g = L, f = o.rowWidth[L]);
            return g;
          }, E.prototype.getLongestRowIndex = function(o) {
            for (var g = -1, f = Number.MIN_VALUE, L = 0; L < o.rows.length; L++)
              o.rowWidth[L] > f && (g = L, f = o.rowWidth[L]);
            return g;
          }, E.prototype.canAddHorizontal = function(o, g, f) {
            var L = this.getShortestRowIndex(o);
            if (L < 0)
              return !0;
            var A = o.rowWidth[L];
            if (A + o.horizontalPadding + g <= o.width) return !0;
            var I = 0;
            o.rowHeight[L] < f && L > 0 && (I = f + o.verticalPadding - o.rowHeight[L]);
            var m;
            o.width - A >= g + o.horizontalPadding ? m = (o.height + I) / (A + g + o.horizontalPadding) : m = (o.height + I) / o.width, I = f + o.verticalPadding;
            var R;
            return o.width < g ? R = (o.height + I) / g : R = (o.height + I) / o.width, R < 1 && (R = 1 / R), m < 1 && (m = 1 / m), m < R;
          }, E.prototype.shiftToLastRow = function(o) {
            var g = this.getLongestRowIndex(o), f = o.rowWidth.length - 1, L = o.rows[g], A = L[L.length - 1], I = A.width + o.horizontalPadding;
            if (o.width - o.rowWidth[f] > I && g != f) {
              L.splice(-1, 1), o.rows[f].push(A), o.rowWidth[g] = o.rowWidth[g] - I, o.rowWidth[f] = o.rowWidth[f] + I, o.width = o.rowWidth[instance.getLongestRowIndex(o)];
              for (var m = Number.MIN_VALUE, R = 0; R < L.length; R++)
                L[R].height > m && (m = L[R].height);
              g > 0 && (m += o.verticalPadding);
              var w = o.rowHeight[g] + o.rowHeight[f];
              o.rowHeight[g] = m, o.rowHeight[f] < A.height + o.verticalPadding && (o.rowHeight[f] = A.height + o.verticalPadding);
              var F = o.rowHeight[g] + o.rowHeight[f];
              o.height += F - w, this.shiftToLastRow(o);
            }
            ...
            for (var o = [], g = !0, f; g; ) {
              ...
              for (var I = 0; I < L.length; I++)
                f = L[I], f.getEdges().length == 1 && !f.getEdges()[0].isInterGraph && f.getChild() == null && (A.push([f, f.getEdges()[0], f.getOwner()]), g = !0);
              if (g == !0) {
                for (var m = [], R = 0; R < A.length; R++)
                  A[R][0].getEdges().length == 1 && (m.push(A[R]), A[R][0].getOwner().remove(A[R][0]));
                o.push(m), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
              }
            }
            this.prunedNodesAll = o;
          }, E.prototype.growTree = function(o) {
            for (var g = o.length, f = o[g - 1], L, A = 0; A < f.length; A++)
              L = f[A], this.findPlaceforPrunedNode(L), L[2].add(L[0]), L[2].add(L[1], L[1].source, L[1].target);
            o.splice(o.length - 1, 1), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
          }, E.prototype.findPlaceforPrunedNode = function(o) {
            var g, f, L = o[0];
            L == o[1].source ? f = o[1].target : f = o[1].source;
            var A = f.startX, I = f.finishX, m = f.startY, R = f.finishY, w = 0, F = 0, Y = 0, x = 0, M = [w, Y, F, x];
            if (m > 0)
              for (var G = A; G <= I; G++)
                M[0] += this.grid[G][m - 1].length + this.grid[G][m].length - 1;
            if (I < this.grid.length - 1)
              for (var G = m; G <= R; G++)
                M[1] += this.grid[I + 1][G].length + this.grid[I][G].length - 1;
            if (R < this.grid[0].length - 1)
              for (var G = A; G <= I; G++)
                M[2] += this.grid[G][R + 1].length + this.grid[G][R].length - 1;
            if (A > 0)
              for (var G = m; G <= R; G++)
                M[3] += this.grid[A - 1][G].length + this.grid[A][G].length - 1;
            for (var S = y.MAX_VALUE, P, _, U = 0; U < M.length; U++)
              M[U] < S ? (S = M[U], P = 1, _ = U) : M[U] == S && P++;
            if (P == 3 && S == 0)
              M[0] == 0 && M[1] == 0 && M[2] == 0 ? g = 1 : M[0] == 0 && M[1] == 0 && M[3] == 0 ? g = 0 : M[0] == 0 && M[2] == 0 && M[3] == 0 ? g = 3 : M[1] == 0 && M[2] == 0 && M[3] == 0 && (g = 2);
            else if (P == 2 && S == 0) {
              var X = Math.floor(Math.random() * 2);
              M[0] == 0 && M[1] == 0 ? X == 0 ? g = 0 : g = 1 : M[0] == 0 && M[2] == 0 ? X == 0 ? g = 0 : g = 2 : M[0] == 0 && M[3] == 0 ? X == 0 ? g = 0 : g = 3 : M[1] == 0 && M[2] == 0 ? X == 0 ? g = 1 : g = 2 : M[1] == 0 && M[3] == 0 ? X == 0 ? g = 1 : g = 3 : X == 0 ? g = 2 : g = 3;
            } else if (P == 4 && S == 0) {
              var X = Math.floor(Math.random() * 4);
              g = X;
            } else
              g = _;
            g == 0 ? L.setCenter(f.getCenterX(), f.getCenterY() - f.getHeight() / 2 - p.DEFAULT_EDGE_LENGTH - L.getHeight() / 2) : g == 1 ? L.setCenter(f.getCenterX() + f.getWidth() / 2 + p.DEFAULT_EDGE_LENGTH + L.getWidth() / 2, f.getCenterY()) : g == 2 ? L.setCenter(f.getCenterX(), f.getCenterY() + f.getHeight() / 2 + p.DEFAULT_EDGE_LENGTH + L.getHeight() / 2) : L.setCenter(f.getCenterX() - f.getWidth() / 2 - p.DEFAULT_EDGE_LENGTH - L.getWidth() / 2, f.getCenterY());
          }, C.exports = E;
        }),
        /* 7 */
        /***/
        (function(C, v, n) {
          "use strict";
          var e = {};
          e.layoutBase = n(0), e.CoSEConstants = n(1), e.CoSEEdge = n(2), e.CoSEGraph = n(3), e.CoSEGraphManager = n(4), e.CoSELayout = n(6), e.CoSENode = n(5), C.exports = e;
        })
        /******/
      ])
    );
...
var nt = $((Q, tt) => {
  (function(C, v) {
    typeof Q == "object" && typeof tt == "object" ? tt.exports = v(J()) : typeof define == "function" && define.amd ? define(["cose-base"], v) : typeof Q == "object" ? Q.cytoscapeCoseBilkent = v(J()) : C.cytoscapeCoseBilkent = v(C.coseBase);
  })(Q, function(N) {
    return (
      /******/
      (function(C) {
        ...
        (function(C, v, n) {
          "use strict";
          var e = n(0).layoutBase.LayoutConstants, t = n(0).layoutBase.FDLayoutConstants, r = n(0).CoSEConstants, a = n(0).CoSELayout, u = n(0).CoSENode, s = n(0).layoutBase.PointD, p = n(0).layoutBase.DimensionD, i = {
          ...
          function l(T) {
            this.options = h(i, T), d(this.options);
          }
          var d = function(c) {
          ...
          l.prototype.run = function() {
            var T, c, D = this.options, E = this.idToLNode = {}, O = this.layout = new a(), o = this;
            o.stopped = !1, this.cy = this.options.cy, this.cy.trigger({ type: "layoutstart", layout: this });
            var g = O.newGraphManager();
            this.gm = g;
            var f = this.options.eles.nodes(), L = this.options.eles.edges();
            this.root = g.addRoot(), this.processChildrenList(this.root, this.getTopMostNodes(f), O);
            for (var A = 0; A < L.length; A++) {
              var I = L[A], m = this.idToLNode[I.data("source")], R = this.idToLNode[I.data("target")];
              if (m !== R && m.getEdgesBetween(R).length == 0) {
                var w = g.add(O.newEdge(), m, R);
                w.id = I.id();
              }
            }
            var F = function(M, G) {
              typeof M == "number" && (M = G);
              var S = M.data("id"), P = o.idToLNode[S];
              return {
                x: P.getRect().getCenterX(),
                y: P.getRect().getCenterY()
              };
            }, Y = function x() {
              for (var M = function() {
                D.fit && D.cy.fit(D.eles, D.padding), T || (T = !0, o.cy.one("layoutready", D.ready), o.cy.trigger({ type: "layoutready", layout: o }));
              }, G = o.options.refresh, S, P = 0; P < G && !S; P++)
                S = o.stopped || o.layout.tick();
              if (S) {
                O.checkLayoutSuccess() && !O.isSubLayout && O.doPostLayout(), O.tilingPostLayout && O.tilingPostLayout(), O.isLayoutFinished = !0, o.options.eles.nodes().positions(F), M(), o.cy.one("layoutstop", o.options.stop), o.cy.trigger({ type: "layoutstop", layout: o }), c && cancelAnimationFrame(c), T = !1;
                return;
              }
              var _ = o.layout.getPositionsData();
              D.eles.nodes().positions(function(U, X) {
                if (typeof U == "number" && (U = X), !U.isParent()) {
                  for (var B = U.id(), b = _[B], H = U; b == null && (b = _[H.data("parent")] || _["DummyCompound_" + H.data("parent")], _[B] = b, H = H.parent()[0], H != null); )
                    ;
                  return b != null ? {
                    x: b.x,
                    y: b.y
              ...
              }), M(), c = requestAnimationFrame(x);
            };
            return O.addListener("layoutstarted", function() {
              o.options.animate === "during" && (c = requestAnimationFrame(Y));
            }), O.runLayout(), this.options.animate !== "during" && (o.options.eles.nodes().not(":parent").layoutPositions(o, o.options, F), T = !1), this;
          }, l.prototype.getTopMostNodes = function(T) {
            for (var c = {}, D = 0; D < T.length; D++)
              c[T[D].id()] = !0;
            var E = T.filter(function(O, o) {
              typeof O == "number" && (O = o);
            ...
            for (var E = c.length, O = 0; O < E; O++) {
              var o = c[O], g = o.children(), f, L = o.layoutDimensions({
              ...
              if (o.outerWidth() != null && o.outerHeight() != null ? f = T.add(new u(D.graphManager, new s(o.position("x") - L.w / 2, o.position("y") - L.h / 2), new p(parseFloat(L.w), parseFloat(L.h)))) : f = T.add(new u(this.graphManager)), f.id = o.data("id"), f.paddingLeft = parseInt(o.css("padding")), f.paddingTop = parseInt(o.css("padding")), f.paddingRight = parseInt(o.css("padding")), f.paddingBottom = parseInt(o.css("padding")), this.options.nodeDimensionsIncludeLabels && o.isParent()) {
                var A = o.boundingBox({ includeLabels: !0, includeNodes: !1 }).w, I = o.boundingBox({ includeLabels: !0, includeNodes: !1 }).h, m = o.css("text-halign");
                f.labelWidth = A, f.labelHeight = I, f.labelPos = m;
              }
              if (this.idToLNode[o.data("id")] = f, isNaN(f.rect.x) && (f.rect.x = 0), isNaN(f.rect.y) && (f.rect.y = 0), g != null && g.length > 0) {
                var R;
                R = D.getGraphManager().add(D.newGraph(), f), this.processChildrenList(R, g, D);
              }
            }
          ...
          typeof cytoscape < "u" && y(cytoscape), C.exports = y;
        })
        /******/
      ])
    );
...
function ot(N, C) {
  N.forEach((v) => {
    ...
    Object.keys(v).forEach((e) => {
      ["id", "label", "height", "width", "padding", "x", "y"].includes(e) || (n[e] = v[e]);
    }), C.add({
      group: "nodes",
      data: n,
      position: {
...
function at(N, C) {
  N.forEach((v) => {
    ...
    Object.keys(v).forEach((e) => {
      ["id", "start", "end"].includes(e) || (n[e] = v[e]);
    }), C.add({
      group: "edges",
      data: n
    });
...
function ht(N) {
  return new Promise((C) => {
    let v = it("body").append("div").attr("id", "cy").attr("style", "display:none"), n = j({
    ...
    v.remove(), ot(N.nodes, n), at(N.edges, n), n.nodes().forEach(function(t) {
      t.layoutDimensions = () => {
        let r = t.data();
    ...
    n.layout(e).run(), n.ready((t) => {
      V.info("Cytoscape ready", t), C(n);
    });
  });
}
W(ht, "createCytoscapeInstance");
function lt(N) {
  return N.nodes().map((C) => {
    let v = C.data(), n = C.position(), e = {
      id: v.id,
      x: n.x,
      y: n.y
    };
...
W(lt, "extractPositionedNodes");
function ut(N) {
  return N.edges().map((C) => {
    let v = C.data(), n = C._private.rscratch, e = {
      id: v.id,
      source: v.source,
      target: v.target,
      startX: n.startX,
    ...
    return Object.keys(v).forEach((t) => {
      ["id", "source", "target"].includes(t) || (e[t] = v[t]);
    }), e;
  });
}
W(ut, "extractPositionedEdges");
async function gt(N, C) {
  V.debug("Starting cose-bilkent layout algorithm");
  try {
    ft(N);
    let v = await ht(N), n = lt(v), e = ut(v);
    return V.debug(`Layout completed: ${n.length} nodes, ${e.length} edges`), {
      nodes: n,
      edges: e
    };
  } catch (v) {
    throw V.error("Error in cose-bilkent layout algorithm:", v), v;
  }
}
W(gt, "executeCoseBilkentLayout");
function ft(N) {
  if (!N)
...
var dt = /* @__PURE__ */ W(async (N, C, {
  ...
  let p = {}, i = {}, h = C.select("g");
  t(h, N.markers, N.type, N.diagramId);
  let l = h.insert("g").attr("class", "subgraphs"), d = h.insert("g").attr("class", "edgePaths"), y = h.insert("g").attr("class", "edgeLabels"), T = h.insert("g").attr("class", "nodes");
  a.debug("Inserting nodes into DOM for dimension calculation"), await Promise.all(
    N.nodes.map(async (E) => {
      if (E.isGroup) {
        let O = { ...E };
        ...
        O.width = g.width, O.height = g.height, O.domId = o, a.debug(`Node ${E.id} dimensions: ${g.width}x${g.height}`);
      }
    })
  ...
  }, D = await gt(c, N.config);
  a.debug("Positioning nodes based on layout results"), D.nodes.forEach((E) => {
    let O = p[E.id];
    O?.domId && (O.domId.attr(
      "transform",
      `translate(${E.x}, ${E.y})`
    ), O.x = E.x, O.y = E.y, a.debug(`Positioned node ${O.id} at center (${E.x}, ${E.y})`));
  }), D.edges.forEach((E) => {
    let O = N.edges.find((o) => o.id === E.id);
    O && (O.points = [
      { x: E.startX, y: E.startY },
      { x: E.midX, y: E.midY },
      { x: E.endX, y: E.endY }
    ]);
  }), a.debug("Inserting and positioning edges"), await Promise.all(
    N.edges.map(async (E) => {
      let O = await e(y, E), o = p[E.start ?? ""], g = p[E.end ?? ""];
      if (o && g) {
        let f = D.edges.find((L) => L.id === E.id);
        if (f) {
