...
function Wt(a, t, s, e = 1) {
  let n = s, o = Math.max(t, 0.1), r = a[0] && a[0][0] && typeof a[0][0] == "number" ? [a] : a, h = [0, 0];
  if (n) for (let l of r) Y(l, h, n);
  let i = (function(l, c, d) {
    let p = [];
    for (let M of l) {
      let m = [...M];
      zt(m[0], m[m.length - 1]) || m.push([m[0][0], m[0][1]]), m.length > 2 && p.push(m);
    }
    let u = [];
    c = Math.max(c, 0.1);
    let f = [];
    for (let M of p) for (let m = 0; m < M.length - 1; m++) {
      let P = M[m], x = M[m + 1];
      if (P[1] !== x[1]) {
        let w = Math.min(P[1], x[1]);
  ...
  if (n) {
    for (let l of r) Y(l, h, -n);
    (function(l, c, d) {
      let p = [];
      l.forEach(((u) => p.push(...u))), Y(p, c, d);
    })(i, h, -n);
  }
  return i;
}
function F(a, t) {
  ...
  let o = 1;
  return t.roughness >= 1 && (((s = t.randomizer) === null || s === void 0 ? void 0 : s.next()) || Math.random()) > 0.7 && (o = n), Wt(a, n, e, o || 1);
}
var q = class {
  constructor(t) {
    this.helper = t;
  ...
  renderLines(t, s) {
    let e = [];
    for (let n of t) e.push(...this.helper.doubleLineOps(n[0][0], n[0][1], n[1][0], n[1][1], s));
    return e;
  }
};
function X(a) {
...
var at = class extends q {
  fillPolygons(t, s) {
    ...
    let n = F(t, Object.assign({}, s, { hachureGap: e })), o = Math.PI / 180 * s.hachureAngle, r = [], h = 0.5 * e * Math.cos(o), i = 0.5 * e * Math.sin(o);
    for (let [l, c] of n) X([l, c]) && r.push([[l[0] - h, l[1] + i], [...c]], [[l[0] + h, l[1] - i], [...c]]);
  ...
  fillPolygons(t, s) {
    let e = F(t, s = Object.assign({}, s, { hachureAngle: 0 }));
  ...
  dotsOnLines(t, s) {
    ...
    for (let h of t) {
      ...
      for (let f = 0; f < c; f++) {
        let g = u + d + f * n, k = p - r + 2 * Math.random() * r, b = g - r + 2 * Math.random() * r, M = this.helper.ellipse(k, b, o, o, s);
        e.push(...M.ops);
      }
    }
  ...
  dashedLine(t, s) {
    ...
    return t.forEach(((r) => {
      ...
      for (let u = 0; u < i; u++) {
        let f = u * (e + n), g = f + e, k = [c[0] + f * Math.cos(p) + l * Math.cos(p), c[1] + f * Math.sin(p) + l * Math.sin(p)], b = [c[0] + g * Math.cos(p) + l * Math.cos(p), c[1] + g * Math.sin(p) + l * Math.sin(p)];
  ...
  fillPolygons(t, s) {
    let e = s.hachureGap < 0 ? 4 * s.strokeWidth : s.hachureGap, n = s.zigzagOffset < 0 ? e : s.zigzagOffset, o = F(t, s = Object.assign({}, s, { hachureGap: e + n }));
  ...
  zigzagLines(t, s, e) {
    ...
    return t.forEach(((o) => {
      ...
      for (let d = 0; d < h; d++) {
        let p = 2 * d * s, u = 2 * (d + 1) * s, f = Math.sqrt(2 * Math.pow(s, 2)), g = [i[0] + p * Math.cos(c), i[1] + p * Math.sin(c)], k = [i[0] + u * Math.cos(c), i[1] + u * Math.sin(c)], b = [g[0] + f * Math.cos(c + Math.PI / 4), g[1] + f * Math.sin(c + Math.PI / 4)];
        n.push(...this.helper.doubleLineOps(g[0], g[1], b[0], b[1], e), ...this.helper.doubleLineOps(b[0], b[1], k[0], k[1], e));
      }
    })), n;
  }
}, S = {}, ct = class {
...
}, Et = 0, tt = 1, bt = 2, Z = { A: 7, a: 7, C: 6, c: 6, H: 1, h: 1, L: 2, l: 2, M: 2, m: 2, Q: 4, q: 4, S: 4, s: 4, T: 2, t: 2, V: 1, v: 1, Z: 0, z: 0 };
function et(a, t) {
  return a.type === t;
}
function gt(a) {
  let t = [], s = (function(r) {
    ...
    else if (r.match(/^([aAcChHlLmMqQsStTvVzZ])/)) h[h.length] = { type: Et, text: RegExp.$1 }, r = r.substr(RegExp.$1.length);
    else {
      if (!r.match(/^(([-+]?[0-9]+(\.[0-9]*)?|[-+]?\.[0-9]+)([eE][-+]?[0-9]+)?)/)) return [];
      h[h.length] = { type: tt, text: `${parseFloat(RegExp.$1)}` }, r = r.substr(RegExp.$1.length);
    }
  ...
  for (; !et(o, bt); ) {
    let r = 0, h = [];
    if (e === "BOD") {
      if (o.text !== "M" && o.text !== "m") return gt("M0,0" + a);
      n++, r = Z[o.text], e = o.text;
    } else et(o, tt) ? r = Z[e] : (n++, r = Z[o.text], e = o.text);
    if (!(n + r < s.length)) throw new Error("Path data ended short");
    for (let i = n; i < n + r; i++) {
      let l = s[i];
      if (!et(l, tt)) throw new Error("Param not a number: " + e + "," + l.text);
      h[h.length] = +l.text;
    }
    if (typeof Z[e] != "number") throw new Error("Bad segment: " + e);
    {
      let i = { key: e, data: h };
...
function Ot(a) {
  ...
  for (let { key: r, data: h } of a) switch (r) {
    case "M":
...
function Lt(a) {
  ...
  for (let { key: l, data: c } of a) {
    switch (l) {
      ...
      case "T": {
        let [d, p] = c, u = 0, f = 0;
        s === "Q" || s === "T" ? (u = e + (e - h), f = n + (n - i)) : (u = e, f = n);
        let g = e + 2 * (u - e) / 3, k = n + 2 * (f - n) / 3, b = d + 2 * (u - d) / 3, M = p + 2 * (f - p) / 3;
        t.push({ key: "C", data: [g, k, b, M, d, p] }), h = u, i = f, e = d, n = p;
        break;
      }
      case "Q": {
        let [d, p, u, f] = c, g = e + 2 * (d - e) / 3, k = n + 2 * (p - n) / 3, b = u + 2 * (d - u) / 3, M = f + 2 * (p - f) / 3;
        t.push({ key: "C", data: [g, k, b, M, u, f] }), h = d, i = p, e = u, n = f;
        break;
      }
      case "A": {
        let d = Math.abs(c[0]), p = Math.abs(c[1]), u = c[2], f = c[3], g = c[4], k = c[5], b = c[6];
        d === 0 || p === 0 ? (t.push({ key: "C", data: [e, n, k, b, k, b] }), e = k, n = b) : (e !== k || n !== b) && (Tt(e, n, k, b, d, p, u, f, g).forEach((function(M) {
          t.push({ key: "C", data: M });
        })), e = k, n = b);
        break;
      }
...
function Tt(a, t, s, e, n, o, r, h, i, l) {
  let c = (d = r, Math.PI * d / 180);
  var d;
  let p = [], u = 0, f = 0, g = 0, k = 0;
  if (l) [u, f, g, k] = l;
  else {
    [a, t] = R(a, t, -c), [s, e] = R(s, e, -c);
    let T = (a - s) / 2, v = (t - e) / 2, _ = T * T / (n * n) + v * v / (o * o);
    _ > 1 && (_ = Math.sqrt(_), n *= _, o *= _);
    let W = n * n, E = o * o, It = W * E - W * v * v - E * T * T, Ct = W * v * v + E * T * T, kt = (h === i ? -1 : 1) * Math.sqrt(Math.abs(It / Ct));
    g = kt * n * v / o + (a + s) / 2, k = kt * -o * T / n + (t + e) / 2, u = Math.asin(parseFloat(((t - k) / o).toFixed(9))), f = Math.asin(parseFloat(((e - k) / o).toFixed(9))), a < g && (u = Math.PI - u), s < g && (f = Math.PI - f), u < 0 && (u = 2 * Math.PI + u), f < 0 && (f = 2 * Math.PI + f), i && u > f && (u -= 2 * Math.PI), !i && f > u && (f -= 2 * Math.PI);
  }
  let b = f - u;
  if (Math.abs(b) > 120 * Math.PI / 180) {
    let T = f, v = s, _ = e;
    f = i && f > u ? u + 120 * Math.PI / 180 * 1 : u + 120 * Math.PI / 180 * -1, p = Tt(s = g + n * Math.cos(f), e = k + o * Math.sin(f), v, _, n, o, r, 0, i, [f, T, g, k]);
  }
  b = f - u;
  let M = Math.cos(u), m = Math.sin(u), P = Math.cos(f), x = Math.sin(f), w = Math.tan(b / 4), L = 4 / 3 * n * w, A = 4 / 3 * o * w, V = [a, t], D = [a + L * m, t - A * M], C = [s + L * x, e - A * P], Mt = [s, e];
  if (D[0] = 2 * V[0] - D[0], D[1] = 2 * V[1] - D[1], l) return [D, C, Mt].concat(p);
  {
    p = [D, C, Mt].concat(p);
    let T = [];
    for (let v = 0; v < p.length; v += 3) {
      let _ = R(p[v][0], p[v][1], c), W = R(p[v + 1][0], p[v + 1][1], c), E = R(p[v + 2][0], p[v + 2][1], c);
      T.push([_[0], _[1], W[0], W[1], E[0], E[1]]);
    }
    return T;
  }
}
var Gt = { randOffset: function(a, t) {
  return y(a, t);
}, randOffsetWithRange: function(a, t, s) {
  return J(a, t, s);
}, ellipse: function(a, t, s, e, n) {
  let o = At(s, e, n);
  return lt(a, t, n, o).opset;
}, doubleLineOps: function(a, t, s, e, n) {
  return I(a, t, s, e, n, !0);
} };
function Dt(a, t, s, e, n) {
  return { type: "path", ops: I(a, t, s, e, n) };
}
function N(a, t, s) {
  let e = (a || []).length;
  if (e > 2) {
    let n = [];
    for (let o = 0; o < e - 1; o++) n.push(...I(a[o][0], a[o][1], a[o + 1][0], a[o + 1][1], s));
    return t && n.push(...I(a[e - 1][0], a[e - 1][1], a[0][0], a[0][1], s)), { type: "path", ops: n };
  }
  return e === 2 ? Dt(a[0][0], a[0][1], a[1][0], a[1][1], s) : { type: "path", ops: [] };
}
function $t(a, t, s, e, n) {
  return (function(o, r) {
    return N(o, !0, r);
...
function yt(a, t) {
  if (a.length) {
    let s = typeof a[0][0] == "number" ? [a] : a, e = Q(s[0], 1 * (1 + 0.2 * t.roughness), t), n = t.disableMultiStroke ? [] : Q(s[0], 1.5 * (1 + 0.22 * t.roughness), xt(t));
    for (let o = 1; o < s.length; o++) {
      let r = s[o];
      if (r.length) {
        let h = Q(r, 1 * (1 + 0.2 * t.roughness), t), i = t.disableMultiStroke ? [] : Q(r, 1.5 * (1 + 0.22 * t.roughness), xt(t));
        for (let l of h) l.op !== "move" && e.push(l);
        for (let l of i) l.op !== "move" && n.push(l);
      }
    }
...
function lt(a, t, s, e) {
  let [n, o] = Pt(e.increment, a, t, e.rx, e.ry, 1, e.increment * J(0.1, J(0.4, 1, s), s), s), r = K(n, null, s);
  if (!s.disableMultiStroke && s.roughness !== 0) {
    let [h] = Pt(e.increment, a, t, e.rx, e.ry, 1.5, 0, s), i = K(h, null, s);
    r = r.concat(i);
  }
  return { estimatedPoints: o, opset: { type: "path", ops: r } };
}
function mt(a, t, s, e, n, o, r, h, i) {
  ...
  let g = 2 * Math.PI / i.curveStepCount, k = Math.min(g / 2, (f - u) / 2), b = vt(k, l, c, d, p, u, f, 1, i);
  if (!i.disableMultiStroke) {
    let M = vt(k, l, c, d, p, u, f, 1.5, i);
    b.push(...M);
  }
...
function wt(a, t) {
  let s = Lt(Ot(gt(a))), e = [], n = [0, 0], o = [0, 0];
  for (let { key: r, data: h } of s) switch (r) {
    case "M":
      o = [h[0], h[1]], n = [h[0], h[1]];
      break;
    case "L":
      e.push(...I(o[0], o[1], h[0], h[1], t)), o = [h[0], h[1]];
      break;
    case "C": {
      let [i, l, c, d, p, u] = h;
      e.push(...Rt(i, l, c, d, p, u, o, t)), o = [p, u];
      break;
    }
    case "Z":
      e.push(...I(o[0], o[1], n[0], n[1], t)), o = [n[0], n[1]];
  }
  return { type: "path", ops: e };
}
function st(a, t) {
  let s = [];
  for (let e of a) if (e.length) {
    let n = t.maxRandomnessOffset || 0, o = e.length;
    if (o > 2) {
      s.push({ op: "move", data: [e[0][0] + y(n, t), e[0][1] + y(n, t)] });
      for (let r = 1; r < o; r++) s.push({ op: "lineTo", data: [e[r][0] + y(n, t), e[r][1] + y(n, t)] });
    }
  }
...
function I(a, t, s, e, n, o = !1) {
  let r = o ? n.disableMultiStrokeFill : n.disableMultiStroke, h = ut(a, t, s, e, n, !0, !1);
  if (r) return h;
  let i = ut(a, t, s, e, n, !0, !0);
  return h.concat(i);
}
function ut(a, t, s, e, n, o, r) {
  ...
  c * c * 100 > h && (c = i / 10);
  let d = c / 2, p = 0.2 + 0.2 * _t(n), u = n.bowing * n.maxRandomnessOffset * (e - t) / 200, f = n.bowing * n.maxRandomnessOffset * (a - s) / 200;
  u = y(u, n, l), f = y(f, n, l);
  let g = [], k = () => y(d, n, l), b = () => y(c, n, l), M = n.preserveVertices;
  return o && (r ? g.push({ op: "move", data: [a + (M ? 0 : k()), t + (M ? 0 : k())] }) : g.push({ op: "move", data: [a + (M ? 0 : y(c, n, l)), t + (M ? 0 : y(c, n, l))] })), r ? g.push({ op: "bcurveTo", data: [u + a + (s - a) * p + k(), f + t + (e - t) * p + k(), u + a + 2 * (s - a) * p + k(), f + t + 2 * (e - t) * p + k(), s + (M ? 0 : k()), e + (M ? 0 : k())] }) : g.push({ op: "bcurveTo", data: [u + a + (s - a) * p + b(), f + t + (e - t) * p + b(), u + a + 2 * (s - a) * p + b(), f + t + 2 * (e - t) * p + b(), s + (M ? 0 : b()), e + (M ? 0 : b())] }), g;
}
function Q(a, t, s) {
  if (!a.length) return [];
  let e = [];
  e.push([a[0][0] + y(t, s), a[0][1] + y(t, s)]), e.push([a[0][0] + y(t, s), a[0][1] + y(t, s)]);
  for (let n = 1; n < a.length; n++) e.push([a[n][0] + y(t, s), a[n][1] + y(t, s)]), n === a.length - 1 && e.push([a[n][0] + y(t, s), a[n][1] + y(t, s)]);
  return K(e, null, s);
}
function K(a, t, s) {
  let e = a.length, n = [];
  if (e > 3) {
    ...
    if (t && t.length === 2) {
      ...
      n.push({ op: "lineTo", data: [t[0] + y(h, s), t[1] + y(h, s)] });
    }
  } else e === 3 ? (n.push({ op: "move", data: [a[1][0], a[1][1]] }), n.push({ op: "bcurveTo", data: [a[1][0], a[1][1], a[2][0], a[2][1], a[2][0], a[2][1]] })) : e === 2 && n.push(...ut(a[0][0], a[0][1], a[1][0], a[1][1], s, !0, !0));
  return n;
}
function Pt(a, t, s, e, n, o, r, h) {
  let i = [], l = [];
  if (h.roughness === 0) {
    ...
    let c = y(0.5, h) - Math.PI / 2;
    l.push([y(o, h) + t + 0.9 * e * Math.cos(c - a), y(o, h) + s + 0.9 * n * Math.sin(c - a)]);
    let d = 2 * Math.PI + c - 0.01;
    for (let p = c; p < d; p += a) {
      let u = [y(o, h) + t + e * Math.cos(p), y(o, h) + s + n * Math.sin(p)];
      i.push(u), l.push(u);
    }
    l.push([y(o, h) + t + e * Math.cos(c + 2 * Math.PI + 0.5 * r), y(o, h) + s + n * Math.sin(c + 2 * Math.PI + 0.5 * r)]), l.push([y(o, h) + t + 0.98 * e * Math.cos(c + r), y(o, h) + s + 0.98 * n * Math.sin(c + r)]), l.push([y(o, h) + t + 0.9 * e * Math.cos(c + 0.5 * r), y(o, h) + s + 0.9 * n * Math.sin(c + 0.5 * r)]);
  }
  return [l, i];
}
function vt(a, t, s, e, n, o, r, h, i) {
  let l = o + y(0.1, i), c = [];
  c.push([y(h, i) + t + 0.9 * e * Math.cos(l - a), y(h, i) + s + 0.9 * n * Math.sin(l - a)]);
  for (let d = l; d <= r; d += a) c.push([y(h, i) + t + e * Math.cos(d), y(h, i) + s + n * Math.sin(d)]);
  return c.push([t + e * Math.cos(r), s + n * Math.sin(r)]), c.push([t + e * Math.cos(r), s + n * Math.sin(r)]), K(c, null, i);
}
function Rt(a, t, s, e, n, o, r, h) {
  let i = [], l = [h.maxRandomnessOffset || 1, (h.maxRandomnessOffset || 1) + 0.3], c = [0, 0], d = h.disableMultiStroke ? 1 : 2, p = h.preserveVertices;
  for (let u = 0; u < d; u++) u === 0 ? i.push({ op: "move", data: [r[0], r[1]] }) : i.push({ op: "move", data: [r[0] + (p ? 0 : y(l[0], h)), r[1] + (p ? 0 : y(l[0], h))] }), c = p ? [n, o] : [n + y(l[u], h), o + y(l[u], h)], i.push({ op: "bcurveTo", data: [a + y(l[u], h), t + y(l[u], h), s + y(l[u], h), e + y(l[u], h), c[0], c[1]] });
  return i;
}
function j(a) {
  return [...a];
...
function St(a, t = 0) {
  ...
  let e = [];
  if (s === 3) e.push(j(a[0]), j(a[1]), j(a[2]), j(a[2]));
  else {
    let n = [];
    n.push(a[0], a[0]);
...
function jt(a, t, s) {
  ...
  return n = Math.max(0, Math.min(1, n)), B(a, z(t, s, n));
}
function z(a, t, s) {
...
function pt(a, t, s, e) {
  ...
  if ((function(h, i) {
    ...
    let i = a[t + 0], l = a[t + 1], c = a[t + 2], d = a[t + 3], p = z(i, l, 0.5), u = z(l, c, 0.5), f = z(c, d, 0.5), g = z(p, u, 0.5), k = z(u, f, 0.5), b = z(g, k, 0.5);
    pt([i, p, g, b], 0, s, n), pt([b, k, f, d], 0, s, n);
  }
  var o, r;
  return n;
}
...
var O = "none", $ = class {
  ...
  line(t, s, e, n, o) {
    let r = this._o(o);
    return this._d("line", [Dt(t, s, e, n, r)], r);
  }
  rectangle(t, s, e, n, o) {
    let r = this._o(o), h = [], i = $t(t, s, e, n, r);
    if (r.fill) {
      let l = [[t, s], [t + e, s], [t + e, s + n], [t, s + n]];
      r.fillStyle === "solid" ? h.push(st([l], r)) : h.push(G([l], r));
    }
    return r.stroke !== O && h.push(i), this._d("rectangle", h, r);
  }
  ellipse(t, s, e, n, o) {
    let r = this._o(o), h = [], i = At(e, n, r), l = lt(t, s, r, i);
    if (r.fill) if (r.fillStyle === "solid") {
      let c = lt(t, s, r, i).opset;
  ...
  linearPath(t, s) {
    let e = this._o(s);
    return this._d("linearPath", [N(t, !1, e)], e);
  }
  arc(t, s, e, n, o, r, h = !1, i) {
    let l = this._o(i), c = [], d = mt(t, s, e, n, o, r, h, !0, l);
    if (h && l.fill) if (l.fillStyle === "solid") {
      let p = Object.assign({}, l);
      p.disableMultiStroke = !0;
      let u = mt(t, s, e, n, o, r, !0, !1, p);
      u.type = "fillPath", c.push(u);
    } else c.push((function(p, u, f, g, k, b, M) {
      let m = p, P = u, x = Math.abs(f / 2), w = Math.abs(g / 2);
      x += y(0.01 * x, M), w += y(0.01 * w, M);
      let L = k, A = b;
      for (; L < 0; ) L += 2 * Math.PI, A += 2 * Math.PI;
      A - L > 2 * Math.PI && (L = 0, A = 2 * Math.PI);
      let V = (A - L) / M.curveStepCount, D = [];
      for (let C = L; C <= A; C += V) D.push([m + x * Math.cos(C), P + w * Math.sin(C)]);
  ...
  curve(t, s) {
    ...
    if (e.fill && e.fill !== O) if (e.fillStyle === "solid") {
      let r = yt(t, Object.assign(Object.assign({}, e), { disableMultiStroke: !0, roughness: e.roughness ? e.roughness + e.fillShapeRoughnessGain : 0 }));
      n.push({ type: "fillPath", ops: this._mergedShape(r.ops) });
    } else {
      let r = [], h = t;
      if (h.length) {
        let i = typeof h[0][0] == "number" ? [h] : h;
        for (let l of i) l.length < 3 ? r.push(...l) : l.length === 3 ? r.push(...nt(St([l[0], l[0], l[1], l[2]]), 10, (1 + e.roughness) / 2)) : r.push(...nt(St(l), 10, (1 + e.roughness) / 2));
      }
      r.length && n.push(G([r], e));
    }
    return e.stroke !== O && n.push(o), this._d("curve", n, e);
  }
  polygon(t, s) {
    let e = this._o(s), n = [], o = N(t, !0, e);
    return e.fill && (e.fillStyle === "solid" ? n.push(st([t], e)) : n.push(G([t], e))), e.stroke !== O && n.push(o), this._d("polygon", n, e);
  }
  path(t, s) {
    let e = this._o(s), n = [];
    if (!t) return this._d("path", n, e);
    t = (t || "").replace(/\n/g, " ").replace(/(-\s)/g, "-").replace("/(ss)/g", " ");
    let o = e.fill && e.fill !== "transparent" && e.fill !== O, r = e.stroke !== O, h = !!(e.simplification && e.simplification < 1), i = (function(c, d, p) {
      let u = Lt(Ot(gt(c))), f = [], g = [], k = [0, 0], b = [], M = () => {
        b.length >= 4 && g.push(...nt(b, d)), b = [];
      }, m = () => {
        M(), g.length && (f.push(g), g = []);
      };
      for (let { key: x, data: w } of u) switch (x) {
        case "M":
    ...
    if (o) if (e.fillStyle === "solid") if (i.length === 1) {
      let c = wt(t, Object.assign(Object.assign({}, e), { disableMultiStroke: !0, roughness: e.roughness ? e.roughness + e.fillShapeRoughnessGain : 0 }));
...
}, H = "http://www.w3.org/2000/svg", dt = class {
  constructor(t, s) {
    this.svg = t, this.gen = new $(s);
  }
  draw(t) {
    let s = t.sets || [], e = t.options || this.getDefaultOptions(), n = this.svg.ownerDocument || window.document, o = n.createElementNS(H, "g"), r = t.options.fixedDecimalPlaceDigits;
    for (let h of s) {
      let i = null;
      switch (h.type) {
        case "path":
          i = n.createElementNS(H, "path"), i.setAttribute("d", this.opsToPath(h, r)), i.setAttribute("stroke", e.stroke), i.setAttribute("stroke-width", e.strokeWidth + ""), i.setAttribute("fill", "none"), e.strokeLineDash && i.setAttribute("stroke-dasharray", e.strokeLineDash.join(" ").trim()), e.strokeLineDashOffset && i.setAttribute("stroke-dashoffset", `${e.strokeLineDashOffset}`);
          break;
        case "fillPath":
          i = n.createElementNS(H, "path"), i.setAttribute("d", this.opsToPath(h, r)), i.setAttribute("stroke", "none"), i.setAttribute("stroke-width", "0"), i.setAttribute("fill", e.fill || ""), t.shape !== "curve" && t.shape !== "polygon" || i.setAttribute("fill-rule", "evenodd");
          break;
        case "fillSketch":
  ...
  fillSketch(t, s, e) {
    ...
    let o = t.createElementNS(H, "path");
...
}, Ft = { canvas: (a, t) => new ft(a, t), svg: (a, t) => new dt(a, t), generator: (a) => new $(a), newSeed: () => $.newSeed() };
