...
var qc = Vc(), Fa = /* @__PURE__ */ Oa(qc), fi = Qe ? Qe.performance : null, lv = fi && fi.now ? function() {
  ...
  return _c(e);
}, Kr = lv, Ct = 9261, vv = 65599, _t = 5381, fv = function(e) {
...
function Ep(r, e, t, a) {
  ...
  if (s.duration === 0 ? g = 1 : g = (t - u) / s.duration, s.applying && (g = s.progress), g < 0 ? g = 0 : g > 1 && (g = 1), s.delay == null) {
    ...
    if (m && n && !r.locked()) {
      var b = {};
      da(p.x, m.x) && (b.x = Nt(p.x, m.x, g, y)), da(p.y, m.y) && (b.y = Nt(p.y, m.y, g, y)), r.position(b);
    }
    var w = s.startPan, E = s.pan, C = i.pan, x = E != null && a;
    x && (da(w.x, E.x) && (C.x = Nt(w.x, E.x, g, y)), da(w.y, E.y) && (C.y = Nt(w.y, E.y, g, y)), r.emit("pan"));
    var T = s.startZoom, k = s.zoom, B = k != null && a;
    B && (da(T, k) && (i.zoom = ka(i.minZoom, Nt(T, k, g, y), i.maxZoom)), r.emit("zoom")), (x || B) && r.emit("viewport");
    var D = s.style;
    if (D && D.length > 0 && n) {
      for (var P = 0; P < D.length; P++) {
        var A = D[P], R = A.name, L = A, I = s.startStyle[R], M = v.properties[I.name], N = Nt(I, L, g, y, M);
...
sr.updateStyleHints = function(r) {
  ...
  if (o) {
    ...
    e.nodeKey = Jr(V), e.hasPie = ne != null && ne[0] !== Ct && ne[1] !== _t, e.hasStripe = Y != null && Y[0] !== Ct && Y[1] !== _t;
  }
  return s !== e.styleKey;
};
...
[bp, Tp, af, Ns, cn, kp, zs, dn, Pp, Pt, Aa].forEach(function(r) {
  me(Sn, r);
});
var Rp = {
  fit: !0,
...
nf.prototype.run = function() {
  ...
  var p = [], m = {}, b = function(se, de) {
    ...
    var ge = zt(se), Ee = ge.depth, be = ge.index;
  ...
  var T = function(se) {
    ...
    for (var ge = zt(se), Ee = se.incomers().filter(function(S) {
      return S.isNode() && t.has(S);
    }), be = -1, Te = se.id(), Be = 0; Be < Ee.length; Be++) {
      var Ae = Ee[Be], Le = zt(Ae);
  ...
  var q = {}, Z = function(se) {
    if (q[se.id()])
      return q[se.id()];
    for (var de = zt(se).depth, ge = se.neighborhood(), Ee = 0, be = 0, Te = 0; Te < ge.length; Te++) {
      var Be = ge[Te];
  ...
  var $ = {
    ...
    var de = zt(se), ge = de.depth, Ee = de.index;
    if (r.circle) {
...
var Fs, Vs, Vr = {}, Dr = {}, Bl, Pl, Tt, hn, $r, mt, Et, zr, Ft, tn, gf, pf, qs, _s, Al, Rl = function(e, t, a) {
  ...
  if (e !== Al ? Rl(t, e, Vr) : ry(Dr, Vr), Rl(t, a, Dr), Bl = Vr.nx * Dr.ny - Vr.ny * Dr.nx, Pl = Vr.nx * Dr.nx - Vr.ny * -Dr.ny, $r = Math.asin(Math.max(-1, Math.min(1, Bl))), Math.abs($r) < 1e-6) {
    Fs = t.x, Vs = t.y, Et = Ft = 0;
    return;
  }
  Tt = 1, hn = !1, Pl < 0 ? $r < 0 ? $r = Math.PI + $r : ($r = Math.PI - $r, Tt = -1, hn = !0) : $r > 0 && (Tt = -1, hn = !0), t.radius !== void 0 ? Ft = t.radius : Ft = n, mt = $r / 2, tn = Math.min(Vr.len / 2, Dr.len / 2), i ? (zr = Math.abs(Math.cos(mt) * Ft / Math.sin(mt)), zr > tn ? (zr = tn, Et = Math.abs(zr * Math.sin(mt) / Math.cos(mt))) : Et = Ft) : (zr = Math.min(tn, Ft), Et = Math.abs(zr * Math.sin(mt) / Math.cos(mt))), qs = t.x + Dr.nx * zr, _s = t.y + Dr.ny * zr, Fs = qs - Dr.ny * Et * Tt, Vs = _s + Dr.nx * Et * Tt, gf = t.x + Vr.nx * zr, pf = t.y + Vr.ny * zr, Al = t;
};
function yf(r, e) {
...
Ga.findEndpoints = function(r) {
  ...
  if (I === "inside-to-node")
    ...
    if (we.length > 0) {
      var ye = l, pe = xt(ye, Gt(s)), se = xt(ye, Gt(we)), de = pe;
  ...
  if (m.endX = be[0], m.endY = be[1], m.arrowEndX = Ee[0], m.arrowEndY = Ee[1], A === "inside-to-node")
    ...
    if (U.length > 0) {
      var ue = v, re = xt(ue, Gt(s)), oe = xt(ue, Gt(U)), ie = re;
...
var Ef = {};
[Rt, Dn, hr, Ga, po, Hr, xf, Kn, Xn].forEach(function(r) {
  me(Ef, r);
});
var Cf = {};
  ...
  r.registerBinding(e, "touchmove", ve = function(S) {
    ...
    if (!(!O && !T(S))) {
      ...
      if (O && r.touchData.cxt) {
        S.preventDefault();
        var Ye = S.touches[0].clientX - j, Ze = S.touches[0].clientY - ne, We = S.touches[1].clientX - j, fr = S.touches[1].clientY - ne, Ar = K(Ye, Ze, We, fr), $e = Ar / Q, Sr = 150, Rr = Sr * Sr, Qr = 1.5, Lt = Qr * Qr;
        if ($e >= Lt || Ar >= Rr) {
...
Yr.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, u) {
      ...
      var f = u * 2;
      return !!(Xr(e, t, this.points, s, o, n, i - f, [0, -1], a) || Xr(e, t, this.points, s, o, n - f, i, [0, -1], a) || St(e, t, f, f, s - l + u, o - v + u, a) || St(e, t, f, f, s + l - u, o - v + u, a) || St(e, t, f, f, s + l - u, o + v - u, a) || St(e, t, f, f, s - l + u, o + v - u, a));
    }
  };
};
    ...
    var ve = function() {
      ...
      if (q > 0) {
        ...
        if (h ? r.stroke(fe) : r.stroke(), Q === "double") {
          r.lineWidth = G / 3;
          var Lt = r.globalCompositeOperation;
          r.globalCompositeOperation = "destination-out", h ? r.stroke(fe) : r.stroke(), r.globalCompositeOperation = Lt;
        }
        r.setLineDash && r.setLineDash([]);
      }
    }, ge = function() {
...
}, Es = 0, Ul = 1, Kl = 2, Cs = 3, qt = 4, nn = 5, ga = 6, pa = 7, pm = /* @__PURE__ */ (function() {
  function r(e, t, a) {
...
for (wt = 0 * Math.PI; wt < 2 * Math.PI; wt += Ff)
  Ws[wt] = Math.sin(wt), $s[wt] = Math.cos(wt);
var wt;
...
[Pf, Wr, Zr, yo, Mt, gt, mr, If, pt, Wa, qf].forEach(function(r) {
  me(Se, r);
});
var Am = [{
  name: "null",
...
/*! For license information please see chunk-VCV5RKWI.js.LEGAL.txt */
