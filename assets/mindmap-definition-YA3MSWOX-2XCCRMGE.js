...
function J() {
  return crypto.getRandomValues(_e);
}

// node_modules/uuid/dist/v4.js
function Se(t, e, o) {
  return !e && !t && crypto.randomUUID ? crypto.randomUUID() : xe(t, e, o);
}
function xe(t, e, o) {
  t = t || {};
  let l = t.random ?? t.rng?.() ?? J();
  if (l.length < 16)
...
var Q = (function() {
  var t = /* @__PURE__ */ h(function(L, s, n, a) {
    for (n = n || {}, a = L.length; a--; n[L[a]] = s) ;
    return n;
  }, "o"), e = [1, 4], o = [1, 13], l = [1, 12], i = [1, 15], d = [1, 16], f = [1, 20], y = [1, 19], k = [6, 7, 8], _ = [1, 26], v = [1, 24], A = [1, 25], g = [6, 7, 11], $ = [1, 6, 13, 15, 16, 19, 22], Z = [1, 33], ee = [1, 34], U = [1, 6, 7, 11, 13, 15, 16, 19, 22], H = {
    ...
    performAction: /* @__PURE__ */ h(function(s, n, a, c, p, r, B) {
      var u = r.length - 1;
      switch (p) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: e }, { 6: o, 7: [1, 10], 9: 9, 12: 11, 13: l, 14: 14, 15: i, 16: d, 17: 17, 18: 18, 19: f, 22: y }, t(k, [2, 3]), { 1: [2, 2] }, t(k, [2, 4]), t(k, [2, 5]), { 1: [2, 6], 6: o, 12: 21, 13: l, 14: 14, 15: i, 16: d, 17: 17, 18: 18, 19: f, 22: y }, { 6: o, 9: 22, 12: 11, 13: l, 14: 14, 15: i, 16: d, 17: 17, 18: 18, 19: f, 22: y }, { 6: _, 7: v, 10: 23, 11: A }, t(g, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: f, 22: y }), t(g, [2, 18]), t(g, [2, 19]), t(g, [2, 20]), t(g, [2, 21]), t(g, [2, 23]), t(g, [2, 24]), t(g, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: _, 7: v, 10: 32, 11: A }, { 1: [2, 7], 6: o, 12: 21, 13: l, 14: 14, 15: i, 16: d, 17: 17, 18: 18, 19: f, 22: y }, t($, [2, 14], { 7: Z, 11: ee }), t(U, [2, 8]), t(U, [2, 9]), t(U, [2, 10]), t(g, [2, 15]), t(g, [2, 16]), t(g, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, t($, [2, 13], { 7: Z, 11: ee }), t(U, [2, 11]), t(U, [2, 12]), { 21: [1, 37] }, t(g, [2, 25]), t(g, [2, 27])],
    defaultActions: { 2: [2, 1], 6: [2, 2] },
    parseError: /* @__PURE__ */ h(function(s, n) {
      if (n.recoverable)
        this.trace(s);
      else {
        var a = new Error(s);
    ...
    parse: /* @__PURE__ */ h(function(s) {
      var n = this, a = [0], c = [], p = [null], r = [], B = this.table, u = "", F = 0, te = 0, ie = 0, ye = 2, ne = 1, ke = r.slice.call(arguments, 1), m = Object.create(this.lexer), T = { yy: {} };
      ...
      var X = m.yylloc;
      r.push(X);
      var be = m.options && m.options.ranges;
      ...
      function re() {
        var S;
        return S = c.pop() || m.lex() || ne, typeof S != "number" && (S instanceof Array && (c = S, S = c.pop()), S = n.symbols_[S] || S), S;
      }
      h(re, "lex");
      for (var E, z, O, x, Re, Y, C = {}, G, N, se, j; ; ) {
        if (O = a[a.length - 1], this.defaultActions[O] ? x = this.defaultActions[O] : ((E === null || typeof E > "u") && (E = re()), x = B[O] && B[O][E]), typeof x > "u" || !x.length || !x[0]) {
          var q = "";
          j = [];
          for (G in B[O])
            this.terminals_[G] && G > ye && j.push("'" + this.terminals_[G] + "'");
          m.showPosition ? q = "Parse error on line " + (F + 1) + `:
` + m.showPosition() + `
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : q = "Parse error on line " + (F + 1) + ": Unexpected " + (E == ne ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(q, {
            text: m.match,
        ...
        if (x[0] instanceof Array && x.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + O + ", token: " + E);
        switch (x[0]) {
          case 1:
            a.push(E), p.push(m.yytext), r.push(m.yylloc), a.push(x[1]), E = null, z ? (E = z, z = null) : (te = m.yyleng, u = m.yytext, F = m.yylineno, X = m.yylloc, ie > 0 && ie--);
            break;
          case 2:
            if (N = this.productions_[x[1]][1], C.$ = p[p.length - N], C._$ = {
              ...
              p,
              r
            ].concat(ke)), typeof Y < "u")
              return Y;
            N && (a = a.slice(0, -1 * N * 2), p = p.slice(0, -1 * N), r = r.slice(0, -1 * N)), a.push(this.productions_[x[1]][0]), p.push(C.$), r.push(C._$), se = B[a[a.length - 2]][a[a.length - 1]], a.push(se);
            break;
          case 3:
            return !0;
        }
    ...
    var L = {
      EOF: 1,
      parseError: /* @__PURE__ */ h(function(n, a) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ h(function(s, n) {
      ...
      unput: /* @__PURE__ */ h(function(s) {
        ...
        return this.yylloc = {
          ...
          last_column: a ? (a.length === c.length ? this.yylloc.first_column : 0) + c[c.length - a.length].length - a[0].length : this.yylloc.first_column - n
...
` + n + "^";
      ...
      test_match: /* @__PURE__ */ h(function(s, n) {
        var a, c, p;
      ...
      next: /* @__PURE__ */ h(function() {
        ...
        return n ? (s = this.test_match(n, p[c]), s !== !1 ? s : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      topState: /* @__PURE__ */ h(function(n) {
        return n = this.conditionStack.length - 1 - Math.abs(n || 0), n >= 0 ? this.conditionStack[n] : "INITIAL";
      }, "topState"),
      // alias for begin(condition)
      pushState: /* @__PURE__ */ h(function(n) {
        this.begin(n);
      }, "pushState"),
      ...
      performAction: /* @__PURE__ */ h(function(n, a, c, p) {
        var r = p;
        switch (c) {
          case 0:
  ...
  return h(V, "Parser"), V.prototype = H, H.Parser = V, new V();
})();
Q.parser = Q;
var Ne = Q, De = 12, D = {
  DEFAULT: 0,
  ...
  addNode(e, o, l, i) {
    ...
    let k = {
      ...
      type: i,
      children: [],
      width: f.mindmap?.maxNodeWidth ?? M.mindmap.maxNodeWidth,
      padding: y,
      isRoot: d
    }, _ = this.getParent(e);
    if (_)
      _.children.push(k), this.nodes.push(k);
    else if (d)
      this.nodes.push(k);
    else
      throw new Error(
        `There can be only one root. No parent could be found for ("${k.descr}")`
      );
  }
  getType(e, o) {
    switch (I.debug("In get type", e, o), e) {
      case "[":
  ...
  decorateNode(e) {
    if (!e)
      return;
    let o = w(), l = this.nodes[this.nodes.length - 1];
    e.icon && (l.icon = P(e.icon, o)), e.class && (l.class = P(e.class, o));
  }
  type2Str(e) {
    switch (e) {
  ...
  assignSections(e, o) {
    if (e.level === 0 ? e.section = void 0 : e.section = o, e.children)
      for (let [l, i] of e.children.entries()) {
        let d = e.level === 0 ? l % (De - 1) : o;
        this.assignSections(i, d);
      }
  }
  /**
   ...
   */
  flattenNodes(e, o) {
    let l = w(), i = ["mindmap-node"];
    e.isRoot === !0 ? i.push("section-root", "section--1") : e.section !== void 0 && i.push(`section-${e.section}`), e.class && i.push(e.class);
    let d = i.join(" "), f = /* @__PURE__ */ h((k) => {
      let v = (l.theme?.toLowerCase() ?? "").includes("redux");
      switch (k) {
        case D.CIRCLE:
    ...
    if (o.push(y), e.children)
      for (let k of e.children)
        this.flattenNodes(k, o);
  }
  /**
  ...
  generateEdges(e, o) {
    ...
    for (let i of e.children) {
      let d = "edge";
      i.section !== void 0 && (d += ` section-edge-${i.section}`);
      let f = e.level + 1;
      d += ` edge-depth-${f}`;
      let y = {
      ...
      o.push(y), this.generateEdges(i, o);
    }
  }
  /**
   ...
   */
  getData() {
    let e = this.getMindmap(), o = w(), i = he().layout !== void 0, d = o;
    if (i || (d.layout = "cose-bilkent"), !e)
      return {
        nodes: [],
        edges: [],
        config: d
      };
    I.debug("getData: mindmapRoot", e, o), this.assignSections(e);
    let f = [], y = [];
    this.flattenNodes(e, f), this.generateEdges(e, y), I.debug(
...
}, h(R, "MindmapDB"), R), ve = /* @__PURE__ */ h(async (t, e, o, l) => {
  I.debug(`Rendering mindmap diagram
` + t);
  let i = l.db, d = i.getData(), f = ue(e, d.config.securityLevel);
  if (d.type = l.type, d.layoutAlgorithm = ge(d.config.layout, {
    fallback: "cose-bilkent"
  }), d.diagramId = e, !i.getMindmap())
    return;
  d.nodes.forEach((g) => {
  ...
  let { themeVariables: k } = le(), { useGradient: _, gradientStart: v, gradientStop: A } = k;
  if (_ && v && A) {
    let g = f.attr("id"), $ = f.append("defs").append("linearGradient").attr("id", `${g}-gradient`).attr("gradientUnits", "objectBoundingBox").attr("x1", "0%").attr("y1", "0%").attr("x2", "100%").attr("y2", "0%");
    $.append("stop").attr("offset", "0%").attr("stop-color", v).attr("stop-opacity", 1), $.append("stop").attr("offset", "100%").attr("stop-color", A).attr("stop-opacity", 1);
  }
  pe(
    f,
    d.config.mindmap?.padding ?? M.mindmap.padding,
    "mindmapDiagram",
    d.config.mindmap?.useMaxWidth ?? M.mindmap.useMaxWidth
  );
}, "draw"), Te = {
  draw: ve
}, Oe = /* @__PURE__ */ h((t) => {
  let { theme: e, look: o } = t, l = "";
  for (let i = 0; i < t.THEME_COLOR_LIMIT; i++)
    t["lineColor" + i] = t["lineColor" + i] || t["cScaleInv" + i], oe(t["lineColor" + i]) ? t["lineColor" + i] = ae(t["lineColor" + i], 20) : t["lineColor" + i] = ce(t["lineColor" + i], 20);
  for (let i = 0; i < t.THEME_COLOR_LIMIT; i++) {
    let d = "" + (o === "neo" ? Math.max(10 - (i - 1) * 2, 2) : 17 - 3 * i);
    l += `
    ...
    [data-look="neo"].section-edge-${i - 1}{
      stroke: ${e?.includes("redux") || e === "neo-dark" ? t.nodeBorder : t["cScale" + i]};
    }
  ...
  return l;
}, "genSections"), Ie = /* @__PURE__ */ h((t, e, o) => {
  let l = "";
  for (let i = 0; i < t; i++)
    l += `
    [data-look="neo"].mindmap-node.section-${i - 1} rect, [data-look="neo"].mindmap-node.section-${i - 1} path, [data-look="neo"].mindmap-node.section-${i - 1} circle, [data-look="neo"].mindmap-node.section-${i - 1} polygon {
  ...
  return l;
}, "genGradient"), Ce = /* @__PURE__ */ h((t) => {
  let { theme: e } = t, o = t.svgId, l = t.dropShadow ? t.dropShadow.replace("url(#drop-shadow)", `url(${o}-drop-shadow)`) : "none";
  return `
  .edge {
    stroke-width: 3;
  }
