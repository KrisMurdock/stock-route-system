import {
  c as Or
} from "./chunk-EJMXA7KY.js";

// node_modules/@mermaid-js/parser/dist/chunks/mermaid-parser.core/chunk-FOHPRMQF.mjs
var HN = Object.create, eu = Object.defineProperty, YN = Object.getOwnPropertyDescriptor, Fm = Object.getOwnPropertyNames, XN = Object.getPrototypeOf, JN = Object.prototype.hasOwnProperty, s = (t, e) => eu(t, "name", { value: e, configurable: !0 }), ZN = (t, e) => function() {
  return t && (e = (0, t[Fm(t)[0]])(t = 0)), e;
}, X = (t, e) => function() {
  return e || (0, t[Fm(t)[0]])((e = { exports: {} }).exports, e), e.exports;
}, Wr = (t, e) => {
  for (var r in e)
    eu(t, r, { get: e[r], enumerable: !0 });
}, cc = (t, e, r, n) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a of Fm(e))
      !JN.call(t, a) && a !== r && eu(t, a, { get: () => e[a], enumerable: !(n = YN(e, a)) || n.enumerable });
  return t;
}, Qc = (t, e, r) => (cc(t, e, "default"), r && cc(r, e, "default")), zm = (t, e, r) => (r = t != null ? HN(XN(t)) : {}, cc(
  // If the importer is in node compatibility mode or this is not an ESM
  // file that has been converted to a CommonJS file using a Babel-
  // compatible transform (i.e. "__esModule" has not been set), then set
  // "default" to the CommonJS "module.exports" for node compatibility.
  e || !t || !t.__esModule ? eu(r, "default", { value: t, enumerable: !0 }) : r,
  t
)), jm = (t) => cc(eu({}, "__esModule", { value: !0 }), t), ef = {};
Wr(ef, {
  AnnotatedTextEdit: () => dr,
  ChangeAnnotation: () => an,
  ChangeAnnotationIdentifier: () => Je,
  CodeAction: () => Td,
  CodeActionContext: () => vd,
  CodeActionKind: () => gd,
  ...
  Color: () => Uu,
  ColorInformation: () => Kp,
  ColorPresentation: () => Bp,
  Command: () => nn,
  CompletionItem: () => id,
  CompletionItemKind: () => Qp,
  CompletionItemLabelDetails: () => ad,
  CompletionItemTag: () => td,
  CompletionList: () => sd,
  CreateFile: () => ga,
  DeleteFile: () => Ta,
  Diagnostic: () => cl,
  DiagnosticRelatedInformation: () => Ku,
  DiagnosticSeverity: () => Vp,
  DiagnosticTag: () => Hp,
  DocumentHighlight: () => fd,
  DocumentHighlightKind: () => cd,
  DocumentLink: () => Ad,
  DocumentSymbol: () => yd,
  DocumentUri: () => zp,
  EOL: () => JT,
  FoldingRange: () => Wp,
  FoldingRangeKind: () => qp,
  FormattingOptions: () => Rd,
  Hover: () => od,
  InlayHint: () => Pd,
  InlayHintKind: () => Wu,
  InlayHintLabelPart: () => Vu,
  InlineCompletionContext: () => Md,
  InlineCompletionItem: () => Od,
  InlineCompletionList: () => Ld,
  InlineCompletionTriggerKind: () => Dd,
  InlineValueContext: () => Nd,
  InlineValueEvaluatableExpression: () => Id,
  InlineValueText: () => Sd,
  InlineValueVariableLookup: () => wd,
  InsertReplaceEdit: () => rd,
  InsertTextFormat: () => ed,
  InsertTextMode: () => nd,
  Location: () => ul,
  LocationLink: () => Up,
  ...
  MarkupContent: () => $a,
  MarkupKind: () => qu,
  OptionalVersionedTextDocumentIdentifier: () => pl,
  ParameterInformation: () => ld,
  Position: () => se,
  Range: () => te,
  RenameFile: () => va,
  SelectedCompletionInfo: () => xd,
  SelectionRange: () => Ed,
  SemanticTokenModifiers: () => bd,
  SemanticTokenTypes: () => Cd,
  SemanticTokens: () => _d,
  SignatureInformation: () => ud,
  StringValue: () => kd,
  SymbolInformation: () => md,
  SymbolKind: () => pd,
  SymbolTag: () => dd,
  TextDocument: () => Fd,
  TextDocumentEdit: () => fl,
  TextDocumentIdentifier: () => Xp,
  TextDocumentItem: () => Zp,
  TextEdit: () => Xt,
  URI: () => ju,
  VersionedTextDocumentIdentifier: () => Jp,
  WorkspaceChange: () => XT,
  WorkspaceEdit: () => Bu,
  WorkspaceFolder: () => Gd,
  WorkspaceSymbol: () => hd,
...
var zp, ju, jp, ll, se, te, ul, Up, Uu, Kp, Bp, qp, Wp, Ku, Vp, Hp, Yp, cl, nn, Xt, an, Je, dr, fl, ga, va, Ta, Bu, Xo, cp, XT, Xp, Jp, pl, Zp, qu, $a, Qp, ed, td, rd, nd, ad, id, sd, dl, od, ld, ud, cd, fd, pd, dd, md, hd, yd, gd, ml, vd, Td, $d, Rd, Ad, Ed, Cd, bd, _d, Sd, wd, Id, Nd, Wu, Vu, Pd, kd, Od, Ld, Dd, xd, Md, Gd, JT, Fd, _g, E, tu = ZN({
  "../../node_modules/.pnpm/vscode-languageserver-types@3.17.5/node_modules/vscode-languageserver-types/lib/esm/main.js"() {
    ...
    (function(a) {
      ...
      function i(u, l) {
        return u === Number.MAX_VALUE && (u = ll.MAX_VALUE), l === Number.MAX_VALUE && (l = ll.MAX_VALUE), { line: u, character: l };
      }
      ...
      function o(u) {
        let l = u;
        return E.objectLiteral(l) && se.is(l.start) && se.is(l.end);
      }
      s(o, "is"), a.is = o;
    })(te || (te = {})), (function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return E.objectLiteral(l) && te.is(l.range) && Uu.is(l.color);
      }
      s(o, "is"), a.is = o;
    })(Kp || (Kp = {})), (function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        let l = u;
        return E.objectLiteral(l) && E.string(l.label) && (E.undefined(l.textEdit) || Xt.is(l)) && (E.undefined(l.additionalTextEdits) || E.typedArray(l.additionalTextEdits, Xt.is));
      }
      s(o, "is"), a.is = o;
    })(Bp || (Bp = {})), (function(a) {
      ...
      function i(u, l, c, f, p, d) {
        ...
        return E.defined(c) && (y.startCharacter = c), E.defined(f) && (y.endCharacter = f), E.defined(p) && (y.kind = p), E.defined(d) && (y.collapsedText = d), y;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
      ...
      function i(u, l, c, f, p, d) {
        ...
        return E.defined(c) && (y.severity = c), E.defined(f) && (y.code = f), E.defined(p) && (y.source = p), E.defined(d) && (y.relatedInformation = d), y;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        var l;
        let c = u;
        return E.defined(c) && te.is(c.range) && E.string(c.message) && (E.number(c.severity) || E.undefined(c.severity)) && (E.integer(c.code) || E.string(c.code) || E.undefined(c.code)) && (E.undefined(c.codeDescription) || E.string((l = c.codeDescription) === null || l === void 0 ? void 0 : l.href)) && (E.string(c.source) || E.undefined(c.source)) && (E.undefined(c.relatedInformation) || E.typedArray(c.relatedInformation, Ku.is));
      }
      s(o, "is"), a.is = o;
    })(cl || (cl = {})), (function(a) {
      function i(u, l, ...c) {
      ...
      function l(c) {
        let f = c;
        return Xt.is(f) && (an.is(f.annotationId) || Je.is(f.annotationId));
      }
      s(l, "is"), a.is = l;
    })(dr || (dr = {})), (function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return E.defined(l) && pl.is(l.textDocument) && Array.isArray(l.edits);
      }
      s(o, "is"), a.is = o;
    })(fl || (fl = {})), (function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        let l = u;
        return l && l.kind === "create" && E.string(l.uri) && (l.options === void 0 || (l.options.overwrite === void 0 || E.boolean(l.options.overwrite)) && (l.options.ignoreIfExists === void 0 || E.boolean(l.options.ignoreIfExists))) && (l.annotationId === void 0 || Je.is(l.annotationId));
      }
      s(o, "is"), a.is = o;
    })(ga || (ga = {})), (function(a) {
      function i(u, l, c, f) {
        ...
        return c !== void 0 && (c.overwrite !== void 0 || c.ignoreIfExists !== void 0) && (p.options = c), f !== void 0 && (p.annotationId = f), p;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
        return l && l.kind === "rename" && E.string(l.oldUri) && E.string(l.newUri) && (l.options === void 0 || (l.options.overwrite === void 0 || E.boolean(l.options.overwrite)) && (l.options.ignoreIfExists === void 0 || E.boolean(l.options.ignoreIfExists))) && (l.annotationId === void 0 || Je.is(l.annotationId));
      }
      s(o, "is"), a.is = o;
    })(va || (va = {})), (function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        let l = u;
        return l && l.kind === "delete" && E.string(l.uri) && (l.options === void 0 || (l.options.recursive === void 0 || E.boolean(l.options.recursive)) && (l.options.ignoreIfNotExists === void 0 || E.boolean(l.options.ignoreIfNotExists))) && (l.annotationId === void 0 || Je.is(l.annotationId));
      }
      s(o, "is"), a.is = o;
    })(Ta || (Ta = {})), (function(a) {
      function i(o) {
        let u = o;
        return u && (u.changes !== void 0 || u.documentChanges !== void 0) && (u.documentChanges === void 0 || u.documentChanges.every((l) => E.string(l.kind) ? ga.is(l) || va.is(l) || Ta.is(l) : fl.is(l)));
      }
      s(i, "is"), a.is = i;
    })(Bu || (Bu = {})), Xo = (t = class {
      constructor(i, o) {
      ...
      insert(i, o, u) {
        let l, c;
        if (u === void 0 ? l = Xt.insert(i, o) : Je.is(u) ? (c = u, l = dr.insert(i, o, u)) : (this.assertChangeAnnotations(this.changeAnnotations), c = this.changeAnnotations.manage(u), l = dr.insert(i, o, c)), this.edits.push(l), c !== void 0)
          return c;
      }
      replace(i, o, u) {
        let l, c;
        if (u === void 0 ? l = Xt.replace(i, o) : Je.is(u) ? (c = u, l = dr.replace(i, o, u)) : (this.assertChangeAnnotations(this.changeAnnotations), c = this.changeAnnotations.manage(u), l = dr.replace(i, o, c)), this.edits.push(l), c !== void 0)
          return c;
      }
      delete(i, o) {
        let u, l;
        if (o === void 0 ? u = Xt.del(i) : Je.is(o) ? (l = o, u = dr.del(i, o)) : (this.assertChangeAnnotations(this.changeAnnotations), l = this.changeAnnotations.manage(o), u = dr.del(i, l)), this.edits.push(u), l !== void 0)
          return l;
      }
      add(i) {
        this.edits.push(i);
    ...
    }, s(t, "TextEditChangeImpl"), t), cp = (e = class {
      constructor(i) {
      ...
      manage(i, o) {
        let u;
        if (Je.is(i) ? u = i : (u = this.nextId(), o = i), this._annotations[u] !== void 0)
    ...
    }, s(e, "ChangeAnnotations"), e), XT = (r = class {
      constructor(i) {
        this._textEditChanges = /* @__PURE__ */ Object.create(null), i !== void 0 ? (this._workspaceEdit = i, i.documentChanges ? (this._changeAnnotations = new cp(i.changeAnnotations), i.changeAnnotations = this._changeAnnotations.all(), i.documentChanges.forEach((o) => {
          if (fl.is(o)) {
            let u = new Xo(o.edits, this._changeAnnotations);
            this._textEditChanges[o.textDocument.uri] = u;
          }
        })) : i.changes && Object.keys(i.changes).forEach((o) => {
          let u = new Xo(i.changes[o]);
      ...
      getTextEditChange(i) {
        if (pl.is(i)) {
          ...
          let o = { uri: i.uri, version: i.version }, u = this._textEditChanges[o.uri];
          if (!u) {
            let l = [], c = {
              textDocument: o,
              edits: l
            };
            this._workspaceEdit.documentChanges.push(c), u = new Xo(l, this._changeAnnotations), this._textEditChanges[o.uri] = u;
          }
          return u;
        } else {
          ...
          if (!o) {
            let u = [];
            this._workspaceEdit.changes[i] = u, o = new Xo(u), this._textEditChanges[i] = o;
          }
          return o;
        }
      }
      initDocumentChanges() {
        this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new cp(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
      }
      initChanges() {
      ...
      createFile(i, o, u) {
        if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
          throw new Error("Workspace edit is not configured for document changes.");
        let l;
        an.is(o) || Je.is(o) ? l = o : u = o;
        let c, f;
        if (l === void 0 ? c = ga.create(i, u) : (f = Je.is(l) ? l : this._changeAnnotations.manage(l), c = ga.create(i, u, f)), this._workspaceEdit.documentChanges.push(c), f !== void 0)
          return f;
      }
      renameFile(i, o, u, l) {
        if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
          throw new Error("Workspace edit is not configured for document changes.");
        let c;
        an.is(u) || Je.is(u) ? c = u : l = u;
        let f, p;
        if (c === void 0 ? f = va.create(i, o, l) : (p = Je.is(c) ? c : this._changeAnnotations.manage(c), f = va.create(i, o, l, p)), this._workspaceEdit.documentChanges.push(f), p !== void 0)
          return p;
      }
      deleteFile(i, o, u) {
        if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
        ...
        an.is(o) || Je.is(o) ? l = o : u = o;
        let c, f;
        if (l === void 0 ? c = Ta.create(i, u) : (f = Je.is(l) ? l : this._changeAnnotations.manage(l), c = Ta.create(i, u, f)), this._workspaceEdit.documentChanges.push(c), f !== void 0)
          return f;
      }
      ...
      function i(o) {
        let u = o;
        return E.objectLiteral(o) && qu.is(u.kind) && E.string(u.value);
      }
      s(i, "is"), a.is = i;
    })($a || ($a = {})), (function(a) {
      ...
      function i(o) {
        let u = o;
        return !!u && E.objectLiteral(u) && ($a.is(u.contents) || dl.is(u.contents) || E.typedArray(u.contents, dl.is)) && (o.range === void 0 || te.is(o.range));
      }
      s(i, "is"), a.is = i;
    })(od || (od = {})), (function(a) {
      function i(o, u) {
      ...
      function i(u, l, c, f, p, d) {
        ...
        return d !== void 0 && (y.children = d), y;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
      ...
      function o(u) {
        let l = u;
        return E.defined(l) && E.typedArray(l.diagnostics, cl.is) && (l.only === void 0 || E.typedArray(l.only, E.string)) && (l.triggerKind === void 0 || l.triggerKind === ml.Invoked || l.triggerKind === ml.Automatic);
      }
      s(o, "is"), a.is = o;
    })(vd || (vd = {})), (function(a) {
      function i(u, l, c) {
        let f = { title: u }, p = !0;
        return typeof l == "string" ? (p = !1, f.kind = l) : nn.is(l) ? f.command = l : f.edit = l, p && c !== void 0 && (f.kind = c), f;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
        return l && E.string(l.title) && (l.diagnostics === void 0 || E.typedArray(l.diagnostics, cl.is)) && (l.kind === void 0 || E.string(l.kind)) && (l.edit !== void 0 || l.command !== void 0) && (l.command === void 0 || nn.is(l.command)) && (l.isPreferred === void 0 || E.boolean(l.isPreferred)) && (l.edit === void 0 || Bu.is(l.edit));
      }
      s(o, "is"), a.is = o;
    })(Td || (Td = {})), (function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return E.defined(l) && te.is(l.range) && (E.undefined(l.command) || nn.is(l.command));
      }
      s(o, "is"), a.is = o;
    })($d || ($d = {})), (function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return E.objectLiteral(l) && (l.tooltip === void 0 || E.string(l.tooltip) || $a.is(l.tooltip)) && (l.location === void 0 || ul.is(l.location)) && (l.command === void 0 || nn.is(l.command));
      }
      s(o, "is"), a.is = o;
    })(Vu || (Vu = {})), (function(a) {
      function i(u, l, c) {
        let f = { position: u, label: l };
        return c !== void 0 && (f.kind = c), f;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
        return E.objectLiteral(l) && se.is(l.position) && (E.string(l.label) || E.typedArray(l.label, Vu.is)) && (l.kind === void 0 || Wu.is(l.kind)) && l.textEdits === void 0 || E.typedArray(l.textEdits, Xt.is) && (l.tooltip === void 0 || E.string(l.tooltip) || $a.is(l.tooltip)) && (l.paddingLeft === void 0 || E.boolean(l.paddingLeft)) && (l.paddingRight === void 0 || E.boolean(l.paddingRight));
      }
      s(o, "is"), a.is = o;
    })(Pd || (Pd = {})), (function(a) {
      function i(o) {
      ...
      function i(o) {
        let u = o;
        return E.objectLiteral(u) && ju.is(u.uri) && E.string(u.name);
      }
      s(i, "is"), a.is = i;
    })(Gd || (Gd = {})), JT = [`
`, `\r
`, "\r"], (function(a) {
      ...
      s(o, "is"), a.is = o;
      function u(c, f) {
        let p = c.getText(), d = l(f, (h, $) => {
          let C = h.range.start.line - $.range.start.line;
          return C === 0 ? h.range.start.character - $.range.start.character : C;
        }), y = p.length;
        for (let h = d.length - 1; h >= 0; h--) {
          let $ = d[h], C = c.offsetAt($.range.start), T = c.offsetAt($.range.end);
          if (T <= y)
            p = p.substring(0, C) + $.newText + p.substring(T, p.length);
          else
      ...
      function l(c, f) {
        if (c.length <= 1)
          return c;
        let p = c.length / 2 | 0, d = c.slice(0, p), y = c.slice(p);
        l(d, f), l(y, f);
        let h = 0, $ = 0, C = 0;
        for (; h < d.length && $ < y.length; )
          f(d[h], y[$]) <= 0 ? c[C++] = d[h++] : c[C++] = y[$++];
        for (; h < d.length; )
          c[C++] = d[h++];
        for (; $ < y.length; )
          c[C++] = y[$++];
...
` && l++;
      ...
      s($, "objectLiteral"), a.objectLiteral = $;
      function C(T, _) {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/events.js"(t) {
    ...
    var n = (i = class {
      ...
      invoke(...l) {
        if (!this._callbacks)
          return [];
        let c = [], f = this._callbacks.slice(0), p = this._contexts.slice(0);
      ...
      get event() {
        return this._event || (this._event = (l, c, f) => {
          ...
          let p = {
            dispose: /* @__PURE__ */ s(() => {
              this._callbacks && (this._callbacks.remove(l, c), p.dispose = o._noop, this._options && this._options.onLastListenerRemove && this._callbacks.isEmpty() && this._options.onLastListenerRemove(this));
            }, "dispose")
          };
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/cancellation.js"(t) {
    ...
    var i = Object.freeze(function(f, p) {
      let d = (0, e.default)().timer.setTimeout(f.bind(p), 0);
      return { dispose() {
        d.dispose();
      } };
    }), o = (l = class {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messages.js"(t) {
    "use strict";
    var k, S, v, I, R, A, w, L, x, O, z, M, Y, V, Z, ne, ke, pe, Ae, qe, Oe, ee, Xe, ue, We;
    ...
    var e = ru(), r;
    (function(ye) {
      ye.ParseError = -32700, ye.InvalidRequest = -32600, ye.MethodNotFound = -32601, ye.InvalidParams = -32602, ye.InternalError = -32603, ye.jsonrpcReservedErrorRangeStart = -32099, ye.serverErrorStart = -32099, ye.MessageWriteError = -32099, ye.MessageReadError = -32098, ye.PendingResponseRejected = -32097, ye.ConnectionInactive = -32096, ye.ServerNotInitialized = -32002, ye.UnknownErrorCode = -32001, ye.jsonrpcReservedErrorRangeEnd = -32e3, ye.serverErrorEnd = -32e3;
    })(r || (t.ErrorCodes = r = {}));
    var n = (k = class extends Error {
      constructor(G, ze, qt) {
        super(ze), this.code = e.number(G) ? G : r.UnknownErrorCode, this.data = qt, Object.setPrototypeOf(this, k.prototype);
      }
      toJson() {
        let G = {
          code: this.code,
    ...
    var a = (S = class {
      ...
      static is(G) {
        return G === S.auto || G === S.byName || G === S.byPosition;
      }
      toString() {
        return this.kind;
      }
    }, s(S, "ParameterStructures"), S);
    t.ParameterStructures = a, a.auto = new a("auto"), a.byPosition = new a("byPosition"), a.byName = new a("byName");
    var i = (v = class {
      constructor(G, ze) {
        this.method = G, this.numberOfParams = ze;
      }
      get parameterStructures() {
        return a.auto;
      }
    }, s(v, "AbstractMessageSignature"), v);
    ...
    var u = (R = class extends i {
      constructor(G, ze = a.auto) {
        super(G, 1), this._parameterStructures = ze;
      }
      get parameterStructures() {
    ...
    t.RequestType3 = f;
    var p = (x = class extends i {
      constructor(G) {
        super(G, 4);
      }
    }, s(x, "RequestType4"), x);
    t.RequestType4 = p;
    var d = (O = class extends i {
      constructor(G) {
        super(G, 5);
      }
    }, s(O, "RequestType5"), O);
    ...
    var _ = (ne = class extends i {
      constructor(G) {
        super(G, 0);
      }
    }, s(ne, "NotificationType0"), ne);
    t.NotificationType0 = _;
    var b = (ke = class extends i {
      constructor(G, ze = a.auto) {
        super(G, 1), this._parameterStructures = ze;
      }
      get parameterStructures() {
    ...
    var U = (Ae = class extends i {
      constructor(G) {
        super(G, 3);
      }
    }, s(Ae, "NotificationType3"), Ae);
    t.NotificationType3 = U;
    var re = (qe = class extends i {
      constructor(G) {
        super(G, 4);
      }
    }, s(qe, "NotificationType4"), qe);
    t.NotificationType4 = re;
    var J = (Oe = class extends i {
      constructor(G) {
        super(G, 5);
      }
    }, s(Oe, "NotificationType5"), Oe);
    t.NotificationType5 = J;
    var me = (ee = class extends i {
      constructor(G) {
        super(G, 6);
      }
    }, s(ee, "NotificationType6"), ee);
    t.NotificationType6 = me;
    var Re = (Xe = class extends i {
      constructor(G) {
        super(G, 7);
      }
    }, s(Xe, "NotificationType7"), Xe);
    t.NotificationType7 = Re;
    var he = (ue = class extends i {
      constructor(G) {
        super(G, 8);
      }
    }, s(ue, "NotificationType8"), ue);
    t.NotificationType8 = he;
    var le = (We = class extends i {
      constructor(G) {
        super(G, 9);
      }
    }, s(We, "NotificationType9"), We);
    ...
    (function(ye) {
      ...
      s(G, "isRequest"), ye.isRequest = G;
      function ze(St) {
        let ge = St;
        return ge && e.string(ge.method) && St.id === void 0;
      }
      s(ze, "isNotification"), ye.isNotification = ze;
      function qt(St) {
        let ge = St;
        return ge && (ge.result !== void 0 || !!ge.error) && (e.string(ge.id) || e.number(ge.id) || ge.id === null);
      }
      s(qt, "isResponse"), ye.isResponse = qt;
    })(rt || (t.Message = rt = {}));
  }
}), QT = X({
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/linkedMap.js"(t) {
    ...
    var n = (i = class {
      ...
      set(l, c, f = r.None) {
        ...
        if (p)
          p.value = c, f !== r.None && this.touch(p, f);
        else {
      ...
      forEach(l, c) {
        let f = this._state, p = this._head;
        for (; p; ) {
      ...
      keys() {
        let l = this._state, c = this._head, f = {
          [Symbol.iterator]: () => f,
          next: /* @__PURE__ */ s(() => {
            if (this._state !== l)
              throw new Error("LinkedMap got modified during iteration.");
            if (c) {
              let p = { value: c.key, done: !1 };
              return c = c.next, p;
            } else
        ...
        let l = this._state, c = this._head, f = {
          ...
          next: /* @__PURE__ */ s(() => {
            if (this._state !== l)
              throw new Error("LinkedMap got modified during iteration.");
            if (c) {
              let p = { value: [c.key, c.value], done: !1 };
              return c = c.next, p;
            } else
              return { value: void 0, done: !0 };
          }, "next")
      ...
      touch(l, c) {
        ...
        if (!(c !== r.First && c !== r.Last)) {
          if (c === r.First) {
            if (l === this._head)
              return;
            let f = l.next, p = l.previous;
            l === this._tail ? (p.next = void 0, this._tail = p) : (f.previous = p, p.next = f), l.previous = void 0, l.next = this._head, this._head.previous = l, this._head = l, this._state++;
          } else if (c === r.Last) {
            if (l === this._tail)
              return;
            let f = l.next, p = l.previous;
            l === this._head ? (f.previous = void 0, this._head = f) : (f.previous = p, p.next = f), l.next = void 0, l.previous = this._tail, this._tail.next = l, this._tail = l, this._state++;
          }
        }
      }
      toJSON() {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/sharedArrayCancellation.js"(t) {
    ...
    var n = (u = class {
      ...
      enableCancellation(d) {
        if (d.id === null)
          return;
        let y = new SharedArrayBuffer(4), h = new Int32Array(y, 0, 1);
        h[0] = r.Continue, this.buffers.set(d.id, y), d.$cancellationData = y;
      }
      async sendCancellation(d, y) {
        let h = this.buffers.get(y);
        if (h === void 0)
          return;
        let $ = new Int32Array(h, 0, 1);
        Atomics.store($, 0, r.Cancelled);
      }
      cleanup(d) {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageReader.js"(t) {
    ...
    var o = (c = class {
      ...
      asError(d) {
        return d instanceof Error ? d : new Error(`Reader received error. Reason: ${r.string(d.message) ? d.message : "unknown"}`);
      }
    ...
    (function(p) {
      function d(y) {
        let h, $, C, T = /* @__PURE__ */ new Map(), _, b = /* @__PURE__ */ new Map();
        if (y === void 0 || typeof y == "string")
          h = y ?? "utf-8";
        else {
          if (h = y.charset ?? "utf-8", y.contentDecoder !== void 0 && (C = y.contentDecoder, T.set(C.name, C)), y.contentDecoders !== void 0)
            for (let N of y.contentDecoders)
              T.set(N.name, N);
          if (y.contentTypeDecoder !== void 0 && (_ = y.contentTypeDecoder, b.set(_.name, _)), y.contentTypeDecoders !== void 0)
            for (let N of y.contentTypeDecoders)
              b.set(N.name, N);
        }
        return _ === void 0 && (_ = (0, e.default)().applicationJson.decoder, b.set(_.name, _)), { charset: h, contentDecoder: C, contentDecoders: T, contentTypeDecoder: _, contentTypeDecoders: b };
      }
      s(d, "fromOptions"), p.fromOptions = d;
    })(u || (u = {}));
    var l = (f = class extends o {
      constructor(d, y) {
        super(), this.readable = d, this.options = u.fromOptions(y), this.buffer = (0, e.default)().messageBuffer.create(this.options.charset), this._partialMessageTimeout = 1e4, this.nextMessageLength = -1, this.messageToken = 0, this.readSemaphore = new a.Semaphore(1);
      }
      ...
      listen(d) {
        this.nextMessageLength = -1, this.messageToken = 0, this.partialMessageTimer = void 0, this.callback = d;
        let y = this.readable.onData((h) => {
          this.onData(h);
        });
        ...
        try {
          for (this.buffer.append(d); ; ) {
            if (this.nextMessageLength === -1) {
              let h = this.buffer.tryReadHeaders(!0);
              if (!h)
                return;
              let $ = h.get("content-length");
              if (!$) {
...
${JSON.stringify(Object.fromEntries(h))}`));
              ...
              let C = parseInt($);
              if (isNaN(C)) {
                this.fireError(new Error(`Content-Length value must be a number. Got ${$}`));
                return;
              }
              this.nextMessageLength = C;
            }
            let y = this.buffer.tryReadBody(this.nextMessageLength);
            if (y === void 0) {
              this.setPartialMessageTimer();
              return;
            }
            this.clearPartialMessageTimer(), this.nextMessageLength = -1, this.readSemaphore.lock(async () => {
              let h = this.options.contentDecoder !== void 0 ? await this.options.contentDecoder.decode(y) : y, $ = await this.options.contentTypeDecoder.decode(h, this.options);
              this.callback($);
            }).catch((h) => {
              this.fireError(h);
            });
      ...
      setPartialMessageTimer() {
        this.clearPartialMessageTimer(), !(this._partialMessageTimeout <= 0) && (this.partialMessageTimer = (0, e.default)().timer.setTimeout((d, y) => {
          this.partialMessageTimer = void 0, d === this.messageToken && (this.firePartialMessage({ messageToken: d, waitingTime: y }), this.setPartialMessageTimer());
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageWriter.js"(t) {
    ...
    var e = Mn(), r = ru(), n = e$(), a = Eo(), i = "Content-Length: ", o = `\r
`, u;
    (function(y) {
      function h($) {
        let C = $;
    ...
    var l = (p = class {
      ...
      fireError(h, $, C) {
        this.errorEmitter.fire([this.asError(h), $, C]);
      }
      get onClose() {
        return this.closeEmitter.event;
      }
    ...
    }, s(p, "AbstractMessageWriter"), p);
    t.AbstractMessageWriter = l;
    var c;
    (function(y) {
      function h($) {
        return $ === void 0 || typeof $ == "string" ? { charset: $ ?? "utf-8", contentTypeEncoder: (0, e.default)().applicationJson.encoder } : { charset: $.charset ?? "utf-8", contentEncoder: $.contentEncoder, contentTypeEncoder: $.contentTypeEncoder ?? (0, e.default)().applicationJson.encoder };
      }
      s(h, "fromOptions"), y.fromOptions = h;
    })(c || (c = {}));
    var f = (d = class extends l {
      constructor(h, $) {
        super(), this.writable = h, this.options = c.fromOptions($), this.errorCount = 0, this.writeSemaphore = new n.Semaphore(1), this.writable.onError((C) => this.fireError(C)), this.writable.onClose(() => this.fireClose());
      }
      async write(h) {
        return this.writeSemaphore.lock(async () => this.options.contentTypeEncoder.encode(h, this.options).then((C) => this.options.contentEncoder !== void 0 ? this.options.contentEncoder.encode(C) : C).then((C) => {
          let T = [];
          return T.push(i, C.byteLength.toString(), o), T.push(o), this.doWrite(h, T, C);
        }, (C) => {
      ...
      async doWrite(h, $, C) {
        try {
          return await this.writable.write($.join(""), "ascii"), this.writable.write(C);
        } catch (T) {
          return this.handleError(T, h), Promise.reject(T);
        }
      }
      handleError(h, $) {
        this.errorCount++, this.fireError(h, $, this.errorCount);
      }
      end() {
        this.writable.end();
      }
    }, s(d, "WriteableStreamMessageWriter"), d);
...
`, a = (i = class {
      ...
      append(u) {
        let l = typeof u == "string" ? this.fromString(u, this._encoding) : u;
      ...
      tryReadHeaders(u = !1) {
        ...
        if (l !== 4)
          return;
        let d = this._read(p + f), y = /* @__PURE__ */ new Map(), h = this.toString(d, "ascii").split(n);
        if (h.length < 2)
          return y;
        for (let $ = 0; $ < h.length - 2; $++) {
          let C = h[$], T = C.indexOf(":");
          if (T === -1)
            throw new Error(`Message header must separate key and value using ':'
${C}`);
          let _ = C.substr(0, T), b = C.substr(T + 1).trim();
          y.set(u ? _.toLowerCase() : _, b);
        }
        return y;
      }
      tryReadBody(u) {
      ...
      _read(u) {
        ...
        if (this._chunks[0].byteLength === u) {
          let p = this._chunks[0];
          return this._chunks.shift(), this._totalLength -= u, this.asNative(p);
        }
        if (this._chunks[0].byteLength > u) {
          let p = this._chunks[0], d = this.asNative(p, u);
          return this._chunks[0] = p.slice(u), this._totalLength -= u, d;
        }
        let l = this.allocNative(u), c = 0, f = 0;
        for (; u > 0; ) {
          let p = this._chunks[f];
          if (p.byteLength > u) {
            let d = p.slice(0, u);
            l.set(d, c), c += u, this._chunks[f] = p.slice(u), this._totalLength -= u, u -= u;
          } else
            l.set(p, c), c += p.byteLength, this._chunks.shift(), this._totalLength -= p.byteLength, u -= p.byteLength;
        }
        return l;
      }
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/connection.js"(t) {
    ...
    var e = Mn(), r = ru(), n = ZT(), a = QT(), i = Eo(), o = tf(), u;
    (function(v) {
    ...
    (function(v) {
      ...
      s(R, "toString"), v.toString = R;
    })(d || (t.Trace = d = {}));
    var h;
    (function(v) {
      v.Text = "text", v.JSON = "json";
    })(h || (t.TraceFormat = h = {})), (function(v) {
      function I(R) {
        return r.string(R) ? (R = R.toLowerCase(), R === "json" ? v.JSON : v.Text) : v.Text;
      }
      s(I, "fromString"), v.fromString = I;
    })(h || (t.TraceFormat = h = {}));
    var $;
    ...
    (function(v) {
      ...
      s(I, "is"), v.is = I;
    })(U || (t.RequestCancellationReceiverStrategy = U = {}));
    var re;
    (function(v) {
    ...
    (function(v) {
      ...
      function I(R) {
        let A = R;
        return A && re.is(A.receiver) && J.is(A.sender);
      }
      s(I, "is"), v.is = I;
    ...
    (function(v) {
      ...
      s(I, "is"), v.is = I;
    })(Re || (t.MessageStrategy = Re = {}));
    var he;
    (function(v) {
      function I(R) {
        let A = R;
        return A && (me.is(A.cancellationStrategy) || b.is(A.connectionStrategy) || Re.is(A.messageStrategy));
      }
      s(I, "is"), v.is = I;
    ...
    function rt(v, I, R, A) {
      let w = R !== void 0 ? R : t.NullLogger, L = 0, x = 0, O = 0, z = "2.0", M, Y = /* @__PURE__ */ new Map(), V, Z = /* @__PURE__ */ new Map(), ne = /* @__PURE__ */ new Map(), ke, pe = new a.LinkedMap(), Ae = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), Oe = /* @__PURE__ */ new Map(), ee = d.Off, Xe = h.Text, ue, We = le.New, ye = new i.Emitter(), G = new i.Emitter(), ze = new i.Emitter(), qt = new i.Emitter(), St = new i.Emitter(), ge = A && A.cancellationStrategy ? A.cancellationStrategy : me.Message;
      function aa(g) {
        if (g === null)
          throw new Error("Can't send requests with id null since the response can't be correlated.");
        return "req-" + g.toString();
      }
      s(aa, "createRequestQueueKey");
      function Oo(g) {
        return g === null ? "res-unknown-" + (++O).toString() : "res-" + g.toString();
      }
      s(Oo, "createResponseQueueKey");
      function Lo() {
        return "not-" + (++x).toString();
      }
      s(Lo, "createNotificationQueueKey");
      function Do(g, P) {
        n.Message.isRequest(P) ? g.set(aa(P.id), P) : n.Message.isResponse(P) ? g.set(Oo(P.id), P) : g.set(Lo(), P);
      }
      s(Do, "addMessageToQueue");
      function xo(g) {
      }
      s(xo, "cancelUndispatched");
      function ia() {
        return We === le.Listening;
      }
      s(ia, "isListening");
      function sa() {
        return We === le.Closed;
      ...
      s(sa, "isClosed");
      function Wt() {
        return We === le.Disposed;
      }
      s(Wt, "isDisposed");
      function oa() {
        (We === le.New || We === le.Listening) && (We = le.Closed, G.fire(void 0));
      }
      s(oa, "closeHandler");
      function Mo(g) {
        ye.fire([g, void 0, void 0]);
      }
      s(Mo, "readErrorHandler");
      function Go(g) {
        ye.fire(g);
      }
      s(Go, "writeErrorHandler"), v.onClose(oa), v.onError(Mo), I.onClose(oa), I.onError(Go);
      function la() {
        ke || pe.size === 0 || (ke = (0, e.default)().timer.setImmediate(() => {
          ke = void 0, Fo();
        }));
      }
      s(la, "triggerMessageQueue");
      function ua(g) {
        n.Message.isRequest(g) ? zo(g) : n.Message.isNotification(g) ? Uo(g) : n.Message.isResponse(g) ? jo(g) : Ko(g);
      }
      s(ua, "handleMessage");
      function Fo() {
        if (pe.size === 0)
        ...
        let g = pe.shift();
        try {
          let P = A?.messageStrategy;
          Re.is(P) ? P.handleMessage(g, ua) : ua(g);
        } finally {
          la();
        }
      }
      s(Fo, "processMessageQueue");
      let Au = /* @__PURE__ */ s((g) => {
        try {
          if (n.Message.isNotification(g) && g.method === u.type.method) {
            let P = g.params.id, D = aa(P), F = pe.get(D);
            if (n.Message.isRequest(F)) {
              let de = A?.connectionStrategy, Le = de && de.cancelUndispatched ? de.cancelUndispatched(F, xo) : void 0;
              if (Le && (Le.error !== void 0 || Le.result !== void 0)) {
                pe.delete(D), Oe.delete(P), Le.id = F.id, kr(Le, g.method, Date.now()), I.write(Le).catch(() => w.error("Sending response for canceled message failed."));
                return;
              }
            }
            let Ee = Oe.get(P);
      ...
      function zo(g) {
        ...
        function P(ae, Ie, ce) {
          ...
          ae instanceof n.ResponseError ? Ue.error = ae.toJson() : Ue.result = ae === void 0 ? null : ae, kr(Ue, Ie, ce), I.write(Ue).catch(() => w.error("Sending response failed."));
        }
        s(P, "reply");
        function D(ae, Ie, ce) {
          let Ue = {
          ...
          kr(Ue, Ie, ce), I.write(Ue).catch(() => w.error("Sending response failed."));
        }
        s(D, "replyError");
        function F(ae, Ie, ce) {
          ae === void 0 && (ae = null);
        ...
        s(F, "replySuccess"), Wo(g);
        let Ee = Y.get(g.method), de, Le;
        Ee && (de = Ee.type, Le = Ee.handler);
        let Me = Date.now();
        if (Le || M) {
          let ae = g.id ?? String(Date.now()), Ie = N.is(ge.receiver) ? ge.receiver.createCancellationTokenSource(ae) : ge.receiver.createCancellationTokenSource(g);
          g.id !== null && qe.has(g.id) && Ie.cancel(), g.id !== null && Oe.set(ae, Ie);
          try {
            let ce;
            if (Le)
              if (g.params === void 0) {
                if (de !== void 0 && de.numberOfParams !== 0) {
                  D(new n.ResponseError(n.ErrorCodes.InvalidParams, `Request ${g.method} defines ${de.numberOfParams} params but received none.`), g.method, Me);
                  return;
                }
                ce = Le(Ie.token);
              } else if (Array.isArray(g.params)) {
                if (de !== void 0 && de.parameterStructures === n.ParameterStructures.byName) {
                  D(new n.ResponseError(n.ErrorCodes.InvalidParams, `Request ${g.method} defines parameters by name but received parameters by position`), g.method, Me);
                  return;
                }
                ce = Le(...g.params, Ie.token);
              } else {
                if (de !== void 0 && de.parameterStructures === n.ParameterStructures.byPosition) {
                  D(new n.ResponseError(n.ErrorCodes.InvalidParams, `Request ${g.method} defines parameters by position but received parameters by name`), g.method, Me);
                  return;
                }
                ce = Le(g.params, Ie.token);
              }
            else M && (ce = M(g.method, g.params, Ie.token));
            let Ue = ce;
            ce ? Ue.then ? Ue.then((nt) => {
              Oe.delete(ae), P(nt, g.method, Me);
            }, (nt) => {
              Oe.delete(ae), nt instanceof n.ResponseError ? D(nt, g.method, Me) : nt && r.string(nt.message) ? D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed with message: ${nt.message}`), g.method, Me) : D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed unexpectedly without providing any details.`), g.method, Me);
            }) : (Oe.delete(ae), P(ce, g.method, Me)) : (Oe.delete(ae), F(ce, g.method, Me));
          } catch (ce) {
            Oe.delete(ae), ce instanceof n.ResponseError ? P(ce, g.method, Me) : ce && r.string(ce.message) ? D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed with message: ${ce.message}`), g.method, Me) : D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed unexpectedly without providing any details.`), g.method, Me);
          }
        } else
          D(new n.ResponseError(n.ErrorCodes.MethodNotFound, `Unhandled method ${g.method}`), g.method, Me);
      }
      s(zo, "handleRequest");
      function jo(g) {
        if (!Wt())
          if (g.id === null)
            g.error ? w.error(`Received response message without id: Error is: 
${JSON.stringify(g.error, void 0, 4)}`) : w.error("Received response message without id. No further error information provided.");
          else {
            let P = g.id, D = Ae.get(P);
            if (Vo(g, D), D !== void 0) {
              Ae.delete(P);
              try {
                if (g.error) {
                ...
                F.message ? w.error(`Response handler '${D.method}' failed with message: ${F.message}`) : w.error(`Response handler '${D.method}' failed unexpectedly.`);
              }
            }
          }
      }
      ...
      function Uo(g) {
        ...
        if (D || V)
          try {
            if (Jr(g), D)
              if (g.params === void 0)
                P !== void 0 && P.numberOfParams !== 0 && P.parameterStructures !== n.ParameterStructures.byName && w.error(`Notification ${g.method} defines ${P.numberOfParams} params but received none.`), D();
              else if (Array.isArray(g.params)) {
                let F = g.params;
                g.method === c.type.method && F.length === 2 && l.is(F[0]) ? D({ token: F[0], value: F[1] }) : (P !== void 0 && (P.parameterStructures === n.ParameterStructures.byName && w.error(`Notification ${g.method} defines parameters by name but received parameters by position`), P.numberOfParams !== g.params.length && w.error(`Notification ${g.method} defines ${P.numberOfParams} params but received ${F.length} arguments`)), D(...F));
              } else
                P !== void 0 && P.parameterStructures === n.ParameterStructures.byPosition && w.error(`Notification ${g.method} defines parameters by position but received parameters by name`), D(g.params);
            else V && V(g.method, g.params);
          } catch (F) {
            F.message ? w.error(`Notification handler '${g.method}' failed with message: ${F.message}`) : w.error(`Notification handler '${g.method}' failed unexpectedly.`);
          }
        else
          ze.fire(g);
      }
      s(Uo, "handleNotification");
      function Ko(g) {
        if (!g) {
...
${JSON.stringify(g, null, 4)}`);
      ...
      function Bo(g) {
        if (!(ee === d.Off || !ue))
          if (Xe === h.Text) {
            let P;
            (ee === d.Verbose || ee === d.Compact) && g.params && (P = `Params: ${wt(g.params)}

`), ue.log(`Sending request '${g.method} - (${g.id})'.`, P);
          } else
            Vt("send-request", g);
      }
      s(Bo, "traceSendingRequest");
      function qo(g) {
        if (!(ee === d.Off || !ue))
          if (Xe === h.Text) {
            let P;
...
`), ue.log(`Sending notification '${g.method}'.`, P);
            ...
            Vt("send-notification", g);
      }
      s(qo, "traceSendingNotification");
      function kr(g, P, D) {
        if (!(ee === d.Off || !ue))
          if (Xe === h.Text) {
            let F;
            (ee === d.Verbose || ee === d.Compact) && (g.error && g.error.data ? F = `Error data: ${wt(g.error.data)}

` : g.result ? F = `Result: ${wt(g.result)}

` : g.error === void 0 && (F = `No result returned.

`)), ue.log(`Sending response '${P} - (${g.id})'. Processing request took ${Date.now() - D}ms`, F);
          } else
            Vt("send-response", g);
      }
      s(kr, "traceSendingResponse");
      function Wo(g) {
        if (!(ee === d.Off || !ue))
          if (Xe === h.Text) {
            let P;
...
`), ue.log(`Received request '${g.method} - (${g.id})'.`, P);
            ...
            Vt("receive-request", g);
      }
      s(Wo, "traceReceivedRequest");
      function Jr(g) {
        if (!(ee === d.Off || !ue || g.method === C.type.method))
          if (Xe === h.Text) {
            let P;
            (ee === d.Verbose || ee === d.Compact) && (g.params ? P = `Params: ${wt(g.params)}
...
`), ue.log(`Received notification '${g.method}'.`, P);
            ...
            Vt("receive-notification", g);
      }
      s(Jr, "traceReceivedNotification");
      function Vo(g, P) {
        if (!(ee === d.Off || !ue))
          if (Xe === h.Text) {
            let D;
            if ((ee === d.Verbose || ee === d.Compact) && (g.error && g.error.data ? D = `Error data: ${wt(g.error.data)}

` : g.result ? D = `Result: ${wt(g.result)}

` : g.error === void 0 && (D = `No result returned.

`)), P) {
              let F = g.error ? ` Request failed: ${g.error.message} (${g.error.code}).` : "";
              ue.log(`Received response '${P.method} - (${g.id})' in ${Date.now() - P.timerStart}ms.${F}`, D);
            } else
              ue.log(`Received response ${g.id} without active response promise.`, D);
          } else
            Vt("receive-response", g);
      }
      s(Vo, "traceReceivedResponse");
      function Vt(g, P) {
        if (!ue || ee === d.Off)
          return;
        let D = {
      ...
      function cr() {
        if (sa())
          throw new _(T.Closed, "Connection is closed.");
        if (Wt())
          throw new _(T.Disposed, "Connection is disposed.");
      }
      s(cr, "throwIfClosedOrDisposed");
      function Ho() {
        if (ia())
          throw new _(T.AlreadyListening, "Connection is already listening");
      }
      s(Ho, "throwIfListening");
      function Yo() {
        if (!ia())
          throw new Error("Call listen() first.");
      }
      s(Yo, "throwIfNotListening");
      function m(g) {
      ...
      function we(g, P) {
        ...
        switch (F) {
          ...
          default:
            D = [];
            for (let Ee = 0; Ee < P.length && Ee < F; Ee++)
              D.push(m(P[Ee]));
            if (P.length < F)
              for (let Ee = P.length; Ee < F; Ee++)
                D.push(null);
            break;
        }
        return D;
      }
      s(we, "computeMessageParams");
      let ca = {
        sendNotification: /* @__PURE__ */ s((g, ...P) => {
          ...
          if (r.string(g)) {
            D = g;
            let de = P[0], Le = 0, Me = n.ParameterStructures.auto;
            n.ParameterStructures.is(de) && (Le = 1, Me = de);
            let ae = P.length, Ie = ae - Le;
            switch (Ie) {
              case 0:
                F = void 0;
                break;
              case 1:
                ...
                break;
              default:
                if (Me === n.ParameterStructures.byName)
                  throw new Error(`Received ${Ie} parameters for 'by Name' notification parameter structure.`);
                F = P.slice(Le, ae).map((ce) => m(ce));
                break;
            }
          } else {
            let de = P;
            D = g.method, F = we(g, de);
          }
          let Ee = {
            jsonrpc: z,
            method: D,
          ...
          return qo(Ee), I.write(Ee).catch((de) => {
            throw w.error("Sending notification failed."), de;
          });
        }, "sendNotification"),
        ...
        sendProgress: /* @__PURE__ */ s((g, P, D) => ca.sendNotification(c.type, { token: P, value: D }), "sendProgress"),
        onUnhandledProgress: qt.event,
        sendRequest: /* @__PURE__ */ s((g, ...P) => {
          cr(), Yo();
          let D, F, Ee;
          if (r.string(g)) {
            D = g;
            let ae = P[0], Ie = P[P.length - 1], ce = 0, Ue = n.ParameterStructures.auto;
            n.ParameterStructures.is(ae) && (ce = 1, Ue = ae);
            let nt = P.length;
            o.CancellationToken.is(Ie) && (nt = nt - 1, Ee = Ie);
            let Ht = nt - ce;
            switch (Ht) {
              case 0:
                F = void 0;
              ...
              default:
                if (Ue === n.ParameterStructures.byName)
                  throw new Error(`Received ${Ht} parameters for 'by Name' request parameter structure.`);
                F = P.slice(ce, nt).map((VN) => m(VN));
                break;
            }
          } else {
            let ae = P;
            D = g.method, F = we(g, ae);
            let Ie = g.numberOfParams;
            Ee = o.CancellationToken.is(ae[Ie]) ? ae[Ie] : void 0;
          }
          let de = L++, Le;
          Ee && (Le = Ee.onCancellationRequested(() => {
            let ae = ge.sender.sendCancellation(ca, de);
            return ae === void 0 ? (w.log(`Received no promise from cancellation strategy when cancelling id ${de}`), Promise.resolve()) : ae.catch(() => {
              w.log(`Sending cancellation messages for id ${de} failed`);
            });
          }));
          let Me = {
            jsonrpc: z,
          ...
          return Bo(Me), typeof ge.sender.enableCancellation == "function" && ge.sender.enableCancellation(Me), new Promise(async (ae, Ie) => {
            let ce = /* @__PURE__ */ s((Ht) => {
              ae(Ht), ge.sender.cleanup(de), Le?.dispose();
            }, "resolveWithCleanup"), Ue = /* @__PURE__ */ s((Ht) => {
              Ie(Ht), ge.sender.cleanup(de), Le?.dispose();
            }, "rejectWithCleanup"), nt = { method: D, timerStart: Date.now(), resolve: ce, reject: Ue };
            try {
              await I.write(Me), Ae.set(de, nt);
            } catch (Ht) {
              throw w.error("Sending request failed."), nt.reject(new n.ResponseError(n.ErrorCodes.MessageWriteError, Ht.message ? Ht.message : "Unknown reason")), Ht;
            }
          });
        }, "sendRequest"),
        onRequest: /* @__PURE__ */ s((g, P) => {
          cr();
          let D = null;
          return p.is(g) ? (D = void 0, M = g) : r.string(g) ? (D = null, P !== void 0 && (D = g, Y.set(g, { handler: P, type: void 0 }))) : P !== void 0 && (D = g.method, Y.set(g.method, { type: g, handler: P })), {
            dispose: /* @__PURE__ */ s(() => {
              D !== null && (D !== void 0 ? Y.delete(D) : M = void 0);
            }, "dispose")
          };
        }, "onRequest"),
        hasPendingResponse: /* @__PURE__ */ s(() => Ae.size > 0, "hasPendingResponse"),
        trace: /* @__PURE__ */ s(async (g, P, D) => {
          let F = !1, Ee = h.Text;
          D !== void 0 && (r.boolean(D) ? F = D : (F = D.sendNotification || !1, Ee = D.traceFormat || h.Text)), ee = g, Xe = Ee, ee === d.Off ? ue = void 0 : ue = P, F && !sa() && !Wt() && await ca.sendNotification($.type, { value: d.toString(g) });
        }, "trace"),
        onError: ye.event,
        onClose: G.event,
        ...
        dispose: /* @__PURE__ */ s(() => {
          if (Wt())
            return;
          We = le.Disposed, St.fire(void 0);
          let g = new n.ResponseError(n.ErrorCodes.PendingResponseRejected, "Pending response rejected since connection got disposed");
          for (let P of Ae.values())
            P.reject(g);
          Ae = /* @__PURE__ */ new Map(), Oe = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), pe = new a.LinkedMap(), r.func(I.dispose) && I.dispose(), r.func(v.dispose) && v.dispose();
        }, "dispose"),
        listen: /* @__PURE__ */ s(() => {
          cr(), Ho(), We = le.Listening, v.listen(Au);
        }, "listen"),
        inspect: /* @__PURE__ */ s(() => {
          (0, e.default)().console.log("inspect");
        }, "inspect")
      };
      return ca.onNotification(C.type, (g) => {
        if (ee === d.Off || !ue)
          return;
        let P = ee === d.Verbose || ee === d.Compact;
        ue.log(g.message, P ? g.verbose : void 0);
      }), ca.onNotification(c.type, (g) => {
        let P = ne.get(g.token);
        P ? P(g.value) : qt.fire(g);
      }), ca;
    }
    s(rt, "createMessageConnection"), t.createMessageConnection = rt;
  }
}), zd = X({
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/browser/ril.js"(t) {
    ...
    var l, c, f;
    Object.defineProperty(t, "__esModule", { value: !0 });
    var e = zd(), r = (l = class extends e.AbstractMessageBuffer {
      constructor(d = "utf-8") {
      ...
      toString(d, y) {
        return y === "ascii" ? this.asciiDecoder.decode(d) : new TextDecoder(y).decode(d);
      }
      asNative(d, y) {
        return y === void 0 ? d : d.slice(0, y);
      }
      allocNative(d) {
    ...
    var n = (c = class {
      constructor(d) {
        this.socket = d, this._onData = new e.Emitter(), this._messageListener = (y) => {
          y.data.arrayBuffer().then(($) => {
            this._onData.fire(new Uint8Array($));
          }, () => {
      ...
      onClose(d) {
        return this.socket.addEventListener("close", d), e.Disposable.create(() => this.socket.removeEventListener("close", d));
      }
      onError(d) {
        return this.socket.addEventListener("error", d), e.Disposable.create(() => this.socket.removeEventListener("error", d));
      }
      onEnd(d) {
        return this.socket.addEventListener("end", d), e.Disposable.create(() => this.socket.removeEventListener("end", d));
      }
      onData(d) {
      ...
      messageBuffer: Object.freeze({
        create: /* @__PURE__ */ s((p) => new r(p), "create")
      }),
      applicationJson: Object.freeze({
        encoder: Object.freeze({
          name: "application/json",
          encode: /* @__PURE__ */ s((p, d) => {
            if (d.charset !== "utf-8")
              throw new Error(`In a Browser environments only utf-8 text encoding is supported. But got encoding: ${d.charset}`);
            return Promise.resolve(i.encode(JSON.stringify(p, void 0, 0)));
          }, "encode")
        }),
        decoder: Object.freeze({
          name: "application/json",
          decode: /* @__PURE__ */ s((p, d) => {
      ...
      stream: Object.freeze({
        asReadableStream: /* @__PURE__ */ s((p) => new n(p), "asReadableStream"),
        asWritableStream: /* @__PURE__ */ s((p) => new a(p), "asWritableStream")
      }),
      console,
      timer: Object.freeze({
        setTimeout(p, d, ...y) {
          let h = setTimeout(p, d, ...y);
          return { dispose: /* @__PURE__ */ s(() => clearTimeout(h), "dispose") };
        },
        setImmediate(p, ...d) {
          let y = setTimeout(p, 0, ...d);
          return { dispose: /* @__PURE__ */ s(() => clearTimeout(y), "dispose") };
        },
        setInterval(p, d, ...y) {
          let h = setInterval(p, d, ...y);
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/browser/main.js"(t) {
    "use strict";
    var l, c;
    var e = t && t.__createBinding || (Object.create ? (function(f, p, d, y) {
      y === void 0 && (y = d);
      var h = Object.getOwnPropertyDescriptor(p, d);
      (!h || ("get" in h ? !p.__esModule : h.writable || h.configurable)) && (h = { enumerable: !0, get: /* @__PURE__ */ s(function() {
        return p[d];
      }, "get") }), Object.defineProperty(f, y, h);
    }) : (function(f, p, d, y) {
      y === void 0 && (y = d), f[y] = p[d];
    })), r = t && t.__exportStar || function(f, p) {
    ...
    var i = (l = class extends a.AbstractMessageReader {
      constructor(p) {
        super(), this._onData = new a.Emitter(), this._messageListener = (d) => {
          this._onData.fire(d.data);
        }, p.addEventListener("error", (d) => this.fireError(d)), p.onmessage = this._messageListener;
      }
      listen(p) {
    ...
    function u(f, p, d, y) {
      return d === void 0 && (d = a.NullLogger), a.ConnectionStrategy.is(y) && (y = { connectionStrategy: y }), (0, a.createMessageConnection)(f, p, d, y);
    }
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/messages.js"(t) {
    ...
    var o = (p = class extends e.NotificationType0 {
      constructor(h) {
        super(h);
      }
    }, s(p, "ProtocolNotificationType0"), p);
    t.ProtocolNotificationType0 = o;
    var u = (d = class extends e.NotificationType {
      constructor(h) {
        super(h, e.ParameterStructures.byName);
      }
    }, s(d, "ProtocolNotificationType"), d);
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.notebook.js"(t) {
    ...
    (function(h) {
      ...
      s(C, "is"), h.is = C;
      function T(_, b) {
        return _ === b ? !0 : _ == null || b === null || b === void 0 ? !1 : _.executionOrder === b.executionOrder && _.success === b.success;
      }
      s(T, "equals"), h.equals = T;
    ...
    (function(h) {
      ...
      function T(b, N) {
        ...
        return b.document !== N.document && U.add("document"), b.kind !== N.kind && U.add("kind"), b.executionSummary !== N.executionSummary && U.add("executionSummary"), (b.metadata !== void 0 || N.metadata !== void 0) && !_(b.metadata, N.metadata) && U.add("metadata"), (b.executionSummary !== void 0 || N.executionSummary !== void 0) && !i.equals(b.executionSummary, N.executionSummary) && U.add("executionSummary"), U;
      }
      s(T, "diff"), h.diff = T;
      function _(b, N) {
        if (b === N)
        ...
        if (b == null || N === null || N === void 0 || typeof b != typeof N || typeof b != "object")
          return !1;
        let U = Array.isArray(b), re = Array.isArray(N);
        if (U !== re)
          return !1;
        if (U && re) {
        ...
        if (r.objectLiteral(b) && r.objectLiteral(N)) {
          let J = Object.keys(b), me = Object.keys(N);
          if (J.length !== me.length || (J.sort(), me.sort(), !_(J, me)))
            return !1;
    ...
    (function(h) {
      function $(T) {
        let _ = T;
        return r.objectLiteral(_) && e.uinteger.is(_.start) && e.uinteger.is(_.deleteCount) && (_.cells === void 0 || r.typedArray(_.cells, o.is));
      }
      s($, "is"), h.is = $;
      function C(T, _, b) {
        let N = { start: T, deleteCount: _ };
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.js"(t) {
    ...
    (function(m) {
      function oe(Se) {
        let H = Se;
        return n.objectLiteral(H) && (n.string(H.notebook) || he.is(H.notebook)) && (H.language === void 0 || n.string(H.language));
      }
      s(oe, "is"), m.is = oe;
    ...
    (function(m) {
      function oe(Se) {
        if (!Array.isArray(Se))
          return !1;
        for (let H of Se)
          if (!n.string(H) && !Re.is(H) && !le.is(H))
            return !1;
        return !0;
      }
      s(oe, "is"), m.is = oe;
    })(rt || (t.DocumentSelector = rt = {}));
    var k;
    (function(m) {
    ...
    (function(m) {
      function oe(Se) {
        let H = Se;
        return H && (H.documentSelector === null || rt.is(H.documentSelector));
      }
      s(oe, "is"), m.is = oe;
    ...
    (function(m) {
      function oe(H) {
        let we = H;
        return n.objectLiteral(we) && (we.workDoneProgress === void 0 || n.boolean(we.workDoneProgress));
      }
      s(oe, "is"), m.is = oe;
      function Se(H) {
        let we = H;
        return we && n.boolean(we.workDoneProgress);
      }
      s(Se, "hasWorkDoneProgress"), m.hasWorkDoneProgress = Se;
    ...
    })(ne || (t.ShowMessageNotification = ne = {}));
    var ke;
    (function(m) {
    ...
    })(Ae || (t.TelemetryEventNotification = Ae = {}));
    var qe;
    (function(m) {
    ...
    })(Oe || (t.DidOpenTextDocumentNotification = Oe = {}));
    var ee;
    (function(m) {
      function oe(H) {
        let we = H;
        return we != null && typeof we.text == "string" && we.range !== void 0 && (we.rangeLength === void 0 || typeof we.rangeLength == "number");
      }
      s(oe, "isIncremental"), m.isIncremental = oe;
      function Se(H) {
        let we = H;
        return we != null && typeof we.text == "string" && we.range === void 0 && we.rangeLength === void 0;
      }
      s(Se, "isFull"), m.isFull = Se;
    ...
    })(Xe || (t.DidChangeTextDocumentNotification = Xe = {}));
    var ue;
    (function(m) {
    ...
    })(We || (t.DidSaveTextDocumentNotification = We = {}));
    var ye;
    (function(m) {
    ...
    })(qt || (t.DidChangeWatchedFilesNotification = qt = {}));
    var St;
    (function(m) {
      m.Created = 1, m.Changed = 2, m.Deleted = 3;
    })(St || (t.FileChangeType = St = {}));
    var ge;
    (function(m) {
      function oe(Se) {
        let H = Se;
    ...
    })(xo || (t.CompletionResolveRequest = xo = {}));
    var ia;
    (function(m) {
    ...
    })(ia || (t.HoverRequest = ia = {}));
    var sa;
    (function(m) {
      m.Invoked = 1, m.TriggerCharacter = 2, m.ContentChange = 3;
    })(sa || (t.SignatureHelpTriggerKind = sa = {}));
    var Wt;
    (function(m) {
    ...
    })(Go || (t.DocumentHighlightRequest = Go = {}));
    var la;
    (function(m) {
    ...
    })(zo || (t.WorkspaceSymbolResolveRequest = zo = {}));
    var jo;
    (function(m) {
    ...
    })(Ko || (t.CodeLensRefreshRequest = Ko = {}));
    var wt;
    (function(m) {
    ...
    })(Bo || (t.DocumentLinkResolveRequest = Bo = {}));
    var qo;
    (function(m) {
    ...
    })(qo || (t.DocumentFormattingRequest = qo = {}));
    var kr;
    (function(m) {
    ...
    })(kr || (t.DocumentRangeFormattingRequest = kr = {}));
    var Wo;
    (function(m) {
    ...
    })(Wo || (t.DocumentRangesFormattingRequest = Wo = {}));
    var Jr;
    (function(m) {
    ...
    })(Jr || (t.DocumentOnTypeFormattingRequest = Jr = {}));
    var Vo;
    (function(m) {
      m.Identifier = 1;
    })(Vo || (t.PrepareSupportDefaultBehavior = Vo = {}));
    var Vt;
    (function(m) {
    ...
    })(Yo || (t.ApplyWorkspaceEditRequest = Yo = {}));
  }
}), wP = X({
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/api.js"(t) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.LSPErrorCodes = t.createProtocolConnection = void 0, r(Co(), t), r((tu(), jm(ef)), t), r(Pe(), t), r(SP(), t);
    var n = wP();
...
Wr(t$, {
  AbstractAstReflection: () => qm,
  AbstractCstNode: () => Vy,
  AbstractLangiumParser: () => Yy,
  AbstractParserErrorMessageProvider: () => jI,
  AbstractThreadedAsyncParser: () => ij,
  AstUtils: () => Wm,
  BiMap: () => Hc,
  Cancellation: () => Te,
  CompositeCstNodeImpl: () => Zf,
  ContextCache: () => ip,
  CstNodeBuilder: () => GI,
  CstUtils: () => Km,
  DEFAULT_TOKENIZE_OPTIONS: () => dg,
  DONE_RESULT: () => at,
  DatatypeSymbol: () => Bc,
  DefaultAstNodeDescriptionProvider: () => gN,
  DefaultAstNodeLocator: () => TN,
  DefaultAsyncParser: () => MN,
  DefaultCommentProvider: () => xN,
  DefaultConfigurationProvider: () => $N,
  DefaultDocumentBuilder: () => RN,
  DefaultDocumentValidator: () => yN,
  DefaultHydrator: () => FN,
  DefaultIndexManager: () => AN,
  DefaultJsonSerializer: () => pN,
  DefaultLangiumDocumentFactory: () => nN,
  DefaultLangiumDocuments: () => aN,
  DefaultLangiumProfiler: () => cj,
  DefaultLexer: () => mg,
  DefaultLexerErrorMessageProvider: () => CN,
  DefaultLinker: () => iN,
  DefaultNameProvider: () => sN,
  DefaultReferenceDescriptionProvider: () => vN,
  DefaultReferences: () => oN,
  DefaultScopeComputation: () => lN,
  DefaultScopeProvider: () => fN,
  DefaultServiceRegistry: () => dN,
  DefaultTokenBuilder: () => tp,
  DefaultValueConverter: () => rg,
  DefaultWorkspaceLock: () => GN,
  DefaultWorkspaceManager: () => EN,
  Deferred: () => _r,
  Disposable: () => Nn,
  DisposableCache: () => ap,
  DocumentCache: () => cN,
  DocumentState: () => Q,
  DocumentValidator: () => It,
  EMPTY_SCOPE: () => tj,
  EMPTY_STREAM: () => fo,
  EmptyFileSystem: () => KN,
  EmptyFileSystemProvider: () => UN,
  ErrorWithLocation: () => ff,
  GrammarAST: () => a$,
  GrammarUtils: () => Ah,
  IndentationAwareLexer: () => oj,
  IndentationAwareTokenBuilder: () => jN,
  JSDocDocumentationProvider: () => DN,
  LangiumCompletionParser: () => UI,
  LangiumParser: () => zI,
  LangiumParserErrorMessageProvider: () => Xy,
  LeafCstNodeImpl: () => Kc,
  LexingMode: () => wn,
  MapScope: () => ej,
  Module: () => $m,
  ...
  UriTrie: () => sg,
  UriUtils: () => st,
  VALIDATE_EACH_NODE: () => hN,
  ValidationCategory: () => Yc,
  ValidationRegistry: () => mN,
  ValueConverter: () => Qt,
  WorkspaceCache: () => ug,
  assertCondition: () => Eh,
  assertUnreachable: () => Vr,
  createCompletionParser: () => Qy,
  createDefaultCoreModule: () => Rg,
  createDefaultSharedCoreModule: () => Ag,
  createGrammarConfig: () => Uh,
  createLangiumParser: () => eg,
  createParser: () => Qf,
  delayNextTick: () => rp,
  diagnosticData: () => Sn,
  eagerLoad: () => Eg,
  getDiagnosticRange: () => fg,
  indentationBuilderDefaultOptions: () => Am,
  inject: () => Zc,
  interruptAndCheck: () => He,
  isAstNode: () => je,
  isAstNodeDescription: () => Bm,
  isAstNodeWithComment: () => cg,
  isCompositeCstNode: () => vr,
  isIMultiModeLexerDefinition: () => lp,
  isJSDoc: () => yg,
  isLeafCstNode: () => Gn,
  isLinkingError: () => dn,
  isMultiReference: () => nr,
  isNamed: () => og,
  isOperationCancelled: () => na,
  isReference: () => it,
  isRootCstNode: () => rf,
  isTokenTypeArray: () => op,
  isTokenTypeDictionary: () => Xc,
  loadGrammarFromJson: () => Ye,
  parseJSDoc: () => hg,
  prepareLangiumParser: () => tg,
  setInterruptionPeriod: () => ng,
  startCancelableOperation: () => np,
  stream: () => fe,
  toDiagnosticData: () => pg,
  toDiagnosticSeverity: () => xl
});
var Km = {};
Wr(Km, {
  DefaultNameRegexp: () => gh,
  RangeComparison: () => er,
  compareRange: () => hh,
  findCommentNode: () => vh,
  findDeclarationNodeAtOffset: () => E$,
  findLeafNodeAtOffset: () => cf,
  findLeafNodeBeforeOffset: () => Th,
  flattenCst: () => A$,
  getDatatypeNode: () => R$,
  getInteriorNodes: () => _$,
  getNextNode: () => C$,
...
var Ba, qm = (Ba = class {
  ...
  getReferenceType(e) {
    let r = this.types[e.container.$type];
    if (!r)
      throw new Error(`Type ${e.container.$type || "undefined"} not found.`);
    let n = r.properties[e.property]?.referenceType;
    if (!n)
  ...
  isSubtype(e, r) {
    ...
    if (a !== void 0)
      return a;
    {
      let i = this.types[e], o = i ? i.superTypes.some((u) => this.isSubtype(u, r)) : !1;
      return n[r] = o, o;
    }
  }
  getAllSubTypes(e) {
...
var ht, tr = (ht = class {
  ...
  join(e = ",") {
    let r = this.iterator(), n = "", a, i = !1;
    do
      a = r.next(), a.done || (i && (n += e), n += r$(a.value)), i = !0;
    while (!a.done);
    return n;
  }
  indexOf(e, r = 0) {
    let n = this.iterator(), a = 0, i = n.next();
    for (; !i.done; ) {
      if (a >= r && i.value === e)
        return a;
      i = n.next(), a++;
  ...
  forEach(e) {
    let r = this.iterator(), n = 0, a = r.next();
    for (; !a.done; )
      e(a.value, n), a = r.next(), n++;
  }
  map(e) {
    return new ht(this.startFn, (r) => {
      let { done: n, value: a } = this.nextFn(r);
      return n ? at : { done: !1, value: e(a) };
    });
  }
  filter(e) {
    return new ht(this.startFn, (r) => {
  ...
  reduce(e, r) {
    let n = this.iterator(), a = r, i = n.next();
    for (; !i.done; )
  ...
  recursiveReduce(e, r, n) {
    ...
    if (a.done)
      return n;
    let i = this.recursiveReduce(e, r, n);
  ...
  flatMap(e) {
    return new ht(() => ({ this: this.startFn() }), (r) => {
      do {
        if (r.iterator) {
          let i = r.iterator.next();
          if (i.done)
            r.iterator = void 0;
          else
            return i;
        }
        let { done: n, value: a } = this.nextFn(r.this);
        if (!n) {
          let i = e(a);
          if (Ml(i))
  ...
  flat(e) {
    ...
    return new ht(() => ({ this: r.startFn() }), (n) => {
      do {
        ...
        let { done: a, value: i } = r.nextFn(n.this);
        if (!a)
          if (Ml(i))
  ...
  limit(e) {
    return new ht(() => ({ size: 0, state: this.startFn() }), (r) => (r.size++, r.size > e ? at : this.nextFn(r.state)));
  }
  distinct(e) {
...
s(Ml, "isIterable");
var fo = new tr(() => {
}, () => at), at = Object.freeze({ done: !0, value: void 0 });
function fe(...t) {
  if (t.length === 1) {
    let e = t[0];
    if (e instanceof tr)
      return e;
    if (Ml(e))
      return new tr(() => e[Symbol.iterator](), (r) => r.next());
    if (typeof e.length == "number")
      return new tr(() => ({ index: 0 }), (r) => r.index < e.length ? { done: !1, value: e[r.index++] } : at);
  }
  return t.length > 1 ? new tr(() => ({ collIndex: 0, arrIndex: 0 }), (e) => {
    do {
      if (e.iterator) {
      ...
      if (e.collIndex < t.length) {
        let r = t[e.collIndex++];
        Ml(r) ? e.iterator = r[Symbol.iterator]() : r && typeof r.length == "number" && (e.array = r);
      }
  ...
  constructor(e, r, n) {
    super(() => ({
      ...
      for (a.pruned && (a.iterators.pop(), a.pruned = !1); a.iterators.length > 0; ) {
        let o = a.iterators[a.iterators.length - 1].next();
        if (o.done)
          a.iterators.pop();
        else
...
var Wm = {};
Wr(Wm, {
  assignMandatoryProperties: () => Vm,
  copyAstNode: () => dc,
  findRootNode: () => za,
  getContainerOfType: () => Fn,
  getDocument: () => Gt,
  getReferenceNodes: () => fc,
  hasContainerOfType: () => n$,
  linkContentToContainer: () => mo,
  streamAllContents: () => wr,
  streamAst: () => Ft,
  streamContents: () => nu,
  streamReferences: () => ho
});
function mo(t, e = {}) {
  for (let [r, n] of Object.entries(t))
    r.startsWith("$") || (Array.isArray(n) ? n.forEach((a, i) => {
      je(a) && (a.$container = t, a.$containerProperty = r, a.$containerIndex = i, e.deep && mo(a, e));
    }) : je(n) && (n.$container = t, n.$containerProperty = r, e.deep && mo(n, e)));
}
s(mo, "linkContentToContainer");
function Fn(t, e) {
  let r = t;
  for (; r; ) {
    if (e(r))
...
s(za, "findRootNode");
function fc(t) {
  return it(t) ? t.ref ? [t.ref] : [] : nr(t) ? t.items.map((e) => e.ref) : [];
}
s(fc, "getReferenceNodes");
function nu(t, e) {
  if (!t)
  ...
  return new tr(() => ({
    ...
    for (; n.keyIndex < n.keys.length; ) {
      let a = n.keys[n.keyIndex];
      if (!a.startsWith("$")) {
        let i = t[a];
        if (je(i)) {
          if (n.keyIndex++, pc(i, r))
            return { done: !1, value: i };
        } else if (Array.isArray(i)) {
          for (; n.arrayIndex < i.length; ) {
            let o = n.arrayIndex++, u = i[o];
            if (je(u) && pc(u, r))
...
function wr(t, e) {
  ...
  return new po(t, (r) => nu(r, e));
}
s(wr, "streamAllContents");
function Ft(t, e) {
  if (t) {
    if (e?.range && !pc(t, e.range))
      return new po(t, () => []);
  } else throw new Error("Root node must be an AstNode.");
  return new po(t, (r) => nu(r, e), { includeRoot: !0 });
}
s(Ft, "streamAst");
function pc(t, e) {
  if (!e)
    return !0;
  let r = t.$cstNode?.range;
  return r ? yh(r, e) : !1;
}
s(pc, "isAstNodeInRange");
function ho(t) {
  return new tr(() => ({
    keys: Object.keys(t),
    keyIndex: 0,
...
function Vm(t, e) {
  let r = t.getTypeMetaData(e.$type), n = e;
  for (let a of Object.values(r.properties))
    a.defaultValue !== void 0 && n[a.name] === void 0 && (n[a.name] = Hm(a.defaultValue));
}
s(Vm, "assignMandatoryProperties");
function Hm(t) {
  return Array.isArray(t) ? [...t.map(Hm)] : t;
}
s(Hm, "copyDefaultValue");
function dc(t, e, r) {
  let n = { $type: t.$type };
  ...
  for (let [a, i] of Object.entries(t))
    if (!a.startsWith("$"))
      if (je(i))
        ...
        let o = [];
        for (let u of i)
          je(u) ? o.push(dc(u, e, r)) : it(u) ? o.push(e(n, a, u.$refNode, u.$refText, u)) : o.push(u);
        n[a] = o;
      } else
        n[a] = i;
  return mo(n, { deep: !0 }), n;
}
s(dc, "copyAstNode");
var a$ = {};
Wr(a$, {
  AbstractElement: () => dt,
  AbstractParserRule: () => Al,
  AbstractRule: () => ka,
  AbstractType: () => $t,
  Action: () => Dr,
  Alternatives: () => El,
  ...
  InferredType: () => Tc,
  InfixRule: () => Zt,
  InfixRuleOperatorList: () => _l,
  InfixRuleOperators: () => $c,
  Interface: () => Oa,
  Keyword: () => La,
  LangiumGrammarAstReflection: () => dh,
  LangiumGrammarTerminals: () => PP,
  NamedArgument: () => Da,
  NegatedToken: () => hn,
  Negation: () => Rc,
  NumberLiteral: () => Ac,
  Parameter: () => xa,
  ParameterReference: () => Ec,
  ParserRule: () => Dt,
  ReferenceType: () => Sl,
  RegexToken: () => yn,
  ReturnType: () => Cc,
  ...
  ValueLiteral: () => Cn,
  Wildcard: () => Ga,
  isAbstractElement: () => nf,
  isAbstractParserRule: () => zn,
  isAbstractRule: () => i$,
  isAbstractType: () => s$,
  isAction: () => jr,
  isAlternatives: () => af,
  ...
  isInferredType: () => au,
  isInfixRule: () => yo,
  isInfixRuleOperatorList: () => f$,
  isInfixRuleOperators: () => p$,
  isInterface: () => th,
  isKeyword: () => $r,
  isNamedArgument: () => d$,
  isNegatedToken: () => rh,
  ...
  isSimpleType: () => sf,
  isStringLiteral: () => y$,
  isTerminalAlternatives: () => lh,
  isTerminalElement: () => g$,
  isTerminalGroup: () => uh,
  isTerminalRule: () => Ot,
  isTerminalRuleCall: () => of,
  isType: () => lf,
  isTypeAttribute: () => v$,
  isTypeDefinition: () => T$,
  isUnionType: () => ch,
...
s(nf, "isAbstractElement");
var Al = {
  $type: "AbstractParserRule"
};
function zn(t) {
  return K.isInstance(t, Al.$type);
}
s(zn, "isAbstractParserRule");
var ka = {
  $type: "AbstractRule"
};
function i$(t) {
...
function Xm(t) {
  return K.isInstance(t, yc.$type);
}
s(Xm, "isBooleanLiteral");
var Mr = {
  $type: "CharacterRange",
  cardinality: "cardinality",
  left: "left",
...
function Jm(t) {
  return K.isInstance(t, Mr.$type);
}
s(Jm, "isCharacterRange");
var Gr = {
  $type: "Condition"
};
function l$(t) {
  return K.isInstance(t, Gr.$type);
}
s(l$, "isCondition");
var Cl = {
  $type: "Conjunction",
...
function jn(t) {
  return K.isInstance(t, Fr.$type);
}
s(jn, "isCrossReference");
var bl = {
  $type: "Disjunction",
  left: "left",
  right: "right"
...
function f$(t) {
  return K.isInstance(t, _l.$type);
}
s(f$, "isInfixRuleOperatorList");
var $c = {
  $type: "InfixRuleOperators",
  precedences: "precedences"
};
function p$(t) {
  return K.isInstance(t, $c.$type);
}
s(p$, "isInfixRuleOperators");
var Oa = {
  $type: "Interface",
...
function ah(t) {
  return K.isInstance(t, Ec.$type);
}
s(ah, "isParameterReference");
var Dt = {
  $type: "ParserRule",
  dataType: "dataType",
...
function ih(t) {
  return K.isInstance(t, Sl.$type);
}
s(ih, "isReferenceType");
var yn = {
  $type: "RegexToken",
  cardinality: "cardinality",
  lookahead: "lookahead",
...
function g$(t) {
  return K.isInstance(t, mt.$type);
}
s(g$, "isTerminalElement");
var Tn = {
  $type: "TerminalGroup",
  cardinality: "cardinality",
  elements: "elements",
...
s(T$, "isTypeDefinition");
var _c = {
  $type: "UnionType",
  types: "types"
};
function ch(t) {
  return K.isInstance(t, _c.$type);
}
s(ch, "isUnionType");
var Il = {
  $type: "UnorderedGroup",
...
function uf(t) {
  return K.isInstance(t, Il.$type);
}
s(uf, "isUnorderedGroup");
var En = {
  $type: "UntilToken",
  cardinality: "cardinality",
  lookahead: "lookahead",
...
function ph(t) {
  return K.isInstance(t, Ga.$type);
}
s(ph, "isWildcard");
var Wa, dh = (Wa = class extends qm {
  constructor() {
    super(...arguments), this.types = {
      ...
      NamedArgument: {
        ...
        properties: {
          calledByName: {
            name: Da.calledByName,
            defaultValue: !1
          },
          parameter: {
            name: Da.parameter,
            referenceType: xa.$type
          },
          value: {
            name: Da.value
          }
...
}, s(Wa, "LangiumGrammarAstReflection"), Wa), K = new dh();
function R$(t) {
  let e = t, r = !1;
  for (; e; ) {
    let n = Fn(e.grammarSource, lt);
    if (n && n.dataType)
      e = e.container, r = !0;
...
s(R$, "getDatatypeNode");
function go(t) {
  return new po(t, (e) => vr(e) ? e.content : [], { includeRoot: !0 });
}
s(go, "streamCst");
function A$(t) {
  return go(t).filter(Gn);
}
s(A$, "flattenCst");
function mh(t, e) {
  for (; t.container; )
...
function hh(t, e) {
  ...
  return r && n ? er.Inside : r ? er.OverlapBack : n ? er.OverlapFront : er.Outside;
}
s(hh, "compareRange");
function yh(t, e) {
  return hh(t, e) > er.After;
}
s(yh, "inRange");
var gh = /^[\w\p{L}]$/u;
function E$(t, e, r = gh) {
  if (t) {
    if (e > 0) {
      let n = e - t.offset, a = t.text.charAt(n);
      r.test(a) || e--;
    }
    return cf(t, e);
  }
}
s(E$, "findDeclarationNodeAtOffset");
function vh(t, e) {
  if (t) {
    let r = Rh(t, !0);
    if (r && Sc(r, e))
      return r;
    if (rf(t)) {
      let n = t.content.findIndex((a) => !a.hidden);
      for (let a = n - 1; a >= 0; a--) {
        let i = t.content[a];
        if (Sc(i, e))
          return i;
...
s(vh, "findCommentNode");
function Sc(t, e) {
  return Gn(t) && e.includes(t.tokenType.name);
}
s(Sc, "isCommentNode");
function cf(t, e) {
  if (Gn(t))
...
s(Th, "findLeafNodeBeforeOffset");
function $h(t, e, r) {
  let n = 0, a = t.content.length - 1, i;
  for (; n <= a; ) {
    let o = Math.floor((n + a) / 2), u = t.content[o];
...
function Rh(t, e = !0) {
  for (; t.container; ) {
    let r = t.container, n = r.content.indexOf(t);
    for (; n > 0; ) {
      n--;
      let a = r.content[n];
      if (e || !a.hidden)
...
s(Rh, "getPreviousNode");
function C$(t, e = !0) {
  for (; t.container; ) {
    let r = t.container, n = r.content.indexOf(t), a = r.content.length - 1;
    for (; n < a; ) {
      n++;
      let i = r.content[n];
      if (e || !i.hidden)
...
function b$(t) {
  ...
  for (; t.container; ) {
    let a = t.container, i = n ?? a.content.indexOf(t);
...
Wr(Ah, {
  findAssignment: () => Dh,
  findNameAssignment: () => vf,
  findNodeForKeyword: () => Lh,
  findNodeForProperty: () => hf,
  findNodesForKeyword: () => L$,
  findNodesForKeywordInternal: () => gf,
  findNodesForProperty: () => Oh,
  getActionAtElement: () => Mh,
  getActionType: () => Fh,
  getAllReachableRules: () => mf,
  getAllRulesUsedForCrossReferences: () => O$,
  getCrossReferenceTerminal: () => Ph,
  getEntryRule: () => wh,
  getExplicitRuleType: () => su,
  getHiddenRules: () => Ih,
  getRuleType: () => zh,
  getRuleTypeName: () => F$,
  getTypeName: () => On,
  isArrayCardinality: () => x$,
  isArrayOperator: () => M$,
  isCommentTerminal: () => kh,
  isDataType: () => G$,
  isDataTypeRule: () => iu,
  isOptionalCardinality: () => D$,
  terminalRegex: () => ou
});
var Va, ff = (Va = class extends Error {
  constructor(e, r) {
    super(e ? `${r} at ${e.range.start.line}:${e.range.start.character}` : r);
  }
}, s(Va, "ErrorWithLocation"), Va);
function Vr(t, e = "Error: Got unexpected value.") {
  throw new Error(e);
}
s(Vr, "assertUnreachable");
function Eh(t, e = "Error: Condition is violated.") {
  if (!t)
    throw new Error(e);
}
s(Eh, "assertCondition");
var Ch = {};
Wr(Ch, {
  NEWLINE_REGEXP: () => I$,
  escapeRegExp: () => bo,
  getTerminalParts: () => P$,
  isMultilineComment: () => bh,
  isWhitespace: () => df,
  partialMatches: () => _h,
  partialRegExp: () => Sh,
  whitespaceCharacters: () => k$
});
function q(t) {
...
s(hl, "ASSERT_NEVER_REACH_HERE");
function Ud(t) {
  return t.type === "Character";
}
s(Ud, "isCharacter");
var wc = [];
for (let t = q("0"); t <= q("9"); t++)
  wc.push(t);
var Ic = [q("_")].concat(wc);
for (let t = q("a"); t <= q("z"); t++)
  Ic.push(t);
for (let t = q("A"); t <= q("Z"); t++)
  Ic.push(t);
var wg = [
...
`),
  ...
  q("\u3000"),
  q("\uFEFF")
], kP = /[0-9a-fA-F]/, Eu = /[0-9]/, OP = /[1-9]/, Ha, w$ = (Ha = class {
  constructor() {
  ...
  quantifier(e = !1) {
    ...
    switch (this.popChar()) {
      ...
      case "?":
        ...
        break;
      case "{":
        let a = this.integerIncludingZero();
        switch (this.popChar()) {
          case "}":
            r = {
              atLeast: a,
  ...
  atom() {
    ...
    return e === void 0 && this.isPatternCharacter() && (e = this.patternCharacter()), sn(e) ? (e.loc = this.loc(r), this.isQuantifier() && (e.quantifier = this.quantifier()), e) : hl();
  }
  dotAll() {
    return this.consumeChar("."), {
      type: "Set",
...
`), q("\r"), q("\u2028"), q("\u2029")]
  ...
  characterClassEscape() {
    ...
    return sn(e) ? { type: "Set", value: e, complement: r } : hl();
  }
  controlEscapeAtom() {
    let e;
    switch (this.popChar()) {
...
`);
    ...
    return sn(e) ? { type: "Character", value: e } : hl();
  }
  ...
  nulCharacterAtom() {
    return this.consumeChar("0"), { type: "Character", value: q("\0") };
  }
  ...
  identityEscapeAtom() {
    let e = this.popChar();
    return { type: "Character", value: q(e) };
  }
...
`:
  ...
  characterClass() {
    ...
    for (this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), r = !0); this.isClassAtom(); ) {
      let n = this.classAtom(), a = n.type === "Character";
      if (Ud(n) && this.isRangeDash()) {
        this.consumeChar("-");
        let i = this.classAtom(), o = i.type === "Character";
        if (Ud(i)) {
          if (i.value < n.value)
            throw Error("Range out of order in character class");
          e.push({ from: n.value, to: i.value });
        } else
          Hu(n.value, e), e.push(q("-")), Hu(i.value, e);
      } else
        Hu(n.value, e);
    }
...
`:
  ...
  classEscape() {
    switch (this.consumeChar("\\"), this.peekChar()) {
      ...
      case "b":
        return this.consumeChar("b"), { type: "Character", value: q("\b") };
      case "d":
      case "D":
      case "s":
      case "S":
...
`:
  ...
  isDigit() {
    return Eu.test(this.peekChar(0));
  }
  isClassAtom(e = 0) {
...
}, s(Ha, "RegExpParser"), Ha), Ya, pf = (Ya = class {
  visitChildren(e) {
    for (let r in e) {
      let n = e[r];
...
}, s(Ya, "BaseRegExpVisitor"), Ya), I$ = /\r?\n/gm, N$ = new w$(), Xa, LP = (Xa = class extends pf {
  constructor() {
...
}, s(Xa, "TerminalRegExpVisitor"), Xa), bn = new LP();
function P$(t) {
  try {
    typeof t != "string" && (t = t.source), t = `/${t}/`;
    let e = N$.pattern(t), r = [];
    for (let n of e.value.value)
      bn.reset(t), bn.visit(n), r.push({
        start: bn.startRegexp,
        end: bn.endRegex
      });
    return r;
  } catch {
...
s(P$, "getTerminalParts");
function bh(t) {
  try {
    return typeof t == "string" && (t = new RegExp(t)), t = t.toString(), bn.reset(t), bn.visit(N$.pattern(t)), bn.multiline;
  } catch {
    return !1;
  }
}
s(bh, "isMultilineComment");
var k$ = `\f
\r	\v \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF`.split("");
function df(t) {
  let e = typeof t == "string" ? new RegExp(t) : t;
  return k$.some((r) => e.test(r));
}
s(df, "isWhitespace");
function bo(t) {
  return t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
s(Sh, "partialRegExp");
function wh(t) {
  return t.rules.find((e) => lt(e) && e.entry);
}
s(wh, "getEntryRule");
function Ih(t) {
  return t.rules.filter((e) => Ot(e) && e.hidden);
}
s(Ih, "getHiddenRules");
function mf(t, e) {
  let r = /* @__PURE__ */ new Set(), n = wh(t);
  if (!n)
  ...
  for (let o of t.rules)
    (r.has(o.name) || Ot(o) && o.hidden) && i.add(o);
  return i;
}
s(mf, "getAllReachableRules");
function Nh(t, e, r) {
  e.add(t.name), wr(t).forEach((n) => {
    if (Rr(n) || r && of(n)) {
      let a = n.rule.ref;
      a && !e.has(a.name) && Nh(a, e, r);
    }
  });
}
s(Nh, "ruleDfs");
function O$(t) {
  ...
  return wr(t).forEach((r) => {
    jn(r) && (lt(r.type.ref) && e.add(r.type.ref), au(r.type.ref) && lt(r.type.ref.$container) && e.add(r.type.ref.$container));
  }), e;
}
s(O$, "getAllRulesUsedForCrossReferences");
function Ph(t) {
  if (t.terminal)
    return t.terminal;
  if (t.type.ref)
    return vf(t.type.ref)?.terminal;
}
s(Ph, "getCrossReferenceTerminal");
function kh(t) {
  return t.hidden && !df(ou(t));
}
s(kh, "isCommentTerminal");
function Oh(t, e) {
  return !t || !e ? [] : yf(t, e, t.astNode, !0);
}
s(Oh, "findNodesForProperty");
function hf(t, e, r) {
  if (!t || !e)
    return;
  let n = yf(t, e, t.astNode, !0);
  if (n.length !== 0)
    return r !== void 0 ? r = Math.max(0, Math.min(r, n.length - 1)) : r = 0, n[r];
}
s(hf, "findNodeForProperty");
function yf(t, e, r, n) {
  if (!n) {
    let a = Fn(t.grammarSource, Tr);
    if (a && a.feature === e)
      return [t];
  }
  return vr(t) && t.astNode === r ? t.content.flatMap((a) => yf(a, e, r, !1)) : [];
}
s(yf, "findNodesForPropertyInternal");
function L$(t, e) {
  return t ? gf(t, e, t?.astNode) : [];
}
s(L$, "findNodesForKeyword");
function Lh(t, e, r) {
  if (!t)
    return;
  let n = gf(t, e, t?.astNode);
  if (n.length !== 0)
    return r !== void 0 ? r = Math.max(0, Math.min(r, n.length - 1)) : r = 0, n[r];
}
s(Lh, "findNodeForKeyword");
function gf(t, e, r) {
  if (t.astNode !== r)
    return [];
  if ($r(t.grammarSource) && t.grammarSource.value === e)
    return [t];
  let n = go(t).iterator(), a, i = [];
  do
    if (a = n.next(), !a.done) {
      let o = a.value;
      o.astNode === r ? $r(o.grammarSource) && o.grammarSource.value === e && i.push(o) : n.prune();
    }
  while (!a.done);
  return i;
}
s(gf, "findNodesForKeywordInternal");
function Dh(t) {
  let e = t.astNode;
  for (; e === t.container?.astNode; ) {
    let r = Fn(t.grammarSource, Tr);
    if (r)
      return r;
    t = t.container;
  }
...
function vf(t) {
  let e = t;
  return au(e) && (jr(e.$container) ? e = e.$container.$container : zn(e.$container) ? e = e.$container : Vr(e.$container)), xh(t, e, /* @__PURE__ */ new Map());
}
s(vf, "findNameAssignment");
function xh(t, e, r) {
  function n(a, i) {
    let o;
    return Fn(a, Tr) || (o = xh(i, i, r)), r.set(t, o), o;
  }
  if (s(n, "go"), r.has(t))
    return r.get(t);
  r.set(t, void 0);
  for (let a of wr(e)) {
    if (Tr(a) && a.feature.toLowerCase() === "name")
      return r.set(t, a), a;
    if (Rr(a) && lt(a.rule.ref))
      return n(a, a.rule.ref);
    if (sf(a) && a.typeRef?.ref)
      return n(a, a.typeRef.ref);
  }
}
s(xh, "findNameAssignmentInternal");
function Mh(t) {
  let e = t.$container;
  if (Un(e)) {
...
s(Mh, "getActionAtElement");
function D$(t, e) {
  return t === "?" || t === "*" || Un(e) && !!e.guardCondition;
}
s(D$, "isOptionalCardinality");
function x$(t) {
  return t === "*" || t === "+";
}
s(x$, "isArrayCardinality");
function M$(t) {
  return t === "+=";
}
s(M$, "isArrayOperator");
function iu(t) {
  return Gh(t, /* @__PURE__ */ new Set());
}
s(iu, "isDataTypeRule");
function Gh(t, e) {
  if (e.has(t))
  ...
  for (let r of wr(t))
    if (Rr(r)) {
      if (!r.rule.ref || lt(r.rule.ref) && !Gh(r.rule.ref, e) || yo(r.rule.ref))
        return !1;
    } else {
      if (Tr(r))
        return !1;
...
s(Gh, "isDataTypeRuleInternal");
function G$(t) {
  return Nc(t.type, /* @__PURE__ */ new Set());
}
s(G$, "isDataType");
function Nc(t, e) {
  if (e.has(t))
  ...
  if (sf(t)) {
    ...
    if (t.typeRef !== void 0) {
      let r = t.typeRef.ref;
      return lf(r) ? Nc(r.type, e) : !1;
    } else
      return !1;
  } else
    return !1;
}
s(Nc, "isDataTypeInternal");
function su(t) {
  if (!Ot(t)) {
    if (t.inferredType)
...
s(su, "getExplicitRuleType");
function On(t) {
  if (zn(t))
    return lt(t) && iu(t) ? t.name : su(t) ?? t.name;
  if (th(t) || lf(t) || oh(t))
    return t.name;
  if (jr(t)) {
    let e = Fh(t);
...
function Fh(t) {
  if (t.inferredType)
    return t.inferredType.name;
  if (t.type?.ref)
    return On(t.type.ref);
}
s(Fh, "getActionType");
function F$(t) {
  return Ot(t) ? t.type?.name ?? "string" : lt(t) && iu(t) ? t.name : su(t) ?? t.name;
}
s(F$, "getRuleTypeName");
function zh(t) {
  return Ot(t) ? t.type?.name ?? "string" : su(t) ?? t.name;
}
s(zh, "getRuleType");
function ou(t) {
  let e = {
    ...
    i: !1,
    u: !1
  }, r = Kn(t.definition, e), n = Object.entries(e).filter(([, a]) => a).map(([a]) => a).join("");
...
function Kn(t, e) {
  ...
  if (of(t)) {
    ...
    if (fh(t))
      return U$(t);
    if (sh(t)) {
      let r = t.regex.lastIndexOf("/"), n = t.regex.substring(1, r), a = t.regex.substring(r + 1);
      return e && (e.i = a.includes("i"), e.s = a.includes("s"), e.u = a.includes("u")), ar(n, {
        cardinality: t.cardinality,
        lookahead: t.lookahead,
        parenthesized: t.parenthesized,
        wrap: !1
...
s(Kn, "abstractElementToRegex");
function z$(t) {
  return ar(t.elements.map((e) => Kn(e)).join("|"), {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized,
    wrap: !1
...
s(z$, "terminalAlternativesToRegex");
function j$(t) {
  return ar(t.elements.map((e) => Kn(e)).join(""), {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
...
s(j$, "terminalGroupToRegex");
function U$(t) {
  return ar(`${jh}*?${Kn(t.terminal)}`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized
  });
}
s(U$, "untilTokenToRegex");
function K$(t) {
  return ar(`(?!${Kn(t.terminal)})${jh}*?`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized
  });
}
s(K$, "negateTokenToRegex");
function B$(t) {
  return t.right ? ar(`[${Yu(t.left)}-${Yu(t.right)}]`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized,
    wrap: !1
...
s(ar, "withCardinality");
function Uh(t) {
  let e = [], r = t.Grammar;
  for (let n of r.rules)
    Ot(n) && kh(n) && bh(ou(n)) && e.push(n.name);
  return {
    multilineCommentRules: e,
    nameRegexp: gh
  };
}
s(Uh, "createGrammarConfig");
var DP = typeof global == "object" && global && global.Object === Object && global, q$ = DP, xP = typeof self == "object" && self && self.Object === Object && self, MP = q$ || xP || Function("return this")(), sr = MP, GP = sr.Symbol, Pt = GP, W$ = Object.prototype, FP = W$.hasOwnProperty, zP = W$.toString, Jo = Pt ? Pt.toStringTag : void 0;
function V$(t) {
  var e = FP.call(t, Jo), r = t[Jo];
  try {
    t[Jo] = void 0;
    var n = !0;
  } catch {
  ...
  var a = zP.call(t);
  return n && (e ? t[Jo] = r : delete t[Jo]), a;
}
s(V$, "getRawTag");
var jP = V$, UP = Object.prototype, KP = UP.toString;
function H$(t) {
  return KP.call(t);
}
s(H$, "objectToString");
var BP = H$, qP = "[object Null]", WP = "[object Undefined]", Ig = Pt ? Pt.toStringTag : void 0;
function Y$(t) {
  return t == null ? t === void 0 ? WP : qP : Ig && Ig in Object(t) ? jP(t) : BP(t);
}
s(Y$, "baseGetTag");
var Hr = Y$;
function X$(t) {
...
s(X$, "isObjectLike");
var Ut = X$, VP = "[object Symbol]";
function J$(t) {
  return typeof t == "symbol" || Ut(t) && Hr(t) == VP;
}
s(J$, "isSymbol");
var Tf = J$;
function Z$(t, e) {
...
s(Z$, "arrayMap");
var lu = Z$, HP = Array.isArray, ie = HP, YP = 1 / 0, Ng = Pt ? Pt.prototype : void 0, Pg = Ng ? Ng.toString : void 0;
function Kh(t) {
  if (typeof t == "string")
    return t;
  if (ie(t))
  ...
  if (Tf(t))
    return Pg ? Pg.call(t) : "";
  var e = t + "";
  return e == "0" && 1 / t == -YP ? "-0" : e;
}
s(Kh, "baseToString");
var XP = Kh, JP = /\s/;
function Q$(t) {
  for (var e = t.length; e-- && JP.test(t.charAt(e)); )
    ;
  return e;
}
s(Q$, "trimmedEndIndex");
var ZP = Q$, QP = /^\s+/;
function eR(t) {
  return t && t.slice(0, ZP(t) + 1).replace(QP, "");
}
s(eR, "baseTrim");
var ek = eR;
function tR(t) {
...
s(tR, "isObject");
var kt = tR, kg = NaN, tk = /^[-+]0x[0-9a-f]+$/i, rk = /^0b[01]+$/i, nk = /^0o[0-7]+$/i, ak = parseInt;
function rR(t) {
  if (typeof t == "number")
    return t;
  if (Tf(t))
  ...
  t = ek(t);
  var r = rk.test(t);
  return r || nk.test(t) ? ak(t.slice(2), r ? 2 : 8) : tk.test(t) ? kg : +t;
}
s(rR, "toNumber");
var ik = rR, Og = 1 / 0, sk = 17976931348623157e292;
function nR(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = ik(t), t === Og || t === -Og) {
...
s(iR, "identity");
var cu = iR, lk = "[object AsyncFunction]", uk = "[object Function]", ck = "[object GeneratorFunction]", fk = "[object Proxy]";
function sR(t) {
  if (!kt(t))
    return !1;
  var e = Hr(t);
  return e == uk || e == ck || e == lk || e == fk;
}
s(sR, "isFunction");
var Ir = sR, pk = sr["__core-js_shared__"], fp = pk, Lg = (function() {
  var t = /[^.]+$/.exec(fp && fp.keys && fp.keys.IE_PROTO || "");
...
s(oR, "isMasked");
var dk = oR, mk = Function.prototype, hk = mk.toString;
function lR(t) {
  if (t != null) {
    try {
      return hk.call(t);
...
s(lR, "toSource");
var Bn = lR, yk = /[\\^$.*+?()[\]{}|]/g, gk = /^\[object .+?Constructor\]$/, vk = Function.prototype, Tk = Object.prototype, $k = vk.toString, Rk = Tk.hasOwnProperty, Ak = RegExp(
  "^" + $k.call(Rk).replace(yk, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function uR(t) {
  if (!kt(t) || dk(t))
    return !1;
...
function fR(t, e) {
  var r = Ck(t, e);
  return Ek(r) ? r : void 0;
}
s(fR, "getNative");
var qn = fR, bk = qn(sr, "WeakMap"), Kd = bk, Dg = Object.create, _k = /* @__PURE__ */ (function() {
  function t() {
  }
...
s(mR, "copyArray");
var Ik = mR, Nk = 800, Pk = 16, kk = Date.now;
function hR(t) {
  var e = 0, r = 0;
  return function() {
    var n = kk(), a = Pk - (n - r);
...
s(yR, "constant");
var Lk = yR, Dk = (function() {
  try {
    var t = qn(Object, "defineProperty");
    return t({}, "", {}), t;
  } catch {
  }
})(), Pc = Dk, xk = Pc ? function(t, e) {
...
s(CR, "arrayIncludes");
var bR = CR, Uk = 9007199254740991, Kk = /^(?:0|[1-9]\d*)$/;
function _R(t, e) {
  var r = typeof t;
  return e = e ?? Uk, !!e && (r == "number" || r != "symbol" && Kk.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
s(_R, "isIndex");
var $f = _R;
function SR(t, e, r) {
  e == "__proto__" && Pc ? Pc(t, e, {
    configurable: !0,
    enumerable: !0,
    value: r,
    writable: !0
...
s(SR, "baseAssignValue");
var qh = SR;
function wR(t, e) {
  return t === e || t !== t && e !== e;
}
s(wR, "eq");
var fu = wR, Bk = Object.prototype, qk = Bk.hasOwnProperty;
function IR(t, e, r) {
  var n = t[e];
  (!(qk.call(t, e) && fu(n, r)) || r === void 0 && !(e in t)) && qh(t, e, r);
}
s(IR, "assignValue");
var Rf = IR;
function NR(t, e, r, n) {
  ...
  for (var i = -1, o = e.length; ++i < o; ) {
    ...
    l === void 0 && (l = t[u]), a ? qh(r, u, l) : Rf(r, u, l);
  }
  return r;
}
s(NR, "copyObject");
var pu = NR, xg = Math.max;
function PR(t, e, r) {
  return e = xg(e === void 0 ? t.length - 1 : e, 0), function() {
    for (var n = arguments, a = -1, i = xg(n.length - e, 0), o = Array(i); ++a < i; )
      o[a] = n[e + a];
    a = -1;
    for (var u = Array(e + 1); ++a < e; )
      u[a] = n[a];
    return u[e] = r(o), wk(t, this, u);
  };
}
s(PR, "overRest");
var Wk = PR;
function kR(t, e) {
  return Fk(Wk(t, e, cu), t + "");
}
s(kR, "baseRest");
var Wh = kR, Vk = 9007199254740991;
function OR(t) {
  return typeof t == "number" && t > -1 && t % 1 == 0 && t <= Vk;
}
s(OR, "isLength");
var Vh = OR;
function LR(t) {
  return t != null && Vh(t.length) && !Ir(t);
}
s(LR, "isArrayLike");
var or = LR;
function DR(t, e, r) {
  if (!kt(r))
    return !1;
  var n = typeof e;
  return (n == "number" ? or(r) && $f(e, r.length) : n == "string" && e in r) ? fu(r[e], t) : !1;
}
s(DR, "isIterateeCall");
var Af = DR;
function xR(t) {
  return Wh(function(e, r) {
    var n = -1, a = r.length, i = a > 1 ? r[a - 1] : void 0, o = a > 2 ? r[2] : void 0;
    for (i = t.length > 3 && typeof i == "function" ? (a--, i) : void 0, o && Af(r[0], r[1], o) && (i = a < 3 ? void 0 : i, a = 1), e = Object(e); ++n < a; ) {
      var u = r[n];
      u && t(e, u, n, i);
    }
    return e;
...
s(xR, "createAssigner");
var Hk = xR, Yk = Object.prototype;
function MR(t) {
  var e = t && t.constructor, r = typeof e == "function" && e.prototype || Yk;
  return t === r;
}
s(MR, "isPrototype");
var du = MR;
...
s(GR, "baseTimes");
var Xk = GR, Jk = "[object Arguments]";
function FR(t) {
  return Ut(t) && Hr(t) == Jk;
}
s(FR, "baseIsArguments");
var Mg = FR, zR = Object.prototype, Zk = zR.hasOwnProperty, Qk = zR.propertyIsEnumerable, eO = Mg(/* @__PURE__ */ (function() {
  return arguments;
})()) ? Mg : function(t) {
  return Ut(t) && Zk.call(t, "callee") && !Qk.call(t, "callee");
}, Ef = eO;
function jR() {
  return !1;
}
s(jR, "stubFalse");
var tO = jR, UR = typeof exports == "object" && exports && !exports.nodeType && exports, Gg = UR && typeof module == "object" && module && !module.nodeType && module, rO = Gg && Gg.exports === UR, Fg = rO ? sr.Buffer : void 0, nO = Fg ? Fg.isBuffer : void 0, aO = nO || tO, zl = aO, iO = "[object Arguments]", sO = "[object Array]", oO = "[object Boolean]", lO = "[object Date]", uO = "[object Error]", cO = "[object Function]", fO = "[object Map]", pO = "[object Number]", dO = "[object Object]", mO = "[object RegExp]", hO = "[object Set]", yO = "[object String]", gO = "[object WeakMap]", vO = "[object ArrayBuffer]", TO = "[object DataView]", $O = "[object Float32Array]", RO = "[object Float64Array]", AO = "[object Int8Array]", EO = "[object Int16Array]", CO = "[object Int32Array]", bO = "[object Uint8Array]", _O = "[object Uint8ClampedArray]", SO = "[object Uint16Array]", wO = "[object Uint32Array]", Ce = {};
Ce[$O] = Ce[RO] = Ce[AO] = Ce[EO] = Ce[CO] = Ce[bO] = Ce[_O] = Ce[SO] = Ce[wO] = !0;
Ce[iO] = Ce[sO] = Ce[vO] = Ce[oO] = Ce[TO] = Ce[lO] = Ce[uO] = Ce[cO] = Ce[fO] = Ce[pO] = Ce[dO] = Ce[mO] = Ce[hO] = Ce[yO] = Ce[gO] = !1;
function KR(t) {
  return Ut(t) && Vh(t.length) && !!Ce[Hr(t)];
}
s(KR, "baseIsTypedArray");
var IO = KR;
function BR(t) {
  return function(e) {
    return t(e);
...
s(BR, "baseUnary");
var mu = BR, qR = typeof exports == "object" && exports && !exports.nodeType && exports, Nl = qR && typeof module == "object" && module && !module.nodeType && module, NO = Nl && Nl.exports === qR, pp = NO && q$.process, PO = (function() {
  try {
    var t = Nl && Nl.require && Nl.require("util").types;
    return t || pp && pp.binding && pp.binding("util");
  } catch {
  }
})(), Ur = PO, zg = Ur && Ur.isTypedArray, kO = zg ? mu(zg) : IO, Hh = kO, OO = Object.prototype, LO = OO.hasOwnProperty;
function WR(t, e) {
  var r = ie(t), n = !r && Ef(t), a = !r && !n && zl(t), i = !r && !n && !a && Hh(t), o = r || n || a || i, u = o ? Xk(t.length, String) : [], l = u.length;
  for (var c in t)
    (e || LO.call(t, c)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
...
s(HR, "overArg");
var YR = HR, DO = YR(Object.keys, Object), xO = DO, MO = Object.prototype, GO = MO.hasOwnProperty;
function XR(t) {
  if (!du(t))
    return xO(t);
  var e = [];
  for (var r in Object(t))
    GO.call(t, r) && r != "constructor" && e.push(r);
  return e;
}
s(XR, "baseKeys");
var JR = XR;
function ZR(t) {
  return or(t) ? VR(t) : JR(t);
}
s(ZR, "keys");
var At = ZR, FO = Object.prototype, zO = FO.hasOwnProperty, jO = Hk(function(t, e) {
  if (du(e) || or(e)) {
    pu(e, At(e), t);
    return;
  }
  for (var r in e)
    zO.call(e, r) && Rf(t, r, e[r]);
}), Et = jO;
function QR(t) {
  var e = [];
  if (t != null)
...
s(QR, "nativeKeysIn");
var UO = QR, KO = Object.prototype, BO = KO.hasOwnProperty;
function eA(t) {
  if (!kt(t))
    return UO(t);
  var e = du(t), r = [];
  for (var n in t)
    n == "constructor" && (e || !BO.call(t, n)) || r.push(n);
  return r;
}
s(eA, "baseKeysIn");
var qO = eA;
function tA(t) {
  return or(t) ? VR(t, !0) : qO(t);
}
s(tA, "keysIn");
var Cf = tA, WO = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, VO = /^\w*$/;
function rA(t, e) {
  if (ie(t))
    return !1;
  var r = typeof t;
  return r == "number" || r == "symbol" || r == "boolean" || t == null || Tf(t) ? !0 : VO.test(t) || !WO.test(t) || e != null && t in Object(e);
}
s(rA, "isKey");
var Yh = rA, HO = qn(Object, "create"), jl = HO;
function nA() {
...
s(aA, "hashDelete");
var XO = aA, JO = "__lodash_hash_undefined__", ZO = Object.prototype, QO = ZO.hasOwnProperty;
function iA(t) {
  var e = this.__data__;
  if (jl) {
    var r = e[t];
...
s(iA, "hashGet");
var e0 = iA, t0 = Object.prototype, r0 = t0.hasOwnProperty;
function sA(t) {
  var e = this.__data__;
  return jl ? e[t] !== void 0 : r0.call(e, t);
}
s(sA, "hashHas");
var n0 = sA, a0 = "__lodash_hash_undefined__";
function oA(t, e) {
  var r = this.__data__;
  return this.size += this.has(t) ? 0 : 1, r[t] = jl && e === void 0 ? a0 : e, this;
}
s(oA, "hashSet");
var i0 = oA;
function Wn(t) {
...
s(Wn, "Hash");
Wn.prototype.clear = YO;
Wn.prototype.delete = XO;
Wn.prototype.get = e0;
Wn.prototype.has = n0;
Wn.prototype.set = i0;
var jg = Wn;
...
s(uA, "assocIndexOf");
var bf = uA, o0 = Array.prototype, l0 = o0.splice;
function cA(t) {
  var e = this.__data__, r = bf(e, t);
  if (r < 0)
    return !1;
  var n = e.length - 1;
  return r == n ? e.pop() : l0.call(e, r, 1), --this.size, !0;
}
s(cA, "listCacheDelete");
var u0 = cA;
function fA(t) {
  var e = this.__data__, r = bf(e, t);
...
var c0 = fA;
function pA(t) {
  return bf(this.__data__, t) > -1;
}
s(pA, "listCacheHas");
var f0 = pA;
function dA(t, e) {
  var r = this.__data__, n = bf(r, t);
...
Vn.prototype.delete = u0;
Vn.prototype.get = c0;
Vn.prototype.has = f0;
Vn.prototype.set = p0;
var _f = Vn, d0 = qn(sr, "Map"), Ul = d0;
function mA() {
...
function yA(t, e) {
  var r = t.__data__;
  return h0(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
}
s(yA, "getMapData");
var Sf = yA;
function gA(t) {
  var e = Sf(this, t).delete(t);
  return this.size -= e ? 1 : 0, e;
}
s(gA, "mapCacheDelete");
var y0 = gA;
...
s(Hn, "MapCache");
Hn.prototype.clear = m0;
Hn.prototype.delete = y0;
Hn.prototype.get = g0;
Hn.prototype.has = v0;
Hn.prototype.set = T0;
var wf = Hn, $0 = "Expected a function";
function If(t, e) {
  ...
  return r.cache = new (If.Cache || wf)(), r;
}
s(If, "memoize");
If.Cache = wf;
var R0 = If, A0 = 500;
function RA(t) {
  var e = R0(t, function(n) {
    return r.size === A0 && r.clear(), n;
  }), r = e.cache;
  return e;
}
s(RA, "memoizeCapped");
var E0 = RA, C0 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, b0 = /\\(\\)?/g, _0 = E0(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(C0, function(r, n, a, i) {
    e.push(a ? i.replace(b0, "$1") : n || r);
  }), e;
}), S0 = _0;
function AA(t) {
  return t == null ? "" : XP(t);
...
var w0 = AA;
function EA(t, e) {
  return ie(t) ? t : Yh(t, e) ? [t] : S0(w0(t));
}
s(EA, "castPath");
var Nf = EA, I0 = 1 / 0;
function CA(t) {
...
s(SA, "arrayPush");
var Jh = SA, Ug = Pt ? Pt.isConcatSpreadable : void 0;
function wA(t) {
  return ie(t) || Ef(t) || !!(Ug && t && t[Ug]);
}
s(wA, "isFlattenable");
var P0 = wA;
function Zh(t, e, r, n, a) {
  var i = -1, o = t.length;
  for (r || (r = P0), a || (a = []); ++i < o; ) {
    var u = t[i];
    e > 0 && r(u) ? e > 1 ? Zh(u, e - 1, r, n, a) : Jh(a, u) : n || (a[a.length] = u);
  }
  return a;
}
s(Zh, "baseFlatten");
...
s(IA, "flatten");
var zt = IA, k0 = YR(Object.getPrototypeOf, Object), NA = k0;
function PA(t, e, r) {
  var n = -1, a = t.length;
...
var F0 = GA;
function Yn(t) {
  var e = this.__data__ = new _f(t);
  this.size = e.size;
}
s(Yn, "Stack");
Yn.prototype.clear = L0;
Yn.prototype.delete = D0;
Yn.prototype.get = x0;
Yn.prototype.has = M0;
Yn.prototype.set = F0;
var Pl = Yn;
function FA(t, e) {
  return t && pu(e, At(e), t);
}
s(FA, "baseAssign");
var z0 = FA;
function zA(t, e) {
  return t && pu(e, Cf(e), t);
}
s(zA, "baseAssignIn");
var j0 = zA, jA = typeof exports == "object" && exports && !exports.nodeType && exports, Kg = jA && typeof module == "object" && module && !module.nodeType && module, U0 = Kg && Kg.exports === jA, Bg = U0 ? sr.Buffer : void 0, qg = Bg ? Bg.allocUnsafe : void 0;
function UA(t, e) {
  if (e)
    return t.slice();
  var r = t.length, n = qg ? qg(r) : new t.constructor(r);
  return t.copy(n), n;
}
s(UA, "cloneBuffer");
var K0 = UA;
...
s(BA, "stubArray");
var qA = BA, B0 = Object.prototype, q0 = B0.propertyIsEnumerable, Wg = Object.getOwnPropertySymbols, W0 = Wg ? function(t) {
  return t == null ? [] : (t = Object(t), ey(Wg(t), function(e) {
    return q0.call(t, e);
  }));
} : qA, ty = W0;
function WA(t, e) {
...
s(WA, "copySymbols");
var V0 = WA, H0 = Object.getOwnPropertySymbols, Y0 = H0 ? function(t) {
  for (var e = []; t; )
    Jh(e, ty(t)), t = NA(t);
  return e;
} : qA, VA = Y0;
...
s(ZA, "getAllKeysIn");
var QA = ZA, J0 = qn(sr, "DataView"), qd = J0, Z0 = qn(sr, "Promise"), Wd = Z0, Q0 = qn(sr, "Set"), ja = Q0, Vg = "[object Map]", eL = "[object Object]", Hg = "[object Promise]", Yg = "[object Set]", Xg = "[object WeakMap]", Jg = "[object DataView]", tL = Bn(qd), rL = Bn(Ul), nL = Bn(Wd), aL = Bn(ja), iL = Bn(Kd), on = Hr;
(qd && on(new qd(new ArrayBuffer(1))) != Jg || Ul && on(new Ul()) != Vg || Wd && on(Wd.resolve()) != Hg || ja && on(new ja()) != Yg || Kd && on(new Kd()) != Xg) && (on = /* @__PURE__ */ s(function(t) {
  var e = Hr(t), r = e == eL ? t.constructor : void 0, n = r ? Bn(r) : "";
  if (n)
    switch (n) {
      case tL:
        return Jg;
...
var To = on, sL = Object.prototype, oL = sL.hasOwnProperty;
function eE(t) {
  var e = t.length, r = new t.constructor(e);
  return e && typeof t[0] == "string" && oL.call(t, "index") && (r.index = t.index, r.input = t.input), r;
}
s(eE, "initCloneArray");
var lL = eE, uL = sr.Uint8Array, kc = uL;
function tE(t) {
  var e = new t.constructor(t.byteLength);
  return new kc(e).set(new kc(t)), e;
}
s(tE, "cloneArrayBuffer");
var ry = tE;
function rE(t, e) {
  var r = e ? ry(t.buffer) : t.buffer;
...
s(nE, "cloneRegExp");
var pL = nE, Zg = Pt ? Pt.prototype : void 0, Qg = Zg ? Zg.valueOf : void 0;
function aE(t) {
  return Qg ? Object(Qg.call(t)) : {};
}
s(aE, "cloneSymbol");
var dL = aE;
function iE(t, e) {
...
s(iE, "cloneTypedArray");
var mL = iE, hL = "[object Boolean]", yL = "[object Date]", gL = "[object Map]", vL = "[object Number]", TL = "[object RegExp]", $L = "[object Set]", RL = "[object String]", AL = "[object Symbol]", EL = "[object ArrayBuffer]", CL = "[object DataView]", bL = "[object Float32Array]", _L = "[object Float64Array]", SL = "[object Int8Array]", wL = "[object Int16Array]", IL = "[object Int32Array]", NL = "[object Uint8Array]", PL = "[object Uint8ClampedArray]", kL = "[object Uint16Array]", OL = "[object Uint32Array]";
function sE(t, e, r) {
  var n = t.constructor;
  switch (e) {
    case EL:
...
var LL = sE;
function oE(t) {
  return typeof t.constructor == "function" && !du(t) ? Sk(NA(t)) : {};
}
s(oE, "initCloneObject");
var DL = oE, xL = "[object Map]";
function lE(t) {
  return Ut(t) && To(t) == xL;
}
s(lE, "baseIsMap");
var ML = lE, ev = Ur && Ur.isMap, GL = ev ? mu(ev) : ML, FL = GL, zL = "[object Set]";
function uE(t) {
  return Ut(t) && To(t) == zL;
}
s(uE, "baseIsSet");
var jL = uE, tv = Ur && Ur.isSet, UL = tv ? mu(tv) : jL, KL = UL, BL = 1, qL = 2, WL = 4, cE = "[object Arguments]", VL = "[object Array]", HL = "[object Boolean]", YL = "[object Date]", XL = "[object Error]", fE = "[object Function]", JL = "[object GeneratorFunction]", ZL = "[object Map]", QL = "[object Number]", pE = "[object Object]", eD = "[object RegExp]", tD = "[object Set]", rD = "[object String]", nD = "[object Symbol]", aD = "[object WeakMap]", iD = "[object ArrayBuffer]", sD = "[object DataView]", oD = "[object Float32Array]", lD = "[object Float64Array]", uD = "[object Int8Array]", cD = "[object Int16Array]", fD = "[object Int32Array]", pD = "[object Uint8Array]", dD = "[object Uint8ClampedArray]", mD = "[object Uint16Array]", hD = "[object Uint32Array]", ve = {};
ve[cE] = ve[VL] = ve[iD] = ve[sD] = ve[HL] = ve[YL] = ve[oD] = ve[lD] = ve[uD] = ve[cD] = ve[fD] = ve[ZL] = ve[QL] = ve[pE] = ve[eD] = ve[tD] = ve[rD] = ve[nD] = ve[pD] = ve[dD] = ve[mD] = ve[hD] = !0;
ve[XL] = ve[fE] = ve[aD] = !1;
function kl(t, e, r, n, a, i) {
  var o, u = e & BL, l = e & qL, c = e & WL;
  ...
  if (f) {
    ...
    var p = To(t), d = p == fE || p == JL;
    if (zl(t))
      return K0(t, u);
    if (p == pE || p == cE || d && !a) {
      if (o = l || d ? {} : DL(t), !u)
        return l ? X0(t, j0(o, t)) : V0(t, z0(o, t));
    } else {
      if (!ve[p])
        return a ? t : {};
      o = LL(t, p, u);
  ...
  if (y)
    return y;
  i.set(t, o), KL(t) ? t.forEach(function(C) {
    o.add(kl(C, e, r, C, t, i));
  }) : FL(t) && t.forEach(function(C, T) {
    o.set(T, kl(C, e, r, T, t, i));
  });
  var h = c ? l ? QA : Bd : l ? Cf : At, $ = f ? void 0 : h(t);
  return vR($ || t, function(C, T) {
    $ && (T = C, C = t[T]), Rf(o, T, kl(C, e, r, T, t, i));
  }), o;
}
s(kl, "baseClone");
var yD = kl, gD = 4;
...
s(mE, "compact");
var yu = mE, vD = "__lodash_hash_undefined__";
function hE(t) {
...
function Kl(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.__data__ = new wf(); ++e < r; )
    this.add(t[e]);
}
s(Kl, "SetCache");
Kl.prototype.add = Kl.prototype.push = TD;
Kl.prototype.has = $D;
var ny = Kl;
function gE(t, e) {
...
function $E(t, e, r, n, a, i) {
  var o = r & RD, u = t.length, l = e.length;
  if (u != l && !(o && l > u))
    return !1;
  var c = i.get(t), f = i.get(e);
  if (c && f)
    return c == e && f == t;
  var p = -1, d = !0, y = r & AD ? new ny() : void 0;
  for (i.set(t, e), i.set(e, t); ++p < u; ) {
    var h = t[p], $ = e[p];
    if (n)
      var C = o ? n($, h, p, e, t, i) : n(h, $, p, t, e, i);
    if (C !== void 0) {
      if (C)
        continue;
      d = !1;
    ...
    if (y) {
      if (!vE(e, function(T, _) {
        if (!ay(y, _) && (h === T || a(h, T, r, n, i)))
          return y.push(_);
      })) {
        d = !1;
        break;
...
s(EE, "setToArray");
var iy = EE, CD = 1, bD = 2, _D = "[object Boolean]", SD = "[object Date]", wD = "[object Error]", ID = "[object Map]", ND = "[object Number]", PD = "[object RegExp]", kD = "[object Set]", OD = "[object String]", LD = "[object Symbol]", DD = "[object ArrayBuffer]", xD = "[object DataView]", rv = Pt ? Pt.prototype : void 0, dp = rv ? rv.valueOf : void 0;
function CE(t, e, r, n, a, i, o) {
  switch (r) {
    case xD:
    ...
    case DD:
      return !(t.byteLength != e.byteLength || !i(new kc(t), new kc(e)));
    case _D:
    case SD:
    case ND:
      return fu(+t, +e);
    ...
    case kD:
      var l = n & CD;
      if (u || (u = iy), t.size != e.size && !l)
        return !1;
      var c = o.get(t);
      if (c)
        return c == e;
      n |= bD, o.set(t, e);
      var f = RE(u(t), u(e), n, a, i, o);
      return o.delete(t), f;
    case LD:
      if (dp)
        return dp.call(t) == dp.call(e);
  }
  return !1;
}
s(CE, "equalByTag");
var MD = CE, GD = 1, FD = Object.prototype, zD = FD.hasOwnProperty;
function bE(t, e, r, n, a, i) {
  var o = r & GD, u = Bd(t), l = u.length, c = Bd(e), f = c.length;
  if (l != f && !o)
    return !1;
  for (var p = l; p--; ) {
    var d = u[p];
    if (!(o ? d in e : zD.call(e, d)))
      return !1;
  }
  ...
  for (var C = o; ++p < l; ) {
    ...
    var T = t[d], _ = e[d];
    if (n)
      var b = o ? n(_, T, d, e, t, i) : n(T, _, d, t, e, i);
  ...
  if ($ && !C) {
    var N = t.constructor, U = e.constructor;
    N != U && "constructor" in t && "constructor" in e && !(typeof N == "function" && N instanceof N && typeof U == "function" && U instanceof U) && ($ = !1);
  }
  return i.delete(t), i.delete(e), $;
}
s(bE, "equalObjects");
var jD = bE, UD = 1, nv = "[object Arguments]", av = "[object Array]", Cu = "[object Object]", KD = Object.prototype, iv = KD.hasOwnProperty;
function _E(t, e, r, n, a, i) {
  var o = ie(t), u = ie(e), l = o ? av : To(t), c = u ? av : To(e);
  l = l == nv ? Cu : l, c = c == nv ? Cu : c;
  var f = l == Cu, p = c == Cu, d = l == c;
  if (d && zl(t)) {
    if (!zl(e))
      return !1;
    o = !0, f = !1;
  ...
  if (d && !f)
    return i || (i = new Pl()), o || Hh(t) ? RE(t, e, r, n, a, i) : MD(t, e, l, r, n, a, i);
  if (!(r & UD)) {
    var y = f && iv.call(t, "__wrapped__"), h = p && iv.call(e, "__wrapped__");
    if (y || h) {
      var $ = y ? t.value() : t, C = h ? e.value() : e;
      return i || (i = new Pl()), a($, C, r, n, i);
    }
  }
  return d ? (i || (i = new Pl()), jD(t, e, r, n, a, i)) : !1;
}
s(_E, "baseIsEqualDeep");
var BD = _E;
function sy(t, e, r, n, a) {
  return t === e ? !0 : t == null || e == null || !Ut(t) && !Ut(e) ? t !== t && e !== e : BD(t, e, r, n, sy, a);
}
s(sy, "baseIsEqual");
var SE = sy, qD = 1, WD = 2;
function wE(t, e, r, n) {
  ...
  for (; ++a < i; ) {
    ...
    if (o && u[2]) {
      ...
      if (n)
        var d = n(c, f, l, t, e, p);
      if (!(d === void 0 ? SE(f, c, qD | WD, n, p) : d))
        return !1;
    }
  }
  return !0;
...
s(kE, "matchesStrictComparable");
var OE = kE;
function LE(t) {
  var e = HD(t);
  return e.length == 1 && e[0][2] ? OE(e[0][0], e[0][1]) : function(r) {
    return r === t || VD(r, t, e);
  };
}
s(LE, "baseMatches");
...
function xE(t, e, r) {
  ...
  return i || ++n != a ? i : (a = t == null ? 0 : t.length, !!a && Vh(a) && $f(o, a) && (ie(t) || Ef(t)));
}
s(xE, "hasPath");
var ME = xE;
function GE(t, e) {
  return t != null && ME(t, e, XD);
}
s(GE, "hasIn");
var JD = GE, ZD = 1, QD = 2;
function FE(t, e) {
  return Yh(t) && NE(e) ? OE(hu(t), e) : function(r) {
    var n = N0(r, t);
    return n === void 0 && n === e ? JD(r, t) : SE(e, n, ZD | QD);
  };
}
s(FE, "baseMatchesProperty");
var ex = FE;
function zE(t) {
  return function(e) {
    return e?.[t];
...
s(jE, "basePropertyDeep");
var rx = jE;
function UE(t) {
  return Yh(t) ? tx(hu(t)) : rx(t);
}
s(UE, "property");
var nx = UE;
function KE(t) {
  return typeof t == "function" ? t : t == null ? cu : typeof t == "object" ? ie(t) ? ex(t[0], t[1]) : YD(t) : nx(t);
}
s(KE, "baseIteratee");
var lr = KE;
function BE(t, e, r, n) {
...
s(VE, "createBaseEach");
var ux = VE, cx = ux(lx), Xn = cx;
function HE(t, e, r, n) {
  return Xn(t, function(a, i, o) {
    e(n, a, r(a), o);
  }), n;
}
s(HE, "baseAggregator");
...
function YE(t, e) {
  return function(r, n) {
    var a = ie(r) ? ax : fx, i = e ? e() : {};
    return a(r, t, lr(n, 2), i);
  };
}
s(YE, "createAggregator");
var px = YE, XE = Object.prototype, dx = XE.hasOwnProperty, mx = Wh(function(t, e) {
  t = Object(t);
  var r = -1, n = e.length, a = n > 2 ? e[2] : void 0;
  for (a && Af(e[0], e[1], a) && (n = 1); ++r < n; )
    for (var i = e[r], o = Cf(i), u = -1, l = o.length; ++u < l; ) {
      var c = o[u], f = t[c];
      (f === void 0 || fu(f, XE[c]) && !dx.call(t, c)) && (t[c] = i[c]);
    }
  return t;
}), oy = mx;
function JE(t) {
...
s(ZE, "arrayIncludesWith");
var QE = ZE, hx = 200;
function eC(t, e, r, n) {
  var a = -1, i = bR, o = !0, u = t.length, l = [], c = e.length;
  if (!u)
    return l;
  r && (e = lu(e, mu(r))), n ? (i = QE, o = !1) : e.length >= hx && (i = ay, o = !1, e = new ny(e));
  e:
    for (; ++a < u; ) {
      var f = t[a], p = r == null ? f : r(f);
...
s(eC, "baseDifference");
var yx = eC, gx = Wh(function(t, e) {
  return sv(t) ? yx(t, Qh(e, 1, sv, !0)) : [];
}), Pf = gx;
function tC(t) {
  var e = t == null ? 0 : t.length;
...
function rC(t, e, r) {
  ...
  return n ? (e = r || e === void 0 ? 1 : uu(e), kA(t, e < 0 ? 0 : e, n)) : [];
}
s(rC, "drop");
var Qe = rC;
function nC(t, e, r) {
  var n = t == null ? 0 : t.length;
  return n ? (e = r || e === void 0 ? 1 : uu(e), e = n - e, kA(t, 0, e < 0 ? 0 : e)) : [];
}
s(nC, "dropRight");
var Bl = nC;
function aC(t) {
  return typeof t == "function" ? t : cu;
}
s(aC, "castFunction");
var vx = aC;
function iC(t, e) {
...
function lC(t, e, r) {
  var n = ie(t) ? Tx : $x;
  return r && Af(t, e, r) && (e = void 0), n(t, lr(e, 3));
}
s(lC, "every");
var jt = lC;
function uC(t, e) {
...
function pC(t) {
  return function(e, r, n) {
    ...
    if (!or(e)) {
      var i = lr(r, 3);
      e = At(e), r = /* @__PURE__ */ s(function(u) {
        return i(a[u], u, a);
      }, "predicate");
    }
    var o = t(e, r, n);
...
s(pC, "createFind");
var Rx = pC, Ax = Math.max;
function dC(t, e, r) {
  var n = t == null ? 0 : t.length;
  if (!n)
    return -1;
  var a = r == null ? 0 : uu(r);
  return a < 0 && (a = Ax(n + a, 0)), $R(t, lr(e, 3), a);
}
s(dC, "findIndex");
var Ex = dC, Cx = Rx(Ex), $o = Cx;
function mC(t) {
...
s(gC, "flatMap");
var Nt = gC, _x = Object.prototype, Sx = _x.hasOwnProperty, wx = px(function(t, e, r) {
  Sx.call(t, r) ? t[r].push(e) : qh(t, r, [e]);
}), Ix = wx, Nx = Object.prototype, Px = Nx.hasOwnProperty;
function vC(t, e) {
  return t != null && Px.call(t, e);
}
s(vC, "baseHas");
var kx = vC;
function TC(t, e) {
  return t != null && ME(t, e, kx);
}
s(TC, "has");
var B = TC, Ox = "[object String]";
function $C(t) {
  return typeof t == "string" || !ie(t) && Ut(t) && Hr(t) == Ox;
}
s($C, "isString");
var yt = $C;
function RC(t, e) {
  return lu(e, function(r) {
    return t[r];
  });
}
s(RC, "baseValues");
var Lx = RC;
function AC(t) {
  return t == null ? [] : Lx(t, At(t));
}
s(AC, "values");
var Ke = AC, Dx = Math.max;
function EC(t, e, r, n) {
  t = or(t) ? t : Ke(t), r = r && !n ? uu(r) : 0;
  var a = t.length;
  return r < 0 && (r = Dx(a + r, 0)), yt(t) ? r <= a && t.indexOf(e, r) > -1 : !!a && Bh(t, e, r) > -1;
}
s(EC, "includes");
var pt = EC, xx = Math.max;
function CC(t, e, r) {
  var n = t == null ? 0 : t.length;
  if (!n)
    return -1;
  var a = r == null ? 0 : uu(r);
  return a < 0 && (a = xx(n + a, 0)), Bh(t, e, a);
}
s(CC, "indexOf");
var ov = CC, Mx = "[object Map]", Gx = "[object Set]", Fx = Object.prototype, zx = Fx.hasOwnProperty;
function bC(t) {
  if (t == null)
    return !0;
  if (or(t) && (ie(t) || typeof t == "string" || typeof t.splice == "function" || zl(t) || Hh(t) || Ef(t)))
    return !t.length;
  var e = To(t);
  if (e == Mx || e == Gx)
    return !t.size;
...
s(bC, "isEmpty");
var $e = bC, jx = "[object RegExp]";
function _C(t) {
  return Ut(t) && Hr(t) == jx;
}
s(_C, "baseIsRegExp");
var Ux = _C, lv = Ur && Ur.isRegExp, Kx = lv ? mu(lv) : Ux, Ar = Kx;
function SC(t) {
  return t === void 0;
}
s(SC, "isUndefined");
var Er = SC, Bx = "Expected a function";
function wC(t) {
...
function IC(t, e, r, n) {
  ...
  for (var a = -1, i = e.length, o = i - 1, u = t; u != null && ++a < i; ) {
    ...
    if (a != o) {
      var f = u[l];
      c = n ? n(f, l, u) : void 0, c === void 0 && (c = kt(f) ? f : $f(e[a + 1]) ? [] : {});
    }
    Rf(u, l, c), u = u[l];
  }
  return t;
...
function PC(t, e) {
  if (t == null)
    return {};
  var r = lu(QA(t), function(n) {
    return [n];
  });
  return e = lr(e), Vx(t, r, function(n, a) {
    return e(n, a[0]);
  });
}
s(PC, "pickBy");
...
var Hx = kC;
function OC(t, e, r) {
  var n = ie(t) ? O0 : Hx, a = arguments.length < 3;
  return n(t, lr(e, 4), r, a, Xn);
}
s(OC, "reduce");
var Ct = OC;
function LC(t, e) {
  var r = ie(t) ? ey : cC;
  return r(t, qx(lr(e, 3)));
}
s(LC, "reject");
var kf = LC;
function DC(t, e) {
...
s(xC, "some");
var MC = xC, Xx = 1 / 0, Jx = ja && 1 / iy(new ja([, -0]))[1] == Xx ? function(t) {
  return new ja(t);
} : Ve, Zx = Jx, Qx = 200;
function GC(t, e, r) {
  var n = -1, a = bR, i = t.length, o = !0, u = [], l = u;
  if (r)
    o = !1, a = QE;
  else if (i >= Qx) {
    var c = e ? null : Zx(t);
...
s(uy, "PRINT_WARNING");
function cy(t) {
  let e = (/* @__PURE__ */ new Date()).getTime(), r = t();
...
s(fy, "toFastProperties");
function zC(t) {
  return jC(t) ? t.LABEL : t.name;
}
s(zC, "tokenLabel");
function jC(t) {
  return yt(t.LABEL) && t.LABEL !== "";
}
s(jC, "hasTokenLabel");
var Ja, ur = (Ja = class {
  get definition() {
  ...
  accept(e) {
    e.visit(this), W(this.definition, (r) => {
      r.accept(e);
    });
  }
}, s(Ja, "AbstractProduction"), Ja), Za, ut = (Za = class extends ur {
  constructor(e) {
    super([]), this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
  set definition(e) {
  }
  get definition() {
...
}, s(Za, "NonTerminal"), Za), Qa, _o = (Qa = class extends ur {
  constructor(e) {
    super(e.definition), this.orgText = "", Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(Qa, "Rule"), Qa), ei, gt = (ei = class extends ur {
  constructor(e) {
    super(e.definition), this.ignoreAmbiguities = !1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(ei, "Alternative"), ei), ti, et = (ti = class extends ur {
  constructor(e) {
    super(e.definition), this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(ti, "Option"), ti), ri, bt = (ri = class extends ur {
  constructor(e) {
    super(e.definition), this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(ri, "RepetitionMandatory"), ri), ni, _t = (ni = class extends ur {
  constructor(e) {
    super(e.definition), this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(ni, "RepetitionMandatoryWithSeparator"), ni), ai, De = (ai = class extends ur {
  constructor(e) {
    super(e.definition), this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(ai, "Repetition"), ai), ii, vt = (ii = class extends ur {
  constructor(e) {
    super(e.definition), this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(ii, "RepetitionWithSeparator"), ii), si, Tt = (si = class extends ur {
  get definition() {
    return this._definition;
  }
  set definition(e) {
  ...
  constructor(e) {
    super(e.definition), this.idx = 1, this.ignoreAmbiguities = !1, this.hasPredicates = !1, Et(this, Bt(e, (r) => r !== void 0));
  }
}, s(si, "Alternation"), si), oi, _e = (oi = class {
  constructor(e) {
    this.idx = 1, Et(this, Bt(e, (r) => r !== void 0));
  }
  accept(e) {
    e.visit(this);
  }
...
s(UC, "serializeGrammar");
function Ol(t) {
  function e(r) {
    return j(r, Ol);
  }
  if (s(e, "convertDefinition"), t instanceof ut) {
    let r = {
      type: "NonTerminal",
      name: t.nonTerminalName,
      idx: t.idx
    };
    return yt(t.label) && (r.label = t.label), r;
  } else {
    if (t instanceof gt)
      return {
        type: "Alternative",
    ...
    if (t instanceof _t)
      return {
        ...
        idx: t.idx,
        separator: Ol(new _e({ terminalType: t.separator })),
        definition: e(t.definition)
      };
    if (t instanceof vt)
      return {
    ...
    if (t instanceof _e) {
      let r = {
        ...
        label: zC(t.terminalType),
        idx: t.idx
      };
      yt(t.label) && (r.terminalLabel = t.label);
      let n = t.terminalType.PATTERN;
      return t.terminalType.PATTERN && (r.pattern = Ar(n) ? n.source : n), r;
    } else {
      if (t instanceof _o)
        return {
          type: "Rule",
...
function KC(t) {
  return t instanceof gt || t instanceof et || t instanceof De || t instanceof bt || t instanceof _t || t instanceof vt || t instanceof _e || t instanceof _o;
}
s(KC, "isSequenceProd");
function ql(t, e = []) {
  return t instanceof et || t instanceof De || t instanceof vt ? !0 : t instanceof Tt ? MC(t.definition, (n) => ql(n, e)) : t instanceof ut && pt(e, t) ? !1 : t instanceof ur ? (t instanceof ut && e.push(t), jt(t.definition, (n) => ql(n, e))) : !1;
}
s(ql, "isOptionalProd");
function BC(t) {
  return t instanceof Tt;
}
s(BC, "isBranchingProd");
function xt(t) {
  if (t instanceof ut)
    return "SUBRULE";
  if (t instanceof et)
...
s(xt, "getProductionDslName");
var ui, Of = (ui = class {
  walk(e, r = []) {
    W(e.definition, (n, a) => {
      let i = Qe(e.definition, a + 1);
      if (n instanceof ut)
  ...
  walkAtLeastOne(e, r, n) {
    let a = [
      new et({ definition: e.definition })
    ].concat(r, n);
    this.walk(e, a);
  }
...
function Vd(t, e, r) {
  return [
    new et({
      definition: [
        new _e({ terminalType: t.separator })
      ].concat(t.definition)
    })
  ].concat(e, r);
}
s(Vd, "restForRepetitionWithSeparator");
function wo(t) {
  if (t instanceof ut)
    return wo(t.referencedRule);
  if (t instanceof _e)
    return VC(t);
  if (KC(t))
    return qC(t);
...
s(wo, "first");
function qC(t) {
  let e = [], r = t.definition, n = 0, a = r.length > n, i, o = !0;
  for (; a && o; )
    i = r[n], o = ql(i), e = e.concat(wo(i)), n = n + 1, a = r.length > n;
  return ly(e);
}
s(qC, "firstForSequence");
function WC(t) {
  let e = j(t.definition, (r) => wo(r));
  return ly(zt(e));
}
s(WC, "firstForBranching");
function VC(t) {
  return [t.terminalType];
}
s(VC, "firstForTerminal");
var HC = "_~IN~_", ci, tM = (ci = class extends Of {
  constructor(e) {
  ...
  walkProdRef(e, r, n) {
    let a = XC(e.referencedRule, e.idx) + this.topProd.name, i = r.concat(n), o = new gt({ definition: i }), u = wo(o);
    this.follows[a] = u;
  }
}, s(ci, "ResyncFollowsWalker"), ci);
function YC(t) {
  let e = {};
  return W(t, (r) => {
    let n = new tM(r).startWalking();
    Et(e, n);
  }), e;
}
s(YC, "computeAllProdsFollows");
function XC(t, e) {
  return t.name + e + HC;
}
s(XC, "buildBetweenProdsFollowPrefix");
var Xu = {}, rM = new w$();
function gu(t) {
  let e = t.toString();
...
s(JC, "clearRegExpParserCache");
var ZC = "Complement Sets are not supported for first char optimization", Lc = `Unable to use "first char" lexer optimizations:
`;
function QC(t, e = !1) {
  try {
    let r = gu(t);
    return Dc(r.value, {}, r.flags.ignoreCase);
  } catch (r) {
    if (r.message === ZC)
      e && uy(`${Lc}	Unable to optimize: < ${t.toString()} >
	...
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#COMPLEMENT for details.`);
      ...
      e && (n = `
	This will disable the lexer's first char optimizations.
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`), Oc(`${Lc}
...
s(QC, "getOptimizedStartCodesIndices");
function Dc(t, e, r) {
  switch (t.type) {
    case "Disjunction":
    ...
    case "Alternative":
      ...
      for (let a = 0; a < n.length; a++) {
            ...
            W(o.value, (l) => {
              if (typeof l == "number")
                ...
                if (r === !0)
                  ...
                  for (let f = c.from; f <= c.to && f < vl; f++)
                    yl(f, e, r);
                  if (c.to >= vl) {
                    let f = c.from >= vl ? c.from : vl, p = c.to, d = Cr(f), y = Cr(p);
                    for (let h = d; h <= y; h++)
                      e[h] = h;
                  }
                }
        ...
        let u = o.quantifier !== void 0 && o.quantifier.atLeast === 0;
        if (
          // A group may be optional due to empty contents /(?:)/
          // or if everything inside it is optional /((a)?)/
          o.type === "Group" && xc(o) === !1 || // If this term is not a group it may only be optional if it has an optional quantifier
          o.type !== "Group" && u === !1
        )
          break;
      }
...
s(Dc, "firstCharOptimizedIndices");
function yl(t, e, r) {
  let n = Cr(t);
  e[n] = n, r === !0 && eb(t, e);
}
...
function eb(t, e) {
  let r = String.fromCharCode(t), n = r.toUpperCase();
  if (n !== r) {
    let a = Cr(n.charCodeAt(0));
    e[a] = a;
  } else {
    let a = r.toLowerCase();
    if (a !== r) {
      let i = Cr(a.charCodeAt(0));
      e[i] = i;
    }
  }
}
s(eb, "handleIgnoreCase");
function Hd(t, e) {
  return $o(t.value, (r) => {
    if (typeof r == "number")
      return pt(e, r);
    {
      let n = r;
      return $o(e, (a) => n.from <= a && a <= n.to) !== void 0;
    }
  });
}
s(Hd, "findCode");
function xc(t) {
  let e = t.quantifier;
  return e && e.atLeast === 0 ? !0 : t.value ? ie(t.value) ? jt(t.value, xc) : xc(t.value) : !1;
}
s(xc, "isWholeOptional");
var fi, nM = (fi = class extends pf {
  constructor(e) {
  ...
  visitCharacter(e) {
    pt(this.targetCharCodes, e.value) && (this.found = !0);
  }
  visitSet(e) {
    e.complement ? Hd(e, this.targetCharCodes) === void 0 && (this.found = !0) : Hd(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}, s(fi, "CharCodeFinder"), fi);
function Lf(t, e) {
  if (e instanceof RegExp) {
    let r = gu(e), n = new nM(t);
    return n.visit(r), n.found;
  } else
    return $o(e, (r) => pt(t, r.charCodeAt(0))) !== void 0;
}
s(Lf, "canMatchCharCode");
var Dn = "PATTERN", gl = "defaultMode", bu = "modes";
function tb(t, e) {
  e = oy(e, {
    debug: !1,
    safeMode: !1,
...
`],
    tracer: /* @__PURE__ */ s((_, b) => b(), "tracer")
  });
  let r = e.tracer;
      ...
      if (Ar(b)) {
        ...
        if (typeof b == "string") {
          if (b.length === 1)
            return b;
          {
            let N = b.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"), U = new RegExp(N);
            return Yd(U);
          }
        } else
          throw Error("non exhaustive match");
  ...
  let o, u, l, c, f;
  r("misc mapping", () => {
    o = j(n, (_) => _.tokenTypeIdx), u = j(n, (_) => {
      let b = _.GROUP;
      if (b !== ot.SKIPPED) {
        if (yt(b))
          return b;
      ...
      let b = _.LONGER_ALT;
      if (b)
        return ie(b) ? j(b, (U) => ov(n, U)) : [ov(n, b)];
    }), c = j(n, (_) => _.PUSH_MODE), f = j(n, (_) => B(_, "POP_MODE"));
  });
  let p;
  r("Line Terminator Handling", () => {
    let _ = my(e.lineTerminatorCharacters);
    p = j(n, (b) => !1), e.positionTracking !== "onlyOffset" && (p = j(n, (b) => B(b, "LINE_BREAKS") ? !!b.LINE_BREAKS : dy(b, _) === !1 && Lf(_, b.PATTERN)));
  });
  let d, y, h, $;
  r("Misc Mapping #2", () => {
    d = j(n, py), y = j(i, $b), h = Ct(n, (_, b) => {
      let N = b.GROUP;
      return yt(N) && N !== ot.SKIPPED && (_[N] = []), _;
    }, {}), $ = j(i, (_, b) => ({
      pattern: i[b],
      longerAlt: l[b],
  ...
  return e.safeMode || r("First Char Optimization", () => {
    T = Ct(n, (_, b, N) => {
      if (typeof b.PATTERN == "string") {
        let U = b.PATTERN.charCodeAt(0), re = Cr(U);
        Ju(_, re, $[N]);
      } else if (ie(b.START_CHARS_HINT)) {
        let U;
        W(b.START_CHARS_HINT, (re) => {
          let J = typeof re == "string" ? re.charCodeAt(0) : re, me = Cr(J);
          U !== me && (U = me, Ju(_, me, $[N]));
        });
      } else if (Ar(b.PATTERN))
        if (b.PATTERN.unicode)
          C = !1, e.ensureOptimizations && Oc(`${Lc}	Unable to analyze < ${b.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
        else {
          let U = QC(b.PATTERN, e.ensureOptimizations);
          $e(U) && (C = !1), W(U, (re) => {
            Ju(_, re, $[N]);
          });
        }
      else
        e.ensureOptimizations && Oc(`${Lc}	TokenType: <${b.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
...
s(tb, "analyzeTokenTypes");
function rb(t, e) {
  let r = [], n = ab(t);
  r = r.concat(n.errors);
  let a = ib(n.valid), i = a.valid;
  return r = r.concat(a.errors), r = r.concat(nb(i)), r = r.concat(fb(i)), r = r.concat(pb(i, e)), r = r.concat(db(i)), r;
}
s(rb, "validatePatterns");
function nb(t) {
  let e = [], r = Lt(t, (n) => Ar(n[Dn]));
  return e = e.concat(sb(r)), e = e.concat(lb(r)), e = e.concat(ub(r)), e = e.concat(cb(r)), e = e.concat(ob(r)), e;
}
s(nb, "validateRegExpPattern");
function ab(t) {
  let e = Lt(t, (a) => !B(a, Dn)), r = j(e, (a) => ({
    message: "Token Type: ->" + a.name + "<- missing static 'PATTERN' property",
    type: xe.MISSING_PATTERN,
    tokenTypes: [a]
  })), n = Pf(t, e);
  return { errors: r, valid: n };
}
s(ab, "findMissingPatterns");
function ib(t) {
  let e = Lt(t, (a) => {
    let i = a[Dn];
    return !Ar(i) && !Ir(i) && !B(i, "exec") && !yt(i);
  }), r = j(e, (a) => ({
    ...
    type: xe.INVALID_PATTERN,
    tokenTypes: [a]
  })), n = Pf(t, e);
  return { errors: r, valid: n };
}
s(ib, "findInvalidPatterns");
var aM = /[^\\][$]/;
function sb(t) {
  let a = class a extends pf {
    constructor() {
  ...
  return j(r, (i) => ({
    ...
    type: xe.EOI_ANCHOR_FOUND,
    tokenTypes: [i]
  }));
}
s(sb, "findEndOfInputAnchor");
function ob(t) {
  let e = Lt(t, (n) => n.PATTERN.test(""));
  return j(e, (n) => ({
    message: "Token Type: ->" + n.name + "<- static 'PATTERN' must not match an empty string",
    type: xe.EMPTY_MATCH_PATTERN,
    tokenTypes: [n]
  }));
}
s(ob, "findEmptyMatchRegExps");
var iM = /[^\\[][\^]|^\^/;
function lb(t) {
  let a = class a extends pf {
    constructor() {
  ...
  return j(r, (i) => ({
    ...
    type: xe.SOI_ANCHOR_FOUND,
    tokenTypes: [i]
  }));
}
s(lb, "findStartOfInputAnchor");
function ub(t) {
  let e = Lt(t, (n) => {
    let a = n[Dn];
  ...
  return j(e, (n) => ({
    ...
    type: xe.UNSUPPORTED_FLAGS_FOUND,
    tokenTypes: [n]
  }));
}
s(ub, "findUnsupportedFlags");
function cb(t) {
  let e = [], r = j(t, (i) => Ct(t, (o, u) => (i.PATTERN.source === u.PATTERN.source && !pt(e, u) && u.PATTERN !== ot.NA && (e.push(u), o.push(u)), o), []));
  r = yu(r);
  let n = Lt(r, (i) => i.length > 1);
  return j(n, (i) => {
    let o = j(i, (l) => l.name);
    return {
      message: `The same RegExp pattern ->${Kt(i).PATTERN}<-has been used in all of the following Token Types: ${o.join(", ")} <-`,
      type: xe.DUPLICATE_PATTERNS_FOUND,
      tokenTypes: i
    };
  });
}
s(cb, "findDuplicatePatterns");
function fb(t) {
  let e = Lt(t, (n) => {
    if (!B(n, "GROUP"))
      return !1;
    let a = n.GROUP;
    return a !== ot.SKIPPED && a !== ot.NA && !yt(a);
  });
  return j(e, (n) => ({
    message: "Token Type: ->" + n.name + "<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String",
    type: xe.INVALID_GROUP_TYPE_FOUND,
    tokenTypes: [n]
  }));
}
s(fb, "findInvalidGroupType");
function pb(t, e) {
  let r = Lt(t, (a) => a.PUSH_MODE !== void 0 && !pt(e, a.PUSH_MODE));
  return j(r, (a) => ({
    message: `Token Type: ->${a.name}<- static 'PUSH_MODE' value cannot refer to a Lexer Mode ->${a.PUSH_MODE}<-which does not exist`,
    type: xe.PUSH_MODE_DOES_NOT_EXIST,
    tokenTypes: [a]
  }));
}
s(pb, "findModesThatDoNotExist");
function db(t) {
  let e = [], r = Ct(t, (n, a, i) => {
    let o = a.PATTERN;
    return o === ot.NA || (yt(o) ? n.push({ str: o, idx: i, tokenType: a }) : Ar(o) && hb(o) && n.push({ str: o.source, idx: i, tokenType: a })), n;
  }, []);
  return W(t, (n, a) => {
    W(r, ({ str: i, idx: o, tokenType: u }) => {
      if (a < o && mb(i, n.PATTERN)) {
        let l = `Token: ->${u.name}<- can never be matched.
Because it appears AFTER the Token Type ->${n.name}<-in the lexer's definition.
See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`;
        e.push({
          message: l,
          type: xe.UNREACHABLE_PATTERN,
          tokenTypes: [n, u]
        });
      }
    });
...
function gb(t, e, r) {
  let n = [];
  return B(t, gl) || n.push({
    message: "A MultiMode Lexer cannot be initialized without a <" + gl + `> property in its definition
`,
    type: xe.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE
  }), B(t, bu) || n.push({
    message: "A MultiMode Lexer cannot be initialized without a <" + bu + `> property in its definition
`,
    type: xe.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY
  }), B(t, bu) && B(t, gl) && !B(t.modes, t.defaultMode) && n.push({
    message: `A MultiMode Lexer cannot be initialized with a ${gl}: <${t.defaultMode}>which does not exist
`,
    type: xe.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST
  }), B(t, bu) && W(t.modes, (a, i) => {
    W(a, (o, u) => {
      if (Er(o))
        n.push({
          message: `A Lexer cannot be initialized using an undefined Token Type. Mode:<${i}> at index: <${u}>
`,
          type: xe.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED
        });
      else if (B(o, "LONGER_ALT")) {
        let l = ie(o.LONGER_ALT) ? o.LONGER_ALT : [o.LONGER_ALT];
        W(l, (c) => {
          !Er(c) && !pt(a, c) && n.push({
            message: `A MultiMode Lexer cannot be initialized with a longer_alt <${c.name}> on token <${o.name}> outside of mode <${i}>
`,
            type: xe.MULTI_MODE_LEXER_LONGER_ALT_NOT_IN_CURRENT_MODE
          });
        });
      }
    });
...
s(gb, "performRuntimeChecks");
function vb(t, e, r) {
  let n = [], a = !1, i = yu(zt(Ke(t.modes))), o = kf(i, (l) => l[Dn] === ot.NA), u = my(r);
  return e && W(o, (l) => {
    let c = dy(l, u);
    if (c !== !1) {
      let p = {
      ...
      B(l, "LINE_BREAKS") ? l.LINE_BREAKS === !0 && (a = !0) : Lf(u, l.PATTERN) && (a = !0);
  }), e && !a && n.push({
	...
	for details.`,
    type: xe.NO_LINE_BREAKS_FLAGS
  }), n;
}
s(vb, "performWarningRuntimeChecks");
function Tb(t) {
  let e = {}, r = At(t);
  return W(r, (n) => {
    let a = t[n];
...
s(py, "isCustomPattern");
function $b(t) {
  return yt(t) && t.length === 1 ? t.charCodeAt(0) : !1;
}
s($b, "isShortPattern");
var sM = {
  // implements /\n|\r\n?/g.test
...
function dy(t, e) {
  ...
  if (Ar(t.PATTERN)) {
    ...
    if (yt(t.PATTERN))
      return !1;
    if (py(t))
      return { issue: xe.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
s(dy, "checkLineBreaksIssues");
function Rb(t, e) {
  if (e.issue === xe.IDENTIFY_TERMINATOR)
    return `Warning: unable to identify line terminator usage in pattern.
	The problem is in the <${t.name}> Token Type
	 Root cause: ${e.errMsg}.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#IDENTIFY_TERMINATOR`;
  if (e.issue === xe.CUSTOM_LINE_BREAK)
    return `Warning: A Custom Token Pattern should specify the <line_breaks> option.
	The problem is in the <${t.name}> Token Type
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_LINE_BREAK`;
  throw Error("non exhaustive match");
}
s(Rb, "buildLineBreakIssueMessage");
function my(t) {
  return j(t, (r) => yt(r) ? r.charCodeAt(0) : r);
}
s(my, "getCharCodes");
function Ju(t, e, r) {
  t[e] === void 0 ? t[e] = [r] : t[e].push(r);
}
s(Ju, "addToMapOfArrays");
var vl = 256, Zu = [];
function Cr(t) {
  return t < vl ? t : Zu[t];
}
s(Cr, "charCodeToOptimizedIndex");
function Ab() {
  if ($e(Zu)) {
    Zu = new Array(65536);
    for (let t = 0; t < 65536; t++)
      Zu[t] = t > 255 ? 255 + ~~(t / 255) : t;
  }
}
s(Ab, "initCharCodeToOptimizedIndexMap");
function Io(t, e) {
  let r = t.tokenTypeIdx;
  return r === e.tokenTypeIdx ? !0 : e.isParent === !0 && e.categoryMatchesMap[r] === !0;
}
s(Io, "tokenStructuredMatcher");
function Wl(t, e) {
  return t.tokenTypeIdx === e.tokenTypeIdx;
}
s(Wl, "tokenStructuredMatcherNoCategories");
var uv = 1, Eb = {};
function No(t) {
  let e = Cb(t);
  bb(e), Sb(e), _b(e), W(e, (r) => {
    r.isParent = r.categoryMatches.length > 0;
  });
}
s(No, "augmentTokenTypes");
function Cb(t) {
  let e = tt(t), r = t, n = !0;
  for (; n; ) {
    r = yu(zt(j(r, (i) => i.CATEGORIES)));
    let a = Pf(r, e);
    e = e.concat(a), $e(a) ? n = !1 : r = a;
  }
  return e;
}
s(Cb, "expandCategories");
function bb(t) {
  W(t, (e) => {
    yy(e) || (Eb[uv] = e, e.tokenTypeIdx = uv++), Xd(e) && !ie(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Xd(e) || (e.CATEGORIES = []), wb(e) || (e.categoryMatches = []), Ib(e) || (e.categoryMatchesMap = {});
  });
}
s(bb, "assignTokenDefaultProps");
function _b(t) {
  W(t, (e) => {
    e.categoryMatches = [], W(e.categoryMatchesMap, (r, n) => {
      e.categoryMatches.push(Eb[n].tokenTypeIdx);
    });
  });
}
s(_b, "assignCategoriesTokensProp");
function Sb(t) {
  W(t, (e) => {
    hy([], e);
  });
}
s(Sb, "assignCategoriesMapProp");
function hy(t, e) {
  W(t, (r) => {
...
s(Xd, "hasCategoriesProperty");
function wb(t) {
  return B(t, "categoryMatches");
}
s(wb, "hasExtendingTokensTypesProperty");
function Ib(t) {
  return B(t, "categoryMatchesMap");
}
s(Ib, "hasExtendingTokensTypesMapProperty");
function Nb(t) {
  return B(t, "tokenTypeIdx");
}
s(Nb, "isTokenType");
  ...
  constructor(e, r = Tl) {
    if (this.lexerDefinition = e, this.lexerDefinitionErrors = [], this.lexerDefinitionWarning = [], this.patternIdxToConfig = {}, this.charCodeToPatternIdxToConfig = {}, this.modes = [], this.emptyGroups = {}, this.trackStartLines = !0, this.trackEndLines = !0, this.hasCustom = !1, this.canModeBeOptimized = {}, this.TRACE_INIT = (a, i) => {
      if (this.traceInitPerf === !0) {
        ...
        let { time: u, value: l } = cy(i), c = u > 10 ? console.warn : console.log;
...
a boolean 2nd argument is no longer supported`);
    ...
    n === !0 ? (this.traceInitMaxIdent = 1 / 0, this.traceInitPerf = !0) : typeof n == "number" && (this.traceInitMaxIdent = n, this.traceInitPerf = !0), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", () => {
      ...
      this.TRACE_INIT("Lexer Config handling", () => {
        if (this.config.lineTerminatorsPattern === Tl.lineTerminatorsPattern)
          this.config.lineTerminatorsPattern = sM;
        else if (this.config.lineTerminatorCharacters === Tl.lineTerminatorCharacters)
          throw Error(`Error: Missing <lineTerminatorCharacters> property on the Lexer config.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        if (r.safeMode && r.ensureOptimizations)
          throw Error('"safeMode" and "ensureOptimizations" flags are mutually exclusive.');
        this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking), this.trackEndLines = /full/i.test(this.config.positionTracking), ie(e) ? a = {
          modes: { defaultMode: tt(e) },
          defaultMode: gl
        } : (i = !1, a = tt(e));
      }), this.config.skipValidations === !1 && (this.TRACE_INIT("performRuntimeChecks", () => {
        this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(gb(a, this.trackStartLines, this.config.lineTerminatorCharacters));
      }), this.TRACE_INIT("performWarningRuntimeChecks", () => {
        this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(vb(a, this.trackStartLines, this.config.lineTerminatorCharacters));
      })), a.modes = a.modes ? a.modes : {}, W(a.modes, (u, l) => {
        a.modes[l] = kf(u, (c) => Er(c));
      });
      let o = At(a.modes);
      if (W(a.modes, (u, l) => {
        this.TRACE_INIT(`Mode: <${l}> processing`, () => {
          if (this.modes.push(l), this.config.skipValidations === !1 && this.TRACE_INIT("validatePatterns", () => {
            this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(rb(u, o));
            ...
            }), this.patternIdxToConfig[l] = c.patternIdxToConfig, this.charCodeToPatternIdxToConfig[l] = c.charCodeToPatternIdxToConfig, this.emptyGroups = Et({}, this.emptyGroups, c.emptyGroups), this.hasCustom = c.hasCustom || this.hasCustom, this.canModeBeOptimized[l] = c.canBeOptimized;
          }
        });
      }), this.defaultMode = a.defaultMode, !$e(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
        let l = j(this.lexerDefinitionErrors, (c) => c.message).join(`-----------------------
`);
        throw new Error(`Errors detected in definition of Lexer:
` + l);
      }
      W(this.lexerDefinitionWarning, (u) => {
        uy(u.message);
      }), this.TRACE_INIT("Choosing sub-methods implementations", () => {
        if (i && (this.handleModes = Ve), this.trackStartLines === !1 && (this.computeNewColumn = cu), this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = Ve), /full/i.test(this.config.positionTracking))
        ...
        let u = Ct(this.canModeBeOptimized, (l, c, f) => (c === !1 && l.push(f), l), []);
        if (r.ensureOptimizations && !$e(u))
  ...
  tokenize(e, r = this.defaultMode) {
    if (!$e(this.lexerDefinitionErrors)) {
      let a = j(this.lexerDefinitionErrors, (i) => i.message).join(`-----------------------
`);
...
` + a);
  ...
  tokenizeInternal(e, r) {
    let n, a, i, o, u, l, c, f, p, d, y, h, $, C, T, _ = e, b = _.length, N = 0, U = 0, re = this.hasCustom ? 0 : Math.floor(e.length / 10), J = new Array(re), me = [], Re = this.trackStartLines ? 1 : void 0, he = this.trackStartLines ? 1 : void 0, le = Tb(this.emptyGroups), rt = this.trackStartLines, k = this.config.lineTerminatorsPattern, S = 0, v = [], I = [], R = [], A = [];
    Object.freeze(A);
    let w = !1, L = /* @__PURE__ */ s((M) => {
      if (R.length === 1 && // if we have both a POP_MODE and a PUSH_MODE this is in-fact a "transition"
      // So no error should occur.
      M.tokenType.PUSH_MODE === void 0) {
        let Y = this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(M);
        me.push({
        ...
        R.pop();
        let Y = Ln(R);
        v = this.patternIdxToConfig[Y], I = this.charCodeToPatternIdxToConfig[Y], S = v.length;
        let V = this.canModeBeOptimized[Y] && this.config.safeMode === !1;
        I && V ? w = !0 : w = !1;
      }
    }, "pop_mode");
    function x(M) {
      R.push(M), I = this.charCodeToPatternIdxToConfig[M], v = this.patternIdxToConfig[M], S = v.length, S = v.length;
      let Y = this.canModeBeOptimized[M] && this.config.safeMode === !1;
      I && Y ? w = !0 : w = !1;
    }
    s(x, "push_mode"), x.call(this, r);
    let O, z = this.config.recoveryEnabled;
    for (; N < b; ) {
      l = null, p = -1;
      let M = _.charCodeAt(N), Y;
      if (w) {
        let Z = Cr(M), ne = I[Z];
        Y = ne !== void 0 ? ne : A;
      } else
      ...
      for (n = 0; n < V; n++) {
        ...
        c = null;
        let ne = O.short;
        if (ne !== !1 ? M === ne && (p = 1, l = Z) : O.isCustom === !0 ? (T = Z.exec(_, N, J, le), T !== null ? (l = T[0], p = l.length, T.payload !== void 0 && (c = T.payload)) : l = null) : (Z.lastIndex = N, p = this.matchLength(Z, e, N)), p !== -1) {
          if (u = O.longerAlt, u !== void 0) {
            l = e.substring(N, N + p);
            let ke = u.length;
            for (i = 0; i < ke; i++) {
              let pe = v[u[i]], Ae = pe.pattern;
              if (f = null, pe.isCustom === !0 ? (T = Ae.exec(_, N, J, le), T !== null ? (o = T[0], T.payload !== void 0 && (f = T.payload)) : o = null) : (Ae.lastIndex = N, o = this.match(Ae, e, N)), o && o.length > l.length) {
                l = o, p = o.length, c = f, O = pe;
                break;
              }
            }
          }
      ...
      if (p !== -1) {
        if (d = O.group, d !== void 0 && (l = l !== null ? l : e.substring(N, N + p), y = O.tokenTypeIdx, h = this.createTokenInstance(l, N, y, O.tokenType, Re, he, p), this.handlePayload(h, c), d === !1 ? U = this.addToken(J, U, h) : le[d].push(h)), rt === !0 && O.canLineTerminator === !0) {
          let Z = 0, ne, ke;
          k.lastIndex = 0;
          do
            l = l !== null ? l : e.substring(N, N + p), ne = k.test(l), ne === !0 && (ke = k.lastIndex - 1, Z++);
          while (ne === !0);
          Z !== 0 ? (Re = Re + Z, he = p - ke, this.updateTokenEndLineColumnLocation(h, d, ke, Z, Re, he, p)) : he = this.computeNewColumn(he, p);
        } else
          he = this.computeNewColumn(he, p);
        N = N + p, this.handleModes(O, L, x, h);
      } else {
        let Z = N, ne = Re, ke = he, pe = z === !1;
        for (; pe === !1 && N < b; )
          for (N++, a = 0; a < S; a++) {
            let Ae = v[a], qe = Ae.pattern, Oe = Ae.short;
            if (Oe !== !1 ? _.charCodeAt(N) === Oe && (pe = !0) : Ae.isCustom === !0 ? pe = qe.exec(_, N, J, le) !== null : (qe.lastIndex = N, pe = qe.exec(e) !== null), pe === !0)
              break;
          }
        if ($ = N - Z, he = this.computeNewColumn(he, $), C = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(_, Z, $, ne, ke, Ln(R)), me.push({
          offset: Z,
          line: ne,
          column: ke,
          length: $,
    ...
    return this.hasCustom || (J.length = U), {
      tokens: J,
      groups: le,
      errors: me
    };
...
ot.SKIPPED = "This marks a skipped Token pattern, this means each token identified by it will be consumed and then thrown into oblivion, this can be used to for example to completely ignore whitespace.";
ot.NA = /NOT_APPLICABLE/;
function In(t) {
...
s(gy, "hasTokenLabel");
var oM = "parent", cv = "categories", fv = "label", pv = "group", dv = "push_mode", mv = "pop_mode", hv = "longer_alt", yv = "line_breaks", gv = "start_chars_hint";
function Ua(t) {
  return Pb(t);
}
s(Ua, "createToken");
function Pb(t) {
  let e = t.pattern, r = {};
  if (r.name = t.name, Er(e) || (r.PATTERN = e), B(t, oM))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return B(t, cv) && (r.CATEGORIES = t[cv]), No([r]), B(t, fv) && (r.LABEL = t[fv]), B(t, pv) && (r.GROUP = t[pv]), B(t, mv) && (r.POP_MODE = t[mv]), B(t, dv) && (r.PUSH_MODE = t[dv]), B(t, hv) && (r.LONGER_ALT = t[hv]), B(t, yv) && (r.LINE_BREAKS = t[yv]), B(t, gv) && (r.START_CHARS_HINT = t[gv]), r;
}
s(Pb, "createTokenInternal");
var Kr = Ua({ name: "EOF", pattern: ot.NA });
No([Kr]);
function vu(t, e, r, n, a, i, o, u) {
  return {
    image: e,
    startOffset: r,
    endOffset: n,
...
var Fa = {
  buildMismatchTokenMessage({ expected: t, actual: e, previous: r, ruleName: n }) {
    return `Expecting ${gy(t) ? `--> ${In(t)} <--` : `token of type --> ${t.name} <--`} but found --> '${e.image}' <--`;
  },
  ...
  buildNoViableAltMessage({ expectedPathsPerAlt: t, actual: e, previous: r, customUserDescription: n, ruleName: a }) {
    let i = "Expecting: ", u = `
but found: '` + Kt(e).image + "'";
    if (n)
      return i + n + u;
    {
      let l = Ct(t, (d, y) => d.concat(y), []), c = j(l, (d) => `[${j(d, (y) => In(y)).join(", ")}]`), p = `one of these possible Token sequences:
${j(c, (d, y) => `  ${y + 1}. ${d}`).join(`
`)}`;
      return i + p + u;
    }
...
inside top level rule: ->` + t.name + "<-";
  ...
  buildDuplicateFoundError(t, e) {
    function r(f) {
      return f instanceof _e ? f.terminalType.name : f instanceof ut ? f.nonTerminalName : "";
    }
    s(r, "getExtraProductionArgument");
    let n = t.name, a = Kt(e), i = a.idx, o = xt(a), u = r(a), l = i > 0, c = `->${o}${l ? i : ""}<- ${u ? `with argument: ->${u}<-` : ""}
...
and Non-Terminal names start with a lower case letter.`;
  ...
  buildAlternationPrefixAmbiguityError(t) {
    let e = j(t.prefixPath, (a) => In(a)).join(", "), r = t.alternation.idx === 0 ? "" : t.alternation.idx;
...
For Further details.`;
  ...
  buildAlternationAmbiguityError(t) {
    let e = t.alternation.idx === 0 ? "" : t.alternation.idx, r = t.prefixPath.length === 0, n = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(" ,")}> in <OR${e}> inside <${t.topLevelRule.name}> Rule,
`;
    if (r)
...
`;
      ...
      let a = j(t.prefixPath, (i) => In(i)).join(", ");
...
<OR${t.alternation.idx}> inside <${t.topLevelRule.name}> Rule.
 has ${t.alternation.definition.length + 1} alternatives.`;
  ...
  buildLeftRecursionError(t) {
    let e = t.topLevelRule.name, r = j(t.leftRecursionPath, (i) => i.name), n = `${e} --> ${r.concat([e]).join(" --> ")}`;
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
  ...
  buildDuplicateRuleNameError(t) {
    let e;
    return t.topLevelRule instanceof _o ? e = t.topLevelRule.name : e = t.topLevelRule, `Duplicate definition, rule: ->${e}<- is already defined in the grammar: ->${t.grammarName}<-`;
  }
};
function kb(t, e) {
  let r = new uM(t, e);
...
var di, uM = (di = class extends So {
  ...
  visitNonTerminal(e) {
    ...
    if (r)
      ...
      let n = this.errMsgProvider.buildRuleNotFoundError(this.currTopLevel, e);
      this.errors.push({
        message: n,
...
}, s(di, "GastRefResolverVisitor"), di), mi, cM = (mi = class extends Of {
  constructor(e, r) {
...
}, s(mi, "AbstractNextPossibleTokensWalker"), mi), hi, fM = (hi = class extends cM {
  constructor(e, r) {
  ...
  walkTerminal(e, r, n) {
    if (this.isAtEndOfPath && e.terminalType.name === this.nextTerminalName && e.idx === this.nextTerminalOccurrence && !this.found) {
      let a = r.concat(n), i = new gt({ definition: a });
      this.possibleTokTypes = wo(i), this.found = !0;
    }
  }
}, s(hi, "NextAfterTokenWalker"), hi), yi, Df = (yi = class extends Of {
  constructor(e, r) {
...
}, s(yi, "AbstractNextTerminalAfterProductionWalker"), yi), gi, pM = (gi = class extends Df {
  walkMany(e, r, n) {
    if (e.idx === this.occurrence) {
      let a = Kt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof _e && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
    } else
      super.walkMany(e, r, n);
  }
}, s(gi, "NextTerminalAfterManyWalker"), gi), vi, vv = (vi = class extends Df {
  walkManySep(e, r, n) {
    if (e.idx === this.occurrence) {
      let a = Kt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof _e && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
...
}, s(vi, "NextTerminalAfterManySepWalker"), vi), Ti, dM = (Ti = class extends Df {
  walkAtLeastOne(e, r, n) {
    if (e.idx === this.occurrence) {
      let a = Kt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof _e && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
...
}, s(Ti, "NextTerminalAfterAtLeastOneWalker"), Ti), $i, Tv = ($i = class extends Df {
  walkAtLeastOneSep(e, r, n) {
    if (e.idx === this.occurrence) {
      let a = Kt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof _e && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
...
}, s($i, "NextTerminalAfterAtLeastOneSepWalker"), $i);
function Mc(t, e, r = []) {
  r = tt(r);
  let n = [], a = 0;
  function i(u) {
    return u.concat(Qe(t, a + 1));
  }
  ...
  for (s(o, "getAlternativesForProd"); r.length < e && a < t.length; ) {
    ...
    if (u instanceof et)
      ...
      let l = [
        new gt({ definition: u.definition }),
        new De({
          definition: [new _e({ terminalType: u.separator })].concat(u.definition)
        })
      ];
      return o(l);
      ...
      if (u instanceof Tt)
        return W(u.definition, (l) => {
          $e(l.definition) === !1 && (n = o(l.definition));
        }), n;
      if (u instanceof _e)
...
s(Mc, "possiblePathsFrom");
function Ty(t, e, r, n) {
  let a = "EXIT_NONE_TERMINAL", i = [a], o = "EXIT_ALTERNATIVE", u = !1, l = e.length, c = l - n - 1, f = [], p = [];
  for (p.push({
    idx: -1,
    def: t,
    ruleStack: [],
    ...
    let y = d.def, h = d.idx, $ = d.ruleStack, C = d.occurrenceStack;
    if ($e(y))
      continue;
    let T = y[0];
    if (T === a) {
      ...
      let N = {
        idx: h,
        def: T.definition.concat(i, Qe(y)),
        ruleStack: _,
        occurrenceStack: b
      };
      p.push(N);
      ...
      let _ = new De({
        ...
        idx: T.idx
      }), b = T.definition.concat([_], Qe(y)), N = {
        idx: h,
        def: b,
        ruleStack: $,
        occurrenceStack: C
      ...
      let _ = new _e({
        ...
        definition: [_].concat(T.definition),
        idx: T.idx
      }), N = T.definition.concat([b], Qe(y)), U = {
        idx: h,
        def: N,
        ruleStack: $,
        occurrenceStack: C
      ...
      let b = new _e({
        ...
        definition: [b].concat(T.definition),
        idx: T.idx
      }), U = T.definition.concat([N], Qe(y)), re = {
        idx: h,
        def: U,
        ruleStack: $,
        occurrenceStack: C
      ...
      for (let _ = T.definition.length - 1; _ >= 0; _--) {
        let b = T.definition[_], N = {
          idx: h,
          def: b.definition.concat(Qe(y)),
          ruleStack: $,
          occurrenceStack: C
        };
        p.push(N), p.push(o);
...
function xf(t) {
  if (t instanceof et || t === "Option")
    return Ne.OPTION;
  if (t instanceof De || t === "Repetition")
    return Ne.REPETITION;
  if (t instanceof bt || t === "RepetitionMandatory")
    return Ne.REPETITION_MANDATORY;
  if (t instanceof _t || t === "RepetitionMandatoryWithSeparator")
    return Ne.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (t instanceof vt || t === "RepetitionWithSeparator")
    return Ne.REPETITION_WITH_SEPARATOR;
  if (t instanceof Tt || t === "Alternation")
    return Ne.ALTERNATION;
  throw Error("non exhaustive match");
}
s(xf, "getProdType");
function Zd(t) {
  let { occurrence: e, rule: r, prodType: n, maxLookahead: a } = t, i = xf(n);
  return i === Ne.ALTERNATION ? Tu(e, r, a) : $u(e, r, i, a);
}
s(Zd, "getLookaheadPaths");
function Lb(t, e, r, n, a, i) {
  let o = Tu(t, e, r), u = Ry(o) ? Wl : Io;
  return i(o, n, u, a);
}
s(Lb, "buildLookaheadFuncForOr");
function Db(t, e, r, n, a, i) {
  let o = $u(t, e, a, r), u = Ry(o) ? Wl : Io;
  return i(o[0], u, n);
}
s(Db, "buildLookaheadFuncForOptionalProd");
function xb(t, e, r, n) {
  let a = t.length, i = jt(t, (o) => jt(o, (u) => u.length === 1));
  if (e)
    return function(o) {
      let u = j(o, (l) => l.GATE);
      for (let l = 0; l < a; l++) {
        let c = t[l], f = c.length, p = u[l];
        if (!(p !== void 0 && p.call(this) === !1))
          e: for (let d = 0; d < f; d++) {
            let y = c[d], h = y.length;
            for (let $ = 0; $ < h; $++) {
              let C = this.LA($ + 1);
              if (r(C, y[$]) === !1)
                continue e;
  ...
  if (i && !n) {
    let o = j(t, (l) => zt(l)), u = Ct(o, (l, c, f) => (W(c, (p) => {
      B(l, p.tokenTypeIdx) || (l[p.tokenTypeIdx] = f), W(p.categoryMatches, (d) => {
        B(l, d) || (l[d] = f);
      });
    }), l), {});
    return function() {
    ...
    return function() {
      for (let o = 0; o < a; o++) {
        let u = t[o], l = u.length;
        e: for (let c = 0; c < l; c++) {
          let f = u[c], p = f.length;
          for (let d = 0; d < p; d++) {
            let y = this.LA(d + 1);
            if (r(y, f[d]) === !1)
              continue e;
...
s(xb, "buildAlternativesLookAheadFunc");
function Mb(t, e, r) {
  let n = jt(t, (i) => i.length === 1), a = t.length;
  if (n && !r) {
    let i = zt(t);
    if (i.length === 1 && $e(i[0].categoryMatches)) {
      let u = i[0].tokenTypeIdx;
      return function() {
        return this.LA(1).tokenTypeIdx === u;
      };
    } else {
      let o = Ct(i, (u, l, c) => (u[l.tokenTypeIdx] = !0, W(l.categoryMatches, (f) => {
        u[f] = !0;
      }), u), []);
      return function() {
        let u = this.LA(1);
...
s(Mb, "buildSingleAlternativeLookaheadFunction");
var Ri, mM = (Ri = class extends Of {
  constructor(e, r, n) {
  ...
  walkOption(e, r, n) {
    this.checkIsTarget(e, Ne.OPTION, r, n) || super.walkOption(e, r, n);
  }
  walkAtLeastOne(e, r, n) {
    this.checkIsTarget(e, Ne.REPETITION_MANDATORY, r, n) || super.walkOption(e, r, n);
  }
  walkAtLeastOneSep(e, r, n) {
    this.checkIsTarget(e, Ne.REPETITION_MANDATORY_WITH_SEPARATOR, r, n) || super.walkOption(e, r, n);
  }
  walkMany(e, r, n) {
    this.checkIsTarget(e, Ne.REPETITION, r, n) || super.walkOption(e, r, n);
  }
  walkManySep(e, r, n) {
    this.checkIsTarget(e, Ne.REPETITION_WITH_SEPARATOR, r, n) || super.walkOption(e, r, n);
  }
}, s(Ri, "RestDefinitionFinderWalker"), Ri), Ai, Gb = (Ai = class extends So {
  constructor(e, r, n) {
  ...
  visitOption(e) {
    this.checkIsTarget(e, Ne.OPTION);
  }
  visitRepetition(e) {
    this.checkIsTarget(e, Ne.REPETITION);
  }
  visitRepetitionMandatory(e) {
    this.checkIsTarget(e, Ne.REPETITION_MANDATORY);
  }
  visitRepetitionMandatoryWithSeparator(e) {
    this.checkIsTarget(e, Ne.REPETITION_MANDATORY_WITH_SEPARATOR);
  }
  visitRepetitionWithSeparator(e) {
    this.checkIsTarget(e, Ne.REPETITION_WITH_SEPARATOR);
  }
  visitAlternation(e) {
    this.checkIsTarget(e, Ne.ALTERNATION);
  }
}, s(Ai, "InsideDefinitionFinderVisitor"), Ai);
function Qd(t) {
  let e = new Array(t);
  for (let r = 0; r < t; r++)
    e[r] = [];
...
s(Fb, "isUniquePrefixHash");
function $y(t, e) {
  let r = j(t, (o) => Mc([o], 1)), n = Qd(r.length), a = j(r, (o) => {
    let u = {};
    return W(o, (l) => {
      let c = Qu(l.partialPath);
      W(c, (f) => {
        u[f] = !0;
      });
    }), u;
  ...
  for (let o = 1; o <= e; o++) {
    ...
    for (let l = 0; l < u.length; l++) {
      ...
      for (let f = 0; f < c.length; f++) {
        let p = c[f].partialPath, d = c[f].suffixDef, y = Qu(p);
        if (Fb(a, y, l) || $e(d) || p.length === e) {
          let $ = n[l];
          if (Gc($, p) === !1) {
            $.push(p);
...
s($y, "lookAheadSequenceFromAlternatives");
function Tu(t, e, r, n) {
  let a = new Gb(t, Ne.ALTERNATION, n);
  return e.accept(a), $y(a.result, r);
}
s(Tu, "getLookaheadPathsForOr");
function $u(t, e, r, n) {
  let a = new Gb(t, r);
  e.accept(a);
  let i = a.result, u = new mM(e, t, r).startWalking(), l = new gt({ definition: i }), c = new gt({ definition: u });
  return $y([l, c], n);
}
s($u, "getLookaheadPathsForOptionalProd");
function Gc(t, e) {
...
s(Gc, "containsPath");
function zb(t, e) {
  return t.length < e.length && jt(t, (r, n) => {
    let a = e[n];
    return r === a || a.categoryMatchesMap[r.tokenTypeIdx];
  });
}
s(zb, "isStrictPrefixOfPath");
function Ry(t) {
  return jt(t, (e) => jt(e, (r) => jt(r, (n) => $e(n.categoryMatches))));
}
s(Ry, "areTokenCategoriesNotUsed");
function jb(t) {
  ...
  return j(e, (r) => Object.assign({ type: ct.CUSTOM_LOOKAHEAD_VALIDATION }, r));
}
s(jb, "validateLookahead");
function Ub(t, e, r, n) {
  let a = Nt(t, (l) => Kb(l, r)), i = Qb(t, e, r), o = Nt(t, (l) => Yb(l, r)), u = Nt(t, (l) => qb(l, t, n, r));
  return a.concat(i, o, u);
}
s(Ub, "validateGrammar");
function Kb(t, e) {
  let r = new hM();
  t.accept(r);
  let n = r.allProductions, a = Ix(n, Bb), i = Bt(a, (u) => u.length > 1);
  return j(Ke(i), (u) => {
    let l = Kt(u), c = e.buildDuplicateFoundError(t, u), f = xt(l), p = {
      message: c,
...
s(Kb, "validateDuplicateProductions");
function Bb(t) {
  return `${xt(t)}_#_${t.idx}_#_${Ay(t)}`;
}
s(Bb, "identifyProductionForDuplicates");
function Ay(t) {
  return t instanceof _e ? t.terminalType.name : t instanceof ut ? t.nonTerminalName : "";
}
s(Ay, "getExtraProductionArgument");
var Ei, hM = (Ei = class extends So {
  constructor() {
...
}, s(Ei, "OccurrenceValidationCollector"), Ei);
function qb(t, e, r, n) {
  let a = [];
  if (Ct(e, (o, u) => u.name === t.name ? o + 1 : o, 0) > 1) {
...
s(qb, "validateRuleDoesNotAlreadyExist");
function Wb(t, e, r) {
  let n = [], a;
  return pt(e, t) || (a = `Invalid rule override, rule: ->${t}<- cannot be overridden in the grammar: ->${r}<-as it is not defined in any of the super grammars `, n.push({
    message: a,
    type: ct.INVALID_RULE_OVERRIDE,
    ruleName: t
  })), n;
}
s(Wb, "validateRuleIsOverridden");
function Ey(t, e, r, n = []) {
  let a = [], i = Ll(e.definition);
  if ($e(i))
    return [];
  {
    let o = t.name;
    ...
    let l = Pf(i, n.concat([t])), c = Nt(l, (f) => {
      let p = tt(n);
      return p.push(f), Ey(t, f, r, p);
    });
    return a.concat(c);
  }
}
s(Ey, "validateNoLeftRecursion");
function Ll(t) {
  let e = [];
  if ($e(t))
    return e;
  ...
  else if (r instanceof gt || r instanceof et || r instanceof bt || r instanceof _t || r instanceof vt || r instanceof De)
    e = e.concat(Ll(r.definition));
  else if (r instanceof Tt)
    e = zt(j(r.definition, (i) => Ll(i.definition)));
  else if (!(r instanceof _e))
    throw Error("non exhaustive match");
  let n = ql(r), a = t.length > 1;
  if (n && a) {
    let i = Qe(t);
    return e.concat(Ll(i));
  } else
    return e;
}
s(Ll, "getFirstNoneTerminal");
var Ci, Cy = (Ci = class extends So {
  constructor() {
...
s(Vb, "validateEmptyOrAlternative");
function Hb(t, e, r) {
  let n = new Cy();
  t.accept(n);
  let a = n.alternations;
  return a = kf(a, (o) => o.ignoreAmbiguities === !0), Nt(a, (o) => {
    let u = o.idx, l = o.maxLookahead || e, c = Tu(u, t, l, o), f = Jb(c, o, t, r), p = Zb(c, o, t, r);
    return f.concat(p);
  });
}
s(Hb, "validateAmbiguousAlternationAlternatives");
var bi, yM = (bi = class extends So {
  constructor() {
    super(...arguments), this.allProductions = [];
  }
  visitRepetitionWithSeparator(e) {
...
}, s(bi, "RepetitionCollector"), bi);
function Yb(t, e) {
  let r = new Cy();
  t.accept(r);
  let n = r.alternations;
  return Nt(n, (i) => i.definition.length > 255 ? [
    {
...
s(Yb, "validateTooManyAlts");
function Xb(t, e, r) {
  let n = [];
  return W(t, (a) => {
    let i = new yM();
    a.accept(i);
    let o = i.allProductions;
    W(o, (u) => {
      let l = xf(u), c = u.maxLookahead || e, f = u.idx, d = $u(f, a, l, c)[0];
      if ($e(zt(d))) {
        let y = r.buildEmptyRepetitionError({
          topLevelRule: a,
          repetition: u
        });
        n.push({
...
s(Xb, "validateSomeNonEmptyLookaheadPath");
function Jb(t, e, r, n) {
  let a = [], i = Ct(t, (u, l, c) => (e.definition[c].ignoreAmbiguities === !0 || W(l, (f) => {
    let p = [c];
    W(t, (d, y) => {
      c !== y && Gc(d, f) && // ignore (skip) ambiguities with this "other" alternative
      e.definition[y].ignoreAmbiguities !== !0 && p.push(y);
    }), p.length > 1 && !Gc(a, f) && (a.push(f), u.push({
      alts: p,
      path: f
    }));
  }), u), []);
  return j(i, (u) => {
    let l = j(u.alts, (f) => f + 1);
    return {
...
s(Jb, "checkAlternativesAmbiguities");
function Zb(t, e, r, n) {
  let a = Ct(t, (o, u, l) => {
    let c = j(u, (f) => ({ idx: l, path: f }));
    return o.concat(c);
  }, []);
  return yu(Nt(a, (o) => {
    if (e.definition[o.idx].ignoreAmbiguities === !0)
      return [];
    let l = o.idx, c = o.path, f = Lt(a, (d) => (
    ...
    return j(f, (d) => {
      let y = [d.idx + 1, l + 1], h = e.idx === 0 ? "" : e.idx;
      return {
...
s(Zb, "checkPrefixAlternativesAmbiguities");
function Qb(t, e, r) {
  let n = [], a = j(e, (i) => i.name);
  return W(t, (i) => {
    let o = i.name;
    if (pt(a, o)) {
      let u = r.buildNamespaceConflictError(i);
      n.push({
        message: u,
...
s(Qb, "checkTerminalAndNoneTerminalsNameSpace");
function e_(t) {
  let e = oy(t, {
    errMsgProvider: lM
  }), r = {};
  return W(t.rules, (n) => {
    r[n.name] = n;
  }), kb(r, e.errMsgProvider);
}
s(e_, "resolveGrammar");
function t_(t) {
  return t = oy(t, {
    errMsgProvider: _n
  }), Ub(t.rules, t.tokenTypes, t.errMsgProvider, t.grammarName);
}
s(t_, "validateGrammar");
var r_ = "MismatchedTokenException", n_ = "NoViableAltException", a_ = "EarlyExitException", i_ = "NotAllInputParsedException", s_ = [
  r_,
  n_,
  a_,
  i_
...
s(Vl, "isRecognitionException");
var _i, Mf = (_i = class extends Error {
  constructor(e, r) {
...
}, s(_i, "RecognitionException"), _i), Si, o_ = (Si = class extends Mf {
  constructor(e, r, n) {
    super(e, r), this.previousToken = n, this.name = r_;
  }
}, s(Si, "MismatchedTokenException"), Si), wi, gM = (wi = class extends Mf {
  constructor(e, r, n) {
    super(e, r), this.previousToken = n, this.name = n_;
  }
}, s(wi, "NoViableAltException"), wi), Ii, vM = (Ii = class extends Mf {
  constructor(e, r) {
    super(e, r), this.name = i_;
  }
}, s(Ii, "NotAllInputParsedException"), Ii), Ni, TM = (Ni = class extends Mf {
  constructor(e, r, n) {
    super(e, r), this.previousToken = n, this.name = a_;
  }
}, s(Ni, "EarlyExitException"), Ni), mp = {}, l_ = "InRuleRecoveryException", Pi, $M = (Pi = class extends Error {
  constructor(e) {
    super(e), this.name = l_;
  }
}, s(Pi, "InRuleRecoveryException"), Pi), ki, RM = (ki = class {
  initRecoverable(e) {
    this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = B(e, "recoveryEnabled") ? e.recoveryEnabled : br.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = u_);
  }
  getTokenToInsert(e) {
    let r = vu(e, "", NaN, NaN, NaN, NaN, NaN, NaN);
  ...
  tryInRepetitionRecovery(e, r, n, a) {
    let i = this.findReSyncTokenType(), o = this.exportLexerState(), u = [], l = !1, c = this.LA(1), f = this.LA(1), p = /* @__PURE__ */ s(() => {
      let d = this.LA(0), y = this.errorMessageProvider.buildMismatchTokenMessage({
        expected: a,
        actual: c,
        previous: d,
        ruleName: this.getCurrRuleFullName()
      }), h = new o_(y, c, this.LA(0));
      h.resyncedTokens = Bl(u), this.SAVE_ERROR(h);
  ...
  canRecoverWithSingleTokenInsertion(e, r) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || $e(r))
      return !1;
    let n = this.LA(1);
    return $o(r, (i) => this.tokenMatcher(n, i)) !== void 0;
  }
  canRecoverWithSingleTokenDeletion(e) {
    return this.canTokenTypeBeDeletedInRecovery(e) ? this.tokenMatcher(this.LA(2), e) : !1;
  }
  isInCurrentRuleReSyncSet(e) {
    let r = this.getCurrFollowKey(), n = this.getFollowSetFromFollowKey(r);
    return pt(n, e);
  }
  findReSyncTokenType() {
    let e = this.flattenFollowSet(), r = this.LA(1), n = 2;
    for (; ; ) {
      let a = $o(e, (i) => vy(r, i));
      if (a !== void 0)
        return a;
  ...
  getCurrFollowKey() {
    if (this.RULE_STACK.length === 1)
      return mp;
    let e = this.getLastExplicitRuleShortName(), r = this.getLastExplicitRuleOccurrenceIndex(), n = this.getPreviousExplicitRuleShortName();
    return {
  ...
  buildFullFollowKeyStack() {
    let e = this.RULE_STACK, r = this.RULE_OCCURRENCE_STACK;
    return j(e, (n, a) => a === 0 ? mp : {
  ...
  flattenFollowSet() {
    let e = j(this.buildFullFollowKeyStack(), (r) => this.getFollowSetFromFollowKey(r));
    return zt(e);
  }
  getFollowSetFromFollowKey(e) {
    if (e === mp)
      return [Kr];
    let r = e.ruleName + e.idxInCallingRule + HC + e.inRule;
    return this.resyncFollows[r];
  }
  // It does not make any sense to include a virtual EOF token in the list of resynced tokens
  // as EOF does not really exist and thus does not contain any useful information (line/column numbers)
  addToResyncTokens(e, r) {
    return this.tokenMatcher(e, Kr) || r.push(e), r;
  }
  reSyncTo(e) {
    let r = [], n = this.LA(1);
  ...
  getCurrentGrammarPath(e, r) {
    let n = this.getHumanReadableRuleStack(), a = tt(this.RULE_OCCURRENCE_STACK);
    return {
      ruleStack: n,
      occurrenceStack: a,
      lastTok: e,
...
function u_(t, e, r, n, a, i, o) {
  let u = this.getKeyForAutomaticLookahead(n, a), l = this.firstAfterRepMap[u];
  if (l === void 0) {
    let d = this.getCurrRuleFullName(), y = this.getGAstProductions()[d];
    l = new i(y, a).startWalking(), this.firstAfterRepMap[u] = l;
  }
  let c = l.token, f = l.occurrence, p = l.isEndOfRule;
  this.RULE_STACK.length === 1 && p && c === void 0 && (c = Kr, f = 1), !(c === void 0 || f === void 0) && this.shouldInRepetitionRecoveryBeTried(c, f, o) && this.tryInRepetitionRecovery(t, e, r, c);
}
s(u_, "attemptInRepetitionRecovery");
var AM = 4, Yr = 8, EM = 8, c_ = 1 << Yr, f_ = 2 << Yr, em = 3 << Yr, tm = 4 << Yr, rm = 5 << Yr, ec = 6 << Yr;
function tc(t, e, r) {
  return r | e | t;
}
s(tc, "getKeyForAutomaticLookahead");
var hU = 32 - EM, Oi, by = (Oi = class {
  constructor(e) {
    var r;
    this.maxLookahead = (r = e?.maxLookahead) !== null && r !== void 0 ? r : br.maxLookahead;
  }
  validate(e) {
    let r = this.validateNoLeftRecursion(e.rules);
    if ($e(r)) {
      let n = this.validateEmptyOrAlternatives(e.rules), a = this.validateAmbiguousAlternationAlternatives(e.rules, this.maxLookahead), i = this.validateSomeNonEmptyLookaheadPath(e.rules, this.maxLookahead);
      return [
        ...r,
        ...n,
        ...a,
  ...
  validateNoLeftRecursion(e) {
    return Nt(e, (r) => Ey(r, r, _n));
  }
  validateEmptyOrAlternatives(e) {
    return Nt(e, (r) => Vb(r, _n));
  }
  validateAmbiguousAlternationAlternatives(e, r) {
    return Nt(e, (n) => Hb(n, r, _n));
  }
  validateSomeNonEmptyLookaheadPath(e, r) {
    return Xb(e, r, _n);
  }
  buildLookaheadForAlternation(e) {
    return Lb(e.prodOccurrence, e.rule, e.maxLookahead, e.hasPredicates, e.dynamicTokensEnabled, xb);
  }
  buildLookaheadForOptional(e) {
    return Db(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, xf(e.prodType), Mb);
  }
}, s(Oi, "LLkLookaheadStrategy"), Oi), Li, CM = (Li = class {
  initLooksAhead(e) {
    this.dynamicTokensEnabled = B(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : br.dynamicTokensEnabled, this.maxLookahead = B(e, "maxLookahead") ? e.maxLookahead : br.maxLookahead, this.lookaheadStrategy = B(e, "lookaheadStrategy") ? e.lookaheadStrategy : new by({ maxLookahead: this.maxLookahead }), this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
  }
  preComputeLookaheadFunctions(e) {
    W(e, (r) => {
      this.TRACE_INIT(`${r.name} Rule Lookahead`, () => {
        let { alternation: n, repetition: a, option: i, repetitionMandatory: o, repetitionMandatoryWithSeparator: u, repetitionWithSeparator: l } = p_(r);
        W(n, (c) => {
          let f = c.idx === 0 ? "" : c.idx;
          this.TRACE_INIT(`${xt(c)}${f}`, () => {
            let p = this.lookaheadStrategy.buildLookaheadForAlternation({
              prodOccurrence: c.idx,
              rule: r,
              maxLookahead: c.maxLookahead || this.maxLookahead,
              hasPredicates: c.hasPredicates,
              dynamicTokensEnabled: this.dynamicTokensEnabled
            }), d = tc(this.fullRuleNameToShort[r.name], c_, c.idx);
            this.setLaFuncCache(d, p);
          });
        }), W(a, (c) => {
          this.computeLookaheadFunc(r, c.idx, em, "Repetition", c.maxLookahead, xt(c));
        }), W(i, (c) => {
          this.computeLookaheadFunc(r, c.idx, f_, "Option", c.maxLookahead, xt(c));
        }), W(o, (c) => {
          this.computeLookaheadFunc(r, c.idx, tm, "RepetitionMandatory", c.maxLookahead, xt(c));
        }), W(u, (c) => {
          this.computeLookaheadFunc(r, c.idx, ec, "RepetitionMandatoryWithSeparator", c.maxLookahead, xt(c));
        }), W(l, (c) => {
          this.computeLookaheadFunc(r, c.idx, rm, "RepetitionWithSeparator", c.maxLookahead, xt(c));
        });
      });
    });
  }
  computeLookaheadFunc(e, r, n, a, i, o) {
    this.TRACE_INIT(`${o}${r === 0 ? "" : r}`, () => {
      let u = this.lookaheadStrategy.buildLookaheadForOptional({
        ...
        dynamicTokensEnabled: this.dynamicTokensEnabled,
        prodType: a
      }), l = tc(this.fullRuleNameToShort[e.name], n, r);
...
}, s(Li, "LooksAhead"), Li), Di, bM = (Di = class extends So {
  constructor() {
...
}, s(Di, "DslMethodsCollectorVisitor"), Di), _u = new bM();
function p_(t) {
  _u.reset(), t.accept(_u);
  let e = _u.dslMethods;
  return _u.reset(), e;
}
s(p_, "collectMethods");
...
s(nm, "setNodeLocationOnlyOffset");
function am(t, e) {
...
s(_y, "defineNameProp");
function h_(t, e) {
  let r = At(t), n = r.length;
  for (let a = 0; a < n; a++) {
    let i = r[a], o = t[i], u = o.length;
    for (let l = 0; l < u; l++) {
      let c = o[l];
...
s(h_, "defaultVisit");
function y_(t, e) {
  let r = /* @__PURE__ */ s(function() {
  }, "derivedConstructor");
  _y(r, t + "BaseSemantics");
  let n = {
...
s(y_, "createBaseSemanticVisitorConstructor");
function g_(t, e, r) {
  let n = /* @__PURE__ */ s(function() {
  }, "derivedConstructor");
  _y(n, t + "BaseSemanticsWithDefaults");
  let a = Object.create(r.prototype);
  return W(e, (i) => {
    a[i] = h_;
  }), n.prototype = a, n.prototype.constructor = n, n;
}
s(g_, "createBaseVisitorConstructorWithDefaults");
var im;
(function(t) {
...
s(v_, "validateVisitor");
function T_(t, e) {
  let r = Lt(e, (a) => Ir(t[a]) === !1), n = j(r, (a) => ({
    msg: `Missing visitor method: <${a}> on ${t.constructor.name} CST Visitor.`,
    type: im.MISSING_METHOD,
    methodName: a
  }));
  return yu(n);
}
s(T_, "validateMissingCstMethods");
var xi, SM = (xi = class {
  initTreeBuilder(e) {
    if (this.CST_STACK = [], this.outputCst = e.outputCst, this.nodeLocationTracking = B(e, "nodeLocationTracking") ? e.nodeLocationTracking : br.nodeLocationTracking, !this.outputCst)
      this.cstInvocationStateUpdate = Ve, this.cstFinallyStateUpdate = Ve, this.cstPostTerminal = Ve, this.cstPostNonTerminal = Ve, this.cstPostRule = Ve;
    else if (/full/i.test(this.nodeLocationTracking))
      this.recoveryEnabled ? (this.setNodeLocationFromToken = am, this.setNodeLocationFromNode = am, this.cstPostRule = Ve, this.setInitialNodeLocation = this.setInitialNodeLocationFullRecovery) : (this.setNodeLocationFromToken = Ve, this.setNodeLocationFromNode = Ve, this.cstPostRule = this.cstPostRuleFull, this.setInitialNodeLocation = this.setInitialNodeLocationFullRegular);
    else if (/onlyOffset/i.test(this.nodeLocationTracking))
      this.recoveryEnabled ? (this.setNodeLocationFromToken = nm, this.setNodeLocationFromNode = nm, this.cstPostRule = Ve, this.setInitialNodeLocation = this.setInitialNodeLocationOnlyOffsetRecovery) : (this.setNodeLocationFromToken = Ve, this.setNodeLocationFromNode = Ve, this.cstPostRule = this.cstPostRuleOnlyOffset, this.setInitialNodeLocation = this.setInitialNodeLocationOnlyOffsetRegular);
    else if (/none/i.test(this.nodeLocationTracking))
      this.setNodeLocationFromToken = Ve, this.setNodeLocationFromNode = Ve, this.cstPostRule = Ve, this.setInitialNodeLocation = Ve;
    else
  ...
  cstPostTerminal(e, r) {
    ...
    d_(n, r, e), this.setNodeLocationFromToken(n.location, r);
  }
  cstPostNonTerminal(e, r) {
    let n = this.CST_STACK[this.CST_STACK.length - 1];
    m_(n, r, e), this.setNodeLocationFromNode(n.location, e.location);
  }
  getBaseCstVisitorConstructor() {
    if (Er(this.baseCstVisitorConstructor)) {
      let e = y_(this.className, At(this.gastProductionsCache));
      return this.baseCstVisitorConstructor = e, e;
    }
    return this.baseCstVisitorConstructor;
  }
  getBaseCstVisitorConstructorWithDefaults() {
    if (Er(this.baseCstVisitorWithDefaultsConstructor)) {
      let e = g_(this.className, At(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
}, s(xi, "TreeBuilder"), xi), Mi, wM = (Mi = class {
  initLexerAdapter() {
  ...
  SKIP_TOKEN() {
    return this.currIdx <= this.tokVector.length - 2 ? (this.consumeToken(), this.LA(1)) : Fc;
  }
  // Lexer (accessing Token vector) related methods which can be overridden to implement lazy lexers
  // or lexers dependent on parser context.
  LA(e) {
    let r = this.currIdx + e;
    return r < 0 || this.tokVectorLength <= r ? Fc : this.tokVector[r];
  }
  consumeToken() {
    this.currIdx++;
  }
...
}, s(Mi, "LexerAdapter"), Mi), Gi, IM = (Gi = class {
  ACTION(e) {
    return e.call(this);
  }
  consume(e, r, n) {
  ...
  RULE(e, r, n = zc) {
    if (pt(this.definedRulesNames, e)) {
      let o = {
        message: _n.buildDuplicateRuleNameError({
          topLevelRule: e,
    ...
    let a = this.defineRule(e, r, n);
    return this[e] = a, a;
  }
  OVERRIDE_RULE(e, r, n = zc) {
    let a = Wb(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return UC(Ke(this.gastProductionsCache));
  }
}, s(Gi, "RecognizerApi"), Gi), Fi, NM = (Fi = class {
  initRecognizerEngine(e, r) {
    ...
    if (ie(e))
      this.tokensMap = Ct(e, (i, o) => (i[o.name] = o, i), {});
    else if (B(e, "modes") && jt(zt(Ke(e.modes)), Nb)) {
      let i = zt(Ke(e.modes)), o = ly(i);
      this.tokensMap = Ct(o, (u, l) => (u[l.name] = l, u), {});
    } else if (kt(e))
      this.tokensMap = tt(e);
    else
      throw new Error("<tokensDictionary> argument must be An Array of Token constructors, A dictionary of Token constructors or an IMultiModeLexerDefinition");
    this.tokensMap.EOF = Kr;
    let n = B(e, "modes") ? zt(Ke(e.modes)) : Ke(e), a = jt(n, (i) => $e(i.categoryMatches));
    this.tokenMatcher = a ? Wl : Io, No(Ke(this.tokensMap));
  }
  defineRule(e, r, n) {
    if (this.selfAnalysisDone)
      throw Error(`Grammar rule <${e}> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    let a = B(n, "resyncEnabled") ? n.resyncEnabled : zc.resyncEnabled, i = B(n, "recoveryValueFunc") ? n.recoveryValueFunc : zc.recoveryValueFunc, o = this.ruleShortNameIdx << AM + Yr;
    ...
    return this.outputCst === !0 ? u = /* @__PURE__ */ s(function(...f) {
      try {
        ...
        let p = this.CST_STACK[this.CST_STACK.length - 1];
  ...
  invokeRuleCatch(e, r, n) {
    let a = this.RULE_STACK.length === 1, i = r && !this.isBackTracking() && this.recoveryEnabled;
    if (Vl(e)) {
      let o = e;
      if (i) {
        let u = this.findReSyncTokenType();
  ...
  optionInternal(e, r) {
    let n = this.getKeyForAutomaticLookahead(f_, r);
  ...
  atLeastOneInternalLogic(e, r, n) {
    ...
    if (a.call(this) === !0) {
      ...
      throw this.raiseEarlyExitException(e, Ne.REPETITION_MANDATORY, r.ERR_MSG);
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, r], a, tm, e, dM);
  }
  atLeastOneSepFirstInternal(e, r) {
    let n = this.getKeyForAutomaticLookahead(ec, e);
  ...
  atLeastOneSepFirstInternalLogic(e, r, n) {
    ...
    if (this.getLaFuncFromCache(n).call(this) === !0) {
      a.call(this);
      let u = /* @__PURE__ */ s(() => this.tokenMatcher(this.LA(1), i), "separatorLookAheadFunc");
      ...
      throw this.raiseEarlyExitException(e, Ne.REPETITION_MANDATORY_WITH_SEPARATOR, r.ERR_MSG);
  }
  manyInternal(e, r) {
    let n = this.getKeyForAutomaticLookahead(em, e);
  ...
  manySepFirstInternal(e, r) {
    let n = this.getKeyForAutomaticLookahead(rm, e);
  ...
  orInternal(e, r) {
    let n = this.getKeyForAutomaticLookahead(c_, r), a = ie(e) ? e : e.DEF, o = this.getLaFuncFromCache(n).call(this, a);
    if (o !== void 0)
  ...
  ruleFinallyStateUpdate() {
    if (this.RULE_STACK.pop(), this.RULE_OCCURRENCE_STACK.pop(), this.cstFinallyStateUpdate(), this.RULE_STACK.length === 0 && this.isAtEndOfInput() === !1) {
      let e = this.LA(1), r = this.errorMessageProvider.buildNotAllInputParsedMessage({
        firstRedundant: e,
        ruleName: this.getCurrRuleFullName()
      });
      this.SAVE_ERROR(new vM(r, e));
    }
  }
  subruleInternal(e, r, n) {
    let a;
    try {
      let i = n !== void 0 ? n.ARGS : void 0;
  ...
  subruleInternalError(e, r, n) {
    throw Vl(e) && e.partialCstResult !== void 0 && (this.cstPostNonTerminal(e.partialCstResult, r !== void 0 && r.LABEL !== void 0 ? r.LABEL : n), delete e.partialCstResult), e;
  }
  ...
  saveRecogState() {
    let e = this.errors, r = tt(this.RULE_STACK);
    return {
      errors: e,
  ...
  isAtEndOfInput() {
    return this.tokenMatcher(this.LA(1), Kr);
  }
  reset() {
    this.resetLexerState(), this.subruleIdx = 0, this.isBackTrackingStack = [], this.errors = [], this.RULE_STACK = [], this.CST_STACK = [], this.RULE_OCCURRENCE_STACK = [];
  }
}, s(Fi, "RecognizerEngine"), Fi), zi, PM = (zi = class {
  initErrorHandler(e) {
    this._errors = [], this.errorMessageProvider = B(e, "errorMessageProvider") ? e.errorMessageProvider : br.errorMessageProvider;
  }
  SAVE_ERROR(e) {
    if (Vl(e))
      return e.context = {
        ruleStack: this.getHumanReadableRuleStack(),
        ruleOccurrenceStack: tt(this.RULE_OCCURRENCE_STACK)
  ...
  raiseEarlyExitException(e, r, n) {
    let a = this.getCurrRuleFullName(), i = this.getGAstProductions()[a], u = $u(e, i, r, this.maxLookahead)[0], l = [];
    ...
    throw this.SAVE_ERROR(new TM(c, this.LA(1), this.LA(0)));
  }
  // TODO: consider caching the error message computed information
  raiseNoAltException(e, r) {
    let n = this.getCurrRuleFullName(), a = this.getGAstProductions()[n], i = Tu(e, a, this.maxLookahead), o = [];
    for (let c = 1; c <= this.maxLookahead; c++)
      o.push(this.LA(c));
    let u = this.LA(0), l = this.errorMessageProvider.buildNoViableAltMessage({
    ...
    throw this.SAVE_ERROR(new gM(l, this.LA(1), u));
  }
}, s(zi, "ErrorHandler"), zi), ji, kM = (ji = class {
  initContentAssist() {
  }
  computeContentAssist(e, r) {
    ...
    return Ty([n], r, this.tokenMatcher, this.maxLookahead);
  }
  // TODO: should this be a member method or a utility? it does not have any state or usage of 'this'...
  // TODO: should this be more explicitly part of the public API?
  getNextPossibleTokenTypes(e) {
    let r = Kt(e.ruleStack), a = this.getGAstProductions()[r];
    return new fM(a, e).startWalking();
  }
}, s(ji, "ContentAssist"), ji), Gf = {
  description: "This Object indicates the Parser is during Recording Phase"
};
Object.freeze(Gf);
var $v = !0, Rv = Math.pow(2, Yr) - 1, $_ = Ua({ name: "RECORDING_PHASE_TOKEN", pattern: ot.NA });
No([$_]);
var R_ = vu(
  $_,
...
var OM = {
  ...
  topLevelRuleRecord(e, r) {
    try {
      let n = new _o({ definition: [], name: e });
  ...
  optionInternalRecord(e, r) {
    return Aa.call(this, et, e, r);
  }
  atLeastOneInternalRecord(e, r) {
    Aa.call(this, bt, r, e);
  }
  atLeastOneSepFirstInternalRecord(e, r) {
    Aa.call(this, _t, r, e, $v);
  }
  manyInternalRecord(e, r) {
    Aa.call(this, De, r, e);
  }
  manySepFirstInternalRecord(e, r) {
    Aa.call(this, vt, r, e, $v);
  }
  orInternalRecord(e, r) {
    return A_.call(this, e, r);
  }
  subruleInternalRecord(e, r, n) {
    if (Hl(r), !e || B(e, "ruleName") === !1) {
      let u = new Error(`<SUBRULE${sm(r)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw u.KNOWN_RECORDER_ERROR = !0, u;
    }
    let a = Ln(this.recordingProdStack), i = e.ruleName, o = new ut({
      idx: r,
      nonTerminalName: i,
      label: n?.LABEL,
    ...
    return a.definition.push(o), this.outputCst ? OM : Gf;
  }
  consumeInternalRecord(e, r, n) {
    if (Hl(r), !yy(e)) {
      let o = new Error(`<CONSUME${sm(r)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw o.KNOWN_RECORDER_ERROR = !0, o;
    }
    let a = Ln(this.recordingProdStack), i = new _e({
      idx: r,
      terminalType: e,
      label: n?.LABEL
    });
    return a.definition.push(i), R_;
  }
}, s(Ui, "GastRecorder"), Ui);
function Aa(t, e, r, n = !1) {
  Hl(r);
  let a = Ln(this.recordingProdStack), i = Ir(e) ? e : e.DEF, o = new t({ definition: [], idx: r });
  return n && (o.separator = e.SEP), B(e, "MAX_LOOKAHEAD") && (o.maxLookahead = e.MAX_LOOKAHEAD), this.recordingProdStack.push(o), i.call(this), a.definition.push(o), this.recordingProdStack.pop(), Gf;
}
s(Aa, "recordProd");
function A_(t, e) {
  Hl(e);
  let r = Ln(this.recordingProdStack), n = ie(t) === !1, a = n === !1 ? t : t.DEF, i = new Tt({
    definition: [],
    idx: e,
    ignoreAmbiguities: n && t.IGNORE_AMBIGUITIES === !0
  });
  B(t, "MAX_LOOKAHEAD") && (i.maxLookahead = t.MAX_LOOKAHEAD);
  let o = MC(a, (u) => Ir(u.GATE));
  return i.hasPredicates = o, r.definition.push(i), W(a, (u) => {
    let l = new gt({ definition: [] });
    i.definition.push(l), B(u, "IGNORE_AMBIGUITIES") ? l.ignoreAmbiguities = u.IGNORE_AMBIGUITIES : B(u, "GATE") && (l.ignoreAmbiguities = !0), this.recordingProdStack.push(l), u.ALT.call(this), this.recordingProdStack.pop();
  }), Gf;
}
s(A_, "recordOrProd");
function sm(t) {
...
function Hl(t) {
  if (t < 0 || t > Rv) {
	...
	Idx value must be a none negative value smaller than ${Rv + 1}`
    );
    throw e.KNOWN_RECORDER_ERROR = !0, e;
  }
}
s(Hl, "assertMethodIdxIsValid");
var Ki, DM = (Ki = class {
  initPerformanceTracer(e) {
    if (B(e, "traceInitPerf")) {
      let r = e.traceInitPerf, n = typeof r == "number";
      this.traceInitMaxIdent = n ? r : 1 / 0, this.traceInitPerf = n ? r > 0 : r;
    } else
      this.traceInitMaxIdent = 0, this.traceInitPerf = br.traceInitPerf;
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      this.TRACE_INIT("toFastProps", () => {
        ...
        try {
          this.enableRecording(), W(this.definedRulesNames, (a) => {
            let o = this[a].originalGrammarAction, u;
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        ...
        let a = YC(Ke(this.gastProductionsCache));
      ...
      })), !Pn.DEFER_DEFINITION_ERRORS_HANDLING && !$e(this.definitionErrors))
...
`)}`);
  ...
  constructor(e, r) {
	...
	For further details.`);
    this.skipValidations = B(r, "skipValidations") ? r.skipValidations : br.skipValidations;
  }
}, s(Pn, "Parser"), Pn);
Sy.DEFER_DEFINITION_ERRORS_HANDLING = !1;
E_(Sy, [
  RM,
  CM,
  SM,
...
var Bi, xM = (Bi = class extends Sy {
  constructor(e, r = br) {
    let n = tt(r);
    n.outputCst = !1, super(e, n);
  }
}, s(Bi, "EmbeddedActionsParser"), Bi);
function C_(t, e) {
  for (var r = -1, n = t == null ? 0 : t.length, a = Array(n); ++r < n; )
    a[r] = e(t[r], r, t);
  return a;
...
s(I_, "assocIndexOf");
var Ff = I_, GM = Array.prototype, FM = GM.splice;
function N_(t) {
  var e = this.__data__, r = Ff(e, t);
  if (r < 0)
    return !1;
  var n = e.length - 1;
  return r == n ? e.pop() : FM.call(e, r, 1), --this.size, !0;
}
s(N_, "listCacheDelete");
var zM = N_;
function P_(t) {
  var e = this.__data__, r = Ff(e, t);
  return r < 0 ? void 0 : e[r][1];
...
s(M_, "stackHas");
var VM = M_, HM = typeof global == "object" && global && global.Object === Object && global, G_ = HM, YM = typeof self == "object" && self && self.Object === Object && self, XM = G_ || YM || Function("return this")(), Nr = XM, JM = Nr.Symbol, ir = JM, F_ = Object.prototype, ZM = F_.hasOwnProperty, QM = F_.toString, Zo = ir ? ir.toStringTag : void 0;
function z_(t) {
  var e = ZM.call(t, Zo), r = t[Zo];
  try {
    t[Zo] = void 0;
    var n = !0;
  } catch {
  ...
  var a = QM.call(t);
  return n && (e ? t[Zo] = r : delete t[Zo]), a;
}
s(z_, "getRawTag");
var e1 = z_, t1 = Object.prototype, r1 = t1.toString;
function j_(t) {
  return r1.call(t);
}
s(j_, "objectToString");
var n1 = j_, a1 = "[object Null]", i1 = "[object Undefined]", Av = ir ? ir.toStringTag : void 0;
function U_(t) {
  return t == null ? t === void 0 ? i1 : a1 : Av && Av in Object(t) ? e1(t) : n1(t);
}
s(U_, "baseGetTag");
var Po = U_;
function K_(t) {
...
s(K_, "isObject");
var wy = K_, s1 = "[object AsyncFunction]", o1 = "[object Function]", l1 = "[object GeneratorFunction]", u1 = "[object Proxy]";
function B_(t) {
  if (!wy(t))
    return !1;
  var e = Po(t);
  return e == o1 || e == l1 || e == s1 || e == u1;
}
s(B_, "isFunction");
var q_ = B_, c1 = Nr["__core-js_shared__"], hp = c1, Ev = (function() {
  var t = /[^.]+$/.exec(hp && hp.keys && hp.keys.IE_PROTO || "");
  return t ? "Symbol(src)_1." + t : "";
})();
function W_(t) {
  return !!Ev && Ev in t;
...
s(W_, "isMasked");
var f1 = W_, p1 = Function.prototype, d1 = p1.toString;
function V_(t) {
  if (t != null) {
    try {
      return d1.call(t);
...
s(V_, "toSource");
var Zn = V_, m1 = /[\\^$.*+?()[\]{}|]/g, h1 = /^\[object .+?Constructor\]$/, y1 = Function.prototype, g1 = Object.prototype, v1 = y1.toString, T1 = g1.hasOwnProperty, $1 = RegExp(
  "^" + v1.call(T1).replace(m1, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function H_(t) {
  if (!wy(t) || f1(t))
    return !1;
...
function X_(t, e) {
  var r = A1(t, e);
  return R1(r) ? r : void 0;
}
s(X_, "getNative");
var ko = X_, E1 = ko(Nr, "Map"), Yl = E1, C1 = ko(Object, "create"), Xl = C1;
function J_() {
...
s(Z_, "hashDelete");
var _1 = Z_, S1 = "__lodash_hash_undefined__", w1 = Object.prototype, I1 = w1.hasOwnProperty;
function Q_(t) {
  var e = this.__data__;
  if (Xl) {
    var r = e[t];
  ...
  return I1.call(e, t) ? e[t] : void 0;
}
s(Q_, "hashGet");
var N1 = Q_, P1 = Object.prototype, k1 = P1.hasOwnProperty;
function eS(t) {
  var e = this.__data__;
  return Xl ? e[t] !== void 0 : k1.call(e, t);
}
s(eS, "hashHas");
var O1 = eS, L1 = "__lodash_hash_undefined__";
function tS(t, e) {
  var r = this.__data__;
  return this.size += this.has(t) ? 0 : 1, r[t] = Xl && e === void 0 ? L1 : e, this;
}
s(tS, "hashSet");
var D1 = tS;
function Qn(t) {
...
s(Qn, "Hash");
Qn.prototype.clear = b1;
Qn.prototype.delete = _1;
Qn.prototype.get = N1;
Qn.prototype.has = O1;
Qn.prototype.set = D1;
var Cv = Qn;
...
function aS(t, e) {
  var r = t.__data__;
  return M1(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
}
s(aS, "getMapData");
var jf = aS;
function iS(t) {
...
s(ea, "MapCache");
ea.prototype.clear = x1;
ea.prototype.delete = G1;
ea.prototype.get = F1;
ea.prototype.has = z1;
ea.prototype.set = j1;
var Uf = ea, U1 = 200;
...
var K1 = uS;
function ta(t) {
  var e = this.__data__ = new zf(t);
  this.size = e.size;
}
s(ta, "Stack");
ta.prototype.clear = BM;
ta.prototype.delete = qM;
ta.prototype.get = WM;
ta.prototype.has = VM;
ta.prototype.set = K1;
var rc = ta, B1 = "__lodash_hash_undefined__";
function cS(t) {
...
function Jl(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.__data__ = new Uf(); ++e < r; )
    this.add(t[e]);
}
s(Jl, "SetCache");
Jl.prototype.add = Jl.prototype.push = q1;
Jl.prototype.has = W1;
var pS = Jl;
function dS(t, e) {
  for (var r = -1, n = t == null ? 0 : t.length; ++r < n; )
...
function yS(t, e, r, n, a, i) {
  var o = r & H1, u = t.length, l = e.length;
  if (u != l && !(o && l > u))
    return !1;
  var c = i.get(t), f = i.get(e);
  if (c && f)
    return c == e && f == t;
  var p = -1, d = !0, y = r & Y1 ? new pS() : void 0;
  for (i.set(t, e), i.set(e, t); ++p < u; ) {
    var h = t[p], $ = e[p];
    if (n)
      var C = o ? n($, h, p, e, t, i) : n(h, $, p, t, e, i);
    ...
    if (y) {
      if (!V1(e, function(T, _) {
        if (!hS(y, _) && (h === T || a(h, T, r, n, i)))
          return y.push(_);
      })) {
        d = !1;
        break;
...
s(yS, "equalArrays");
var gS = yS, X1 = Nr.Uint8Array, bv = X1;
function vS(t) {
  var e = -1, r = Array(t.size);
  return t.forEach(function(n, a) {
    r[++e] = [a, n];
...
s(TS, "setToArray");
var Iy = TS, Z1 = 1, Q1 = 2, eG = "[object Boolean]", tG = "[object Date]", rG = "[object Error]", nG = "[object Map]", aG = "[object Number]", iG = "[object RegExp]", sG = "[object Set]", oG = "[object String]", lG = "[object Symbol]", uG = "[object ArrayBuffer]", cG = "[object DataView]", _v = ir ? ir.prototype : void 0, yp = _v ? _v.valueOf : void 0;
function $S(t, e, r, n, a, i, o) {
  switch (r) {
    case cG:
      if (t.byteLength != e.byteLength || t.byteOffset != e.byteOffset)
        return !1;
      t = t.buffer, e = e.buffer;
    case uG:
      return !(t.byteLength != e.byteLength || !i(new bv(t), new bv(e)));
    case eG:
    case tG:
    case aG:
      return w_(+t, +e);
    ...
    case sG:
      ...
      if (c)
        return c == e;
      n |= Q1, o.set(t, e);
      var f = gS(u(t), u(e), n, a, i, o);
      return o.delete(t), f;
    case lG:
      if (yp)
        return yp.call(t) == yp.call(e);
  }
  return !1;
}
s($S, "equalByTag");
...
s(RS, "arrayPush");
var AS = RS, pG = Array.isArray, ft = pG;
function ES(t, e, r) {
  var n = e(t);
  return ft(t) ? n : AS(n, r(t));
}
s(ES, "baseGetAllKeys");
var dG = ES;
function CS(t, e) {
...
s(_S, "stubArray");
var mG = _S, hG = Object.prototype, yG = hG.propertyIsEnumerable, Sv = Object.getOwnPropertySymbols, gG = Sv ? function(t) {
  return t == null ? [] : (t = Object(t), bS(Sv(t), function(e) {
    return yG.call(t, e);
  }));
} : mG, vG = gG;
function SS(t, e) {
...
s(wS, "isObjectLike");
var Ro = wS, $G = "[object Arguments]";
function IS(t) {
  return Ro(t) && Po(t) == $G;
}
s(IS, "baseIsArguments");
var wv = IS, NS = Object.prototype, RG = NS.hasOwnProperty, AG = NS.propertyIsEnumerable, EG = wv(/* @__PURE__ */ (function() {
  return arguments;
})()) ? wv : function(t) {
  return Ro(t) && RG.call(t, "callee") && !AG.call(t, "callee");
}, Kf = EG;
function PS() {
  return !1;
}
s(PS, "stubFalse");
var CG = PS, kS = typeof exports == "object" && exports && !exports.nodeType && exports, Iv = kS && typeof module == "object" && module && !module.nodeType && module, bG = Iv && Iv.exports === kS, Nv = bG ? Nr.Buffer : void 0, _G = Nv ? Nv.isBuffer : void 0, SG = _G || CG, jc = SG, wG = 9007199254740991, IG = /^(?:0|[1-9]\d*)$/;
function OS(t, e) {
  var r = typeof t;
  return e = e ?? wG, !!e && (r == "number" || r != "symbol" && IG.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
s(OS, "isIndex");
var LS = OS, NG = 9007199254740991;
function DS(t) {
  return typeof t == "number" && t > -1 && t % 1 == 0 && t <= NG;
}
s(DS, "isLength");
var Ny = DS, PG = "[object Arguments]", kG = "[object Array]", OG = "[object Boolean]", LG = "[object Date]", DG = "[object Error]", xG = "[object Function]", MG = "[object Map]", GG = "[object Number]", FG = "[object Object]", zG = "[object RegExp]", jG = "[object Set]", UG = "[object String]", KG = "[object WeakMap]", BG = "[object ArrayBuffer]", qG = "[object DataView]", WG = "[object Float32Array]", VG = "[object Float64Array]", HG = "[object Int8Array]", YG = "[object Int16Array]", XG = "[object Int32Array]", JG = "[object Uint8Array]", ZG = "[object Uint8ClampedArray]", QG = "[object Uint16Array]", eF = "[object Uint32Array]", be = {};
be[WG] = be[VG] = be[HG] = be[YG] = be[XG] = be[JG] = be[ZG] = be[QG] = be[eF] = !0;
be[PG] = be[kG] = be[BG] = be[OG] = be[qG] = be[LG] = be[DG] = be[xG] = be[MG] = be[GG] = be[FG] = be[zG] = be[jG] = be[UG] = be[KG] = !1;
function xS(t) {
  return Ro(t) && Ny(t.length) && !!be[Po(t)];
}
s(xS, "baseIsTypedArray");
var tF = xS;
function MS(t) {
  return function(e) {
    return t(e);
...
s(MS, "baseUnary");
var rF = MS, GS = typeof exports == "object" && exports && !exports.nodeType && exports, Dl = GS && typeof module == "object" && module && !module.nodeType && module, nF = Dl && Dl.exports === GS, gp = nF && G_.process, aF = (function() {
  try {
    var t = Dl && Dl.require && Dl.require("util").types;
    return t || gp && gp.binding && gp.binding("util");
  } catch {
  }
})(), Pv = aF, kv = Pv && Pv.isTypedArray, iF = kv ? rF(kv) : tF, Py = iF, sF = Object.prototype, oF = sF.hasOwnProperty;
function FS(t, e) {
  var r = ft(t), n = !r && Kf(t), a = !r && !n && jc(t), i = !r && !n && !a && Py(t), o = r || n || a || i, u = o ? TG(t.length, String) : [], l = u.length;
  for (var c in t)
    (e || oF.call(t, c)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
    (c == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
    a && (c == "offset" || c == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
    i && (c == "buffer" || c == "byteLength" || c == "byteOffset") || // Skip index properties.
    LS(c, l))) && u.push(c);
...
s(FS, "arrayLikeKeys");
var lF = FS, uF = Object.prototype;
function zS(t) {
  var e = t && t.constructor, r = typeof e == "function" && e.prototype || uF;
  return t === r;
}
s(zS, "isPrototype");
var jS = zS;
...
s(US, "overArg");
var cF = US, fF = cF(Object.keys, Object), pF = fF, dF = Object.prototype, mF = dF.hasOwnProperty;
function KS(t) {
  if (!jS(t))
    return pF(t);
  var e = [];
...
var BS = KS;
function qS(t) {
  return t != null && Ny(t.length) && !q_(t);
}
s(qS, "isArrayLike");
var Bf = qS;
function WS(t) {
  return Bf(t) ? lF(t) : BS(t);
}
s(WS, "keys");
var ky = WS;
function VS(t) {
...
s(VS, "getAllKeys");
var Ov = VS, hF = 1, yF = Object.prototype, gF = yF.hasOwnProperty;
function HS(t, e, r, n, a, i) {
  var o = r & hF, u = Ov(t), l = u.length, c = Ov(e), f = c.length;
  if (l != f && !o)
    return !1;
  for (var p = l; p--; ) {
    var d = u[p];
    if (!(o ? d in e : gF.call(e, d)))
      return !1;
  }
  var y = i.get(t), h = i.get(e);
  if (y && h)
...
s(HS, "equalObjects");
var vF = HS, TF = ko(Nr, "DataView"), lm = TF, $F = ko(Nr, "Promise"), um = $F, RF = ko(Nr, "Set"), Ka = RF, AF = ko(Nr, "WeakMap"), cm = AF, Lv = "[object Map]", EF = "[object Object]", Dv = "[object Promise]", xv = "[object Set]", Mv = "[object WeakMap]", Gv = "[object DataView]", CF = Zn(lm), bF = Zn(Yl), _F = Zn(um), SF = Zn(Ka), wF = Zn(cm), ln = Po;
(lm && ln(new lm(new ArrayBuffer(1))) != Gv || Yl && ln(new Yl()) != Lv || um && ln(um.resolve()) != Dv || Ka && ln(new Ka()) != xv || cm && ln(new cm()) != Mv) && (ln = /* @__PURE__ */ s(function(t) {
  var e = Po(t), r = e == EF ? t.constructor : void 0, n = r ? Zn(r) : "";
  if (n)
    switch (n) {
      case CF:
        return Gv;
...
var fm = ln, IF = 1, Fv = "[object Arguments]", zv = "[object Array]", Su = "[object Object]", NF = Object.prototype, jv = NF.hasOwnProperty;
function YS(t, e, r, n, a, i) {
  var o = ft(t), u = ft(e), l = o ? zv : fm(t), c = u ? zv : fm(e);
  l = l == Fv ? Su : l, c = c == Fv ? Su : c;
  var f = l == Su, p = c == Su, d = l == c;
  if (d && jc(t)) {
    if (!jc(e))
      return !1;
    o = !0, f = !1;
  ...
  if (d && !f)
    return i || (i = new rc()), o || Py(t) ? gS(t, e, r, n, a, i) : fG(t, e, l, r, n, a, i);
  if (!(r & IF)) {
    var y = f && jv.call(t, "__wrapped__"), h = p && jv.call(e, "__wrapped__");
    if (y || h) {
      var $ = y ? t.value() : t, C = h ? e.value() : e;
      return i || (i = new rc()), a($, C, r, n, i);
    }
  }
  return d ? (i || (i = new rc()), vF(t, e, r, n, a, i)) : !1;
}
s(YS, "baseIsEqualDeep");
var PF = YS;
function Oy(t, e, r, n, a) {
  return t === e ? !0 : t == null || e == null || !Ro(t) && !Ro(e) ? t !== t && e !== e : PF(t, e, r, n, Oy, a);
}
s(Oy, "baseIsEqual");
var XS = Oy, kF = 1, OF = 2;
function JS(t, e, r, n) {
  ...
  for (; ++a < i; ) {
    ...
    if (o && u[2]) {
      ...
      if (n)
        var d = n(c, f, l, t, e, p);
      if (!(d === void 0 ? XS(f, c, kF | OF, n, p) : d))
        return !1;
    }
  }
  return !0;
...
s(ZS, "isStrictComparable");
var QS = ZS;
function ew(t) {
  for (var e = ky(t), r = e.length; r--; ) {
    var n = e[r], a = t[n];
    e[r] = [n, a, QS(a)];
  }
  return e;
...
s(tw, "matchesStrictComparable");
var rw = tw;
function nw(t) {
  var e = DF(t);
  return e.length == 1 && e[0][2] ? rw(e[0][0], e[0][1]) : function(r) {
    return r === t || LF(r, t, e);
  };
}
s(nw, "baseMatches");
var xF = nw, MF = "[object Symbol]";
function aw(t) {
  return typeof t == "symbol" || Ro(t) && Po(t) == MF;
}
s(aw, "isSymbol");
var qf = aw, GF = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, FF = /^\w*$/;
function iw(t, e) {
  if (ft(t))
    return !1;
  var r = typeof t;
  return r == "number" || r == "symbol" || r == "boolean" || t == null || qf(t) ? !0 : FF.test(t) || !GF.test(t) || e != null && t in Object(e);
}
s(iw, "isKey");
var Ly = iw, zF = "Expected a function";
function Wf(t, e) {
  if (typeof t != "function" || e != null && typeof e != "function")
  ...
  return r.cache = new (Wf.Cache || Uf)(), r;
}
s(Wf, "memoize");
Wf.Cache = Uf;
var jF = Wf, UF = 500;
...
s(sw, "memoizeCapped");
var KF = sw, BF = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, qF = /\\(\\)?/g, WF = KF(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(BF, function(r, n, a, i) {
    e.push(a ? i.replace(qF, "$1") : n || r);
  }), e;
}), VF = WF, HF = 1 / 0, Uv = ir ? ir.prototype : void 0, Kv = Uv ? Uv.toString : void 0;
function Dy(t) {
  if (typeof t == "string")
    return t;
  if (ft(t))
...
var XF = ow;
function lw(t, e) {
  return ft(t) ? t : Ly(t, e) ? [t] : VF(XF(t));
}
s(lw, "castPath");
var uw = lw, JF = 1 / 0;
function cw(t) {
...
function hw(t, e, r) {
  ...
  return i || ++n != a ? i : (a = t == null ? 0 : t.length, !!a && Ny(a) && LS(o, a) && (ft(t) || Kf(t)));
}
s(hw, "hasPath");
var ez = hw;
function yw(t, e) {
  return t != null && ez(t, e, QF);
}
s(yw, "hasIn");
var tz = yw, rz = 1, nz = 2;
function gw(t, e) {
  return Ly(t) && QS(e) ? rw(Vf(t), e) : function(r) {
    var n = ZF(r, t);
    return n === void 0 && n === e ? tz(r, t) : XS(e, n, rz | nz);
  };
}
s(gw, "baseMatchesProperty");
var az = gw;
function vw(t) {
  return t;
}
...
s($w, "basePropertyDeep");
var sz = $w;
function Rw(t) {
  return Ly(t) ? iz(Vf(t)) : sz(t);
}
s(Rw, "property");
var oz = Rw;
function Aw(t) {
  return typeof t == "function" ? t : t == null ? xy : typeof t == "object" ? ft(t) ? az(t[0], t[1]) : xF(t) : oz(t);
}
s(Aw, "baseIteratee");
var Hf = Aw;
function Ew(t) {
...
s(bw, "createBaseEach");
var pz = bw, dz = pz(fz), Yf = dz;
function _w(t, e) {
  var r = -1, n = Bf(t) ? Array(t.length) : [];
  return Yf(t, function(a, i, o) {
    n[++r] = e(a, i, o);
  }), n;
}
s(_w, "baseMap");
...
s(xn, "buildATNKey");
var Br = 1, gz = 2, Nw = 4, Pw = 5, Ru = 7, vz = 8, Tz = 9, $z = 10, Rz = 11, kw = 12, qi, My = (qi = class {
  constructor(e) {
    this.target = e;
  }
  isEpsilon() {
...
}, s(qi, "AbstractTransition"), qi), Wi, Gy = (Wi = class extends My {
  constructor(e, r) {
    super(e), this.tokenType = r;
  }
}, s(Wi, "AtomTransition"), Wi), Vi, Ow = (Vi = class extends My {
  constructor(e) {
    super(e);
  }
  isEpsilon() {
...
}, s(Vi, "EpsilonTransition"), Vi), Hi, Fy = (Hi = class extends My {
  constructor(e, r, n) {
...
s(Dw, "createRuleStartAndStopATNStates");
function zy(t, e, r) {
  return r instanceof _e ? Xf(t, e, r.terminalType, r) : r instanceof ut ? qw(t, e, r) : r instanceof Tt ? zw(t, e, r) : r instanceof et ? jw(t, e, r) : r instanceof De ? xw(t, e, r) : r instanceof vt ? Mw(t, e, r) : r instanceof bt ? Gw(t, e, r) : r instanceof _t ? Fw(t, e, r) : Xr(t, e, r);
}
s(zy, "atom");
function xw(t, e, r) {
  let n = Be(t, e, r, {
...
function Mw(t, e, r) {
  ...
  Pr(t, n);
  let a = ra(t, e, n, r, Xr(t, e, r)), i = Xf(t, e, r.separator, r);
  return Uy(t, e, r, a, i);
}
s(Mw, "repetitionSep");
function Gw(t, e, r) {
...
s(Fw, "repetitionMandatorySep");
function zw(t, e, r) {
  let n = Be(t, e, r, {
    type: Br
  });
  Pr(t, n);
  let a = gr(r.definition, (o) => zy(t, e, o));
  return ra(t, e, n, r, ...a);
}
s(zw, "alternation");
function jw(t, e, r) {
...
s(jw, "option");
function Xr(t, e, r) {
  let n = yz(gr(r.definition, (a) => zy(t, e, a)), (a) => a !== void 0);
  return n.length === 1 ? n[0] : n.length === 0 ? void 0 : Bw(t, n);
}
s(Xr, "block");
function jy(t, e, r, n, a) {
  let i = n.left, o = n.right, u = Be(t, e, r, {
    type: Rz
  });
  Pr(t, u);
  let l = Be(t, e, r, {
  ...
  return i.loopback = u, l.loopback = u, t.decisionMap[xn(e, a ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", r.idx)] = u, Ge(o, u), a === void 0 ? (Ge(u, i), Ge(u, l)) : (Ge(u, l), Ge(u, a.left), Ge(a.right, i)), {
    left: i,
    right: l
  };
}
s(jy, "plus");
function Uy(t, e, r, n, a) {
  let i = n.left, o = n.right, u = Be(t, e, r, {
    type: $z
  });
  Pr(t, u);
  ...
  return u.loopback = c, l.loopback = c, Ge(u, i), Ge(u, l), Ge(o, c), a !== void 0 ? (Ge(c, l), Ge(c, a.left), Ge(a.right, i)) : Ge(c, u), t.decisionMap[xn(e, a ? "RepetitionWithSeparator" : "Repetition", r.idx)] = u, {
    left: u,
    right: l
  };
}
s(Uy, "star");
function Uw(t, e, r, n) {
  let a = n.left, i = n.right;
  return Ge(a, i), t.decisionMap[xn(e, "Option", r.idx)] = a, n;
}
s(Uw, "optional");
function Pr(t, e) {
  return t.decisionStates.push(e), e.decision = t.decisionStates.length - 1, e.decision;
}
s(Pr, "defineDecisionState");
function ra(t, e, r, n, ...a) {
  ...
  r.end = i;
  for (let u of a)
    u !== void 0 ? (Ge(r, u.left), Ge(u.right, i)) : Ge(r, i);
  let o = {
    left: r,
    right: i
  };
  return t.decisionMap[xn(e, Kw(n), n.idx)] = r, o;
}
s(ra, "makeAlts");
function Kw(t) {
  if (t instanceof Tt)
...
function Bw(t, e) {
  ...
  for (let i = 0; i < r - 1; i++) {
    ...
    let l = u instanceof Fy, c = u, f = e[i + 1].left;
    o.left.type === Br && o.right.type === Br && u !== void 0 && (l && c.followState === o.right || u.target === o.right) ? (l ? c.followState = f : u.target = f, Vw(t, o.right)) : Ge(o.right, f);
  }
  let n = e[0], a = e[r - 1];
  return {
    left: n.left,
...
s(Xf, "tokenRef");
function qw(t, e, r) {
  let n = r.referencedRule, a = t.ruleToStartState.get(n), i = Be(t, e, r, {
    type: Br
  }), o = Be(t, e, r, {
    type: Br
  }), u = new Fy(a, n, o);
...
function Ww(t, e, r) {
  ...
  Ge(n, r.left);
  let a = t.ruleToStopState.get(e);
  return Ge(r.right, a), {
    left: n,
    right: a
  };
}
s(Ww, "buildRuleHandle");
function Ge(t, e) {
  let r = new Ow(e);
  Jf(t, r);
}
...
var Ez = Yw;
function Xw(t) {
  return t && t.length ? Az(t, xy, Ez) : void 0;
}
s(Xw, "min");
var Cz = Xw, Bv = ir ? ir.isConcatSpreadable : void 0;
function Jw(t) {
  return ft(t) || Kf(t) || !!(Bv && t && t[Bv]);
}
s(Jw, "isFlattenable");
var bz = Jw;
function By(t, e, r, n, a) {
  var i = -1, o = t.length;
  for (r || (r = bz), a || (a = []); ++i < o; ) {
    var u = t[i];
    e > 0 && r(u) ? e > 1 ? By(u, e - 1, r, n, a) : AS(a, u) : n || (a[a.length] = u);
  }
  return a;
}
s(By, "baseFlatten");
...
s(iI, "arrayIncludesWith");
var kz = iI;
function sI() {
}
s(sI, "noop");
var Oz = sI, Lz = 1 / 0, Dz = Ka && 1 / Iy(new Ka([, -0]))[1] == Lz ? function(t) {
  return new Ka(t);
} : Oz, xz = Dz, Mz = 200;
function oI(t, e, r) {
  var n = -1, a = Pz, i = t.length, o = !0, u = [], l = u;
  if (r)
    o = !1, a = kz;
  else if (i >= Mz) {
    var c = e ? null : xz(t);
...
s(pI, "forEach");
var vp = pI, Kz = "[object Map]", Bz = "[object Set]", qz = Object.prototype, Wz = qz.hasOwnProperty;
function dI(t) {
  if (t == null)
    return !0;
  if (Bf(t) && (ft(t) || typeof t == "string" || typeof t.splice == "function" || jc(t) || Py(t) || Kf(t)))
    return !t.length;
  var e = fm(t);
  if (e == Kz || e == Bz)
    return !t.size;
...
var Yz = hI;
function yI(t, e, r) {
  var n = ft(t) ? Hz : Yz, a = arguments.length < 3;
  return n(t, Hf(e, 4), r, a, Yf);
}
s(yI, "reduce");
var qv = yI;
function gI(t, e) {
...
var Xi, vI = (Xi = class {
...
}, s(Xi, "PredicateSet"), Xi), Wv = new vI(), Ji, Xz = (Ji = class extends by {
  constructor(e) {
    var r;
    super(), this.logging = (r = e?.logging) !== null && r !== void 0 ? r : ((n) => console.log(n));
  }
  initialize(e) {
    this.atn = Lw(e.rules), this.dfas = TI(this.atn);
  }
  ...
  buildLookaheadForAlternation(e) {
    let { prodOccurrence: r, rule: n, hasPredicates: a, dynamicTokensEnabled: i } = e, o = this.dfas, u = this.logging, l = xn(n, "Alternation", r), f = this.atn.decisionMap[l].decision, p = gr(Zd({
      maxLookahead: 1,
      occurrence: r,
    ...
    if (dm(p, !1) && !i) {
      let d = qv(p, (y, h, $) => (vp(h, (C) => {
        C && (y[C.tokenTypeIdx] = $, vp(C.categoryMatches, (T) => {
          y[T] = $;
        }));
      }), y), {});
      return a ? function(y) {
        var h;
        let $ = this.LA(1), C = d[$.tokenTypeIdx];
        if (y !== void 0 && C !== void 0) {
          let T = (h = y[C]) === null || h === void 0 ? void 0 : h.GATE;
        ...
        let y = this.LA(1);
        return d[y.tokenTypeIdx];
      };
    } else return a ? function(d) {
      let y = new vI(), h = d === void 0 ? 0 : d.length;
      for (let C = 0; C < h; C++) {
        let T = d?.[C].GATE;
        y.set(C, T === void 0 || T.call(this));
      }
      let $ = nc.call(this, o, f, y, u);
      return typeof $ == "number" ? $ : void 0;
    } : function() {
      let d = nc.call(this, o, f, Wv, u);
      return typeof d == "number" ? d : void 0;
    };
  }
  buildLookaheadForOptional(e) {
    let { prodOccurrence: r, rule: n, prodType: a, dynamicTokensEnabled: i } = e, o = this.dfas, u = this.logging, l = xn(n, a, r), f = this.atn.decisionMap[l].decision, p = gr(Zd({
      maxLookahead: 1,
      occurrence: r,
      prodType: a,
      rule: n
    ...
    if (dm(p) && p[0][0] && !i) {
      let d = p[0], y = zz(d);
      if (y.length === 1 && Vz(y[0].categoryMatches)) {
        let $ = y[0].tokenTypeIdx;
        return function() {
          return this.LA(1).tokenTypeIdx === $;
        };
      } else {
        let h = qv(y, ($, C) => (C !== void 0 && ($[C.tokenTypeIdx] = !0, vp(C.categoryMatches, (T) => {
          $[T] = !0;
        })), $), {});
        return function() {
          let $ = this.LA(1);
          return h[$.tokenTypeIdx] === !0;
        };
      }
    }
    return function() {
...
}, s(Ji, "LLStarLookaheadStrategy"), Ji);
function dm(t, e = !0) {
  ...
  for (let n of t) {
    ...
    for (let i of n) {
      ...
      let o = [i.tokenTypeIdx].concat(i.categoryMatches);
      for (let u of o)
        if (r.has(u)) {
          if (!a.has(u))
            return !1;
...
function TI(t) {
  ...
  for (let n = 0; n < e; n++)
    r[n] = gI(t.decisionStates[n], n);
  return r;
}
s(TI, "initATNSimulator");
function nc(t, e, r, n) {
  let a = t[e](r), i = a.start;
  if (i === void 0) {
    let u = NI(a.atnStartState);
    i = Wy(a, qy(u)), a.start = i;
  }
  return $I.apply(this, [a, i, r, n]);
}
s(nc, "adaptivePredict");
function $I(t, e, r, n) {
  let a = e, i = 1, o = [], u = this.LA(i++);
  for (; ; ) {
    let l = _I(a, u);
    if (l === void 0 && (l = RI.apply(this, [t, a, u, i, r, n])), l === Uc)
      return bI(o, a, u);
...
s($I, "performLookahead");
function RI(t, e, r, n, a, i) {
  let o = SI(e.configs, r, a);
  if (o.size === 0)
    return mm(t, e, r, Uc), Uc;
  let u = qy(o), l = II(o, a);
  if (l !== void 0)
    u.isAcceptState = !0, u.prediction = l, u.configs.uniqueAlt = l;
  else if (LI(o)) {
    let c = Cz(o.alts);
    u.isAcceptState = !0, u.prediction = c, u.configs.uniqueAlt = c, AI.apply(this, [t, n, o.alts, i]);
  }
  return u = mm(t, e, r, u), u;
}
s(RI, "computeLookaheadTarget");
function AI(t, e, r, n) {
  let a = [];
  for (let c = 1; c <= e; c++)
    a.push(this.LA(c).tokenType);
  let i = t.atnStartState, o = i.rule, u = i.production, l = EI({
    topLevelRule: o,
    ambiguityIndices: r,
    production: u,
    prefixPath: a
...
s(AI, "reportLookaheadAmbiguity");
function EI(t) {
  let e = gr(t.prefixPath, (a) => In(a)).join(", "), r = t.production.idx === 0 ? "" : t.production.idx, n = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(", ")}> in <${CI(t.production)}${r}> inside <${t.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return n = n + `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`, n;
}
s(EI, "buildAmbiguityError");
function CI(t) {
  if (t instanceof ut)
    return "SUBRULE";
  if (t instanceof et)
...
s(CI, "getProductionDslName");
function bI(t, e, r) {
  let n = _z(e.configs.elements, (i) => i.state.transitions), a = Fz(n.filter((i) => i instanceof Gy).map((i) => i.tokenType), (i) => i.tokenTypeIdx);
  return {
    actualToken: r,
...
s(bI, "buildAdaptivePredictError");
function _I(t, e) {
  return t.edges[e.tokenTypeIdx];
}
s(_I, "getExistingTargetState");
function SI(t, e, r) {
  let n = new pm(), a = [];
  for (let o of t.elements) {
    ...
    let u = o.state.transitions.length;
    for (let l = 0; l < u; l++) {
      let c = o.state.transitions[l], f = wI(c, e);
      f !== void 0 && n.add({
        state: f,
        alt: o.alt,
        stack: o.stack
...
s(SI, "computeReachSet");
function wI(t, e) {
  if (t instanceof Gy && vy(e, t.tokenType))
    return t.target;
}
s(wI, "getReachableTarget");
function II(t, e) {
  let r;
...
s(qy, "newDFAState");
function mm(t, e, r, n) {
  return n = Wy(t, n), e.edges[r.tokenTypeIdx] = n, n;
}
s(mm, "addDFAEdge");
function Wy(t, e) {
  if (e === Uc)
...
s(Wy, "addDFAState");
function NI(t) {
  let e = new pm(), r = t.transitions.length;
  for (let n = 0; n < r; n++) {
    let i = {
...
function Zl(t, e) {
  ...
  for (let a = 0; a < n; a++) {
    let i = r.transitions[a], o = PI(t, i);
    o !== void 0 && Zl(o, e);
  }
}
s(Zl, "closure");
...
s(OI, "allConfigsInRuleStopStates");
function LI(t) {
  if (OI(t))
    return !0;
  let e = DI(t.elements);
...
s(LI, "hasConflictTerminatingPrediction");
function DI(t) {
  let e = /* @__PURE__ */ new Map();
  for (let r of t) {
    let n = Ky(r, !1), a = e.get(n);
    a === void 0 && (a = {}, e.set(n, a)), a[r.alt] = !0;
  }
  return e;
}
s(DI, "getConflictingAltSets");
function xI(t) {
...
s(MI, "hasStateAssociatedWithOneAlt");
tu();
var Zi, GI = (Zi = class {
  constructor() {
    this.nodeStack = [];
  ...
  buildRootNode(e) {
    return this.rootNode = new Hy(e), this.rootNode.root = this.rootNode, this.nodeStack = [this.rootNode], this.rootNode;
  }
  ...
  buildLeafNode(e, r) {
    let n = new Kc(e.startOffset, e.image.length, Fl(e), e.tokenType, !r);
  ...
  addHiddenNodes(e) {
    let r = [];
    for (let i of e) {
      let o = new Kc(i.startOffset, i.image.length, Fl(i), i.tokenType, !0);
    ...
    for (; n.container; ) {
      let i = n.container.content.indexOf(n);
      if (i > 0) {
...
}, s(Zi, "CstNodeBuilder"), Zi), Qi, Vy = (Qi = class {
  get hidden() {
    return !1;
  }
  get astNode() {
...
}, s(Qi, "AbstractCstNode"), Qi), es, Kc = (es = class extends Vy {
  get offset() {
    return this._offset;
  }
  get length() {
...
}, s(es, "LeafCstNodeImpl"), es), ts, Zf = (ts = class extends Vy {
  constructor() {
    super(...arguments), this.content = new Jz(this);
  }
  get offset() {
...
}, s(ts, "CompositeCstNodeImpl"), ts), kn, Jz = (kn = class extends Array {
  constructor(e) {
    super(), this.parent = e, Object.setPrototypeOf(this, kn.prototype);
  }
  push(...e) {
...
}, s(kn, "CstNodeContainer"), kn), rs, Hy = (rs = class extends Zf {
  get text() {
...
}, s(rs, "RootCstNodeImpl"), rs), Bc = /* @__PURE__ */ Symbol("Datatype");
function ac(t) {
  return t.$type === Bc;
}
s(ac, "isDataTypeNode");
var Vv = "\u200B", FI = /* @__PURE__ */ s((t) => t.endsWith(Vv) ? t : t + Vv, "withRuleSuffix"), ns, Yy = (ns = class {
  constructor(e) {
    this._unorderedGroups = /* @__PURE__ */ new Map(), this.allRules = /* @__PURE__ */ new Map(), this.lexer = e.parser.Lexer;
    let r = this.lexer.definition, n = e.LanguageMetaData.mode === "production";
    e.shared.profilers.LangiumProfiler?.isActive("parsing") ? this.wrapper = new Qz(r, {
      ...e.parser.ParserConfig,
      skipValidations: n,
      errorMessageProvider: e.parser.ParserErrorMessageProvider
    }, e.shared.profilers.LangiumProfiler.createTask("parsing", e.LanguageMetaData.languageId)) : this.wrapper = new KI(r, {
      ...e.parser.ParserConfig,
      skipValidations: n,
      errorMessageProvider: e.parser.ParserErrorMessageProvider
    });
...
}, s(ns, "AbstractLangiumParser"), ns), as, zI = (as = class extends Yy {
  get current() {
    return this.stack[this.stack.length - 1];
  }
  constructor(e) {
    super(e), this.nodeBuilder = new GI(), this.stack = [], this.assignmentMap = /* @__PURE__ */ new Map(), this.operatorPrecedence = /* @__PURE__ */ new Map(), this.linker = e.references.Linker, this.converter = e.parser.ValueConverter, this.astReflection = e.shared.AstReflection;
  }
  rule(e, r) {
    let n = this.computeRuleType(e), a;
    yo(e) && (a = e.name, this.registerPrecedenceMap(e));
    let i = this.wrapper.DEFINE_RULE(FI(e.name), this.startImplementation(n, a, r).bind(this));
    return this.allRules.set(e.name, i), lt(e) && e.entry && (this.mainRule = i), i;
  }
  registerPrecedenceMap(e) {
    let r = e.name, n = /* @__PURE__ */ new Map();
    for (let a = 0; a < e.operators.precedences.length; a++) {
      let i = e.operators.precedences[a];
      for (let o of i.operators)
        n.set(o.value, {
          precedence: a,
  ...
  computeRuleType(e) {
    return yo(e) ? On(e) : e.fragment ? void 0 : iu(e) ? Bc : On(e);
  }
  parse(e, r = {}) {
    this.nodeBuilder.buildRootNode(e);
    let n = this.lexerResult = this.lexer.tokenize(e);
    this.wrapper.input = n.tokens;
    let a = r.rule ? this.allRules.get(r.rule) : this.mainRule;
    if (!a)
      throw new Error(r.rule ? `No rule found with name '${r.rule}'` : "No main rule available.");
    let i = this.doParse(a);
    return this.nodeBuilder.addHiddenNodes(n.hidden), this.unorderedGroups.clear(), this.lexerResult = void 0, mo(i, { deep: !0 }), {
      value: i,
  ...
  startImplementation(e, r, n) {
    return (a) => {
      ...
      if (i) {
        let o = { $type: e };
        this.stack.push(o), e === Bc ? o.value = "" : r !== void 0 && (o.$infixName = r);
      }
  ...
  consume(e, r, n) {
    let a = this.wrapper.wrapConsume(e, r);
    if (!this.isRecording() && this.isValidToken(a)) {
      let i = this.extractHiddenTokens(a);
      this.nodeBuilder.addHiddenNodes(i);
      let o = this.nodeBuilder.buildLeafNode(a, n), { assignment: u, crossRef: l } = this.getAssignment(n), c = this.current;
      if (u) {
        let f = $r(n) ? a.image : this.converter.convert(a.image, o);
        this.assign(u.operator, u.feature, f, o, l);
      } else if (ac(c)) {
        let f = a.image;
        $r(n) || (f = this.converter.convert(f, o).toString()), c.value += f;
      }
    }
  }
  /**
  ...
  performSubruleAssignment(e, r, n) {
    let { assignment: a, crossRef: i } = this.getAssignment(r);
    if (a)
      ...
      if (ac(o))
        ...
        let l = this.assignWithoutOverride(e, o);
  ...
  construct() {
    ...
    return this.nodeBuilder.construct(e), "$infixName" in e ? this.constructInfix(e, this.operatorPrecedence.get(e.$infixName)) : ac(e) ? this.converter.convert(e.value, e.$cstNode) : (Vm(this.astReflection, e), e);
  }
  constructInfix(e, r) {
    let n = e.parts;
    ...
    for (let $ = 0; $ < a.length; $++) {
      ...
      T.precedence > o ? (o = T.precedence, i = $) : T.precedence === o && (T.rightAssoc || (i = $));
    }
    let u = a.slice(0, i), l = a.slice(i + 1), c = n.slice(0, i + 1), f = n.slice(i + 1), p = {
      ...
      parts: f,
      operators: l
    }, y = this.constructInfix(p, r), h = this.constructInfix(d, r);
    return {
      $type: e.$type,
      $cstNode: e.$cstNode,
      left: y,
  ...
  getAssignment(e) {
    if (!this.assignmentMap.has(e)) {
      ...
      this.assignmentMap.set(e, {
        assignment: r,
        crossRef: r && jn(r.terminal) ? r.terminal.isMulti ? "multi" : "single" : void 0
      });
    }
    return this.assignmentMap.get(e);
  }
  assign(e, r, n, a, i) {
    let o = this.current, u;
...
}, s(as, "LangiumParser"), as), is, jI = (is = class {
  buildMismatchTokenMessage(e) {
    return Fa.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return Fa.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return Fa.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return Fa.buildEarlyExitMessage(e);
  }
}, s(is, "AbstractParserErrorMessageProvider"), is), ss, Xy = (ss = class extends jI {
...
}, s(ss, "LangiumParserErrorMessageProvider"), ss), os, UI = (os = class extends Yy {
  constructor() {
  ...
  parse(e) {
    this.resetState();
    let r = this.lexer.tokenize(e, { mode: "partial" });
  ...
  rule(e, r) {
    let n = this.wrapper.DEFINE_RULE(FI(e.name), this.startImplementation(r).bind(this));
...
}, s(os, "LangiumCompletionParser"), os), Zz = {
  recoveryEnabled: !0,
  nodeLocationTracking: "full",
  skipValidations: !0,
  errorMessageProvider: new Xy()
}, ls, KI = (ls = class extends xM {
  constructor(e, r) {
    let n = r && "maxLookahead" in r;
    super(e, {
      ...Zz,
      lookaheadStrategy: n ? new by({ maxLookahead: r.maxLookahead }) : new Xz({
...
}, s(ls, "ChevrotainWrapper"), ls), us, Qz = (us = class extends KI {
  constructor(e, r, n) {
...
s(Qf, "createParser");
function BI(t, e) {
  let r = mf(e, !1), n = fe(e.rules).filter(lt).filter((i) => r.has(i));
  for (let i of n) {
    let o = {
      ...t,
      consume: 1,
    ...
    t.parser.rule(i, qr(o, i.definition));
  }
  let a = fe(e.rules).filter(yo).filter((i) => r.has(i));
  for (let i of a)
    t.parser.rule(i, qI(t, i));
}
s(BI, "buildRules");
function qI(t, e) {
  let r = e.call.rule.ref;
  if (!r)
  ...
  let n = e.operators.precedences.flatMap((y) => y.operators), a = {
    $type: "Group",
    elements: []
  }, i = {
    $container: a,
  ...
  o.elements.push(l, c);
  let p = n.map((y) => t.tokens[y.value]).map((y, h) => ({
    ALT: /* @__PURE__ */ s(() => t.parser.consume(h, y, l), "ALT")
  })), d;
  return (y) => {
    d ?? (d = ep(t, r)), t.parser.subrule(0, d, !1, i, y), t.parser.many(0, {
      DEF: /* @__PURE__ */ s(() => {
        t.parser.alternatives(0, p), t.parser.subrule(1, d, !1, c, y);
      }, "DEF")
    });
  };
}
...
function qr(t, e, r = !1) {
  ...
  if ($r(e))
    ...
    let a = t.consume++;
    n = /* @__PURE__ */ s(() => t.parser.consume(a, Kr, e), "method");
  } else
    throw new ff(e.$cstNode, `Unexpected element type: ${e.$type}`);
  return Zy(t, r ? void 0 : Ql(e), n, e.cardinality);
}
s(qr, "buildElement");
function WI(t, e) {
  let r = On(e);
...
function VI(t, e) {
  let r = e.rule.ref;
  if (zn(r)) {
    let n = t.subrule++, a = lt(r) && r.fragment, i = e.arguments.length > 0 ? HI(r, e.arguments) : () => ({}), o;
    return (u) => {
      o ?? (o = ep(t, r)), t.parser.subrule(n, o, a, e, i(u));
    };
  } else if (Ot(r)) {
    let n = t.consume++, a = qc(t, r.name);
...
function HI(t, e) {
  if (e.some((n) => n.calledByName)) {
    let n = e.map((a) => ({
      ...
      predicate: Mt(a.value)
    }));
    return (a) => {
      let i = {};
      for (let { parameterName: o, predicate: u } of n)
        o && (i[o] = u(a));
      return i;
    };
  } else {
    let n = e.map((a) => Mt(a.value));
    return (a) => {
      let i = {};
      for (let o = 0; o < n.length; o++)
        if (o < t.parameters.length) {
          let u = t.parameters[o].name, l = n[o];
          i[u] = l(a);
        }
      return i;
    };
...
s(HI, "buildRuleCallPredicate");
function Mt(t) {
  if (Qm(t)) {
    let e = Mt(t.left), r = Mt(t.right);
    return (n) => e(n) || r(n);
  } else if (Zm(t)) {
    let e = Mt(t.left), r = Mt(t.right);
    return (n) => e(n) && r(n);
...
s(YI, "buildAlternatives");
function XI(t, e) {
  if (e.elements.length === 1)
    return qr(t, e.elements[0]);
  let r = [];
  for (let u of e.elements) {
    let l = {
      // Since we handle the guard condition in the alternative already
      // We can ignore the group guard condition inside
      ALT: qr(t, u, !0)
    }, c = Ql(u);
    c && (l.GATE = Mt(c)), r.push(l);
  }
  let n = t.or++, a = /* @__PURE__ */ s((u, l) => {
    let c = l.getRuleStack().join("-");
    return `uGroup_${u}_${c}`;
  }, "idFunc"), i = /* @__PURE__ */ s((u) => t.parser.alternatives(n, r.map((l, c) => {
    let f = { ALT: /* @__PURE__ */ s(() => !0, "ALT") }, p = t.parser;
    f.ALT = () => {
      if (l.ALT(u), !p.isRecording()) {
        let y = a(n, p);
        p.unorderedGroups.get(y) || p.unorderedGroups.set(y, []);
        let h = p.unorderedGroups.get(y);
        typeof h?.[c] > "u" && (h[c] = !0);
      }
    };
    let d = l.GATE;
    return d ? f.GATE = () => d(u) : f.GATE = () => !p.unorderedGroups.get(a(n, p))?.[c], f;
  })), "alternatives"), o = Zy(t, Ql(e), i, "*");
  return (u) => {
    o(u), t.parser.isRecording() || t.parser.unorderedGroups.delete(a(n, t.parser));
  };
}
s(XI, "buildUnorderedGroup");
function JI(t, e) {
  let r = e.elements.map((n) => qr(t, n));
...
s(Ql, "getGuardCondition");
function Jy(t, e, r = e.terminal) {
  if (r)
    if (Rr(r) && lt(r.rule.ref)) {
      let n = r.rule.ref, a = t.subrule++, i;
      return (o) => {
        i ?? (i = ep(t, n)), t.parser.subrule(a, i, !1, e, o);
      };
    } else if (Rr(r) && Ot(r.rule.ref)) {
      let n = t.consume++, a = qc(t, r.rule.ref.name);
      return () => t.parser.consume(n, a, e);
    } else if ($r(r)) {
      let n = t.consume++, a = qc(t, r.value);
      return () => t.parser.consume(n, a, e);
    } else
    ...
    let a = vf(e.type.ref)?.terminal;
    if (!a)
      throw new Error("Could not find name assignment for type: " + On(e.type.ref));
    return Jy(t, e, a);
  }
}
s(Jy, "buildCrossReference");
function ZI(t, e) {
...
s(Zy, "wrap");
function ep(t, e) {
  let r = QI(t, e), n = t.parser.getRule(r);
  if (!n)
...
function QI(t, e) {
    ...
    return t.ruleNames.get(e);
  {
    ...
    for (; !lt(n); )
      (Un(n) || af(n) || uf(n)) && (a = n.elements.indexOf(r).toString() + ":" + a), r = n, n = n.$container;
...
s(qc, "getToken");
function Qy(t) {
  let e = t.Grammar, r = t.parser.Lexer, n = new UI(t);
  return Qf(e, n, r.definition), n.finalize(), n;
}
s(Qy, "createCompletionParser");
function eg(t) {
  let e = tg(t);
  return e.finalize(), e;
}
s(eg, "createLangiumParser");
function tg(t) {
  let e = t.Grammar, r = t.parser.Lexer, n = new zI(t);
  return Qf(e, n, r.definition);
}
s(tg, "prepareLangiumParser");
var cs, tp = (cs = class {
  constructor() {
    this.diagnostics = [];
  }
  buildTokens(e, r) {
    let n = fe(mf(e, !1)), a = this.buildTerminalTokens(n), i = this.buildKeywordTokens(n, a, r);
    return i.push(...a), i;
  }
  ...
  buildTerminalTokens(e) {
    return e.filter(Ot).filter((r) => !r.fragment).map((r) => this.buildTerminalToken(r)).toArray();
  }
  buildTerminalToken(e) {
    let r = ou(e), n = this.requiresCustomPattern(r) ? this.regexPatternFunction(r) : r, a = {
      name: e.name,
      PATTERN: n
    };
    return typeof n == "function" && (a.LINE_BREAKS = !0), e.hidden && (a.GROUP = df(r) ? ot.SKIPPED : "hidden"), a;
  }
  requiresCustomPattern(e) {
    return !!(e.flags.includes("u") || e.flags.includes("s"));
  }
  regexPatternFunction(e) {
    let r = new RegExp(e, e.flags + "y");
    return (n, a) => (r.lastIndex = a, r.exec(n));
  }
  buildKeywordTokens(e, r, n) {
    return e.filter(zn).flatMap((a) => wr(a).filter($r)).distinct((a) => a.value).toArray().sort((a, i) => i.value.length - a.value.length).map((a) => this.buildKeywordToken(a, r, !!n?.caseInsensitive));
  }
  buildKeywordToken(e, r, n) {
    let a = this.buildKeywordPattern(e, n), i = {
      name: e.value,
      PATTERN: a,
  ...
  buildKeywordPattern(e, r) {
    return r ? new RegExp(bo(e.value), "i") : e.value;
  }
  findLongerAlt(e, r) {
    return r.reduce((n, a) => {
      let i = a?.PATTERN;
      return i?.source && _h("^" + i.source + "$", e.value) && n.push(a), n;
    }, []);
  }
}, s(cs, "DefaultTokenBuilder"), cs), fs, rg = (fs = class {
  convert(e, r) {
  ...
  runConverter(e, r, n) {
    switch (e.name.toUpperCase()) {
      case "INT":
        return Qt.convertInt(r);
      case "STRING":
        return Qt.convertString(r);
      case "ID":
        return Qt.convertID(r);
    }
    switch (zh(e)?.toLowerCase()) {
      case "number":
        return Qt.convertNumber(r);
      case "boolean":
        return Qt.convertBoolean(r);
      case "bigint":
        return Qt.convertBigint(r);
      case "date":
        return Qt.convertDate(r);
      default:
        return r;
    }
  }
}, s(fs, "DefaultValueConverter"), fs), Qt;
(function(t) {
  function e(c) {
    let f = "";
...
var ic = 0, eN = 10;
function np() {
  return ic = performance.now(), new Te.CancellationTokenSource();
}
s(np, "startCancelableOperation");
function ng(t) {
  eN = t;
}
s(ng, "setInterruptionPeriod");
var rr = /* @__PURE__ */ Symbol("OperationCancelled");
function na(t) {
  return t === rr;
}
s(na, "isOperationCancelled");
async function He(t) {
  if (t === Te.CancellationToken.None)
    return;
  let e = performance.now();
  if (e - ic >= eN && (ic = e, await rp(), ic = performance.now()), t.isCancellationRequested)
    throw rr;
}
s(He, "interruptAndCheck");
var ps, _r = (ps = class {
  constructor() {
...
}, s(ps, "Deferred"), ps), zr, Hv = (zr = class {
  constructor(e, r, n, a) {
  ...
  update(e, r) {
    for (let n of e)
      if (zr.isIncremental(n)) {
        let a = ig(n.range), i = this.offsetAt(a.start), o = this.offsetAt(a.end);
        this._content = this._content.substring(0, i) + n.text + this._content.substring(o, this._content.length);
        let u = Math.max(a.start.line, 0), l = Math.max(a.end.line, 0), c = this._lineOffsets, f = hm(n.text, !1, i);
        if (l - u === f.length)
          for (let d = 0, y = f.length; d < y; d++)
            c[d + u + 1] = f[d];
        else
          f.length < 1e4 ? c.splice(u + 1, l - u, ...f) : this._lineOffsets = c = c.slice(0, u + 1).concat(f, c.slice(l + 1));
        let p = n.text.length - (o - i);
        if (p !== 0)
          for (let d = u + 1 + f.length, y = c.length; d < y; d++)
            c[d] = c[d] + p;
      } else if (zr.isFull(n))
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = hm(this._content, !0)), this._lineOffsets;
  }
  positionAt(e) {
  ...
  offsetAt(e) {
    ...
    if (e.character <= 0)
      return n;
    let a = e.line + 1 < r.length ? r[e.line + 1] : this._content.length, i = Math.min(n + e.character, a);
    return this.ensureBeforeEOL(i, n);
  }
  ensureBeforeEOL(e, r) {
    for (; e > r && ag(this._content.charCodeAt(e - 1)); )
      e--;
    return e;
  }
  get lineCount() {
...
}, s(zr, "FullTextDocument"), zr), Wc;
(function(t) {
  function e(a, i, o, u) {
    return new Hv(a, i, o, u);
  }
  ...
  function n(a, i) {
    let o = a.getText(), u = Vc(i.map(tN), (f, p) => {
      let d = f.range.start.line - p.range.start.line;
      return d === 0 ? f.range.start.character - p.range.start.character : d;
    }), l = 0, c = [];
    for (let f of u) {
      let p = a.offsetAt(f.range.start);
      if (p < l)
        throw new Error("Overlapping edit");
...
function Vc(t, e) {
  if (t.length <= 1)
    return t;
  let r = t.length / 2 | 0, n = t.slice(0, r), a = t.slice(r);
  Vc(n, e), Vc(a, e);
  let i = 0, o = 0, u = 0;
...
function hm(t, e, r = 0) {
  ...
  for (let a = 0; a < t.length; a++) {
    ...
    ag(i) && (i === 13 && a + 1 < t.length && t.charCodeAt(a + 1) === 10 && a++, n.push(r + a + 1));
  }
  return n;
}
s(hm, "computeLineOffsets");
function ag(t) {
  return t === 13 || t === 10;
}
s(ag, "isEOL");
function ig(t) {
  let e = t.start, r = t.end;
  return e.line > r.line || e.line === r.line && e.character > r.character ? { start: r, end: e } : t;
}
s(ig, "getWellformedRange");
function tN(t) {
  let e = ig(t.range);
  return e !== t.range ? { newText: t.newText, range: e } : t;
}
s(tN, "getWellformedEdit");
var rN;
(() => {
  "use strict";
  var t = { 975: (k) => {
    ...
    s(S, "e");
    function v(R, A) {
      for (var w, L = "", x = 0, O = -1, z = 0, M = 0; M <= R.length; ++M) {
        if (M < R.length) w = R.charCodeAt(M);
        else {
          if (w === 47) break;
          w = 47;
        }
    ...
    var I = { resolve: /* @__PURE__ */ s(function() {
      for (var R, A = "", w = !1, L = arguments.length - 1; L >= -1 && !w; L--) {
        var x;
        L >= 0 ? x = arguments[L] : (R === void 0 && (R = process.cwd()), x = R), S(x), x.length !== 0 && (A = x + "/" + A, w = x.charCodeAt(0) === 47);
      }
      return A = v(A, !w), w ? A.length > 0 ? "/" + A : "/" : A.length > 0 ? A : ".";
    }, "resolve"), normalize: /* @__PURE__ */ s(function(R) {
      if (S(R), R.length === 0) return ".";
      var A = R.charCodeAt(0) === 47, w = R.charCodeAt(R.length - 1) === 47;
      return (R = v(R, !A)).length !== 0 || A || (R = "."), R.length > 0 && w && (R += "/"), A ? "/" + R : R;
      ...
      if (S(R), S(A), R === A || (R = I.resolve(R)) === (A = I.resolve(A))) return "";
      for (var w = 1; w < R.length && R.charCodeAt(w) === 47; ++w) ;
      for (var L = R.length, x = L - w, O = 1; O < A.length && A.charCodeAt(O) === 47; ++O) ;
      for (var z = A.length - O, M = x < z ? x : z, Y = -1, V = 0; V <= M; ++V) {
        if (V === M) {
          if (z > M) {
            if (A.charCodeAt(O + V) === 47) return A.slice(O + V + 1);
            if (V === 0) return A.slice(O + V);
          } else x > M && (R.charCodeAt(w + V) === 47 ? Y = V : V === 0 && (Y = 0));
          break;
        }
        var Z = R.charCodeAt(w + V);
        if (Z !== A.charCodeAt(O + V)) break;
        Z === 47 && (Y = V);
      }
      var ne = "";
      for (V = w + Y + 1; V <= L; ++V) V !== L && R.charCodeAt(V) !== 47 || (ne.length === 0 ? ne += ".." : ne += "/..");
      return ne.length > 0 ? ne + A.slice(O + Y) : (O += Y, A.charCodeAt(O) === 47 && ++O, A.slice(O));
    }, "relative"), _makeLong: /* @__PURE__ */ s(function(R) {
      return R;
    }, "_makeLong"), dirname: /* @__PURE__ */ s(function(R) {
      if (S(R), R.length === 0) return ".";
      for (var A = R.charCodeAt(0), w = A === 47, L = -1, x = !0, O = R.length - 1; O >= 1; --O) if ((A = R.charCodeAt(O)) === 47) {
        if (!x) {
          L = O;
          break;
        }
      ...
      if (A !== void 0 && A.length > 0 && A.length <= R.length) {
        ...
        for (w = R.length - 1; w >= 0; --w) {
          ...
          } else M === -1 && (O = !1, M = w + 1), z >= 0 && (Y === A.charCodeAt(z) ? --z == -1 && (x = w) : (z = -1, x = M));
        }
        return L === x ? x = M : x === -1 && (x = R.length), R.slice(L, x);
      }
      for (w = R.length - 1; w >= 0; --w) if (R.charCodeAt(w) === 47) {
        if (!O) {
          L = w + 1;
          break;
        }
      ...
      S(R);
      for (var A = -1, w = 0, L = -1, x = !0, O = 0, z = R.length - 1; z >= 0; --z) {
      ...
      return A === -1 || L === -1 || O === 0 || O === 1 && A === L - 1 && A === w + 1 ? "" : R.slice(A, L);
      ...
      return (function(A, w) {
        var L = w.dir || w.root, x = w.base || (w.name || "") + (w.ext || "");
        return L ? L === w.root ? L + x : L + "/" + x : x;
      })(0, R);
    }, "format"), parse: /* @__PURE__ */ s(function(R) {
      S(R);
      var A = { root: "", dir: "", base: "", ext: "", name: "" };
      if (R.length === 0) return A;
      var w, L = R.charCodeAt(0), x = L === 47;
      x ? (A.root = "/", w = 1) : w = 0;
      for (var O = -1, z = 0, M = -1, Y = !0, V = R.length - 1, Z = 0; V >= w; --V) if ((L = R.charCodeAt(V)) !== 47) M === -1 && (Y = !1, M = V + 1), L === 46 ? O === -1 ? O = V : Z !== 1 && (Z = 1) : O !== -1 && (Z = -1);
      else if (!Y) {
        z = V + 1;
        break;
      }
  ...
  function r(k) {
    ...
    var v = e[k] = { exports: {} };
    return t[k](v, v.exports, r), v.exports;
  }
  s(r, "r"), r.d = (k, S) => {
    for (var v in S) r.o(S, v) && !r.o(k, v) && Object.defineProperty(k, v, { enumerable: !0, get: S[v] });
  }, r.o = (k, S) => Object.prototype.hasOwnProperty.call(k, S), r.r = (k) => {
  ...
  var n = {};
  let a;
  r.r(n), r.d(n, { URI: /* @__PURE__ */ s(() => d, "URI"), Utils: /* @__PURE__ */ s(() => he, "Utils") }), typeof process == "object" ? a = process.platform === "win32" : typeof navigator == "object" && (a = navigator.userAgent.indexOf("Windows") >= 0);
  let i = /^\w[\w\d+.-]*$/, o = /^\//, u = /^\/\//;
  function l(k, S) {
    if (!k.scheme && S) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${k.authority}", path: "${k.path}", query: "${k.query}", fragment: "${k.fragment}"}`);
  ...
  s(l, "a");
  let c = "", f = "/", p = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, le = class le {
    constructor(S, v, I, R, A, w = !1) {
      Or(this, "scheme");
      Or(this, "authority");
      Or(this, "path");
      Or(this, "query");
      Or(this, "fragment");
      typeof S == "object" ? (this.scheme = S.scheme || c, this.authority = S.authority || c, this.path = S.path || c, this.query = S.query || c, this.fragment = S.fragment || c) : (this.scheme = /* @__PURE__ */ (function(L, x) {
        return L || x ? L : "file";
      })(S, w), this.authority = v || c, this.path = (function(L, x) {
        switch (L) {
          case "https":
          case "http":
          case "file":
        ...
        return x;
      })(this.scheme, I || c), this.query = R || c, this.fragment = A || c, l(this, w));
    }
    static isUri(S) {
      return S instanceof le || !!S && typeof S.authority == "string" && typeof S.fragment == "string" && typeof S.path == "string" && typeof S.query == "string" && typeof S.scheme == "string" && typeof S.fsPath == "string" && typeof S.with == "function" && typeof S.toString == "function";
    }
    get fsPath() {
      return _(this, !1);
    }
    with(S) {
      if (!S) return this;
      let { scheme: v, authority: I, path: R, query: A, fragment: w } = S;
      return v === void 0 ? v = this.scheme : v === null && (v = c), I === void 0 ? I = this.authority : I === null && (I = c), R === void 0 ? R = this.path : R === null && (R = c), A === void 0 ? A = this.query : A === null && (A = c), w === void 0 ? w = this.fragment : w === null && (w = c), v === this.scheme && I === this.authority && R === this.path && A === this.query && w === this.fragment ? this : new h(v, I, R, A, w);
    }
    static parse(S, v = !1) {
      let I = p.exec(S);
      return I ? new h(I[2] || c, re(I[4] || c), re(I[5] || c), re(I[7] || c), re(I[9] || c), v) : new h(c, c, c, c, c);
    }
    static file(S) {
      let v = c;
      if (a && (S = S.replace(/\\/g, f)), S[0] === f && S[1] === f) {
        let I = S.indexOf(f, 2);
        I === -1 ? (v = S.substring(2), S = f) : (v = S.substring(2, I), S = S.substring(I) || f);
      }
      return new h("file", v, S, c, c);
    }
    static from(S) {
      let v = new h(S.scheme, S.authority, S.path, S.query, S.fragment);
      return l(v, !0), v;
    }
    toString(S = !1) {
      return b(this, S);
    ...
    static revive(S) {
      if (S) {
        ...
        {
          let v = new h(S);
          return v._formatted = S.external, v._fsPath = S._sep === y ? S.fsPath : null, v;
        }
      }
      return S;
    }
  ...
  s(le, "l");
  let d = le, y = a ? 1 : void 0, rt = class rt extends d {
    constructor() {
      super(...arguments);
      Or(this, "_formatted", null);
      Or(this, "_fsPath", null);
    }
    get fsPath() {
      return this._fsPath || (this._fsPath = _(this, !1)), this._fsPath;
    }
    toString(v = !1) {
      return v ? b(this, !0) : (this._formatted || (this._formatted = b(this, !1)), this._formatted);
    }
    toJSON() {
      let v = { $mid: 1 };
      return this._fsPath && (v.fsPath = this._fsPath, v._sep = y), this._formatted && (v.external = this._formatted), this.path && (v.path = this.path), this.scheme && (v.scheme = this.scheme), this.authority && (v.authority = this.authority), this.query && (v.query = this.query), this.fragment && (v.fragment = this.fragment), v;
    }
  };
  s(rt, "d");
  let h = rt, $ = { 58: "%3A", 47: "%2F", 63: "%3F", 35: "%23", 91: "%5B", 93: "%5D", 64: "%40", 33: "%21", 36: "%24", 38: "%26", 39: "%27", 40: "%28", 41: "%29", 42: "%2A", 43: "%2B", 44: "%2C", 59: "%3B", 61: "%3D", 32: "%20" };
  function C(k, S, v) {
    let I, R = -1;
    for (let A = 0; A < k.length; A++) {
      let w = k.charCodeAt(A);
      if (w >= 97 && w <= 122 || w >= 65 && w <= 90 || w >= 48 && w <= 57 || w === 45 || w === 46 || w === 95 || w === 126 || S && w === 47 || v && w === 91 || v && w === 93 || v && w === 58) R !== -1 && (I += encodeURIComponent(k.substring(R, A)), R = -1), I !== void 0 && (I += k.charAt(A));
      else {
  ...
  function T(k) {
    ...
    for (let v = 0; v < k.length; v++) {
      let I = k.charCodeAt(v);
      I === 35 || I === 63 ? (S === void 0 && (S = k.substr(0, v)), S += $[I]) : S !== void 0 && (S += k[v]);
    }
    return S !== void 0 ? S : k;
  }
  s(T, "y");
  function _(k, S) {
    let v;
    return v = k.authority && k.path.length > 1 && k.scheme === "file" ? `//${k.authority}${k.path}` : k.path.charCodeAt(0) === 47 && (k.path.charCodeAt(1) >= 65 && k.path.charCodeAt(1) <= 90 || k.path.charCodeAt(1) >= 97 && k.path.charCodeAt(1) <= 122) && k.path.charCodeAt(2) === 58 ? S ? k.path.substr(1) : k.path[1].toLowerCase() + k.path.substr(2) : k.path, a && (v = v.replace(/\//g, "\\")), v;
  }
  s(_, "v");
  function b(k, S) {
    let v = S ? T : C, I = "", { scheme: R, authority: A, path: w, query: L, fragment: x } = k;
    if (R && (I += R, I += ":"), (A || R === "file") && (I += f, I += f), A) {
      let O = A.indexOf("@");
      if (O !== -1) {
        let z = A.substr(0, O);
        A = A.substr(O + 1), O = z.lastIndexOf(":"), O === -1 ? I += v(z, !1, !1) : (I += v(z.substr(0, O), !1, !1), I += ":", I += v(z.substr(O + 1), !1, !0)), I += "@";
      }
      A = A.toLowerCase(), O = A.lastIndexOf(":"), O === -1 ? I += v(A, !1, !0) : (I += v(A.substr(0, O), !1, !0), I += A.substr(O));
    }
    if (w) {
      if (w.length >= 3 && w.charCodeAt(0) === 47 && w.charCodeAt(2) === 58) {
        let O = w.charCodeAt(1);
        O >= 65 && O <= 90 && (w = `/${String.fromCharCode(O + 32)}:${w.substr(3)}`);
      } else if (w.length >= 2 && w.charCodeAt(1) === 58) {
        let O = w.charCodeAt(0);
        O >= 65 && O <= 90 && (w = `${String.fromCharCode(O + 32)}:${w.substr(2)}`);
      }
      I += v(w, !0, !1);
    }
    return L && (I += "?", I += v(L, !1, !1)), x && (I += "#", I += S ? x : C(x, !1, !1)), I;
  }
  s(b, "b");
  function N(k) {
    try {
  ...
  function re(k) {
    return k.match(U) ? k.replace(U, ((S) => N(S))) : k;
  }
  s(re, "w");
  var J = r(975);
  let me = J.posix || J, Re = "/";
  var he;
  (function(k) {
    k.joinPath = function(S, ...v) {
      return S.with({ path: me.join(S.path, ...v) });
    }, k.resolvePath = function(S, ...v) {
      let I = S.path, R = !1;
      I[0] !== Re && (I = Re + I, R = !0);
      let A = me.resolve(I, ...v);
      return R && A[0] === Re && !S.authority && (A = A.substring(1)), S.with({ path: A });
    }, k.dirname = function(S) {
      if (S.path.length === 0 || S.path === Re) return S;
      let v = me.dirname(S.path);
      return v.length === 1 && v.charCodeAt(0) === 46 && (v = ""), S.with({ path: v });
...
var { URI: Rt, Utils: Qo } = rN, st;
(function(t) {
  t.basename = Qo.basename, t.dirname = Qo.dirname, t.extname = Qo.extname, t.joinPath = Qo.joinPath, t.resolvePath = Qo.resolvePath;
  let e = typeof process == "object" && process?.platform === "win32";
  function r(o, u) {
    return o?.toString() === u?.toString();
  }
  s(r, "equals"), t.equals = r;
  function n(o, u) {
    let l = typeof o == "string" ? Rt.parse(o).path : o.path, c = typeof u == "string" ? Rt.parse(u).path : u.path, f = l.split("/").filter(($) => $.length > 0), p = c.split("/").filter(($) => $.length > 0);
    if (e) {
      let $ = /^[A-Z]:$/;
      if (f[0] && $.test(f[0]) && (f[0] = f[0].toLowerCase()), p[0] && $.test(p[0]) && (p[0] = p[0].toLowerCase()), f[0] !== p[0])
        return c.substring(1);
    }
    let d = 0;
    for (; d < f.length && f[d] === p[d]; d++)
      ;
    let y = "../".repeat(f.length - d), h = p.slice(d).join("/");
    return y + h;
  }
...
var ds, sg = (ds = class {
  ...
  delete(e) {
    let r = this.getNode(this.normalizeUri(e), !1);
  ...
  findNode(e) {
    let r = this.normalizeUri(e), n = this.getNode(r, !1);
    if (n)
      return {
        name: n.name,
        uri: st.joinPath(Rt.parse(r), n.name).toString(),
        element: n.element
      };
  }
  findChildren(e) {
    ...
    return n ? Array.from(n.children.values()).map((a) => ({
      name: a.name,
      uri: st.joinPath(Rt.parse(r), a.name).toString(),
      element: a.element
    })) : [];
  }
  all() {
  ...
  findAll(e) {
    let r = this.getNode(st.normalize(e), !1);
  ...
  collectValues(e) {
    ...
    for (let n of e.children.values())
...
var ms, nN = (ms = class {
  ...
  async fromUri(e, r = Te.CancellationToken.None) {
    let n = await this.fileSystemProvider.readFile(e);
    return this.createAsync(e, n, r);
  }
  fromTextDocument(e, r, n) {
    return r = r ?? Rt.parse(e.uri), Te.CancellationToken.is(n) ? this.createAsync(r, e, n) : this.create(r, e, n);
  }
  fromString(e, r, n) {
    return Te.CancellationToken.is(n) ? this.createAsync(r, e, n) : this.create(r, e, n);
  }
  fromModel(e, r) {
  ...
  create(e, r, n) {
    if (typeof r == "string") {
      let a = this.parse(e, r, n);
      return this.createLangiumDocument(a, e, void 0, r);
    } else if ("$model" in r) {
      let a = { value: r.$model, parserErrors: [], lexerErrors: [] };
      return this.createLangiumDocument(a, e);
    } else {
      let a = this.parse(e, r.getText(), n);
      return this.createLangiumDocument(a, e, r);
    }
  }
  async createAsync(e, r, n) {
    if (typeof r == "string") {
      let a = await this.parseAsync(e, r, n);
      return this.createLangiumDocument(a, e, void 0, r);
    } else {
      let a = await this.parseAsync(e, r.getText(), n);
      return this.createLangiumDocument(a, e, r);
    }
  }
  /**
  ...
  createLangiumDocument(e, r, n, a) {
    ...
    if (n)
      ...
      let o = this.createTextDocumentGetter(r, a);
      i = {
        parseResult: e,
        uri: r,
        state: Q.Parsed,
  ...
  async update(e, r) {
    let n = e.parseResult.value.$cstNode?.root.fullText, a = this.textDocuments?.get(e.uri.toString()), i = a ? a.getText() : await this.fileSystemProvider.readFile(e.uri);
    if (a)
      Object.defineProperty(e, "textDocument", {
        value: a
      });
    else {
      let o = this.createTextDocumentGetter(e.uri, i);
      Object.defineProperty(e, "textDocument", {
        get: o
      });
    }
  ...
  createTextDocumentGetter(e, r) {
    let n = this.serviceRegistry, a;
    return () => a ?? (a = Wc.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, r ?? ""));
  }
}, s(ms, "DefaultLangiumDocumentFactory"), ms), hs, aN = (hs = class {
  constructor(e) {
    this.documentTrie = new sg(), this.services = e, this.langiumDocumentFactory = e.workspace.LangiumDocumentFactory, this.documentBuilder = () => e.workspace.DocumentBuilder;
  }
  get all() {
  ...
  createDocument(e, r, n) {
    ...
    {
      let a = this.langiumDocumentFactory.fromString(r, e);
  ...
  invalidateDocument(e) {
    let r = e.toString(), n = this.documentTrie.find(r);
  ...
  deleteDocuments(e) {
    let r = e.toString(), n = this.documentTrie.findAll(r);
    for (let a of n)
      a.state = Q.Changed;
    return this.documentTrie.delete(r), n;
  }
}, s(hs, "DefaultLangiumDocuments"), hs), un = /* @__PURE__ */ Symbol("RefResolving"), ys, iN = (ys = class {
  constructor(e) {
  ...
  async link(e, r = Te.CancellationToken.None) {
    if (this.profiler?.isActive("linking")) {
      let n = this.profiler.createTask("linking", this.languageId);
      n.start();
      try {
        for (let a of Ft(e.parseResult.value))
          await He(r), ho(a).forEach((i) => {
            let o = `${a.$type}:${i.property}`;
            n.startSubTask(o);
            try {
              this.doLink(i, e);
            } finally {
      ...
      for (let n of Ft(e.parseResult.value))
        await He(r), ho(n).forEach((a) => this.doLink(a, e));
  }
  doLink(e, r) {
    let n = e.reference;
    if ("_ref" in n && n._ref === void 0) {
      ...
      n._items = un;
      try {
        let a = this.getCandidates(e), i = [];
        if (dn(a))
          n._linkingError = a;
        else
          for (let o of a) {
            let u = this.loadAstNode(o);
  ...
  getCandidates(e) {
    let n = this.scopeProvider.getScope(e).getElements(e.reference.$refText).distinct((a) => `${a.documentUri}#${a.path}`).toArray();
    ...
    let i = this, o = {
      ...
      get items() {
        ...
        if (this._items === void 0) {
          this._items = un;
          let u = za(e).$document, l = i.getCandidates({
            reference: o,
            container: e,
            property: r
          }), c = [];
          if (dn(l))
            ...
            for (let f of l) {
              let p = i.loadAstNode(f);
              p && c.push({ ref: p, $nodeDescription: f });
            }
          this._items = c, u?.references.push(this);
        } else this._items === un && i.throwCyclicReferenceError(e, r, a);
  ...
  createLinkingError(e, r) {
    ...
    let a = this.reflection.getReferenceType(e);
    return {
      info: e,
...
var gs, sN = (gs = class {
  ...
  getNameNode(e) {
    return hf(e.$cstNode, "name");
  }
}, s(gs, "DefaultNameProvider"), gs), vs, oN = (vs = class {
  constructor(e) {
    this.nameProvider = e.references.NameProvider, this.index = e.shared.workspace.IndexManager, this.nodeLocator = e.workspace.AstNodeLocator, this.documents = e.shared.workspace.LangiumDocuments, this.hasMultiReference = Ft(e.Grammar).some((r) => jn(r) && r.isMulti);
  }
  findDeclarations(e) {
    if (e) {
      let r = Dh(e), n = e.astNode;
      if (r && n) {
        let a = n[r.feature];
        if (it(a) || nr(a))
          return fc(a);
        if (Array.isArray(a)) {
          for (let i of a)
            if ((it(i) || nr(i)) && i.$refNode && i.$refNode.offset <= e.offset && i.$refNode.end >= e.end)
              return fc(i);
        }
      }
      if (n) {
        let a = this.nameProvider.getNameNode(n);
        if (a && (a === e || mh(e, a)))
  ...
  getSelfNodes(e) {
    if (this.hasMultiReference) {
      let r = this.index.findAllReferences(e, this.nodeLocator.getAstNodePath(e)), n = this.getNodeFromReferenceDescription(r.head());
      if (n) {
        for (let a of ho(n))
          if (nr(a.reference) && a.reference.items.some((i) => i.ref === e))
  ...
  getNodeFromReferenceDescription(e) {
    if (!e)
      return;
    let r = this.documents.getDocument(e.sourceUri);
    if (r)
      return this.nodeLocator.getAstNode(r.parseResult.value, e.sourcePath);
  }
  findDeclarationNodes(e) {
    let r = this.findDeclarations(e), n = [];
    for (let a of r) {
      let i = this.nameProvider.getNameNode(a) ?? a.$cstNode;
      i && n.push(i);
    }
    return n;
  }
  findReferences(e, r) {
    ...
    return r.documentUri && (a = a.filter((i) => st.equals(i.sourceUri, r.documentUri))), n.push(...a), fe(n);
  }
  getSelfReferences(e) {
    let r = this.getSelfNodes(e), n = [];
    for (let a of r) {
      let i = this.nameProvider.getNameNode(a);
      if (i) {
        let o = Gt(a), u = this.nodeLocator.getAstNodePath(a);
        n.push({
          sourceUri: o.uri,
          sourcePath: u,
          targetUri: o.uri,
...
}, s(vs, "DefaultReferences"), vs), Ts, Sr = (Ts = class {
  constructor(e) {
   ...
   */
  get size() {
    return Gl.sum(fe(this.map.values()).map((e) => e.length));
  }
  /**
   ...
   */
  async collectExportedSymbolsForNode(e, r, n = nu, a = Te.CancellationToken.None) {
    let i = [];
    this.addExportedSymbol(e, i, r);
    for (let o of n(e))
      await He(a), this.addExportedSymbol(o, i, r);
    return i;
  }
  /**
  ...
  async collectLocalSymbols(e, r = Te.CancellationToken.None) {
    let n = e.parseResult.value, a = new Sr();
    for (let i of wr(n))
      await He(r), this.addLocalSymbol(i, e, a);
    return a;
  }
  /**
...
}, s(Rs, "DefaultScopeComputation"), Rs), As, ym = (As = class {
  constructor(e, r, n) {
  ...
  getElement(e) {
    let r = this.caseInsensitive ? e.toLowerCase() : e, n = this.caseInsensitive ? this.elements.find((a) => a.name.toLowerCase() === r) : this.elements.find((a) => a.name === e);
    if (n)
      return n;
    if (this.outerScope)
  ...
  getElements(e) {
    let r = this.caseInsensitive ? e.toLowerCase() : e, n = this.caseInsensitive ? this.elements.filter((a) => a.name.toLowerCase() === r) : this.elements.filter((a) => a.name === e);
    return (this.concatOuterScope || n.isEmpty()) && this.outerScope ? n.concat(this.outerScope.getElements(e)) : n;
  }
}, s(As, "StreamScope"), As), Es, ej = (Es = class {
  constructor(e, r, n) {
    this.elements = /* @__PURE__ */ new Map(), this.caseInsensitive = n?.caseInsensitive ?? !1, this.concatOuterScope = n?.concatOuterScope ?? !0;
    for (let a of e) {
      let i = this.caseInsensitive ? a.name.toLowerCase() : a.name;
      this.elements.set(i, a);
    }
    this.outerScope = r;
  }
  getElement(e) {
    let r = this.caseInsensitive ? e.toLowerCase() : e, n = this.elements.get(r);
    if (n)
      return n;
    if (this.outerScope)
      return this.outerScope.getElement(e);
  ...
  getElements(e) {
    let r = this.caseInsensitive ? e.toLowerCase() : e, n = this.elements.get(r), a = n ? [n] : [];
    return (this.concatOuterScope || a.length > 0) && this.outerScope ? fe(a).concat(this.outerScope.getElements(e)) : fe(a);
  }
  getAllElements() {
    let e = fe(this.elements.values());
    return this.outerScope && (e = e.concat(this.outerScope.getAllElements())), e;
  }
}, s(Es, "MapScope"), Es), Cs, uN = (Cs = class {
  constructor(e, r, n) {
    this.elements = new Sr(), this.caseInsensitive = n?.caseInsensitive ?? !1, this.concatOuterScope = n?.concatOuterScope ?? !0;
    for (let a of e) {
      let i = this.caseInsensitive ? a.name.toLowerCase() : a.name;
  ...
  getElement(e) {
    let r = this.caseInsensitive ? e.toLowerCase() : e, n = this.elements.get(r)[0];
    if (n)
      return n;
    if (this.outerScope)
      return this.outerScope.getElement(e);
...
}, s(bs, "DisposableCache"), bs), _s, lg = (_s = class extends ap {
  constructor() {
...
}, s(_s, "SimpleCache"), _s), Ss, ip = (Ss = class extends ap {
  constructor(e) {
  ...
  clear(e) {
    if (this.throwIfDisposed(), e) {
      let r = this.converter(e);
      this.cache.delete(r);
    } else
      this.cache.clear();
  }
  cacheForContext(e) {
    let r = this.converter(e), n = this.cache.get(r);
    return n || (n = /* @__PURE__ */ new Map(), this.cache.set(r, n)), n;
  }
}, s(Ss, "ContextCache"), Ss), ws, cN = (ws = class extends ip {
  /**
...
}, s(ws, "DocumentCache"), ws), Is, ug = (Is = class extends lg {
  /**
...
}, s(Is, "WorkspaceCache"), Is), Ns, fN = (Ns = class {
  constructor(e) {
    this.reflection = e.shared.AstReflection, this.nameProvider = e.references.NameProvider, this.descriptions = e.workspace.AstNodeDescriptionProvider, this.indexManager = e.shared.workspace.IndexManager, this.globalScopeCache = new ug(e.shared);
  }
  getScope(e) {
    let r = [], n = this.reflection.getReferenceType(e), a = Gt(e.container).localSymbols;
    if (a) {
      let o = e.container;
      do
   ...
   */
  getGlobalScope(e, r) {
    return this.globalScopeCache.get(e, () => new uN(this.indexManager.allElements(e)));
  }
}, s(Ns, "DefaultScopeProvider"), Ns);
function cg(t) {
  return typeof t.$comment == "string";
}
s(cg, "isAstNodeWithComment");
function gm(t) {
  return typeof t == "object" && !!t && ("$ref" in t || "$error" in t);
}
s(gm, "isIntermediateReference");
var Ps, pN = (Ps = class {
  constructor(e) {
  ...
  serialize(e, r) {
    let n = r ?? {}, a = r?.replacer, i = /* @__PURE__ */ s((u, l) => this.replacer(u, l, n), "defaultReplacer"), o = a ? (u, l) => a(u, l, i) : i;
    try {
      return this.currentDocument = Gt(e), JSON.stringify(e, o, r?.space);
    } finally {
      this.currentDocument = void 0;
    }
  }
  deserialize(e, r) {
    let n = r ?? {}, a = JSON.parse(e);
  ...
  replacer(e, r, { refText: n, sourceText: a, textRegions: i, comments: o, uriConverter: u }) {
    if (!this.ignoreProperties.has(e))
      if (it(r)) {
        let l = r.ref, c = n ? r.$refText : void 0;
        if (l) {
          let f = Gt(l), p = "";
          this.currentDocument && this.currentDocument !== f && (u ? p = u(f.uri, l) : p = f.uri.toString());
          let d = this.astNodeLocator.getAstNodePath(l);
          return {
            $ref: `${p}#${d}`,
            $refText: c
          };
        ...
        let l = n ? r.$refText : void 0, c = [];
        for (let f of r.items) {
          let p = f.ref, d = Gt(f.ref), y = "";
          this.currentDocument && this.currentDocument !== d && (u ? y = u(d.uri, p) : y = d.uri.toString());
          let h = this.astNodeLocator.getAstNodePath(p);
          c.push(`${y}#${h}`);
        }
        return {
          $refs: c,
        ...
        if (i && (l = this.addAstNodeRegionWithAssignmentsTo({ ...r }), (!e || r.$document) && l?.$textRegion && (l.$textRegion.documentURI = this.currentDocument?.uri.toString())), a && !e && (l ?? (l = { ...r }), l.$sourceText = r.$cstNode?.text), o) {
          l ?? (l = { ...r });
          let c = this.commentProvider.getComment(r);
  ...
  addAstNodeRegionWithAssignmentsTo(e) {
    ...
    if (e.$cstNode) {
      let n = e.$textRegion = r(e.$cstNode), a = n.assignments = {};
      return Object.keys(e).filter((i) => !i.startsWith("$")).forEach((i) => {
        let o = Oh(e.$cstNode, i).map(r);
        o.length !== 0 && (a[i] = o);
      }), e;
    }
  }
  linkNode(e, r, n, a, i, o) {
    for (let [l, c] of Object.entries(e))
      if (Array.isArray(c))
        for (let f = 0; f < c.length; f++) {
          let p = c[f];
          gm(p) ? c[f] = this.reviveReference(e, l, r, p, n) : je(p) && this.linkNode(p, r, n, e, l, f);
        }
      else gm(c) ? e[l] = this.reviveReference(e, l, r, c, n) : je(c) && this.linkNode(c, r, n, e, l);
    let u = e;
  ...
  reviveReference(e, r, n, a, i) {
    ...
    if (a.$ref) {
      let c = this.getRefNode(n, a.$ref, i.uriConverter);
      if (je(c))
      ...
      let c = [];
      for (let f of a.$refs) {
        let p = this.getRefNode(n, f, i.uriConverter);
        je(p) && c.push({ ref: p });
      }
      if (c.length === 0)
        l = {
  ...
  getRefNode(e, r, n) {
    try {
      let a = r.indexOf("#");
      if (a === 0) {
        let l = this.astNodeLocator.getAstNode(e, r.substring(1));
        return l || "Could not resolve path: " + r;
      }
      if (a < 0) {
        let l = n ? n(r) : Rt.parse(r), c = this.langiumDocuments.getDocument(l);
        return c ? c.parseResult.value : "Could not find document for URI: " + r;
      }
      let i = n ? n(r.substring(0, a)) : Rt.parse(r.substring(0, a)), o = this.langiumDocuments.getDocument(i);
      if (!o)
        return "Could not find document for URI: " + r;
      if (a === r.length - 1)
        return o.parseResult.value;
      let u = this.astNodeLocator.getAstNode(o.parseResult.value, r.substring(a + 1));
      return u || "Could not resolve URI: " + r;
    } catch (a) {
      return String(a);
    }
  }
}, s(Ps, "DefaultJsonSerializer"), Ps), ks, dN = (ks = class {
  /**
  ...
  getServices(e) {
    ...
    let r = this.textDocuments?.get(e)?.languageId;
    if (r !== void 0) {
      let o = this.languageIdMap.get(r);
      if (o)
        return o;
    }
    let n = st.extname(e), a = st.basename(e), i = this.fileNameMap.get(a) ?? this.fileExtensionMap.get(n);
    if (!i)
...
}, s(ks, "DefaultServiceRegistry"), ks);
function Sn(t) {
  return { code: t };
}
s(Sn, "diagnosticData");
...
var Os, mN = (Os = class {
  constructor(e) {
    this.entries = new Sr(), this.knownCategories = new Set(Yc.defaults), this.entriesBefore = [], this.entriesAfter = [], this.reflection = e.shared.AstReflection;
  }
  /**
...
}, s(Os, "ValidationRegistry"), Os), hN = Object.freeze({
  validateNode: !0,
  validateChildren: !0
}), Ls, yN = (Ls = class {
  constructor(e) {
  ...
  async validateDocument(e, r = {}, n = Te.CancellationToken.None) {
    let a = e.parseResult, i = [];
    if (await He(n), (!r.categories || r.categories.includes("built-in")) && (this.processLexingErrors(a, i, r), r.stopAfterLexingErrors && i.some((o) => o.data?.code === It.LexingError) || (this.processParsingErrors(a, i, r), r.stopAfterParsingErrors && i.some((o) => o.data?.code === It.ParsingError)) || (this.processLinkingErrors(e, i, r), r.stopAfterLinkingErrors && i.some((o) => o.data?.code === It.LinkingError))))
      return i;
    try {
  ...
  processLexingErrors(e, r, n) {
    let a = [...e.lexerErrors, ...e.lexerReport?.diagnostics ?? []];
    for (let i of a) {
      let o = i.severity ?? "error", u = {
        severity: xl(o),
        range: {
          start: {
            line: i.line - 1,
  ...
  processParsingErrors(e, r, n) {
    for (let a of e.parserErrors) {
      let i;
      if (isNaN(a.token.startOffset)) {
        if ("previousToken" in a) {
          let o = a.previousToken;
          if (isNaN(o.startOffset)) {
            let u = { line: 0, character: 0 };
            i = { start: u, end: u };
          } else {
            let u = { line: o.endLine - 1, character: o.endColumn };
            i = { start: u, end: u };
          }
        }
      } else
  ...
  async validateAst(e, r, n = Te.CancellationToken.None) {
    let a = [], i = /* @__PURE__ */ s((o, u, l) => {
  ...
  async validateAstBefore(e, r, n, a = Te.CancellationToken.None) {
    let i = this.validationRegistry.checksBefore;
    for (let o of i)
      await He(a), await o(e, n, r.categories ?? [], a);
  }
  async validateAstNodes(e, r, n, a = Te.CancellationToken.None) {
    if (this.profiler?.isActive("validating")) {
      ...
      try {
        ...
        for (let u of o) {
          ...
          let l = this.validateSingleNodeOptions(u, r);
          if (l.validateNode)
            try {
              let c = this.validationRegistry.getChecks(u.$type, r.categories);
              for (let f of c)
                await f(u, n, a);
            } finally {
      ...
      for (let o of i) {
        await He(a);
        let u = this.validateSingleNodeOptions(o, r);
        if (u.validateNode) {
          let l = this.validationRegistry.getChecks(o.$type, r.categories);
          for (let c of l)
            await c(o, n, a);
        }
  ...
  async validateAstAfter(e, r, n, a = Te.CancellationToken.None) {
...
}, s(Ls, "DefaultDocumentValidator"), Ls);
function fg(t) {
  if (t.range)
    return t.range;
  let e;
  return typeof t.property == "string" ? e = hf(t.node.$cstNode, t.property, t.index) : typeof t.keyword == "string" && (e = Lh(t.node.$cstNode, t.keyword, t.index)), e ?? (e = t.node.$cstNode), e ? e.range : {
    start: { line: 0, character: 0 },
    end: { line: 0, character: 0 }
  };
}
s(fg, "getDiagnosticRange");
function xl(t) {
  switch (t) {
    case "error":
      return 1;
...
s(xl, "toDiagnosticSeverity");
function pg(t) {
  switch (t) {
    case "error":
      return Sn(It.LexingError);
    case "warning":
      return Sn(It.LexingWarning);
    case "info":
      return Sn(It.LexingInfo);
    case "hint":
      return Sn(It.LexingHint);
    default:
      throw new Error("Invalid diagnostic severity: " + t);
  }
}
s(pg, "toDiagnosticData");
var It;
(function(t) {
...
var Ds, gN = (Ds = class {
  ...
  createDescription(e, r, n) {
    ...
    let o, u = /* @__PURE__ */ s(() => o ?? (o = vo(this.nameProvider.getNameNode(e) ?? e.$cstNode)), "nameSegmentGetter");
    return {
      node: e,
      name: r,
      get nameSegment() {
      ...
      selectionSegment: vo(e.$cstNode),
      type: e.$type,
      documentUri: a.uri,
      path: i
    };
  }
}, s(Ds, "DefaultAstNodeDescriptionProvider"), Ds), xs, vN = (xs = class {
  constructor(e) {
    this.nodeLocator = e.workspace.AstNodeLocator;
  }
  async createDescriptions(e, r = Te.CancellationToken.None) {
    let n = [], a = e.parseResult.value;
    for (let i of Ft(a))
      await He(r), ho(i).forEach((o) => {
  ...
  createInfoDescriptions(e) {
    ...
    if (r.error || !r.$refNode)
      return [];
    let n = [];
    it(r) && r.$nodeDescription ? n = [r.$nodeDescription] : nr(r) && (n = r.items.map((l) => l.$nodeDescription).filter((l) => l !== void 0));
    let a = Gt(e.container).uri, i = this.nodeLocator.getAstNodePath(e.container), o = [], u = vo(r.$refNode);
    for (let l of n)
      o.push({
        sourceUri: a,
        sourcePath: i,
        ...
        targetPath: l.path,
        segment: u,
        local: st.equals(l.documentUri, a)
      });
    return o;
  }
}, s(xs, "DefaultReferenceDescriptionProvider"), xs), Ms, TN = (Ms = class {
  constructor() {
  ...
  getAstNode(e, r) {
    return r.split(this.segmentSeparator).reduce((a, i) => {
      if (!a || i.length === 0)
        return a;
      let o = i.indexOf(this.indexSeparator);
      if (o > 0) {
        let u = i.substring(0, o), l = parseInt(i.substring(o + 1));
        return a[u]?.[l];
      }
      return a[i];
    }, e);
  }
}, s(Ms, "DefaultAstNodeLocator"), Ms), sp = {};
Qc(sp, zm(Eo(), 1));
var Gs, $N = (Gs = class {
  constructor(e) {
    this._ready = new _r(), this.onConfigurationSectionUpdateEmitter = new sp.Emitter(), this.settings = {}, this.workspaceConfig = !1, this.serviceRegistry = e.ServiceRegistry;
  }
  get ready() {
  ...
  async initialized(e) {
    if (this.workspaceConfig) {
      ...
      if (e.fetchConfiguration) {
        let r = this.serviceRegistry.all.map((a) => ({
...
}, s(Gs, "DefaultConfigurationProvider"), Gs), wu = zm(NP(), 1), Nn;
(function(t) {
  function e(r) {
    return {
...
var Fs, RN = (Fs = class {
    ...
    for (let a of e) {
      ...
      if (a.state === Q.Validated) {
        if (typeof r.validation == "boolean" && r.validation)
          ...
          let o = this.findMissingValidationCategories(a, r);
  ...
  async update(e, r, n = Te.CancellationToken.None) {
    this.currentState = Q.Changed;
    let a = [];
    for (let l of r) {
      let c = this.langiumDocuments.deleteDocuments(l);
      for (let f of c)
    ...
    let o = fe(i).concat(a).map((l) => l.toString()).toSet();
    this.langiumDocuments.all.filter((l) => !o.has(l.uri.toString()) && this.shouldRelink(l, o)).forEach((l) => this.resetToState(l, Q.ComputedScopes)), await this.emitUpdate(i, a), await He(n);
    let u = this.sortDocuments(this.langiumDocuments.all.filter((l) => (
  ...
  onUpdate(e) {
    return this.updateListeners.push(e), Nn.create(() => {
  ...
  async buildDocuments(e, r, n) {
    this.prepareBuild(e, r), await this.runCancelable(e, Q.Parsed, n, (o) => this.langiumDocumentFactory.update(o, n)), await this.runCancelable(e, Q.IndexedContent, n, (o) => this.indexManager.updateContent(o, n)), await this.runCancelable(e, Q.ComputedScopes, n, async (o) => {
      let u = this.serviceRegistry.getServices(o.uri).references.ScopeComputation;
      o.localSymbols = await u.collectLocalSymbols(o, n);
    });
    let a = e.filter((o) => this.shouldLink(o));
    ...
    let i = e.filter((o) => this.shouldValidate(o) ? !0 : (this.markAsCompleted(o), !1));
    await this.runCancelable(i, Q.Validated, n, async (o) => {
      await this.validate(o, n), this.markAsCompleted(o);
    });
  }
  markAsCompleted(e) {
    let r = this.buildState.get(e.uri.toString());
    r && (r.completed = !0);
  }
  /**
  ...
  prepareBuild(e, r) {
    for (let n of e) {
      let a = n.uri.toString(), i = this.buildState.get(a);
  ...
  async runCancelable(e, r, n, a) {
    for (let o of e)
      o.state < r && (await He(n), await a(o), o.state = r, await this.notifyDocumentPhase(o, r, n));
    let i = e.filter((o) => o.state === r);
    await this.notifyBuildPhase(i, r, n), this.currentState = r;
  }
  onBuildPhase(e, r) {
    return this.buildPhaseListeners.add(e, r), Nn.create(() => {
      this.buildPhaseListeners.delete(e, r);
    });
  }
  onDocumentPhase(e, r) {
    return this.documentPhaseListeners.add(e, r), Nn.create(() => {
      this.documentPhaseListeners.delete(e, r);
    });
  }
  waitUntil(e, r, n) {
    let a;
    return r && "path" in r ? a = r : n = r, n ?? (n = Te.CancellationToken.None), a ? this.awaitDocumentState(e, a, n) : this.awaitBuilderState(e, n);
  }
  awaitDocumentState(e, r, n) {
    let a = this.langiumDocuments.getDocument(r);
    if (a) {
      if (a.state >= e)
      ...
      if (this.currentState >= e && e > a.state)
        return Promise.reject(new wu.ResponseError(wu.LSPErrorCodes.RequestFailed, `Document state of ${r.toString()} is ${Q[a.state]}, requiring ${Q[e]}, but workspace state is already ${Q[this.currentState]}. Returning undefined.`));
    } else return Promise.reject(new wu.ResponseError(wu.LSPErrorCodes.ServerCancelled, `No document found for URI: ${r.toString()}`));
    return new Promise((i, o) => {
      let u = this.onDocumentPhase(e, (c) => {
        st.equals(c.uri, r) && (u.dispose(), l.dispose(), i(c.uri));
      }), l = n.onCancellationRequested(() => {
        u.dispose(), l.dispose(), o(rr);
      });
    });
  }
  awaitBuilderState(e, r) {
    return this.currentState >= e ? Promise.resolve() : r.isCancellationRequested ? Promise.reject(rr) : new Promise((n, a) => {
      let i = this.onBuildPhase(e, () => {
        i.dispose(), o.dispose(), n();
      }), o = r.onCancellationRequested(() => {
        i.dispose(), o.dispose(), a(rr);
      });
    });
  }
  async notifyDocumentPhase(e, r, n) {
    let i = this.documentPhaseListeners.get(r).slice();
    for (let o of i)
      try {
        await He(n), await o(e, n);
      } catch (u) {
        if (!na(u))
          throw u;
      }
  ...
  async notifyBuildPhase(e, r, n) {
    if (e.length === 0)
      return;
    let i = this.buildPhaseListeners.get(r).slice();
    for (let o of i)
      await He(n), await o(e, n);
  }
  /**
   ...
   */
  async validate(e, r) {
    let n = this.serviceRegistry.getServices(e.uri).validation.DocumentValidator, a = this.getBuildOptions(e), i = typeof a.validation == "object" ? { ...a.validation } : {};
    i.categories = this.findMissingValidationCategories(e, a);
    let o = await n.validateDocument(e, i, r);
    e.diagnostics ? e.diagnostics.push(...o) : e.diagnostics = o;
    let u = this.buildState.get(e.uri.toString());
    u && (u.result ?? (u.result = {}), u.result.validationChecks ? u.result.validationChecks = fe(u.result.validationChecks).concat(i.categories).distinct().toArray() : u.result.validationChecks = [...i.categories]);
  }
  getBuildOptions(e) {
    return this.buildState.get(e.uri.toString())?.options ?? {};
  }
}, s(Fs, "DefaultDocumentBuilder"), Fs), zs, AN = (zs = class {
  constructor(e) {
    this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new ip(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
  }
  findAllReferences(e, r) {
    let n = Gt(e).uri, a = [];
    return this.referenceIndex.forEach((i) => {
      i.forEach((o) => {
        st.equals(o.targetUri, n) && o.targetPath === r && a.push(o);
      });
    }), fe(a);
  }
  allElements(e, r) {
  ...
  async updateContent(e, r = Te.CancellationToken.None) {
    let a = await this.serviceRegistry.getServices(e.uri).references.ScopeComputation.collectExportedSymbols(e, r), i = e.uri.toString();
    this.symbolIndex.set(i, a), this.symbolByTypeIndex.clear(i);
  }
  async updateReferences(e, r = Te.CancellationToken.None) {
    let a = await this.serviceRegistry.getServices(e.uri).workspace.ReferenceDescriptionProvider.createDescriptions(e, r);
...
}, s(zs, "DefaultIndexManager"), zs), js, EN = (js = class {
  constructor(e) {
    this.initialBuildOptions = {}, this._ready = new _r(), this.serviceRegistry = e.ServiceRegistry, this.langiumDocuments = e.workspace.LangiumDocuments, this.documentBuilder = e.workspace.DocumentBuilder, this.fileSystemProvider = e.workspace.FileSystemProvider, this.mutex = e.workspace.WorkspaceLock;
  }
  get ready() {
    return this._ready.promise;
  }
  ...
  async initializeWorkspace(e, r = Te.CancellationToken.None) {
    let n = await this.performStartup(e);
    await He(r), await this.documentBuilder.build(n, this.initialBuildOptions, r);
  }
  /**
  ...
  async performStartup(e) {
    ...
    let i = fe(a).distinct((o) => o.toString()).filter((o) => !this.langiumDocuments.hasDocument(o));
  ...
  async loadWorkspaceDocuments(e, r) {
    await Promise.all(e.map(async (n) => {
      let a = await this.langiumDocuments.getOrCreateDocument(n);
      r(a);
    }));
  }
  /**
...
function yg(t, e) {
  ...
  if (n.length === 0)
    return !1;
  let a = n[0], i = n[n.length - 1], o = r.start, u = r.end;
  return !!o?.exec(a) && !!u?.exec(i);
}
s(yg, "isJSDoc");
function gg(t) {
  let e = "";
  return typeof t == "string" ? e = t : e = t.text, e.split(I$);
}
s(gg, "getLines");
var Yv = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy, rj = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function bN(t) {
  let e = [], r = t.position.line, n = t.position.character;
  for (let a = 0; a < t.lines.length; a++) {
    let i = a === 0, o = a === t.lines.length - 1, u = t.lines[a], l = 0;
    if (i && t.options.start) {
      let f = t.options.start?.exec(u);
      f && (l = f.index + f[0].length);
    } else {
      let f = t.options.line?.exec(u);
      f && (l = f.index + f[0].length);
    }
    if (o) {
      let f = t.options.end?.exec(u);
      f && (u = u.substring(0, f.index));
    }
    if (u = u.substring(0, SN(u)), Jc(u, l) >= u.length) {
      if (e.length > 0) {
        let f = se.create(r, n);
        e.push({
          type: "break",
      ...
      let f = Yv.exec(u);
      if (f) {
        let p = f[0], d = f[1], y = se.create(r, n + l), h = se.create(r, n + l + p.length);
        e.push({
          type: "tag",
          content: d,
          range: te.create(y, h)
      ...
      if (l < u.length) {
        let p = u.substring(l), d = Array.from(p.matchAll(rj));
        e.push(..._N(d, p, r, n + l));
      }
    }
    r++, n = 0;
...
function _N(t, e, r, n) {
  let a = [];
  if (t.length === 0) {
    let i = se.create(r, n), o = se.create(r, n + e.length);
    a.push({
      type: "text",
      content: e,
      range: te.create(i, o)
    ...
    for (let u of t) {
      ...
      if (a.push({
        ...
        a.push({
          type: "text",
          content: "",
          range: te.create(se.create(r, i + f + n), se.create(r, i + f + n))
        });
      i = l + u[0].length;
    }
    let o = e.substring(i);
    o.length > 0 && a.push({
      type: "text",
      content: o,
      range: te.create(se.create(r, i + n), se.create(r, i + n + o.length))
    });
  }
  return a;
}
s(_N, "buildInlineTokens");
var nj = /\S/, aj = /\s*$/;
function Jc(t, e) {
  let r = t.substring(e).match(nj);
...
s(SN, "lastCharacter");
function wN(t) {
  let e = se.create(t.position.line, t.position.character);
  if (t.tokens.length === 0)
    return new Xv([], te.create(e, e));
  let r = [];
  for (; t.index < t.tokens.length; ) {
    let i = IN(t, r[r.length - 1]);
    i && r.push(i);
  }
  let n = r[0]?.range.start ?? e, a = r[r.length - 1]?.range.end ?? e;
  return new Xv(r, te.create(n, a));
}
s(wN, "parseJSDocComment");
function IN(t, e) {
...
s(IN, "parseJSDocElement");
function NN(t, e) {
  if (e) {
    let r = new LN("", t.range);
    "inlines" in e ? e.inlines.push(r) : e.content.inlines.push(r);
  }
}
s(NN, "appendEmptyLine");
function vg(t) {
  let e = t.tokens[t.index], r = e, n = e, a = [];
  for (; e && e.type !== "break" && e.type !== "tag"; )
    a.push(PN(t)), n = e, e = t.tokens[t.index];
  return new vm(a, te.create(r.range.start, n.range.end));
}
s(vg, "parseJSDocText");
function PN(t) {
  return t.tokens[t.index].type === "inline-tag" ? Tg(t, !0) : $g(t);
}
s(PN, "parseJSDocInline");
function Tg(t, e) {
  let r = t.tokens[t.index++], n = r.content.substring(1);
  if (t.tokens[t.index]?.type === "text")
    if (e) {
      let i = $g(t);
      return new Tp(n, new vm([i], i.range), e, te.create(r.range.start, i.range.end));
    } else {
      let i = vg(t);
      return new Tp(n, i, e, te.create(r.range.start, i.range.end));
    }
  else {
    let i = r.range;
    return new Tp(n, new vm([], i), e, i);
  }
}
s(Tg, "parseJSDocTag");
function $g(t) {
  let e = t.tokens[t.index++];
  return new LN(e.content, e.range);
}
s($g, "parseJSDocLine");
function up(t) {
  if (!t)
...
s(up, "normalizeOptions");
function sc(t, e) {
  if (typeof t == "string" || typeof t == "object") {
    let r = typeof t == "string" ? bo(t) : t.source;
    return e ? new RegExp(`^\\s*${r}`) : new RegExp(`\\s*${r}\\s*$`);
  } else
    return t;
}
s(sc, "normalizeOption");
var Bs, Xv = (Bs = class {
  constructor(e, r) {
  ...
  toMarkdown(e) {
    ...
    for (let n of this.elements)
      if (r.length === 0)
        ...
        let a = n.toMarkdown(e);
        r += Tm(r) + a;
      }
    return r.trim();
  }
}, s(Bs, "JSDocCommentImpl"), Bs), qs, Tp = (qs = class {
  constructor(e, r, n, a) {
...
function kN(t, e, r) {
  if (t === "linkplain" || t === "linkcode" || t === "link") {
    ...
    return (t === "linkcode" || t === "link" && r.link === "code") && (a = `\`${a}\``), r.renderLink?.(e, a) ?? ON(e, a);
  }
}
s(kN, "renderInlineTag");
function ON(t, e) {
  try {
...
var Ws, vm = (Ws = class {
  ...
  toString() {
    ...
    for (let r = 0; r < this.inlines.length; r++) {
      let n = this.inlines[r], a = this.inlines[r + 1];
...
`);
  ...
  toMarkdown(e) {
    ...
    for (let n = 0; n < this.inlines.length; n++) {
      let a = this.inlines[n], i = this.inlines[n + 1];
      r += a.toMarkdown(e), i && i.range.start.line > a.range.start.line && (r += `
`);
    }
    return r;
  }
}, s(Ws, "JSDocTextImpl"), Ws), Vs, LN = (Vs = class {
  constructor(e, r) {
...
var Hs, DN = (Hs = class {
  ...
  documentationLinkRenderer(e, r, n) {
    let a = this.findNameInLocalSymbols(e, r) ?? this.findNameInGlobalScope(e, r);
    if (a && a.nameSegment) {
      let i = a.nameSegment.range.start.line + 1, o = a.nameSegment.range.start.character + 1, u = a.documentUri.with({ fragment: `L${i},${o}` });
      return `[${n}](${u.toString()})`;
    } else
      return;
  }
  ...
  findNameInLocalSymbols(e, r) {
    let a = Gt(e).localSymbols;
    if (!a)
      return;
    let i = e;
    do {
      let u = a.getStream(i).find((l) => l.name === r);
      if (u)
        return u;
      i = i.$container;
    } while (i);
...
}, s(Hs, "JSDocDocumentationProvider"), Hs), Ys, xN = (Ys = class {
  constructor(e) {
    this.grammarConfig = () => e.parser.GrammarConfig;
  }
  getComment(e) {
    return cg(e) ? e.$comment : vh(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
  }
}, s(Ys, "DefaultCommentProvider"), Ys), Xs, MN = (Xs = class {
  constructor(e) {
...
}, s(Xs, "DefaultAsyncParser"), Xs), Js, ij = (Js = class {
  constructor(e) {
  ...
  async parse(e, r) {
    let n = await this.acquireParserWorker(r), a = new _r(), i, o = r.onCancellationRequested(() => {
      i = setTimeout(() => {
        this.terminateWorker(n);
      }, this.terminationDelay);
    });
    return n.parse(e).then((u) => {
      let l = this.hydrator.hydrate(u);
      a.resolve(l);
    }).catch((u) => {
      a.reject(u);
    }).finally(() => {
  ...
  terminateWorker(e) {
    e.terminate();
    let r = this.workerPool.indexOf(e);
    r >= 0 && this.workerPool.splice(r, 1);
  }
  async acquireParserWorker(e) {
    this.initializeWorkers();
    for (let n of this.workerPool)
      if (n.ready)
        return n.lock(), n;
    let r = new _r();
    return e.onCancellationRequested(() => {
      let n = this.queue.indexOf(r);
      n >= 0 && this.queue.splice(n, 1), r.reject(rr);
    }), this.queue.push(r), r.promise;
  }
}, s(Js, "AbstractThreadedAsyncParser"), Js), Zs, sj = (Zs = class {
  get ready() {
    return this._ready;
  }
  get onReady() {
  ...
  constructor(e, r, n, a) {
    this.onReadyEmitter = new sp.Emitter(), this.deferred = new _r(), this._ready = !0, this._parsing = !1, this.sendMessage = e, this._terminate = a, r((i) => {
      let o = i;
  ...
  terminate() {
    this.deferred.reject(rr), this._terminate();
  }
  lock() {
    this._ready = !1;
  }
  ...
  parse(e) {
    ...
    return this._parsing = !0, this.deferred = new _r(), this.sendMessage(e), this.deferred.promise;
  }
}, s(Zs, "ParserWorker"), Zs), Qs, GN = (Qs = class {
  constructor() {
    this.previousTokenSource = new Te.CancellationTokenSource(), this.writeQueue = [], this.readQueue = [], this.done = !0;
  }
  write(e) {
    this.cancelWrite();
    let r = np();
  ...
  enqueue(e, r, n = Te.CancellationToken.None) {
    let a = new _r(), i = {
      action: r,
      deferred: a,
      cancellationToken: n
  ...
  async performNextOperation() {
    ...
    this.done = !1, await Promise.all(e.map(async ({ action: r, deferred: n, cancellationToken: a }) => {
      try {
        let i = await Promise.resolve().then(() => r(a));
        n.resolve(i);
      } catch (i) {
        na(i) ? n.resolve(void 0) : n.reject(i);
      }
...
}, s(Qs, "DefaultWorkspaceLock"), Qs), eo, FN = (eo = class {
  constructor(e) {
    this.grammarElementIdMap = new Hc(), this.tokenTypeIdMap = new Hc(), this.grammar = e.Grammar, this.lexer = e.parser.Lexer, this.linker = e.references.Linker;
  }
  dehydrate(e) {
    return {
    ...
    for (let [a, i] of Object.entries(e))
      if (!a.startsWith("$"))
        if (Array.isArray(i)) {
          ...
          n[a] = o;
          for (let u of i)
            je(u) ? o.push(this.dehydrateAstNode(u, r)) : it(u) ? o.push(this.dehydrateReference(u, r)) : o.push(u);
        } else je(i) ? n[a] = this.dehydrateAstNode(i, r) : it(i) ? n[a] = this.dehydrateReference(i, r) : i !== void 0 && (n[a] = i);
    return n;
  }
  ...
  dehydrateCstNode(e, r) {
    let n = r.cstNodes.get(e);
    return rf(e) ? n.fullText = e.fullText : n.grammarSource = this.getGrammarElementId(e.grammarSource), n.hidden = e.hidden, n.astNode = r.astNodes.get(e.astNode), vr(e) ? n.content = e.content.map((a) => this.dehydrateCstNode(a, r)) : Gn(e) && (n.tokenType = e.tokenType.name, n.offset = e.offset, n.length = e.length, n.startLine = e.range.start.line, n.startColumn = e.range.start.character, n.endLine = e.range.end.line, n.endColumn = e.range.end.character), n;
  }
  hydrate(e) {
    let r = e.value, n = this.createHydrationContext(r);
  ...
  createHydrationContext(e) {
    ...
    let a;
    if (e.$cstNode)
      for (let i of go(e.$cstNode)) {
        let o;
        "fullText" in i ? (o = new Hy(i.fullText), a = o) : "content" in i ? o = new Zf() : "tokenType" in i && (o = this.hydrateCstLeafNode(i)), o && (n.set(i, o), o.root = a);
      }
    return {
      astNodes: r,
      cstNodes: n
    ...
    for (let [a, i] of Object.entries(e))
      if (!a.startsWith("$"))
        if (Array.isArray(i)) {
          ...
          n[a] = o;
          for (let u of i)
            je(u) ? o.push(this.setParent(this.hydrateAstNode(u, r), n)) : it(u) ? o.push(this.hydrateReference(u, n, a, r)) : o.push(u);
        } else je(i) ? n[a] = this.setParent(this.hydrateAstNode(i, r), n) : it(i) ? n[a] = this.hydrateReference(i, n, a, r) : i !== void 0 && (n[a] = i);
    return n;
  }
  setParent(e, r) {
  ...
  hydrateCstNode(e, r, n = 0) {
    ...
    if (typeof e.grammarSource == "number" && (a.grammarSource = this.getGrammarElement(e.grammarSource)), a.astNode = r.astNodes.get(e.astNode), vr(a))
      for (let i of e.content) {
        let o = this.hydrateCstNode(i, r, n++);
        a.content.push(o);
      }
    return a;
  }
  hydrateCstLeafNode(e) {
    let r = this.getTokenType(e.tokenType), n = e.offset, a = e.length, i = e.startLine, o = e.startColumn, u = e.endLine, l = e.endColumn, c = e.hidden;
    return new Kc(n, a, {
      start: {
        line: i,
        character: o
  ...
  createGrammarElementIdMap() {
    let e = 0;
    for (let r of Ft(this.grammar))
      nf(r) && this.grammarElementIdMap.set(r, e++);
  }
}, s(eo, "DefaultHydrator"), eo);
function Rg(t) {
  return {
    documentation: {
      CommentProvider: /* @__PURE__ */ s((e) => new xN(e), "CommentProvider"),
      DocumentationProvider: /* @__PURE__ */ s((e) => new DN(e), "DocumentationProvider")
    },
    parser: {
      AsyncParser: /* @__PURE__ */ s((e) => new MN(e), "AsyncParser"),
      GrammarConfig: /* @__PURE__ */ s((e) => Uh(e), "GrammarConfig"),
      LangiumParser: /* @__PURE__ */ s((e) => eg(e), "LangiumParser"),
      CompletionParser: /* @__PURE__ */ s((e) => Qy(e), "CompletionParser"),
      ValueConverter: /* @__PURE__ */ s(() => new rg(), "ValueConverter"),
      TokenBuilder: /* @__PURE__ */ s(() => new tp(), "TokenBuilder"),
      Lexer: /* @__PURE__ */ s((e) => new mg(e), "Lexer"),
      ParserErrorMessageProvider: /* @__PURE__ */ s(() => new Xy(), "ParserErrorMessageProvider"),
      LexerErrorMessageProvider: /* @__PURE__ */ s(() => new CN(), "LexerErrorMessageProvider")
    },
    workspace: {
      AstNodeLocator: /* @__PURE__ */ s(() => new TN(), "AstNodeLocator"),
      AstNodeDescriptionProvider: /* @__PURE__ */ s((e) => new gN(e), "AstNodeDescriptionProvider"),
      ReferenceDescriptionProvider: /* @__PURE__ */ s((e) => new vN(e), "ReferenceDescriptionProvider")
    },
    references: {
      Linker: /* @__PURE__ */ s((e) => new iN(e), "Linker"),
      NameProvider: /* @__PURE__ */ s(() => new sN(), "NameProvider"),
      ScopeProvider: /* @__PURE__ */ s((e) => new fN(e), "ScopeProvider"),
      ScopeComputation: /* @__PURE__ */ s((e) => new lN(e), "ScopeComputation"),
      References: /* @__PURE__ */ s((e) => new oN(e), "References")
    },
    serializer: {
      Hydrator: /* @__PURE__ */ s((e) => new FN(e), "Hydrator"),
      JsonSerializer: /* @__PURE__ */ s((e) => new pN(e), "JsonSerializer")
    },
    validation: {
      DocumentValidator: /* @__PURE__ */ s((e) => new yN(e), "DocumentValidator"),
      ValidationRegistry: /* @__PURE__ */ s((e) => new mN(e), "ValidationRegistry")
    },
    shared: /* @__PURE__ */ s(() => t.shared, "shared")
  };
}
s(Rg, "createDefaultCoreModule");
function Ag(t) {
  return {
    ServiceRegistry: /* @__PURE__ */ s((e) => new dN(e), "ServiceRegistry"),
    workspace: {
      LangiumDocuments: /* @__PURE__ */ s((e) => new aN(e), "LangiumDocuments"),
      LangiumDocumentFactory: /* @__PURE__ */ s((e) => new nN(e), "LangiumDocumentFactory"),
      DocumentBuilder: /* @__PURE__ */ s((e) => new RN(e), "DocumentBuilder"),
      IndexManager: /* @__PURE__ */ s((e) => new AN(e), "IndexManager"),
      WorkspaceManager: /* @__PURE__ */ s((e) => new EN(e), "WorkspaceManager"),
      FileSystemProvider: /* @__PURE__ */ s((e) => t.fileSystemProvider(e), "FileSystemProvider"),
      WorkspaceLock: /* @__PURE__ */ s(() => new GN(), "WorkspaceLock"),
      ConfigurationProvider: /* @__PURE__ */ s((e) => new $N(e), "ConfigurationProvider")
    },
    profilers: {}
  };
}
s(Ag, "createDefaultSharedCoreModule");
var $m;
(function(t) {
  t.merge = (e, r) => Ao(Ao({}, e), r);
})($m || ($m = {}));
function Zc(t, e, r, n, a, i, o, u, l) {
  let c = [t, e, r, n, a, i, o, u, l].reduce(Ao, {});
  return Cg(c);
}
s(Zc, "inject");
var zN = /* @__PURE__ */ Symbol("isProxy");
function Eg(t) {
  if (t && t[zN])
...
function Cg(t, e) {
  let r = new Proxy({}, {
    ...
    get: /* @__PURE__ */ s((n, a) => a === zN ? !0 : Rm(n, a, t, e || r), "get"),
    getOwnPropertyDescriptor: /* @__PURE__ */ s((n, a) => (Rm(n, a, t, e || r), Object.getOwnPropertyDescriptor(n, a)), "getOwnPropertyDescriptor"),
    // used by for..in
...
function Rm(t, e, r, n) {
  if (e in t) {
    ...
    t[e] = Jv;
    try {
      t[e] = typeof a == "function" ? a(n) : Cg(a, n);
    } catch (i) {
  ...
  if (e) {
    for (let [r, n] of Object.entries(e))
      if (n != null)
        if (typeof n == "object") {
          let a = t[r];
          typeof a == "object" && a !== null ? t[r] = Ao(a, n) : t[r] = Ao({}, n);
        } else
          t[r] = n;
  }
  return t;
...
var to, jN = (to = class extends tp {
  ...
  buildTokens(e, r) {
    let n = super.buildTokens(e, r);
    if (!op(n))
      throw new Error("Invalid tokens built by default builder");
    let { indentTokenName: a, dedentTokenName: i, whitespaceTokenName: o, ignoreIndentationDelimiters: u } = this.options, l, c, f, p = [];
    for (let d of n) {
      for (let [y, h] of u)
        d.name === y ? d.PUSH_MODE = wn.IGNORE_INDENTATION : d.name === h && (d.POP_MODE = !0);
    ...
    return u.length > 0 ? {
      modes: {
        [wn.REGULAR]: [l, c, ...p, f],
        [wn.IGNORE_INDENTATION]: [...p, f]
      },
      defaultMode: wn.REGULAR
    } : [l, c, f, ...p];
  }
  flushLexingReport(e) {
    return {
...
`.includes(e[r - 1]);
  ...
  createIndentationTokenInstance(e, r, n, a) {
    let i = this.getLineNumber(r, a);
    return vu(e, n, a, a + n.length, i, i, 1, n.length);
  }
  /**
  ...
  indentMatcher(e, r, n, a) {
    if (!this.isStartOfLine(e, r))
      return null;
    let { currIndentLevel: i, prevIndentLevel: o, match: u } = this.matchWhitespace(e, r, n, a);
  ...
  dedentMatcher(e, r, n, a) {
    ...
    let c = this.indentationStack.length - l - 1, f = e.substring(0, r).match(/[\r\n]+$/)?.[0].length ?? 1;
    for (let p = 0; p < c; p++) {
      let d = this.createIndentationTokenInstance(
      ...
      n.push(d), this.indentationStack.pop();
    }
    return null;
  }
  buildTerminalToken(e) {
    let r = super.buildTerminalToken(e), { indentTokenName: n, dedentTokenName: a, whitespaceTokenName: i } = this.options;
    return r.name === n ? this.indentTokenType : r.name === a ? this.dedentTokenType : r.name === i ? Ua({
      name: i,
...
}, s(to, "IndentationAwareTokenBuilder"), to), ro, oj = (ro = class extends mg {
  constructor(e) {
    if (super(e), e.parser.TokenBuilder instanceof jN)
  ...
  tokenize(e, r = dg) {
    let n = super.tokenize(e), a = n.report;
    r?.mode === "full" && n.tokens.push(...a.remainingDedents), a.remainingDedents = [];
    let { indentTokenType: i, dedentTokenType: o } = this.indentationTokenBuilder, u = i.tokenTypeIdx, l = o.tokenTypeIdx, c = [], f = n.tokens.length - 1;
    for (let p = 0; p < f; p++) {
      let d = n.tokens[p], y = n.tokens[p + 1];
      if (d.tokenTypeIdx === u && y.tokenTypeIdx === l) {
        p++;
        continue;
      }
      c.push(d);
...
}, s(ro, "IndentationAwareLexer"), ro), bg = {};
Wr(bg, {
  AstUtils: () => Wm,
  BiMap: () => Hc,
  Cancellation: () => Te,
...
var no, UN = (no = class {
...
}, s(no, "EmptyFileSystemProvider"), no), KN = {
  fileSystemProvider: /* @__PURE__ */ s(() => new UN(), "fileSystemProvider")
}, lj = {
  Grammar: /* @__PURE__ */ s(() => {
  }, "Grammar"),
  ...
  AstReflection: /* @__PURE__ */ s(() => new dh(), "AstReflection")
};
function BN() {
  let t = Zc(Ag(KN), uj), e = Zc(Rg({ shared: t }), lj);
  return t.ServiceRegistry.register(e), e;
}
s(BN, "createMinimalGrammarServices");
function Ye(t) {
  let e = BN(), r = e.serializer.JsonSerializer.deserialize(t);
  return e.shared.workspace.LangiumDocumentFactory.fromModel(r, Rt.parse(`memory:/${r.name ?? "grammar"}.langium`)), r;
}
s(Ye, "loadGrammarFromJson");
Qc(t$, bg);
var ao, cj = (ao = class {
  constructor(e) {
    this.activeCategories = /* @__PURE__ */ new Set(), this.allCategories = /* @__PURE__ */ new Set(["validating", "parsing", "linking"]), this.activeCategories = e ?? new Set(this.allCategories), this.records = new Sr();
  }
  isActive(e) {
  ...
  createTask(e, r) {
    ...
    return console.log(`Creating profiling task for '${e}.${r}'.`), new qN((n) => this.records.add(e, this.dumpRecord(e, n)), r);
  }
  dumpRecord(e, r) {
    console.info(`Task ${e}.${r.identifier} executed in ${r.duration.toFixed(2)}ms and ended at ${r.date.toISOString()}`);
    let n = [];
    for (let o of r.entries.keys()) {
      let u = r.entries.get(o), l = u.reduce((c, f) => c + f);
      n.push({ name: `${r.identifier}.${o}`, count: u.length, duration: l });
    }
    let a = r.duration - n.map((o) => o.duration).reduce((o, u) => o + u, 0);
...
}, s(ao, "DefaultLangiumProfiler"), ao), io, qN = (io = class {
  constructor(e, r) {
    this.stack = [], this.entries = new Sr(), this.addRecord = e, this.identifier = r;
  }
  start() {
...
function fj(t) {
  return Fe.isInstance(t, Jt.$type);
}
s(fj, "isArchitecture");
var Pu = {
  $type: "Axis",
...
function pj(t) {
  return Fe.isInstance(t, oc.$type);
}
s(pj, "isBranch");
var iT = {
  $type: "Checkout",
...
function dj(t) {
  return Fe.isInstance(t, Ea.$type);
}
s(dj, "isCommit");
var Ou = {
  $type: "Common",
...
function mj(t) {
  return Fe.isInstance(t, cn.$type);
}
s(mj, "isCynefin");
var Du = {
  $type: "Deaccelerator",
...
function hj(t) {
  return Fe.isInstance(t, lc.$type);
}
s(hj, "isDomainBlock");
var Gm = {
  $type: "DomainItem",
...
function yj(t) {
  return Fe.isInstance(t, Gm.$type);
}
s(yj, "isDomainItem");
var oT = {
  $type: "EbnfChoice",
...
function vj(t) {
  return Fe.isInstance(t, mr.$type);
}
s(vj, "isEmResetFrame");
var Lr = {
  $type: "EmTimeFrame",
...
function Tj(t) {
  return Fe.isInstance(t, fn.$type);
}
s(Tj, "isGitGraph");
var nl = {
  $type: "Group",
...
function Rj(t) {
  return Fe.isInstance(t, Ca.$type);
}
s(Rj, "isMerge");
var Fu = {
  $type: "Note",
...
function Aj(t) {
  return Fe.isInstance(t, ba.$type);
}
s(Aj, "isPacket");
var _a = {
  $type: "PacketBlock",
...
function Ej(t) {
  return Fe.isInstance(t, _a.$type);
}
s(Ej, "isPacketBlock");
var RT = {
  $type: "PegAny",
...
function Cj(t) {
  return Fe.isInstance(t, pn.$type);
}
s(Cj, "isPie");
var uc = {
  $type: "PieSection",
...
function bj(t) {
  return Fe.isInstance(t, uc.$type);
}
s(bj, "isPieSection");
var Dp = {
  $type: "Pipeline",
...
function _j(t) {
  return Fe.isInstance(t, Sa.$type);
}
s(_j, "isRailroad");
var wa = {
  $type: "RailroadAbnf",
...
function Sj(t) {
  return Fe.isInstance(t, wa.$type);
}
s(Sj, "isRailroadAbnf");
var ST = {
...
function wj(t) {
  return Fe.isInstance(t, Ia.$type);
}
s(wj, "isRailroadEbnf");
var pr = {
...
function Ij(t) {
  return Fe.isInstance(t, Na.$type);
}
s(Ij, "isRailroadPeg");
var xp = {
  $type: "RailroadRule",
...
function Nj(t) {
  return Fe.isInstance(t, Rl.$type);
}
s(Nj, "isTransition");
var Pa = {
  $type: "Treemap",
...
function Pj(t) {
  return Fe.isInstance(t, Pa.$type);
}
s(Pj, "isTreemap");
var Fp = {
  $type: "TreemapRow",
...
function kj(t) {
  return Fe.isInstance(t, Ze.$type);
}
s(kj, "isWardley");
var so, WN = (so = class extends qm {
  constructor() {
    super(...arguments), this.types = {
      AbnfAlternation: {
        name: Zv.$type,
      ...
      EmGwt: {
        ...
        properties: {
          givenStatements: {
            name: rl.givenStatements,
            defaultValue: []
          },
          sourceFrame: {
            name: rl.sourceFrame,
            referenceType: en.$type
          },
          thenStatements: {
            name: rl.thenStatements,
            defaultValue: []
          },
          whenStatements: {
            name: rl.whenStatements,
            defaultValue: []
          }
        },
        superTypes: []
      ...
      EmGwtStatement: {
        ...
        properties: {
          entityIdentifier: {
            name: TT.entityIdentifier,
            referenceType: Sp.$type
          }
        },
        superTypes: []
      },
      ...
      EmResetFrame: {
        ...
        properties: {
          dataInlineValue: {
            name: mr.dataInlineValue
          },
          dataReference: {
            name: mr.dataReference,
            referenceType: da.$type
          },
          dataType: {
            name: mr.dataType
          },
          entityIdentifier: {
            name: mr.entityIdentifier
          },
          modelEntityType: {
            name: mr.modelEntityType
          },
          name: {
            name: mr.name
          },
          sourceFrames: {
            name: mr.sourceFrames,
            defaultValue: [],
            referenceType: en.$type
          }
        },
      ...
      TreeNode: {
        ...
        properties: {
          classAnnotation: {
            name: ya.classAnnotation
          },
          descAnnotation: {
            name: ya.descAnnotation
          },
          iconAnnotation: {
            name: ya.iconAnnotation
          },
          indent: {
            name: ya.indent
          },
  ...
  AstReflection: /* @__PURE__ */ s(() => new WN(), "AstReflection")
}, vU = {
  Grammar: /* @__PURE__ */ s(() => Oj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => Hj, "LanguageMetaData"),
  parser: {}
}, TU = {
  Grammar: /* @__PURE__ */ s(() => Lj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => Yj, "LanguageMetaData"),
  parser: {}
}, $U = {
  Grammar: /* @__PURE__ */ s(() => Dj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => Xj, "LanguageMetaData"),
  parser: {}
}, RU = {
  Grammar: /* @__PURE__ */ s(() => xj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => Jj, "LanguageMetaData"),
  parser: {}
}, AU = {
  Grammar: /* @__PURE__ */ s(() => Mj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => Zj, "LanguageMetaData"),
  parser: {}
}, EU = {
  Grammar: /* @__PURE__ */ s(() => Gj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => Qj, "LanguageMetaData"),
  parser: {}
}, CU = {
  Grammar: /* @__PURE__ */ s(() => Fj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => eU, "LanguageMetaData"),
  parser: {}
}, bU = {
  Grammar: /* @__PURE__ */ s(() => zj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => tU, "LanguageMetaData"),
  parser: {}
}, _U = {
  Grammar: /* @__PURE__ */ s(() => jj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => rU, "LanguageMetaData"),
  parser: {}
}, SU = {
  Grammar: /* @__PURE__ */ s(() => Uj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => nU, "LanguageMetaData"),
  parser: {}
}, wU = {
  Grammar: /* @__PURE__ */ s(() => Kj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => aU, "LanguageMetaData"),
  parser: {}
}, IU = {
  Grammar: /* @__PURE__ */ s(() => Bj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => iU, "LanguageMetaData"),
  parser: {}
}, NU = {
  Grammar: /* @__PURE__ */ s(() => qj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => sU, "LanguageMetaData"),
  parser: {}
}, PU = {
  Grammar: /* @__PURE__ */ s(() => Wj(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ s(() => oU, "LanguageMetaData"),
  parser: {}
}, kU = {
  Grammar: /* @__PURE__ */ s(() => Vj(), "Grammar"),
...
}, s(oo, "AbstractMermaidValueConverter"), oo), lo, OU = (lo = class extends dU {
  runCustomConverter(e, r, n) {
  }
}, s(lo, "CommonValueConverter"), lo), uo, mU = (uo = class extends tp {
  constructor(e) {
    super(), this.keywords = new Set(e);
  }
  buildKeywordTokens(e, r, n) {
    let a = super.buildKeywordTokens(e, r, n);
    return a.forEach((i) => {
      this.keywords.has(i.name) && i.PATTERN !== void 0 && (i.PATTERN = new RegExp(i.PATTERN.toString() + "(?:(?=%%)|(?!\\S))"));
    }), a;
  }
}, s(uo, "AbstractMermaidTokenBuilder"), uo), co, LU = (co = class extends mU {
}, s(co, "CommonTokenBuilder"), co);
...
/*! For license information please see chunk-LEOT2I4D.js.LEGAL.txt */
