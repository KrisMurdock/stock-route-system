...
var Ae = ye((Y, J) => {
  (function(n) {
    "use strict";
    var e = function() {
    }, r = n.requestAnimationFrame || n.webkitRequestAnimationFrame || n.mozRequestAnimationFrame || n.msRequestAnimationFrame || function(c) {
      return setTimeout(c, 16);
    };
    function s() {
      var c = this;
      c.reads = [], c.writes = [], c.raf = r.bind(n), e("initialized", c);
    }
    s.prototype = {
      constructor: s,
      /**
       ...
       */
      extend: function(c) {
        if (e("extend", c), typeof c != "object") throw new Error("expected object");
        var p = Object.create(this);
        return o(p, c), p.fastdom = this, p.initialize && p.initialize(), p;
      },
    ...
    function t(c) {
      c.scheduled || (c.scheduled = !0, c.raf(l.bind(null, c)), e("flush scheduled"));
    }
    function l(c) {
      e("flush");
      var p = c.writes, h = c.reads, u;
      try {
        e("flushing reads", h.length), c.runTasks(h), e("flushing writes", p.length), c.runTasks(p);
      } catch (f) {
        u = f;
      }
...
var Le = ye((Jt, ee) => {
  (function() {
    var n = {
      ...
      clear: function(r) {
        var s = this._tasks, t = s.get(r);
        this.fastdom.clear(t), s.delete(r);
      }
    };
    function e(r, s, t, l) {
      var i = r._tasks, o = r.fastdom, a, c = new Promise(function(p, h) {
        a = o[s](function() {
          i.delete(c);
          try {
            p(l ? t.call(l) : t());
    ...
    (typeof define)[0] == "f" ? define(function() {
      return n;
    }) : (typeof ee)[0] == "o" ? ee.exports = n : window.fastdomPromised = n;
  })();
});

// node_modules/mermaid/dist/chunks/mermaid.core/chunk-GMAD6QVW.mjs
var Ke = Te(Ae(), 1), Xe = Te(Le(), 1);
...
var I = { exec: () => null };
function d(n, e = "") {
  let r = typeof n == "string" ? n : n.source, s = { replace: (t, l) => {
...
})(), w = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (n) => new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}#`), htmlBeginRegex: (n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}<(?:[a-z].*>|!--)`, "i") }, ht = /^(?:[ \t]*(?:\n|$))+/, ut = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, ft = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, B = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, gt = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, ie = /(?:[*+-]|\d{1,9}[.)])/, qe = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, Oe = d(qe).replace(/bull/g, ie).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), dt = d(qe).replace(/bull/g, ie).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), le = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, kt = /^[^\n]+/, ae = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, xt = d(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", ae).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), mt = d(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, ie).getRegex(), W = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", oe = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, bt = d("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", oe).replace("tag", W).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), je = d(le).replace("hr", B).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", W).getRegex(), wt = d(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", je).getRegex(), ce = { blockquote: wt, code: ut, def: xt, fences: ft, heading: gt, hr: B, html: bt, lheading: Oe, list: mt, newline: ht, paragraph: je, table: I, text: kt }, _e = d("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", B).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", W).getRegex(), yt = { ...ce, lheading: dt, table: _e, paragraph: d(le).replace("hr", B).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", _e).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", W).getRegex() }, Tt = { ...ce, html: d(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", oe).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: I, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: d(le).replace("hr", B).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", Oe).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, $t = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, St = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Fe = /^( {2,}|\\)\n(?!\s*$)/, Rt = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, Z = /[\p{P}\p{S}]/u, pe = /[\s\p{P}\p{S}]/u, We = /[^\s\p{P}\p{S}]/u, vt = d(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, pe).getRegex(), Ze = /(?!~)[\p{P}\p{S}]/u, zt = /(?!~)[\s\p{P}\p{S}]/u, At = /(?:[^\s\p{P}\p{S}]|~)/u, Lt = d(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", pt ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), De = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, _t = d(De, "u").replace(/punct/g, Z).getRegex(), Pt = d(De, "u").replace(/punct/g, Ze).getRegex(), He = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", Et = d(He, "gu").replace(/notPunctSpace/g, We).replace(/punctSpace/g, pe).replace(/punct/g, Z).getRegex(), It = d(He, "gu").replace(/notPunctSpace/g, At).replace(/punctSpace/g, zt).replace(/punct/g, Ze).getRegex(), Bt = d("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, We).replace(/punctSpace/g, pe).replace(/punct/g, Z).getRegex(), Ct = d(/\\(punct)/, "gu").replace(/punct/g, Z).getRegex(), Mt = d(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), qt = d(oe).replace("(?:-->|$)", "-->").getRegex(), Ot = d("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", qt).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), O = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, jt = d(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", O).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), Ne = d(/^!?\[(label)\]\[(ref)\]/).replace("label", O).replace("ref", ae).getRegex(), Ge = d(/^!?\[(ref)\](?:\[\])?/).replace("ref", ae).getRegex(), Ft = d("reflink|nolink(?!\\()", "g").replace("reflink", Ne).replace("nolink", Ge).getRegex(), Pe = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, he = { _backpedal: I, anyPunctuation: Ct, autolink: Mt, blockSkip: Lt, br: Fe, code: St, del: I, emStrongLDelim: _t, emStrongRDelimAst: Et, emStrongRDelimUnd: Bt, escape: $t, link: jt, nolink: Ge, punctuation: vt, reflink: Ne, reflinkSearch: Ft, tag: Ot, text: Rt, url: I }, Wt = { ...he, link: d(/^!?\[(label)\]\((.*?)\)/).replace("label", O).getRegex(), reflink: d(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", O).getRegex() }, te = { ...he, emStrongRDelimAst: It, emStrongLDelim: Pt, url: d(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", Pe).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: d(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", Pe).getRegex() }, Zt = { ...te, br: d(Fe).replace("{2,}", "*").getRegex(), text: d(te.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, M = { normal: ce, gfm: yt, pedantic: Tt }, _ = { normal: he, gfm: te, breaks: Zt, pedantic: Wt }, Dt = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Ee = (n) => Dt[n];
function $(n, e) {
  if (e) {
    if (w.escapeTest.test(n)) return n.replace(w.escapeReplace, Ee);
  } else if (w.escapeTestNoEncode.test(n)) return n.replace(w.escapeReplaceNoEncode, Ee);
  return n;
}
function Ie(n) {
  try {
...
${p}` : p;
        ...
        if (this.lexer.state.top = !0, this.lexer.blockTokens(p, l, !0), this.lexer.state.top = h, r.length === 0) break;
        let u = l.at(-1);
...
` + r.join(`
`), b = this.blockquote(g);
          l[l.length - 1] = b, s = s.substring(0, s.length - f.raw.length) + b.raw, t = t.substring(0, t.length - f.text.length) + b.text;
          break;
        } else if (u?.type === "list") {
          let f = u, g = f.raw + `
` + r.join(`
`), b = this.list(g);
          l[l.length - 1] = b, s = s.substring(0, s.length - u.raw.length) + b.raw, t = t.substring(0, t.length - f.raw.length) + b.raw, r = g.substring(l.at(-1).raw.length).split(`
`);
          continue;
        }
      }
  ...
  list(n) {
    ...
    if (e) {
      ...
      for (; n; ) {
        ...
        let h = e[2].split(`
`, 1)[0].replace(this.rules.other.listReplaceTabs, (G) => " ".repeat(3 * G.length)), u = n.split(`
`, 1)[0], f = !h.trim(), g = 0;
        if (this.options.pedantic ? (g = 2, p = h.trimStart()) : f ? g = e[1].length + 1 : (g = e[2].search(this.rules.other.nonSpaceChar), g = g > 4 ? 1 : g, p = h.slice(g), g += e[1].length), f && this.rules.other.blankLine.test(u) && (c += u + `
`, n = n.substring(u.length + 1), a = !0), !a) {
          let G = this.rules.other.nextBulletRegex(g), me = this.rules.other.hrRegex(g), be = this.rules.other.fencesBeginRegex(g), we = this.rules.other.headingBeginRegex(g), ct = this.rules.other.htmlBeginRegex(g);
          for (; n; ) {
            let Q = n.split(`
`, 1)[0], L;
            if (u = Q, this.options.pedantic ? (u = u.replace(this.rules.other.listReplaceNesting, "  "), L = u) : L = u.replace(this.rules.other.tabCharGlobal, "    "), be.test(u) || we.test(u) || ct.test(u) || G.test(u) || me.test(u)) break;
            if (L.search(this.rules.other.nonSpaceChar) >= g || !u.trim()) p += `
` + L.slice(g);
            else {
              if (f || h.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || be.test(h) || we.test(h) || me.test(h)) break;
              p += `
` + u;
            }
            !f && !u.trim() && (f = !0), c += Q + `
`, n = n.substring(Q.length + 1), h = L.slice(g);
          }
        }
        t.loose || (i ? t.loose = !0 : this.rules.other.doubleBlankLine.test(c) && (i = !0));
        let b = null, C;
        this.options.gfm && (b = this.rules.other.listIsTask.exec(p), b && (C = b[0] !== "[ ] ", p = p.replace(this.rules.other.listReplaceTask, ""))), t.items.push({ type: "list_item", raw: c, task: !!b, checked: C, loose: !1, text: p, tokens: [] }), t.raw += c;
      }
      let o = t.items.at(-1);
      if (o) o.raw = o.raw.trimEnd(), o.text = o.text.trimEnd();
      else return;
      t.raw = t.raw.trimEnd();
      for (let a = 0; a < t.items.length; a++) if (this.lexer.state.top = !1, t.items[a].tokens = this.lexer.blockTokens(t.items[a].text, []), !t.loose) {
        let c = t.items[a].tokens.filter((h) => h.type === "space"), p = c.length > 0 && c.some((h) => this.rules.other.anyLine.test(h.raw));
        t.loose = p;
      }
  ...
  table(n) {
    ...
    let r = Be(e[1]), s = e[2].replace(this.rules.other.tableAlignChars, "").split("|"), t = e[3]?.trim() ? e[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], l = { type: "table", raw: e[0], header: [], align: [], rows: [] };
    if (r.length === s.length) {
      ...
      for (let i of t) l.rows.push(Be(i, l.header.length).map((o, a) => ({ text: o, tokens: this.lexer.inline(o), header: !1, align: l.align[a] })));
      return l;
    }
  }
  lheading(n) {
...
` ? e[1].slice(0, -1) : e[1];
  ...
  emStrong(n, e, r = "") {
    ...
    if (!(!s || s[3] && r.match(this.rules.other.unicodeAlphaNumeric)) && (!(s[1] || s[2]) || !r || this.rules.inline.punctuation.exec(r))) {
      ...
      for (c.lastIndex = 0, e = e.slice(-1 * n.length + t); (s = c.exec(e)) != null; ) {
        ...
        if (o -= i, o > 0) continue;
        i = Math.min(i, i + o + a);
        let p = [...s[0]][0].length, h = n.slice(0, t + s.index + p + i);
        if (Math.min(t, i) % 2) {
          let f = h.slice(1, -1);
          return { type: "em", raw: h, text: f, tokens: this.lexer.inlineTokens(f) };
        }
        let u = h.slice(2, -2);
        return { type: "strong", raw: h, text: u, tokens: this.lexer.inlineTokens(u) };
      }
    }
  }
  codespan(n) {
  ...
  constructor(e) {
    ...
    x(this, "tokenizer");
    x(this, "inlineQueue");
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || R, this.options.tokenizer = this.options.tokenizer || new j(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: !1, inRawBlock: !1, top: !0 };
    let r = { other: w, block: M.normal, inline: _.normal };
    this.options.pedantic ? (r.block = M.pedantic, r.inline = _.pedantic) : this.options.gfm && (r.block = M.gfm, this.options.breaks ? r.inline = _.breaks : r.inline = _.gfm), this.tokenizer.rules = r;
  }
  static get rules() {
...
` + t.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = i.text) : r.push(t);
  ...
  inlineTokens(e, r = []) {
    ...
    let l;
    for (; (t = this.tokenizer.rules.inline.blockSkip.exec(s)) != null; ) l = t[2] ? t[2].length : 0, s = s.slice(0, t.index + l) + "[" + "a".repeat(t[0].length - l - 2) + "]" + s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
    s = this.options.hooks?.emStrongMask?.call({ lexer: this }, s) ?? s;
    let i = !1, o = "";
    for (; e; ) {
      i || (o = ""), i = !1;
      let a;
      if (this.options.extensions?.inline?.some((p) => (a = p.call({ lexer: this }, e, r)) ? (e = e.substring(a.raw.length), r.push(a), !0) : !1)) continue;
      ...
      if (a = this.tokenizer.reflink(e, this.tokens.links)) {
        ...
        let p = r.at(-1);
        a.type === "text" && p?.type === "text" ? (p.raw += a.raw, p.text += a.text) : r.push(a);
        continue;
      }
      ...
      if (this.options.extensions?.startInline) {
        let p = 1 / 0, h = e.slice(1), u;
        this.options.extensions.startInline.forEach((f) => {
          u = f.call({ lexer: this }, h), typeof u == "number" && u >= 0 && (p = Math.min(p, u));
        }), p < 1 / 0 && p >= 0 && (c = e.substring(0, p + 1));
      }
      if (a = this.tokenizer.inlineText(c)) {
        e = e.substring(a.raw.length), a.raw.slice(-1) !== "_" && (o = a.raw.slice(-1)), i = !0;
        let p = r.at(-1);
        p?.type === "text" ? (p.raw += a.raw, p.text += a.text) : r.push(a);
        continue;
      }
      if (e) {
...
`;
    return s ? '<pre><code class="language-' + $(s) + '">' + (r ? t : $(t, !0)) + `</code></pre>
...
`;
  ...
  listitem(n) {
    ...
    if (n.task) {
      ...
      n.loose ? n.tokens[0]?.type === "paragraph" ? (n.tokens[0].text = r + " " + n.tokens[0].text, n.tokens[0].tokens && n.tokens[0].tokens.length > 0 && n.tokens[0].tokens[0].type === "text" && (n.tokens[0].tokens[0].text = r + " " + $(n.tokens[0].tokens[0].text), n.tokens[0].tokens[0].escaped = !0)) : n.tokens.unshift({ type: "text", raw: r + " ", text: r + " ", escaped: !0 }) : e += r + " ";
    }
...
`;
  ...
  link({ href: n, title: e, tokens: r }) {
    let s = this.parser.parseInline(r), t = Ie(n);
    if (t === null) return s;
    n = t;
    let l = '<a href="' + n + '"';
  ...
  constructor(e) {
    ...
    x(this, "renderer");
    x(this, "textRenderer");
    this.options = e || R, this.options.renderer = this.options.renderer || new F(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new ue();
  }
  static parse(e, r) {
...
` + this.renderer.text(o);
          r ? s += this.renderer.paragraph({ type: "paragraph", raw: a, text: a, tokens: [{ type: "text", raw: a, text: a, escaped: !0 }] }) : s += a;
          continue;
        }
        default: {
...
}, x(q, "passThroughHooks", /* @__PURE__ */ new Set(["preprocess", "postprocess", "processAllTokens", "emStrongMask"])), x(q, "passThroughHooksRespectAsync", /* @__PURE__ */ new Set(["preprocess", "postprocess", "processAllTokens"])), q), Gt = class {
  constructor(...n) {
    x(this, "defaults", se());
        ...
        for (let l in r.hooks) {
          ...
          E.passThroughHooks.has(l) ? t[i] = (c) => {
            ...
            if (this.defaults.async) return (async () => {
              ...
              return h === !1 && (h = await a.apply(t, c)), h;
            })();
            let p = o.apply(t, c);
            return p === !1 && (p = a.apply(t, c)), p;
          };
  ...
  parseMarkdown(n) {
    return (e, r) => {
      ...
      if (t.hooks && (t.hooks.options = t, t.hooks.block = n), t.async) return (async () => {
        let i = t.hooks ? await t.hooks.preprocess(e) : e, o = await (t.hooks ? await t.hooks.provideLexer() : n ? y.lex : y.lexInline)(i, t), a = t.hooks ? await t.hooks.processAllTokens(o) : o;
        t.walkTokens && await Promise.all(this.walkTokens(a, t.walkTokens));
        let c = await (t.hooks ? await t.hooks.provideParser() : n ? T.parse : T.parseInline)(a, t);
        return t.hooks ? await t.hooks.postprocess(c) : c;
      })().catch(l);
      try {
        t.hooks && (e = t.hooks.preprocess(e));
        let i = (t.hooks ? t.hooks.provideLexer() : n ? y.lex : y.lexInline)(e, t);
        t.hooks && (i = t.hooks.processAllTokens(i)), t.walkTokens && this.walkTokens(i, t.walkTokens);
        let o = (t.hooks ? t.hooks.provideParser() : n ? T.parse : T.parseInline)(i, t);
...
k.options = k.setOptions = function(n) {
  return S.setOptions(n), k.defaults = S.defaults, Me(k.defaults), k;
};
k.getDefaults = se;
k.defaults = R;
k.use = function(...n) {
  return S.use(...n), k.defaults = S.defaults, Me(k.defaults), k;
};
...
k.Hooks = E;
k.parse = k;
var er = k.options, tr = k.setOptions, rr = k.use, nr = k.walkTokens, sr = k.parseInline;
var ir = T.parse, lr = y.lex;
...
function Qe(n) {
  ...
  var t = s.reduce(function(o, a) {
    var c = a.match(/\n([\t ]+|(?!\s).)/g);
    return c ? o.concat(c.map(function(p) {
      var h, u;
      return (u = (h = p.match(/[\t ]/g)) === null || h === void 0 ? void 0 : h.length) !== null && u !== void 0 ? u : 0;
    })) : o;
  }, []);
  if (t.length) {
    var l = new RegExp(`
[	 ]{`.concat(Math.min.apply(Math, t), "}"), "g");
    s = s.map(function(o) {
      return o.replace(l, `
`);
    });
...
`) && (h = String(o).split(`
`).map(function(u, f) {
      return f === 0 ? u : "".concat(p).concat(u);
    }).join(`
`)), i += h + s[a + 1];
  }), i;
}
...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-GMAD6QVW.mjs
var ge = typeof performance < "u" && typeof performance.now == "function", z = /* @__PURE__ */ m(() => ge ? performance.now() : 0, "now"), fe = "\u{1F9DC} ", Qt = "Mermaid render", Ut = "Mermaid", Kt = {
  parse: "tertiary",
  prepare: "secondary",
  measure: "primary",
  layout: "primary-dark",
  ...
  stop() {
    ...
    for (; this.stack.length > 0; )
      this.end();
    let e = this.roots.at(-1), r = this.runLabel ?? e?.name;
    return e && (this.records.push({ label: r ?? e.name, tree: e, buckets: { ...this.buckets } }), this.records.length > this.maxRecords && this.records.splice(0, this.records.length - this.maxRecords), this.autoPrint && this.printSummary(e, r)), this.runLabel = void 0, e;
  }
  /** Open a child span. Pair with {@link end}. No-op unless enabled. */
  begin(e) {
    if (!this.enabled)
      return;
    let r = { name: e, start: z(), duration: -1, children: [] }, s = this.stack.at(-1);
    if (s ? s.children.push(r) : this.roots.push(r), this.stack.push(r), ge && typeof performance.mark == "function")
      try {
  ...
  /** Close the most recently opened span. No-op unless enabled. */
    ...
    if (!e)
      return;
    let r = z();
    if (e.duration = r - e.start, ge && typeof performance.measure == "function")
      try {
  ...
  printSummary(e = this.report(), r) {
    if (!e)
      return;
    let s = e.duration, t = r && r !== e.name ? `${e.name} [${r}]` : e.name, l = ["ms        %    phase"], i = /* @__PURE__ */ m((a, c) => {
      let p = "  ".repeat(c), h = a.duration.toFixed(1).padStart(8), u = s > 0 ? `${(a.duration / s * 100).toFixed(0).padStart(3)}%` : "   -";
      l.push(`${h}  ${u}  ${p}${a.name}`);
      for (let f of a.children)
        i(f, c + 1);
      if (a.children.length > 0) {
        let f = a.children.reduce((b, C) => b + C.duration, 0), g = a.duration - f;
        if (g > 0.5) {
          let b = g.toFixed(1).padStart(8);
          l.push(`${b}       ${p}  (self)`);
        }
      }
    }, "walk");
    i(e, 0);
    let o = Object.keys(this.buckets);
    if (o.length > 0) {
      l.push("\u2014\u2014 buckets (summed) \u2014\u2014");
      for (let a of o)
        l.push(`${this.buckets[a].toFixed(1).padStart(8)}       ${a}`);
    }
...
var Xt = (
  ...
  Ke.default.extend({
     ...
     */
    raf(n) {
      typeof queueMicrotask == "function" ? queueMicrotask(n) : setTimeout(n, 0);
    }
  }).extend(Xe.default)
), Vt = Xt;
...
function Ye(n) {
  return n.split(/\\n|\n|<br\s*\/?>/gi).map(
    (e) => e.trim().match(/<[^>]+>|[^\s<>]+/g)?.map((r) => ({ content: r, type: "normal" })) ?? []
  );
}
m(Ye, "nonMarkdownToLines");
function Je(n, e = {}) {
  let r = Ve(n, e), s = k.lexer(r), t = [[]], l = 0;
  function i(o, a = "normal") {
    o.type === "text" ? o.text.split(`
`).forEach((p, h) => {
      h !== 0 && (l++, t.push([])), p.split(" ").forEach((u) => {
...
function tt(n, { markdownAutoWrap: e } = {}) {
  let r = k.lexer(n);
  function s(t) {
    return t.type === "text" ? e === !1 ? t.text.replace(/\n */g, "<br/>").replace(/ /g, "&nbsp;") : t.text.replace(/\n */g, "<br/>") : t.type === "strong" ? `<strong>${t.tokens?.map(s).join("")}</strong>` : t.type === "em" ? `<em>${t.tokens?.map(s).join("")}</em>` : t.type === "paragraph" ? `<p>${t.tokens?.map(s).join("")}</p>` : t.type === "space" ? "" : t.type === "html" ? `${t.text}` : t.type === "escape" ? t.text : (U.warn(`Unsupported markdown: ${t.type}`), t.raw);
  }
...
function xe(n, e, r, s) {
  ...
  let [t, ...l] = r, i = [...e, t];
  return n([{ content: i.join(""), type: s }]) ? xe(n, i, l, s) : (e.length === 0 && t && (e.push(t), r.shift()), [
    { content: e.join(""), type: s },
...
function D(n, e, r = [], s = []) {
  if (n.length === 0)
    return s.length > 0 && r.push(s), r.length > 0 ? r : [];
  let t = "";
...
async function it(n, e, r, s, t = !1, l = $e()) {
  ...
  i.attr("width", `${Math.min(10 * r, Ue)}px`), i.attr("height", `${Math.min(10 * r, Ue)}px`);
  let o = i.append("xhtml:div"), a = X(e.label) ? await Se(e.label.replace(Re.lineBreakRegex, `
`), l) : K(e.label, l), c = e.isNode ? "nodeLabel" : "edgeLabel", p = o.append("span");
  return p.html(a), de(p, e.labelStyle), p.attr("class", `${c} ${s}`), de(o, e.labelStyle), o.style("display", "table-cell"), o.style("white-space", "nowrap"), o.style("line-height", "1.5"), r !== Number.POSITIVE_INFINITY && (o.style("max-width", r + "px"), o.style("text-align", "center")), o.attr("xmlns", "http://www.w3.org/1999/xhtml"), t && o.attr("class", "labelBkg"), (await Vt.measure(() => o.node().getBoundingClientRect())).width === r && (o.style("display", "table"), o.style("white-space", "break-spaces"), o.style("width", r + "px")), i.node();
}
m(it, "addHtmlSpan");
function H(n, e, r, s = !1) {
  let t = n.append("tspan").attr("class", "text-outer-tspan").attr("x", 0).attr("y", e * r - 0.1 + "em").attr("dy", r + "em");
  return s && t.attr("text-anchor", "middle"), t;
}
m(H, "createTspan");
function lt(n, e, r) {
  let s = n.append("text"), t = H(s, 1, e);
  N(t, r);
...
function at(n, e, r, s = !1, t = !1) {
  let i = e.append("g"), o = i.insert("rect").attr("class", "background").attr("style", "stroke: none"), a = i.append("text").attr("y", "-10.1");
  t && a.attr("text-anchor", "middle");
  let c = 0;
  for (let p of r) {
    let h = /* @__PURE__ */ m((f) => lt(i, 1.1, f) <= n, "checkWidth"), u = h(p) ? [p] : st(p, h);
    for (let f of u) {
      let g = H(a, c, 1.1, t);
      N(g, f), c++;
    }
  ...
  if (s) {
    let p = a.node().getBBox(), h = 2;
    return o.attr("x", p.x - h).attr("y", p.y - h).attr("width", p.width + 2 * h).attr("height", p.height + 2 * h), i.node();
  } else
    return a.node();
}
...
async function ot(n, e = {}) {
  let r = [];
  n.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (t, l, i) => (r.push(
    (async () => {
      let o = `${l}:${i}`;
      return await ve(o) ? await ze(o, void 0, { class: "label-icon" }) : `<i class='${K(t, e).replace(":", " ")}'></i>`;
    })()
  ), t));
...
var Sr = /* @__PURE__ */ m(async (n, e = "", {
  ...
  if (U.debug(
    ...
    let h = i ? tt(e, p) : et(e), u = await ot(V(h), p), f = e.replace(/\\\\/g, "\\"), g = {
      isNode: o,
      label: X(e) ? f : u,
    ...
    let h = V(e.replace(/<br\s*\/?>/g, "<br/>")), u = i ? Je(h.replace("<br>", "<br/>"), p) : Ye(h), f = at(
      a,
      n,
      u,
      e ? c : !1,
    ...
    if (o) {
      ...
      let g = r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
      v(f).attr("style", g);
    } else {
      let g = r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/background:/g, "fill:");
      v(f).select("rect").attr("style", g.replace(/background:/g, "fill:"));
      let b = r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
      v(f).select("text").attr("style", b);
    }
    return s ? v(f).selectAll("tspan.text-outer-tspan").classed("title-row", !0) : v(f).selectAll("tspan.text-outer-tspan").classed("row", !0), f;
  }
}, "createText");
